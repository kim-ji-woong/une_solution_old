...
namespace Assets
{
    public class UnityScene
    {
        ...
        private GameObject m_redModel = null;
        ...
        private float m_fPoiBottom = 0.0f;
        ...
        {
            get { return m_redModel; }
            set { m_redModel = value; }
        }
        ...
        public string SelectAlarmZone(Ray ray)
        {
            RaycastHit hit;
            ...
            foreach (KeyValuePair<string, GameObject> pair in m_alarmZones)
            {
                ...
                MeshCollider collider = pair.Value.GetComponent<MeshCollider>();

                if (collider != null)
                {
                    if (collider.Raycast(ray, out hit, Mathf.Infinity))
                    {
                        ShowAlarmZone(pair.Key, true);
                        return pair.Key;
                    }
                }
    ...
    public class CameraData
    {
        ...
        private float m_fOrthoCameraSize = 25.0f;
        private DBUtility2.VariousData<int> m_orthoMinSize = null;
        private DBUtility2.VariousData<int> m_orthoMaxSize = null;
        ...
        {
            get { return m_fOrthoCameraSize; }
            set { m_fOrthoCameraSize = value; }
        }

        public DBUtility2.VariousData<int> OrthoMaxSize
        {
            get { return m_orthoMaxSize; }
            set { m_orthoMaxSize = value; }
        }

        public DBUtility2.VariousData<int> OrthoMinSize
        {
            get { return m_orthoMinSize; }
            set { m_orthoMinSize = value; }
        }
    }
}

...
public class CanvasPOI : MonoBehaviour
{
    ...
    public static CanvasPOI MakeInstance(Vector3 vPos, float fDetectBottom, string strOriginalType, string strType, int nID, ref EffectPOI effectPOI)
    {
        GameObject obj = null;
        CanvasPOI poi = null;
        ...
        if (obj != null)
        {
            ...
            {
                effectPOI = EffectPOI.MakeInstance(vPos, fDetectBottom, strOriginalType, strOriginalType, nID);
            }
        }

...
public class bl_CameraOrbitEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (script.editorValues["zoom"])
        {
            ...
            EditorGUILayout.MinMaxSlider(string.Format("Distance Clamp ({0:00}|{1:00})",script.DistanceClamp.x,script.DistanceClamp.y), 
                ref script.DistanceClamp.x, ref script.DistanceClamp.y, 0, 300);
            script.ScrollSensitivity = EditorGUILayout.Slider("Zoom Sensitivity", script.ScrollSensitivity, 1, 30);
            script.ZoomSpeed = EditorGUILayout.Slider("Zoom Speed", script.ZoomSpeed, 1, 100);

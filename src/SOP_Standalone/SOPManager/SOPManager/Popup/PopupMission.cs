...
namespace SOPManager
{
    public partial class PopupMission : Form
    {
        ...
        public void UpdateControlSize()
        {
            ...
            FormMain.Instance.UpdateWindowRate(labelWarning, WindowRateWidth, WindowRateHeight, "나눔스퀘어 Bold");
        ...
        private bool CompareTeamList(ArrayList arOrgMission, ArrayList arMission)
        {
            if (arMission == null)
                return false;

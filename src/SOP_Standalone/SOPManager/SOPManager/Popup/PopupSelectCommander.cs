...
namespace SOPManager.Popup
{
    public partial class PopupSelectCommander : Form
    {
        ...
        public void UpdateControlSize()
        {
            ...
            FormMain.Instance.UpdateWindowRate(lblRegular, WindowRateWidth, WindowRateHeight, "나눔스퀘어 Bold");
            FormMain.Instance.UpdateWindowRate(picEmergency, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(lblEmergency, WindowRateWidth, WindowRateHeight, "나눔스퀘어 Bold");
            FormMain.Instance.UpdateWindowRate(picExternal, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(lblExternal, WindowRateWidth, WindowRateHeight, "나눔스퀘어 Bold");
            FormMain.Instance.UpdateWindowRate(picUserDefine, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(lblUserDefine, WindowRateWidth, WindowRateHeight, "나눔스퀘어 Bold");
            FormMain.Instance.UpdateWindowRate(picControlRoom, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(lblControlRoom, WindowRateWidth, WindowRateHeight, "나눔스퀘어 Bold");
            FormMain.Instance.UpdateWindowRate(labelTeamType, WindowRateWidth, WindowRateHeight, "나눔스퀘어 Bold");
            FormMain.Instance.UpdateWindowRate(picDefault, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(lblDefault, WindowRateWidth, WindowRateHeight, "나눔스퀘어 Bold");
            FormMain.Instance.UpdateWindowRate(labelFullPath, WindowRateWidth, WindowRateHeight, "나눔스퀘어 Bold");
            FormMain.Instance.UpdateWindowRate(label1, WindowRateWidth, WindowRateHeight, "나눔스퀘어 Bold");

...
namespace SOPManager
{
    public partial class FormSaveOption : Form
	{
		...
		public FormSaveOption()
		{
            ...
            ribbonButton1.Font = new Font("나눔스퀘어", 10f, FontStyle.Bold);
            ribbonButton2.Font = new Font("나눔스퀘어", 10f, FontStyle.Bold);
            ribbonButton3.Font = new Font("나눔스퀘어", 10f, FontStyle.Bold);
            ribbonButton4.Font = new Font("나눔스퀘어", 10f, FontStyle.Bold);

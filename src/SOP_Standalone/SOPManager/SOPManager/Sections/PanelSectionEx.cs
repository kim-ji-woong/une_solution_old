	   ...
	   this.TeamName);
        ...
        private void PopupDecisionEdit(SectionDecision section)
        {
            if (m_decisionForm == null || m_decisionForm.IsDisposed == true || m_decisionForm.IsHandleCreated == false)
            {
                ...
                m_decisionFrame.TitleTextFont = new Font("나눔스퀘어", 12.5f, FontStyle.Bold);
        ...
        /// <summary>
        /// 사용자 정의 인자 변경하는 시점에 판단문 팝업이 열려있으면 변경된 사항 적용
        /// </summary>
        public void test(int changeColumnIndex, SOPParameter param, object rollbackData)
        {
            //if (m_decisionForm != null && m_decisionFrame != null && m_decisionFrame.Visible)
            //{
            //    m_decisionForm.DisplayUserType();
            //    m_decisionForm.ttt(changeColumnIndex, param, rollbackData);                
            //}
        }

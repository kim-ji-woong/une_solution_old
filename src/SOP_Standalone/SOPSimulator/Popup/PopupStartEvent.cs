    ...
    public partial class PopupStartEvent : Form, IWorkflowStartOption
	{
        ...
        private void SetPosition(bool showShelter, bool showUserDefinedConfig)
        {
            if (showShelter)
            {
                ...
                {
                    this.Size = new Size(454, 684);
                    labelUserDefinedParameters.Location = new Point(12, 421);
                    gridUserDefinedParameters.Location = new Point(12, 443);
                    btnRun.Location = new Point(12, 604);
                    btnCancel.Location = new Point(95, 604);
                }
                else
                {
                    this.Size = new Size(454, 561);
                    btnRun.Location = new Point(12, 481);
                    btnCancel.Location = new Point(95, 481);
                }
            }
            else
            {
                ...
                {
                    this.Size = new Size(454, 561);
                    labelUserDefinedParameters.Location = new Point(12, 298);
                    gridUserDefinedParameters.Location = new Point(12, 320);
                    btnRun.Location = new Point(12, 481);
                    btnCancel.Location = new Point(95, 481);
                }
                else
                {
                    this.Size = new Size(454, 384);
                    btnRun.Location = new Point(12, 304);
                    btnCancel.Location = new Point(95, 304);
                }
            }

...
namespace TeamEditor.Command
{
    public class CommandMoveRegularTeam : CommandEx
    {
        ...
        public CommandMoveRegularTeam(TeamTreeView tree, TreeNode nodeSrcParent, TreeNode nodeSrc, TreeNode nodeTrg)
        {
        ...
        private void UpdateDB(DBUtility.WebDBManager dbMgr, RegularTeam teamParent)
        {

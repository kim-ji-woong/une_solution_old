...
namespace SOPManager
{
    public partial class PopupProcessNumber : Form
    {
        ...
        {
            FormMain.Instance.GetPageLevel().GetPropertiesLevel().Number = cboOption.Text + " " + cboNumber.Text + "회";

            FormMain.Instance.GetPageLevel().GetPropertiesLevel().NumberType = cboOption.SelectedIndex;

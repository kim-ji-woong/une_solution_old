...
namespace FireManagement
{
    ...
    {
        // 소화기(Fire Extinguisher), 소화전(Hydrant), 발신기(Fire Alarm)
        public enum EquipmentType { FE = 1, HD, FA, UNKNOWN };
        ...
        private DXFViewer.Shape m_shapeLinked = null;
        ...
        public void Move(UnE.Geometry.Vertex2D vPos)
        {
            ...
            double x = (vPos.x - vMove.x);// *fFlag;
            double y = (vPos.y - vMove.y);// *fFlag;
            ...
            {
                DXFViewer.Hatch hatch = (DXFViewer.Hatch)m_shapeLinked;
        ...
        public DXFViewer.Shape LinkedShape
        {

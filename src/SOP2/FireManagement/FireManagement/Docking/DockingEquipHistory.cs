...
namespace FireManagement
{
    public partial class DockingEquipHistory : Form
    {
        ...
        {
            colHistoryID.HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            colCheckTime.HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            colStatus.HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            colStatus.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            colHDHistoryID.HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            colHDCheckTime.HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            colHDStatus.HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            colHDStatus.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            colFAHistoryID.HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            colFACheckTime.HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            colFAStatus.HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            colFAStatus.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
        }
        ...
        private void AddEquipment(FireEquipment equip, FireEquipmentHistory history, DataGridView grid, Dictionary<DXFViewer.Shape, DataGridViewRow> dicShape)
        {
        ...
        private void dataGridFA_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void dataGridFA_CellClick_1(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex < 0 || e.ColumnIndex < 0)
                return;

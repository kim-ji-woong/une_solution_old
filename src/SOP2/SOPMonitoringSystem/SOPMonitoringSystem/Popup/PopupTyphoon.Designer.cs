namespace SOPMonitoringSystem
{
    partial class PopupTyphoon
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PopupTyphoon));
			...
			this.cboBoxDisaster = new System.Windows.Forms.ComboBox();
			...
			this.groupBox1.Controls.Add(this.cboBoxNumber);
			this.groupBox1.Controls.Add(this.label2);
			this.groupBox1.Controls.Add(this.label1);
			this.groupBox1.Controls.Add(this.cboBoxDisaster);
			...
			// panel1
			// 
			this.panel1.Controls.Add(this.comboType3);
			this.panel1.Controls.Add(this.comboType2);
			this.panel1.Controls.Add(this.comboType1);
            ...
            "청색",
            "적색"});
			this.comboType3.Location = new System.Drawing.Point(526, 42);
			this.comboType3.Name = "comboType3";
			this.comboType3.Size = new System.Drawing.Size(61, 20);
			this.comboType3.TabIndex = 24;
			// 
			// comboType2
			// 
            ...
            "호우",
            "강풍"});
			this.comboType2.Location = new System.Drawing.Point(241, 42);
			this.comboType2.Name = "comboType2";
			this.comboType2.Size = new System.Drawing.Size(61, 20);
			this.comboType2.TabIndex = 22;
			// 
			// comboType1
			// 
            ...
            "폭풍",
            "태풍"});
			this.comboType1.Location = new System.Drawing.Point(39, 42);
			this.comboType1.Name = "comboType1";
			this.comboType1.Size = new System.Drawing.Size(58, 20);
			this.comboType1.TabIndex = 21;
			// 
			// textMessage
			// 
			...
			this.textMessage.Size = new System.Drawing.Size(612, 267);
			...
			// btnOK
			// 
			this.btnOK.Location = new System.Drawing.Point(442, 21);
            ...
            "7",
            "상황 종료시까지 무한 반복"});
			this.cboBoxNumber.Location = new System.Drawing.Point(246, 47);
			this.cboBoxNumber.Name = "cboBoxNumber";
			this.cboBoxNumber.Size = new System.Drawing.Size(161, 20);
			this.cboBoxNumber.TabIndex = 31;
			this.cboBoxNumber.SelectedIndexChanged += new System.EventHandler(this.cboBoxNumber_SelectedIndexChanged);
			// 
			// label2
			// 
			...
			// cboBoxDisaster
			// 
			this.cboBoxDisaster.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.cboBoxDisaster.FormattingEnabled = true;
			this.cboBoxDisaster.Items.AddRange(new object[] {
            "집중호우 및 태풍(주의예보 단계)",
            "집중호우 및 태풍(경보예보(청색-적색)단계)",
            "집중호우 및 태풍(긴급대피)",
            "기타(시스템 제공)",
            "사용자 입력",
            "시나리오"});
			this.cboBoxDisaster.Location = new System.Drawing.Point(112, 21);
			this.cboBoxDisaster.Name = "cboBoxDisaster";
			this.cboBoxDisaster.Size = new System.Drawing.Size(295, 20);
			this.cboBoxDisaster.TabIndex = 28;
			this.cboBoxDisaster.SelectedIndexChanged += new System.EventHandler(this.cboBoxDisaster_SelectedIndexChanged);
			// 
			// btnCancel2
			// 
			...
			this.checkBoxSiren.TabIndex = 53;
			...
			this.Name = "PopupTyphoon";
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "집중 호우 및 태풍 방송 안내";
        ...
        private System.Windows.Forms.ComboBox cboBoxDisaster;
        ...
        public System.Windows.Forms.RichTextBox textMessage;

    ...
    public partial class PopupRequestControl : Form, UnE.GUI.IImageButtonOwner
    {
        ...
        public void OnImageButtonMouseUp(object sender, MouseEventArgs e)
        {
            if (sender == btnOK)
            {
                ...
                {
                    FormMain.Instance.NetworkManager.SendControl((string)trgRow.Tag, trgRow.Cells[1].Tag.ToString(), trgRow.Cells[0].Tag.ToString());
                    FormMain.Instance.ClearRequestControl();
            ...
            else if (sender == btnCancel)
            {
                ...
                {
                    FormMain.Instance.NetworkManager.SendRejectRequestControl((string)row.Tag, row.Cells[1].Tag.ToString(), row.Cells[0].Tag.ToString());
                }

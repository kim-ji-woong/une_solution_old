...
namespace SOPBulletin
{
    public partial class DockingRealTime : Form
    {
        ...
        public void UpdateActionSteps(ArrayList arrActionStepHistoryList)
        {
            ...
            DataGridViewComboBoxCell cellCombo = (DataGridViewComboBoxCell)dataGridView1.Rows[0].Cells[1];
        ...
        private void UpdateStartTime()
        {
            ...
            dataGridView2.Rows[0].Cells[1].Value = string.Format("{0}년 {1}월 {2}일 {3}시 {4}분 상황발생",
        ...
        private void AddRowSOPState2()
        {
            ...
            cell = new DataGridViewTextBoxCell();
            cell.Value = "0000년 00월 00일 00시 00분 상황발생";
            gridRow.Cells.Add(cell);
            ...
            cell = new DataGridViewTextBoxCell();
            cell.Value = FormMain.Instance.DBManager.DefSOPName;//"<태풍-2저탄장 상하탄기 전도>";
            gridRow.Cells.Add(cell);
        ...
        private void SetPositionText()
        {
            ...
            DataGridViewTextBoxCell cell = (DataGridViewTextBoxCell)gridRow.Cells[3];
        ...
        public void AddMessageRow(DateTime dtMessage, string strMessage, ActionStepHistoryData data)
        {
            int nRowCount = dataGridView3.Rows.Count;
        ...
        private void UpdateHistory(ActionStepHistoryData data)
        {
            ...
            foreach (ComponentHistoryData componentHistory in data.ComponentHistoryList)
            {
                ...
                {
                    nLastIndex++;
                    dataGridView3.Rows.Insert(nLastIndex, MakeHistoryRow(new DataGridViewRow(), componentHistory, nLastIndex));
                }
                else
                {
                    nLastIndex = nIndex;
        ...
        {
            return System.IO.File.Exists(Application.StartupPath + "\\BulletinResult.txt");
        ...
        {
            System.IO.File.Delete(Application.StartupPath + "\\BulletinResult.txt");
        ...
        {
            using (System.IO.StreamWriter file = new System.IO.StreamWriter(Application.StartupPath + "\\BulletHwpData.txt"))
            {
                //SOP명
        ...
        {
            using (System.IO.StreamWriter file = new System.IO.StreamWriter(Application.StartupPath + "\\BulletHwpAllData.txt", false, System.Text.Encoding.UTF8))
            {

...
namespace SOPBulletin
{
    public class SOPManager
    {
        ...
        private bool LoadTemporaryTeam()
        {
            ...
            strSQL = "select id, TeamName, ParentTeamID, GroupName, LevelNo, RegularTeamLink from TemporaryNormalTeam";
            arrResult = m_dbMgr.GetResultData(strSQL, 0);
            ...
            strSQL = "select id, TeamName, ParentTeamID, GroupName, LevelNo, RegularTeamLink from TemporaryEmergencyTeam";
            arrResult = m_dbMgr.GetResultData(strSQL, 0);

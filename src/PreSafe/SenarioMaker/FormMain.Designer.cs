namespace UnE.SenarioMaker
{
    partial class FormMain
    {
        ...
        private void InitializeComponent()
        {
			...
			this.mFileToolStripMenuItem = new UnE.SenarioMaker.IDToolStripMenuItem();
			this.mNewSennarioMenuItem = new UnE.SenarioMaker.IDToolStripMenuItem();
			this.toolStripSeparator4 = new System.Windows.Forms.ToolStripSeparator();
			this.mOpenSennarioMenuItem = new UnE.SenarioMaker.IDToolStripMenuItem();
			this.mSaveSenarioMenuItem = new UnE.SenarioMaker.IDToolStripMenuItem();
			this.mSaveAsMenuItem = new UnE.SenarioMaker.IDToolStripMenuItem();
			this.toolStripSeparator1 = new System.Windows.Forms.ToolStripSeparator();
			this.mOpenUserVarMenuItem = new UnE.SenarioMaker.IDToolStripMenuItem();
			this.mSaveUserVarMenuItem = new UnE.SenarioMaker.IDToolStripMenuItem();
			this.toolStripSeparator2 = new System.Windows.Forms.ToolStripSeparator();
			this.mOpenEnumMenuItem = new UnE.SenarioMaker.IDToolStripMenuItem();
			this.saveEnumToolstripMenuItem = new UnE.SenarioMaker.IDToolStripMenuItem();
			this.toolStripSeparator3 = new System.Windows.Forms.ToolStripSeparator();
			this.exitToolStripMenuItem = new UnE.SenarioMaker.IDToolStripMenuItem();
			this.mViewToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			this.viewExprToolStripMenuItem = new UnE.SenarioMaker.IDToolStripMenuItem();
			this.viewTextToolStripMenuItem = new UnE.SenarioMaker.IDToolStripMenuItem();
			this.compOptionToolStripMenuItem = new UnE.SenarioMaker.IDToolStripMenuItem();
			this.leftPaneToolStripMenuItem = new UnE.SenarioMaker.IDToolStripMenuItem();
			this.mSenarioToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			this.mCheckValidationToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			this.mSimulationToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			this.mMainPanel = new System.Windows.Forms.Panel();
			this.mSplitContent = new System.Windows.Forms.SplitContainer();
			this.mLeftUpSplit = new System.Windows.Forms.SplitContainer();
			this.mLeftDownSplit = new System.Windows.Forms.SplitContainer();
			this.mPaneRibbonToolBar = new System.Windows.Forms.Panel();
			this.mRBtnVerify = new UnE.GUI.RibbonButton();
			this.pictureBox4 = new System.Windows.Forms.PictureBox();
			this.mRbtnSimulation = new UnE.GUI.RibbonButton();
			...
			this.mSplitContent.Panel1.SuspendLayout();
			this.mSplitContent.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.mLeftUpSplit)).BeginInit();
			this.mLeftUpSplit.Panel2.SuspendLayout();
			this.mLeftUpSplit.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.mLeftDownSplit)).BeginInit();
			this.mLeftDownSplit.SuspendLayout();
            ...
            this.mSenarioToolStripMenuItem});
			...
			// 
			// mNewSennarioMenuItem
			// 
			this.mNewSennarioMenuItem.CommandID = -1;
			this.mNewSennarioMenuItem.Name = "mNewSennarioMenuItem";
			this.mNewSennarioMenuItem.Size = new System.Drawing.Size(214, 22);
			this.mNewSennarioMenuItem.Text = "새 시나리오 (&N)";
			// 
			// toolStripSeparator4
			// 
			...
			// mSaveAsMenuItem
			// 
			this.mSaveAsMenuItem.CommandID = -1;
			this.mSaveAsMenuItem.Name = "mSaveAsMenuItem";
			this.mSaveAsMenuItem.Size = new System.Drawing.Size(214, 22);
			this.mSaveAsMenuItem.Text = "다른 이름으로 저장 (&A)";
			// 
			// toolStripSeparator1
			// 
			...
			this.compOptionToolStripMenuItem.Checked = true;
			this.compOptionToolStripMenuItem.CheckState = System.Windows.Forms.CheckState.Checked;
			...
			this.compOptionToolStripMenuItem.ToolTipText = "Component의 옵션에 따라 표시됩니다.";
			// 
			...
			// 
			// mSenarioToolStripMenuItem
			// 
			this.mSenarioToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.mCheckValidationToolStripMenuItem,
            this.mSimulationToolStripMenuItem});
			this.mSenarioToolStripMenuItem.Name = "mSenarioToolStripMenuItem";
			this.mSenarioToolStripMenuItem.Size = new System.Drawing.Size(86, 20);
			this.mSenarioToolStripMenuItem.Text = "시나리오 (&S)";
			// 
			// mCheckValidationToolStripMenuItem
			// 
			this.mCheckValidationToolStripMenuItem.Name = "mCheckValidationToolStripMenuItem";
			this.mCheckValidationToolStripMenuItem.Size = new System.Drawing.Size(153, 22);
			this.mCheckValidationToolStripMenuItem.Text = "검증 (&V)";
			this.mCheckValidationToolStripMenuItem.Click += new System.EventHandler(this.mCheckValidationToolStripMenuItem_Click);
			// 
			// mSimulationToolStripMenuItem
			// 
			this.mSimulationToolStripMenuItem.Name = "mSimulationToolStripMenuItem";
			this.mSimulationToolStripMenuItem.Size = new System.Drawing.Size(153, 22);
			this.mSimulationToolStripMenuItem.Text = "시뮬레이션 (&S)";
			this.mSimulationToolStripMenuItem.Click += new System.EventHandler(this.SimulationToolStripMenuItem_Click);
			// 
			// mMainPanel
			// 
			this.mMainPanel.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(75)))), ((int)(((byte)(71)))), ((int)(((byte)(86)))));
			...
			this.mSplitContent.Panel1.Controls.Add(this.mLeftUpSplit);
			this.mSplitContent.Panel1MinSize = 120;
			// 
			// mSplitContent.Panel2
			// 
			this.mSplitContent.Panel2.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(75)))), ((int)(((byte)(71)))), ((int)(((byte)(86)))));
			...
			// mLeftUpSplit
			// 
			this.mLeftUpSplit.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(60)))), ((int)(((byte)(56)))), ((int)(((byte)(71)))));
			this.mLeftUpSplit.Dock = System.Windows.Forms.DockStyle.Fill;
			this.mLeftUpSplit.FixedPanel = System.Windows.Forms.FixedPanel.Panel1;
			this.mLeftUpSplit.Location = new System.Drawing.Point(0, 0);
			this.mLeftUpSplit.Name = "mLeftUpSplit";
			this.mLeftUpSplit.Orientation = System.Windows.Forms.Orientation.Horizontal;
			// 
			// mLeftUpSplit.Panel1
			// 
			this.mLeftUpSplit.Panel1.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(75)))), ((int)(((byte)(71)))), ((int)(((byte)(86)))));
			this.mLeftUpSplit.Panel1MinSize = 100;
			// 
			// mLeftUpSplit.Panel2
			// 
			this.mLeftUpSplit.Panel2.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(60)))), ((int)(((byte)(56)))), ((int)(((byte)(71)))));
			this.mLeftUpSplit.Panel2.Controls.Add(this.mLeftDownSplit);
			this.mLeftUpSplit.Size = new System.Drawing.Size(300, 582);
			this.mLeftUpSplit.SplitterDistance = 280;
			this.mLeftUpSplit.SplitterWidth = 1;
			this.mLeftUpSplit.TabIndex = 0;
			// 
			// mLeftDownSplit
			// 
			this.mLeftDownSplit.Dock = System.Windows.Forms.DockStyle.Fill;
			this.mLeftDownSplit.Location = new System.Drawing.Point(0, 0);
			this.mLeftDownSplit.Name = "mLeftDownSplit";
			this.mLeftDownSplit.Orientation = System.Windows.Forms.Orientation.Horizontal;
			// 
			// mLeftDownSplit.Panel1
			// 
			this.mLeftDownSplit.Panel1.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(75)))), ((int)(((byte)(71)))), ((int)(((byte)(86)))));
			// 
			// mLeftDownSplit.Panel2
			// 
			this.mLeftDownSplit.Panel2.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(75)))), ((int)(((byte)(71)))), ((int)(((byte)(86)))));
			this.mLeftDownSplit.Size = new System.Drawing.Size(300, 301);
			this.mLeftDownSplit.SplitterDistance = 107;
			this.mLeftDownSplit.SplitterWidth = 2;
			this.mLeftDownSplit.TabIndex = 0;
			// 
			// mPaneRibbonToolBar
			// 
			this.mPaneRibbonToolBar.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(75)))), ((int)(((byte)(71)))), ((int)(((byte)(86)))));
			this.mPaneRibbonToolBar.BackgroundImage = global::UnE.SenarioMaker.Properties.Resources.관리아이콘bg_02;
			this.mPaneRibbonToolBar.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Stretch;
			this.mPaneRibbonToolBar.Controls.Add(this.mRBtnVerify);
			this.mPaneRibbonToolBar.Controls.Add(this.pictureBox4);
			this.mPaneRibbonToolBar.Controls.Add(this.mRbtnSimulation);
			...
			// mRBtnVerify
			// 
			this.mRBtnVerify.BackColor = System.Drawing.Color.Transparent;
			this.mRBtnVerify.CheckButton = false;
			this.mRBtnVerify.CheckedBkgndImage = global::UnE.SenarioMaker.Properties.Resources.clicked배경;
			this.mRBtnVerify.CheckedImage = global::UnE.SenarioMaker.Properties.Resources.검증_normal;
			this.mRBtnVerify.ClickedBackgroundImage = global::UnE.SenarioMaker.Properties.Resources.clicked배경;
			this.mRBtnVerify.ClickedImage = global::UnE.SenarioMaker.Properties.Resources.검증_normal;
			this.mRBtnVerify.CustomImageRect = new System.Drawing.Rectangle(20, 8, 40, 40);
			this.mRBtnVerify.DisabledBkgndImage = null;
			this.mRBtnVerify.DisabledImage = global::UnE.SenarioMaker.Properties.Resources.검증_disable;
			this.mRBtnVerify.ID = -1;
			this.mRBtnVerify.InitButtonWidth = 70;
			this.mRBtnVerify.IsChecked = false;
			this.mRBtnVerify.Location = new System.Drawing.Point(396, 9);
			this.mRBtnVerify.MouseOverBkgndImage = global::UnE.SenarioMaker.Properties.Resources.over배경;
			this.mRBtnVerify.MouseOverImage = global::UnE.SenarioMaker.Properties.Resources.검증_normal;
			this.mRBtnVerify.Name = "mRBtnVerify";
			this.mRBtnVerify.NormalImage = global::UnE.SenarioMaker.Properties.Resources.검증_normal;
			this.mRBtnVerify.Owner = null;
			this.mRBtnVerify.Size = new System.Drawing.Size(81, 80);
			this.mRBtnVerify.TabIndex = 23;
			this.mRBtnVerify.Text = "시나리오검증";
			this.mRBtnVerify.TextLocation = new System.Drawing.Point(0, 0);
			this.mRBtnVerify.TextPos = UnE.GUI.RibbonButton.TextPosition.BOTTOM;
			this.mRBtnVerify.ToolTipText = "시나리오검증";
			this.mRBtnVerify.UseCustomImageRect = true;
			this.mRBtnVerify.UseTextLocation = false;
			this.mRBtnVerify.UseVisualStyleBackColor = false;
			// 
			// pictureBox4
			// 
			this.pictureBox4.Image = global::UnE.SenarioMaker.Properties.Resources.skin_line_img;
			...
			// mRbtnSimulation
			// 
			this.mRbtnSimulation.BackColor = System.Drawing.Color.Transparent;
			this.mRbtnSimulation.CheckButton = false;
			this.mRbtnSimulation.CheckedBkgndImage = global::UnE.SenarioMaker.Properties.Resources.clicked배경;
			this.mRbtnSimulation.CheckedImage = global::UnE.SenarioMaker.Properties.Resources.시뮬레이션_normal;
			this.mRbtnSimulation.ClickedBackgroundImage = global::UnE.SenarioMaker.Properties.Resources.clicked배경;
			this.mRbtnSimulation.ClickedImage = global::UnE.SenarioMaker.Properties.Resources.시뮬레이션_normal;
			this.mRbtnSimulation.CustomImageRect = new System.Drawing.Rectangle(15, 8, 40, 40);
			this.mRbtnSimulation.DisabledBkgndImage = null;
			this.mRbtnSimulation.DisabledImage = global::UnE.SenarioMaker.Properties.Resources.시뮬레이션_disable;
			this.mRbtnSimulation.ID = -1;
			this.mRbtnSimulation.InitButtonWidth = 70;
			this.mRbtnSimulation.IsChecked = false;
			this.mRbtnSimulation.Location = new System.Drawing.Point(478, 9);
			this.mRbtnSimulation.MouseOverBkgndImage = global::UnE.SenarioMaker.Properties.Resources.over배경;
			this.mRbtnSimulation.MouseOverImage = global::UnE.SenarioMaker.Properties.Resources.시뮬레이션_normal;
			this.mRbtnSimulation.Name = "mRbtnSimulation";
			this.mRbtnSimulation.NormalImage = global::UnE.SenarioMaker.Properties.Resources.시뮬레이션_normal;
			this.mRbtnSimulation.Owner = null;
			this.mRbtnSimulation.Size = new System.Drawing.Size(70, 80);
			this.mRbtnSimulation.TabIndex = 21;
			this.mRbtnSimulation.Text = "시뮬레이션";
			this.mRbtnSimulation.TextLocation = new System.Drawing.Point(0, 0);
			this.mRbtnSimulation.TextPos = UnE.GUI.RibbonButton.TextPosition.BOTTOM;
			this.mRbtnSimulation.ToolTipText = "시뮬레이션";
			this.mRbtnSimulation.UseCustomImageRect = true;
			this.mRbtnSimulation.UseTextLocation = false;
			this.mRbtnSimulation.UseVisualStyleBackColor = false;
			// 
			// pictureBox3
			// 
			this.pictureBox3.Image = global::UnE.SenarioMaker.Properties.Resources.skin_line_img;
			...
			// pictureBox2
			// 
			this.pictureBox2.Image = global::UnE.SenarioMaker.Properties.Resources.skin_line_img;
			this.pictureBox2.Location = new System.Drawing.Point(393, 5);
			...
			// pictureBox1
			// 
			this.pictureBox1.Image = global::UnE.SenarioMaker.Properties.Resources.skin_line_img;
			...
			this.mRBtnUndo.CheckButton = false;
			this.mRBtnUndo.CheckedBkgndImage = global::UnE.SenarioMaker.Properties.Resources.clicked배경;
			this.mRBtnUndo.CheckedImage = global::UnE.SenarioMaker.Properties.Resources.뒤로_normal;
			this.mRBtnUndo.ClickedBackgroundImage = global::UnE.SenarioMaker.Properties.Resources.clicked배경;
			this.mRBtnUndo.ClickedImage = global::UnE.SenarioMaker.Properties.Resources.뒤로_normal;
			this.mRBtnUndo.CustomImageRect = new System.Drawing.Rectangle(15, 8, 40, 40);
			this.mRBtnUndo.DisabledBkgndImage = null;
			this.mRBtnUndo.DisabledImage = global::UnE.SenarioMaker.Properties.Resources.뒤로_disable;
			this.mRBtnUndo.ID = -1;
			this.mRBtnUndo.InitButtonWidth = 70;
			this.mRBtnUndo.IsChecked = false;
			this.mRBtnUndo.Location = new System.Drawing.Point(33, 9);
			this.mRBtnUndo.MouseOverBkgndImage = global::UnE.SenarioMaker.Properties.Resources.over배경;
			this.mRBtnUndo.MouseOverImage = global::UnE.SenarioMaker.Properties.Resources.뒤로_normal;
			this.mRBtnUndo.Name = "mRBtnUndo";
			this.mRBtnUndo.NormalImage = global::UnE.SenarioMaker.Properties.Resources.뒤로_normal;
			...
			this.mRBtnRedo.CheckButton = false;
			this.mRBtnRedo.CheckedBkgndImage = global::UnE.SenarioMaker.Properties.Resources.clicked배경;
			this.mRBtnRedo.CheckedImage = global::UnE.SenarioMaker.Properties.Resources.다시실행_normal;
			this.mRBtnRedo.ClickedBackgroundImage = global::UnE.SenarioMaker.Properties.Resources.clicked배경;
			this.mRBtnRedo.ClickedImage = global::UnE.SenarioMaker.Properties.Resources.다시실행_normal;
			this.mRBtnRedo.CustomImageRect = new System.Drawing.Rectangle(15, 8, 40, 40);
			this.mRBtnRedo.DisabledBkgndImage = null;
			this.mRBtnRedo.DisabledImage = global::UnE.SenarioMaker.Properties.Resources.다시실행_disable;
			this.mRBtnRedo.ID = -1;
			this.mRBtnRedo.InitButtonWidth = 70;
			this.mRBtnRedo.IsChecked = false;
			this.mRBtnRedo.Location = new System.Drawing.Point(104, 9);
			this.mRBtnRedo.MouseOverBkgndImage = global::UnE.SenarioMaker.Properties.Resources.over배경;
			this.mRBtnRedo.MouseOverImage = global::UnE.SenarioMaker.Properties.Resources.다시실행_normal;
			this.mRBtnRedo.Name = "mRBtnRedo";
			this.mRBtnRedo.NormalImage = global::UnE.SenarioMaker.Properties.Resources.다시실행_normal;
			...
			this.mRBtnSystemVar.CheckButton = false;
			this.mRBtnSystemVar.CheckedBkgndImage = global::UnE.SenarioMaker.Properties.Resources.clicked배경;
			this.mRBtnSystemVar.CheckedImage = global::UnE.SenarioMaker.Properties.Resources.시스템변수_normal;
			this.mRBtnSystemVar.ClickedBackgroundImage = global::UnE.SenarioMaker.Properties.Resources.clicked배경;
			this.mRBtnSystemVar.ClickedImage = global::UnE.SenarioMaker.Properties.Resources.시스템변수_normal;
			this.mRBtnSystemVar.CustomImageRect = new System.Drawing.Rectangle(15, 8, 40, 40);
			this.mRBtnSystemVar.DisabledBkgndImage = null;
			this.mRBtnSystemVar.DisabledImage = global::UnE.SenarioMaker.Properties.Resources.시스템변수_disable;
			...
			this.mRBtnSystemVar.MouseOverBkgndImage = global::UnE.SenarioMaker.Properties.Resources.over배경;
			this.mRBtnSystemVar.MouseOverImage = global::UnE.SenarioMaker.Properties.Resources.시스템변수_normal;
			this.mRBtnSystemVar.Name = "mRBtnSystemVar";
			this.mRBtnSystemVar.NormalImage = global::UnE.SenarioMaker.Properties.Resources.시스템변수_normal;
			...
			this.mRBtnUserVar.CheckButton = false;
			this.mRBtnUserVar.CheckedBkgndImage = global::UnE.SenarioMaker.Properties.Resources.clicked배경;
			this.mRBtnUserVar.CheckedImage = global::UnE.SenarioMaker.Properties.Resources.사용자변수_normal;
			this.mRBtnUserVar.ClickedBackgroundImage = global::UnE.SenarioMaker.Properties.Resources.clicked배경;
			this.mRBtnUserVar.ClickedImage = global::UnE.SenarioMaker.Properties.Resources.사용자변수_normal;
			this.mRBtnUserVar.CustomImageRect = new System.Drawing.Rectangle(15, 8, 40, 40);
			this.mRBtnUserVar.DisabledBkgndImage = null;
			this.mRBtnUserVar.DisabledImage = global::UnE.SenarioMaker.Properties.Resources.사용자변수_disable;
			...
			this.mRBtnUserVar.MouseOverBkgndImage = global::UnE.SenarioMaker.Properties.Resources.over배경;
			this.mRBtnUserVar.MouseOverImage = global::UnE.SenarioMaker.Properties.Resources.사용자변수_normal;
			this.mRBtnUserVar.Name = "mRBtnUserVar";
			this.mRBtnUserVar.NormalImage = global::UnE.SenarioMaker.Properties.Resources.사용자변수_normal;
			...
			this.mRBtnEnum.CheckButton = false;
			this.mRBtnEnum.CheckedBkgndImage = global::UnE.SenarioMaker.Properties.Resources.clicked배경;
			this.mRBtnEnum.CheckedImage = global::UnE.SenarioMaker.Properties.Resources.열거형변수_normal;
			this.mRBtnEnum.ClickedBackgroundImage = global::UnE.SenarioMaker.Properties.Resources.clicked배경;
			this.mRBtnEnum.ClickedImage = global::UnE.SenarioMaker.Properties.Resources.열거형변수_normal;
			this.mRBtnEnum.CustomImageRect = new System.Drawing.Rectangle(17, 8, 40, 40);
			this.mRBtnEnum.DisabledBkgndImage = null;
			this.mRBtnEnum.DisabledImage = global::UnE.SenarioMaker.Properties.Resources.열거형변수_disable;
			this.mRBtnEnum.ID = -1;
			this.mRBtnEnum.InitButtonWidth = 70;
			this.mRBtnEnum.IsChecked = false;
			this.mRBtnEnum.Location = new System.Drawing.Point(320, 9);
			this.mRBtnEnum.MouseOverBkgndImage = global::UnE.SenarioMaker.Properties.Resources.over배경;
			this.mRBtnEnum.MouseOverImage = global::UnE.SenarioMaker.Properties.Resources.열거형변수_normal;
			this.mRBtnEnum.Name = "mRBtnEnum";
			this.mRBtnEnum.NormalImage = global::UnE.SenarioMaker.Properties.Resources.열거형변수_normal;
			...
			this.mRBtnHelp.CheckButton = false;
			this.mRBtnHelp.CheckedBkgndImage = global::UnE.SenarioMaker.Properties.Resources.clicked배경;
			this.mRBtnHelp.CheckedImage = global::UnE.SenarioMaker.Properties.Resources.코딩가이드_normal;
			this.mRBtnHelp.ClickedBackgroundImage = global::UnE.SenarioMaker.Properties.Resources.clicked배경;
			this.mRBtnHelp.ClickedImage = global::UnE.SenarioMaker.Properties.Resources.코딩가이드_normal;
			this.mRBtnHelp.CustomImageRect = new System.Drawing.Rectangle(15, 8, 40, 40);
			this.mRBtnHelp.DisabledBkgndImage = null;
			this.mRBtnHelp.DisabledImage = global::UnE.SenarioMaker.Properties.Resources.코딩가이드_disable;
			this.mRBtnHelp.ID = -1;
			this.mRBtnHelp.InitButtonWidth = 70;
			this.mRBtnHelp.IsChecked = false;
			this.mRBtnHelp.Location = new System.Drawing.Point(550, 9);
			this.mRBtnHelp.MouseOverBkgndImage = global::UnE.SenarioMaker.Properties.Resources.over배경;
			this.mRBtnHelp.MouseOverImage = global::UnE.SenarioMaker.Properties.Resources.코딩가이드_normal;
			this.mRBtnHelp.Name = "mRBtnHelp";
			this.mRBtnHelp.NormalImage = global::UnE.SenarioMaker.Properties.Resources.코딩가이드_normal;
			...
			this.mSplitContent.Panel1.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.mSplitContent)).EndInit();
			this.mSplitContent.ResumeLayout(false);
			this.mLeftUpSplit.Panel2.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.mLeftUpSplit)).EndInit();
			this.mLeftUpSplit.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.mLeftDownSplit)).EndInit();
			this.mLeftDownSplit.ResumeLayout(false);
        ...
        internal IDToolStripMenuItem mOpenSennarioMenuItem;
        internal IDToolStripMenuItem mSaveSenarioMenuItem;
        internal IDToolStripMenuItem mSaveAsMenuItem;
        private System.Windows.Forms.ToolStripSeparator toolStripSeparator1;
        internal IDToolStripMenuItem mOpenUserVarMenuItem;
        internal IDToolStripMenuItem mSaveUserVarMenuItem;
        private System.Windows.Forms.ToolStripSeparator toolStripSeparator2;
        internal IDToolStripMenuItem mOpenEnumMenuItem;
        internal IDToolStripMenuItem viewExprToolStripMenuItem;
        internal IDToolStripMenuItem viewTextToolStripMenuItem;
        internal IDToolStripMenuItem compOptionToolStripMenuItem;
        internal IDToolStripMenuItem saveEnumToolstripMenuItem;
        private System.Windows.Forms.ToolStripSeparator toolStripSeparator3;
        internal IDToolStripMenuItem exitToolStripMenuItem;
        internal IDToolStripMenuItem leftPaneToolStripMenuItem;
        internal IDToolStripMenuItem mFileToolStripMenuItem;
        internal IDToolStripMenuItem mNewSennarioMenuItem;
        ...
        internal System.Windows.Forms.SplitContainer mLeftUpSplit;
        internal System.Windows.Forms.SplitContainer mLeftDownSplit;
        ...
        private System.Windows.Forms.ToolStripMenuItem mSenarioToolStripMenuItem;
        private System.Windows.Forms.ToolStripMenuItem mCheckValidationToolStripMenuItem;
        private System.Windows.Forms.ToolStripMenuItem mSimulationToolStripMenuItem;
		private GUI.RibbonButton mRBtnVerify;
		private System.Windows.Forms.PictureBox pictureBox4;
		private GUI.RibbonButton mRbtnSimulation;

...
namespace UnE.SenarioMaker
{
    ...
    public sealed class KeyManager
    {
        ...
        static private CertResult ValidKey1(string strDBName, string strCertCode, out byte[] bytes, out string strCode, out bool isAdmin, out CertOption option, bool bUsedCode)
        {
            strCode = "";
            isAdmin = false;
            bytes = null;
        ...
        static public CertResult VaildKey(string strDBURL, string strDBID, string strDBPW, string strDBName, string strTableName, string strFieldName, string strCertCode, ArrayList arrMacAddrList, out string strCode, out bool isAdmin, out CertOption option, bool bUsedCode)
        {
            byte[] bytes = null;
            CertResult result = ValidKey1(strDBName, strCertCode, out bytes, out strCode, out isAdmin, out option, bUsedCode);
        ...
        static public CertResult VaildKey(string strDBURL, string strDBID, string strDBPW, string strDBName, string strTableName, string strFieldName, string strCertCode, out string strCode, out bool isAdmin, out CertOption option, bool bUsedCode)
        {
            byte[] bytes = null;
            CertResult result = ValidKey1(strDBName, strCertCode, out bytes, out strCode, out isAdmin, out option, bUsedCode);

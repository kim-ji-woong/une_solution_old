...
namespace UnE.SenarioMaker
{
    ...
    internal class XMLReader<T> : XMLBase where T : Variable
    {
		...
		internal static Variables<TVAR> GetVariables<TVAR>(XmlDocument xDoc, XmlNode nodeParent) where TVAR : Variable
        {
			Variables<TVAR> mResult = new Variables<TVAR>();
            ...
            {
				if (typeof(TVAR) == typeof(UserVariable))
                {
                    ...
                    if (node.Name == szNodeName)
                    {
                        ...
                        {
							mResult.AddVariable((TVAR)(object)item);
                        }
                    }
                }
				else if (typeof(TVAR) == typeof(Enums))
                {
                    szNodeName = "UserEnum";
                    if (node.Name == szNodeName)
                    {
    ...
    internal class XMLWriter<T> : XMLBase where T : Variable
    {
        ...
        protected static bool AddAttribute(XmlWriter writer, UserVariable var)
        {
            bool bResult = AddAttribute(writer, (Variable)var);
            if (bResult == false)
                return false;
            ...
            writer.WriteString(szValue);
            writer.WriteEndAttribute();

            writer.WriteStartAttribute("minValue");
            writer.WriteString(szMinValue);
            writer.WriteEndAttribute();

            writer.WriteStartAttribute("maxValue");
            writer.WriteString(szMaxValue);
            writer.WriteEndAttribute();

            writer.WriteStartAttribute("defaultValue");
            writer.WriteString(szDefaultValue);
            writer.WriteEndAttribute();
        ...
        protected static bool AddAttribute(XmlWriter writer, Variable var)
        {
            if (writer == null || var == null)
                return false;
            ...
            writer.WriteString(szUnit);
            writer.WriteEndAttribute();

            writer.WriteStartAttribute("description");
            writer.WriteString(szDesc);
            writer.WriteEndAttribute();
        ...
        protected static bool AddAttribute(XmlWriter writer, Enums var)
        {
            bool bResult = AddAttribute(writer, (Variable)var);
            if (bResult == false)
                return false;
		...
		internal static bool DeleteVariable<TVAR>(XmlDocument xDoc, XmlNode nodeParent, string szVarName) where TVAR : Variable
        {
            XmlNodeList childList = nodeParent.ChildNodes;
            if (childList == null || childList.Count == 0)
                return false;
		...
		internal static bool AddVariable<TVAR>(XmlWriter writer, TVAR item) where TVAR : Variable
        {
			...
			if (typeof(TVAR) == typeof(UserVariable))
            {
                ...
                writer.WriteStartElement(szNodeName);
                AddAttribute(writer, var);
            ...
            writer.WriteStartElement(szNodeName);
            AddAttribute(writer, item);
            writer.WriteFullEndElement();
            return true;
        }

		internal static bool AddVariable<TVAR>(XmlDocument xDoc, XmlNode nodeParent, TVAR item) where TVAR : Variable
        {
            string szNodeName = item.GetTypeString();
			if (typeof(TVAR) == typeof(UserVariable))
            {

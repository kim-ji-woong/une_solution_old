...
namespace UnE.SenarioMaker
{
    ...
    internal partial class FormContent : Form, ISectionListener, ISectionPageContainer
    {
        ...
        public int SenarioType
        {
            ...
            {                
                ...
                if (m_CurrentPane != null)
                {
                    ...
                    {
                        case 1:
                            m_CurrentPane.DisasterType = "강간형";
                            break;
                        case 2:
                            m_CurrentPane.DisasterType = "특수 강간형";
                            break;
                        case 3:
                            m_CurrentPane.DisasterType = "미성년자 강간형";
                            break;
                        case 4:
                            m_CurrentPane.DisasterType = "강제 추행형";
                            break;
                        case 5:
                            m_CurrentPane.DisasterType = "미성년자 강제 추행형";
                            break;
                        case 6:
                            m_CurrentPane.DisasterType = "공통";
                            break;
                    }
                }
            }
        ...
        private TabPage AddTabPage(ActionStep actionStep)
        {
            ...
            {
                case 1:
                    mSectionPanel.DisasterType = "강간형";
                    break;
                case 2:
                    mSectionPanel.DisasterType = "특수 강간형";
                    break;
                case 3:
                    mSectionPanel.DisasterType = "미성년자 강간형";
                    break;
                case 4:
                    mSectionPanel.DisasterType = "강제 추행형";
                    break;
                case 5:
                    mSectionPanel.DisasterType = "미성년자 강제 추행형";
                    break;
                case 6:
                    mSectionPanel.DisasterType = "공통";
                    break;
            }

...
namespace DXFViewer
{
    public class Line : DXFDotNet.Line, IDrawableShape
    {
        protected EditBox m_editBox = null;

        protected PathGeometry m_PathGeom = null;
        ...
        public Line(Line rhs) : base((DXFDotNet.Line)rhs)
        {
        }

        public Line(UnE.Geometry.Vertex2D vBegin, UnE.Geometry.Vertex2D vEnd)
            : base(vBegin, vEnd)
        {
        }

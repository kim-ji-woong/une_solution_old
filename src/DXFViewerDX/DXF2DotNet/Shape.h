...
namespace DXFDotNet
{
	...
	{
	public:
		enum class ShapeType {LINE = 0, POLYLINE, ARC, EARC, HATCH, TEXT, GROUP, NONE };
	...
	public:
		...
		virtual bool CheckClipBounds(UnE::Geometry::Vertex2D^ vClipTL, UnE::Geometry::Vertex2D^ vClipBR) = 0;
	public:
		...
		void SetOwner(IShapeOwner^ owner);
		IShapeOwner^ GetOwner();
	...
	protected:
		...
		bool CheckClipBounds(UnE::Geometry::Vertex2D^ vClipTL, UnE::Geometry::Vertex2D^ vClipBR, UnE::Geometry::Vertex2D^ vTL, UnE::Geometry::Vertex2D^ vBR);

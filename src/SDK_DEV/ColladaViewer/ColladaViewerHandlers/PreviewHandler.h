...
#include <afxext.h>
#include "..\ColladaViewer\ColladaDoc.h"
#include "..\ColladaViewer\ColladaView.h"
...
public:
	virtual HRESULT InitializeDocumentPreview(HWND hWndParent, RECT* prc)
	{
		...
		CCreateContext ctx;
		ctx.m_pNewViewClass = RUNTIME_CLASS(ColladaView);
		...
		m_pDocument->AddRef();
		ctx.m_pCurrentDoc = DYNAMIC_DOWNCAST(ColladaDoc, (CObject*) m_pDocument->GetContainer());

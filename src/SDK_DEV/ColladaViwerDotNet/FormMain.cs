...
namespace UBMLViewer
{
    public partial class FormMain : Form
    {
        ...
        {           
            ...
            GroupEdit.Add(XTPControlType.xtpControlButton, ID.ID_ADD_TREE1, "TreeA", false, false);
            GroupEdit.Add(XTPControlType.xtpControlButton, ID.ID_ADD_TREE2, "TreeB", false, false);
        ...
        private void CommandBars_UpdateEvent(object sender, AxXtremeCommandBars._DCommandBarsEvents_UpdateEvent e)
        {
            ...
            switch(e.control.Id)
            {
                ...
                case ID.ID_EDIT_SCRIPT:
                    ...
                    break;
                case ID.ID_ADD_TREE1:
                    if (m_PageHome != null && m_CurMode == ClickMode.AddTree1)
                    {
                        e.control.Checked = m_PageHome.View3D.ComponentMode;
                    }
                    else
                        e.control.Checked = false;
                    break;
                case ID.ID_ADD_TREE2:
                    if (m_PageHome != null && m_CurMode == ClickMode.AddTree2)
                    {
                        e.control.Checked = m_PageHome.View3D.ComponentMode;
                    }
                    else
        ...
        enum ClickMode
        {
            Pick = 0, AddTree1, AddTree2
        }

        private ClickMode m_CurMode = ClickMode.Pick;
        ...
        private void CommandBarsMenu_Execute(object sender, AxXtremeCommandBars._DCommandBarsEvents_ExecuteEvent e)
        {
            ...
            switch (e.control.Id)
            {
                ...
                case ID.ID_VIEW_HOME:
                    ...
                    break;
                case ID.ID_ADD_TREE1:
                    m_CurMode = ClickMode.AddTree1;
                    if (m_PageHome != null)
                        m_PageHome.View3D.SetComponentMode(!m_PageHome.View3D.ComponentMode, (int)m_CurMode);
                    break;
                case ID.ID_ADD_TREE2:                    
                    m_CurMode = ClickMode.AddTree2;                   
                    if (m_PageHome != null)
                        m_PageHome.View3D.SetComponentMode(!m_PageHome.View3D.ComponentMode, (int)m_CurMode);
                    break;

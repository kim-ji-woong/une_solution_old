...
namespace UnE.SenarioMaker
{
    ...
    {
        //private string strPath = @"C:\PreSafeTemp";
        //경로
        //private string strPath = Environment.GetEnvironmentVariable("Path");
        private string strPath = System.IO.Path.GetTempPath();
        private string strFilePath = System.IO.Path.GetTempPath() + "Save.txt";
        ...
        internal FormFindPassword m_findpasswordForm = null;
        ...
        public FormLoginMain()
        {
            ...
            m_findpasswordForm = new FormFindPassword();
            ...
            this.Controls.Add(m_findpasswordForm);
        ...
        {
            if (CheckCurrentForm(typeof(FormFindPassword)))
                SetCurrentForm(m_findpasswordForm);
        }
    }
}

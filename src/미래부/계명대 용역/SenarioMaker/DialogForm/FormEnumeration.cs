        ...
        private void DataGridView_CellValuePushed(object sender, DataGridViewCellValueEventArgs e)
        {
            ...
            switch (nCol)
            {
                case 0:
                    ...
                    {
                        UnE.Utility.UMessageBox.Show("사용자 Enum의 이름이 중복 되었습니다.\n고유한 이름을 입력해 주세요.", "입력오류", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        return;
                    }
                    if (SenarioManager.Instance.SystemVariables.ContainsKey(szName))
                    {
                        UnE.Utility.UMessageBox.Show("시스템 변수와 이름이 중복 되었습니다.\n고유한 이름을 입력해 주세요.", "입력오류", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        return;
                    }
                    if (SenarioManager.Instance.UserVariables.ContainsKey(szName))
                    {
                        UnE.Utility.UMessageBox.Show("사용자 변수와 이름이 중복 되었습니다.\n고유한 이름을 입력해 주세요.", "입력오류", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        return;
                    }

...
namespace SOPMonitoringSystem
{
    ...
    {
        protected static Font TEXT_FONT = new Font("맑은고딕", 9);
        protected static SolidBrush TEXT_BRUSH = new SolidBrush(Color.Black);
        protected static Pen SECTION_PEN = new Pen(Color.Gray, 7);
        ...
        private void InitControl()
        {
            ...
            //m_textBox.TextAlign = ContentAlignment.TopCenter;
        ...
        protected void DrawSectionLink(Section section, Graphics g, bool directLink, ref Vertex2D vCenter)
        {
            ...
            else
            {
                ...
                g.DrawLine(SECTION_PEN, (int)vCenter.x, (int)vCenter.y, (int)vCenter.x, cy2+ 4);
        ...
        {
            RoundRect((int)g.GetHdc(), xLeft, yTop, xRight, yBottom, 20, 20);
            g.ReleaseHdc();
        }
        ...
        public void Draw(Graphics g)
        {
            ...
            g.DrawString(m_textBox.Text, TEXT_FONT, Brushes.Black, new Rectangle(m_textBox.Location, m_textBox.Size), m_textFormat);
        ...
        public SectionTextBox GetTextBox()
        {
            return m_textBox;
        }

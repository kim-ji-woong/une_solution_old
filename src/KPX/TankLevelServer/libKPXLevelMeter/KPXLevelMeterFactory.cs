...
{
    internal class KPXLevelMeterFactory
    {
        ...
        public KPXLevelMeterFactory(LevelMeterManager dm, ConfigFile file)
        {
            m_Main = dm;
            m_Conf = file;
        }
        ...
        private List<KPXLevelMeter> m_List = new List<KPXLevelMeter>();
        
        private List<KPXLevelMeter> CreateDetector()
        {
                ...
                for (int i = 0; i < m_nUnitNum; i++)
                {
                    ...
                    if (szUnitValues != null && szUnitValues.Length > 0)
                    {
                        ...
                        if (values.Length >= 6)
                        {
                            ...
                            KPXLevelMeter detector = new KPXLevelMeter(nID, nStartUnit, nEndUnit, aUnits);                            
        ...
        public List<KPXLevelMeter> CreateDetectorList()
        {

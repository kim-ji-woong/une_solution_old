...
{    
    internal class NetworkManager
    {
        ...
        public NetworkManager(LeakDetectorManager dm, ConfigFile file)
        {
        ...
        private static List<NetworkManager> mManagerList = new List<NetworkManager>();
        public static NetworkManager CreateNetworkManager(LeakDetectorManager dm, ConfigFile file, string szIP)
        {
        ...
        private void SendLog(Byte[] bufRecive, int ret)
        {
            ...
            logger.Debug(szName + "[SEND TXT] : " + tmp);
        }
        ...
        private void AddLog(Byte[] bufRecive, int ret)
        {
            ...
            System.Diagnostics.Trace.WriteLine(szName + "[RECIVED TXT] : " + tmp);
            logger.Debug(szName + " [RECIVED TXT] : " + tmp);

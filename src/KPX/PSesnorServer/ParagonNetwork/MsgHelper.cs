...
namespace ParagonNetwork
{
    internal class MsgHelper
    {
        ...
        internal static byte[] MakeLongCmdReadRegisterData(byte nStartAddressHi, byte nStartAddressLow, byte nRegCntHi, byte nRegCntLow, byte nSlaveID, byte nFunc, out byte nHeader)
        {
            byte[] data = new byte[12];

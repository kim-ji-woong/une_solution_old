...
{    
    internal class NetworkManager
    {
        ...
        public NetworkManager(ParagonManager dm, ConfigFile file)
        {
        ...
        public static NetworkManager CreateNetworkManager(ParagonManager dm, ConfigFile file, string szIP)
        {
        ...
        private bool Connect()
        {
            ...
            { 
                ...
                if (IsConnected == false)
                {
                    ...
                    { 
                        ...
                        Logger.Instance.Write("Connect [ " + m_szIP + " ] : " + bResult);
            ...
            {
                Logger.Instance.Write("Connect Error [ " + m_szIP + " ] : " + e);
        ...
        private void ConnectThread()
        {
            while(!bExitThread)
            {
                ...
                {
                    Logger.Instance.Write("ConThread Error[ " + m_szIP + "] : " + ex);
        ...
        private void AddLog(Byte[] bufRecive, int ret)
        {
            ...
            Logger.Instance.Write("[RECIVED TXT] : " + tmp);
        }
    }    

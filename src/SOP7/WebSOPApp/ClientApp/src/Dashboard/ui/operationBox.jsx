...
class OperationBox extends Component {
    ...
    displayOperationUI = () => {
        ...
        return [operationUI, totaLCnt];
    }


    componentDidMount() {

        const resizaleOperationBoxColumn = "." + dashboard.operationBox;
        const resizaleOperationBoxRow = "." + dashboard.operationBox;

        $(function() {
            $(resizaleOperationBoxRow).resizable({
                direction: 'bottom'
           });
        });
    }
    ...
    render() {
        const [displayOperationUI, selectCnt] = this.displayOperationUI();
                ...
                <div className={dashboard.operationBox}>
                    ...
                    <div className={dashboard.operationBoard}>
                        <div className={dashboard.whole}>
                            ...
                            <div className={dashboard.wholeNum}>{selectCnt}<span>건</span></div>
                        </div>
                    </div>

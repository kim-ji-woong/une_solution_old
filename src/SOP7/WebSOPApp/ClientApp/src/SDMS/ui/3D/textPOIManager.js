...
export class TextPOIManager {
    ...
    addBuildingText(buildings/*: { [buildingGroupName: string]: {} }*/, siteID)/*: void*/ {
        let textCount = 0;
        for (const buildingGroupName in buildings) {
            ...
            for (const buildingName in buildingGroup) {
                ...
                if (x !== null && x !== undefined && y !== null && y !== undefined && z !== null && z !== undefined) {
                    const sprite = this.makeBuildingText(SDMSMainMenu.BuildingNameText, displayText, -1, id, x, y, z, this.buildingFontSize, siteID);
    ...
    addEquipZoneText(zoneID/*: number*/, equipZones/*: { [equipZoneID: number]: [number, string, THREE.Vector3] }*/, siteID)/*: void*/ {
        ...
        for (const equipZoneID in equipZones) {
            ...
            if (equipZone && equipZone[1].length > 0 && equipZone[2] !== null) {
                ...
                const sprite = this.makeBuildingText(SDMSMainMenu.EquipZoneNameText, equipZoneName, zoneID, equipZoneID, textCenter.x, textCenter.y, textCenter.z, TextPOIManager.EquipZoneFontSize, siteID);
    ...
    makeBuildingText(textTag/*: string*/, text/*: string*/, zoneID/*: number*/, id/*: number*/, x/*: number*/, y/*: number*/, z/*: number*/, fontSize/*: number*/, siteID)/*: THREE.Sprite | null*/ {
        const backgroundColor = { r: 0, g: 0, b: 0, a: 0.7 };
        const borderColor = this.buildingTextBorderColor;
        //const borderColor = { r: 63, g: 108, b: 219, a: 1.0 };
        const textColor = this.textColor;
    ...
    async reloadEquipZoneText() {
        ...
        this.showEquipZoneSprites(this.prevZoneID);
    ...
    updateBuildingText(buildingData, buildingIDData, allBuildingData, building, buildingSprites, oldSprite, siteID) {
        ...
        const sprite = this.makeBuildingText(buildingData.displayText, pos.x, pos.y, pos.z, TextPOIManager.BuildingFontSize, siteID);
    ...
    updateEquipZoneText(equipZoneData, equipZone, equipZoneSprites, oldSprite, siteID) {
        ...
        const sprite = this.makeBuildingText(SDMSMainMenu.EquipZoneNameText, equipZoneData.zoneName, this.getFirstLinkedZoneID(equipZoneData), equipZoneData.id, pos.x, pos.y, pos.z, TextPOIManager.EquipZoneFontSize, siteID);
            ...
            if (spriteData) {
                ...
                if (buildingGroup && buildingGroup[1]) {
                    if (_buildingGroup.displayText !== buildingGroup[1] ||
                        ...
                        const sprite = this.makeBuildingGroupText(_buildingGroup.displayText, pos.x, pos.y, pos.z, this.buildingGroupFontSize, _3dOptions.siteID);
    ...
    addText(tag/*: string*/, text/*: string*/, zoneID/*: number*/, id/*: number*/, x/*: number*/, y/*: number*/, z/*: number*/, fontSize/*: number*/, backgroundColor/*: rgbaColor*/, borderColor/*: rgbaColor*/, textColor/*: rgbaColor*/, borderThickness/*: number*/, siteID)/*: THREE.Sprite | null*/ {
    ...
    getTextLayer(siteID) {
        ...
        if (!textLayer && this.scene) {
            ...
            this.siteTextLayers[siteID] = textLayer;
        }

...
class OpenSOPOptions extends Component {
	...
	getDisasterContents(disasterData) {
		...
		return (
			<li key={"disaster_" + this.disasterCount} className={"treeviewLastItem " + OpenSOPOptions.cssStyles.clickable} onClick={() => this.onClickDisaster(disasterData)}>{disasterData.disasterName}</li>
		);
	}

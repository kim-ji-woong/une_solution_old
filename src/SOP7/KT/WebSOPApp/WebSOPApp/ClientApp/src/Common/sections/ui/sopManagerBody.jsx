...
class SopManagerBody extends Component {
	...
	getBodyContents() {
		if (this.props.menu === SopManager.menu.editSOP ||
			...
			return <SopManagerBodyMain sopData={this.props.menuDatas} loginUser={this.props.loginUser} showCascading={this.props.showCascading} changeCascadingMode={this.props.changeCascadingMode} />;
		}

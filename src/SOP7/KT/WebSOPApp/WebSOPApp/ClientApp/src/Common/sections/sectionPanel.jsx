    ...
    render() {
        ...
        return (
            <section ref={this.refPanel} className={sectionStyles.sectionPanel} onScroll={this.onScroll} onClick={this.onClick}>
                ...
                <SectionGrid currentMenu={this.props.currentMenu} onSelectComponent={this.props.onSelectComponent} onSelectArrow={this.props.onSelectArrow} onAddComponent={this.props.onAddComponent} onRemoveComponent={this.props.onRemoveComponent} sopData={this.props.sopData} loginUser={this.props.loginUser} selectedSectionData={this.props.selectedSectionData} selectedArrowData={this.props.selectedArrowData} editDatas={this.props.editDatas} onProcessEdit={this.props.onProcessEdit} actionStep={actionStep1st} rowCount={this.props.rowCount} columnCount={this.props.columnCount} showGrid={this.state.showGrid} calcArrow={this.state.calcArrow} columnRefs={columnRefs} rowRefs={rowRefs} mode={this.state.mode} />
                <SectionGrid currentMenu={this.props.currentMenu} onSelectComponent={this.props.onSelectComponent} onSelectArrow={this.props.onSelectArrow} onAddComponent={this.props.onAddComponent} onRemoveComponent={this.props.onRemoveComponent} sopData={this.props.sopData} loginUser={this.props.loginUser} selectedSectionData={this.props.selectedSectionData} selectedArrowData={this.props.selectedArrowData} editDatas={this.props.editDatas} onProcessEdit={this.props.onProcessEdit} actionStep={actionStep2nd} rowCount={this.props.rowCount} columnCount={this.props.columnCount} showGrid={this.state.showGrid} calcArrow={this.state.calcArrow} columnRefs={columnRefs} rowRefs={rowRefs} mode={this.state.mode} />
                <SectionGrid currentMenu={this.props.currentMenu} onSelectComponent={this.props.onSelectComponent} onSelectArrow={this.props.onSelectArrow} onAddComponent={this.props.onAddComponent} onRemoveComponent={this.props.onRemoveComponent} sopData={this.props.sopData} loginUser={this.props.loginUser} selectedSectionData={this.props.selectedSectionData} selectedArrowData={this.props.selectedArrowData} editDatas={this.props.editDatas} onProcessEdit={this.props.onProcessEdit} actionStep={actionStep3rd} rowCount={this.props.rowCount} columnCount={this.props.columnCount} showGrid={this.state.showGrid} calcArrow={this.state.calcArrow} columnRefs={columnRefs} rowRefs={rowRefs} mode={this.state.mode} />
                <SectionGrid currentMenu={this.props.currentMenu} onSelectComponent={this.props.onSelectComponent} onSelectArrow={this.props.onSelectArrow} onAddComponent={this.props.onAddComponent} onRemoveComponent={this.props.onRemoveComponent} sopData={this.props.sopData} loginUser={this.props.loginUser} selectedSectionData={this.props.selectedSectionData} selectedArrowData={this.props.selectedArrowData} editDatas={this.props.editDatas} onProcessEdit={this.props.onProcessEdit} actionStep={actionStep4th} rowCount={this.props.rowCount} columnCount={this.props.columnCount} showGrid={this.state.showGrid} calcArrow={this.state.calcArrow} columnRefs={columnRefs} rowRefs={rowRefs} mode={this.state.mode} />

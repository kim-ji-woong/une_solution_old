    ...
    setMissionUI() {
        ...
        for (let i = 0; i < sectionsLength; i++) {            
            if (this.props.sections[i].componentType === 0) {
                list.push(<Process key={i} id={'section_' + this.props.sopTabIndex + '_' + i} sectionData={this.props.sections[i]} runSection={this.runSection} currentSection={this.props.currentSection} onProgressMission={this.props.onProgressMission} runSectionFromChart={this.props.runSectionFromChart} onProgressSpread={this.props.onProgressSpread} teamDatas={this.props.teamDatas}/>);
            }
            else if (this.props.sections[i].componentType === 1) {
                // 판단
                list.push(<Decision key={i} id={'section_' + this.props.sopTabIndex + '_' + i} sectionData={this.props.sections[i]} runSection={this.runSection} currentSection={this.props.currentSection} />);
            }
            else if (this.props.sections[i].componentType === 3) {
                // 시작, 종료
                list.push(<EndPoint key={i} id={'section_' + this.props.sopTabIndex + '_' + i} sectionData={this.props.sections[i]} runSection={this.runSection} currentSection={this.props.currentSection} />);
            }
            else if (this.props.sections[i].componentType === 6) {
                // 상황 전파
                list.push(<Internal key={i} id={'section_' + this.props.sopTabIndex + '_' + i} sectionData={this.props.sections[i]} runSection={this.runSection} currentSection={this.props.currentSection} onProgressMission={this.props.onProgressMission} runSectionFromChart={this.props.runSectionFromChart} onProgressSpread={this.props.onProgressSpread} teamDatas={this.props.teamDatas}/>)
            }
        }
        return list;
    }

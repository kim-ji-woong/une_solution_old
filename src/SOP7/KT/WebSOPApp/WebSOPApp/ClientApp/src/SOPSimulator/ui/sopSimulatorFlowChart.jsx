...
/*import test from '../../SOPSimulator/img/flowchart_sample2.jpg';*/


class SopSimulatorFlowChart extends Component {
...
/*    watermarkplay() {
    ...
    gridCenterForcus = (rowIndex, columnIndex) => {
        ...
        // 그리드 계산
        let width = (SopSimulatorFlowChart.cellDefaultWidth * columnIndex) - SopSimulatorFlowChart.scrollCenterWidth;
        let height = SopSimulatorFlowChart.gridHeaderMargin + (SopSimulatorFlowChart.cellDefaultHeight * rowIndex);
    ...
    getActionStepArea() {
        ...
        // 현재 단계 클래스 부여 
        if (this.props.sopData.currentActionStep.stepName === SopSimulatorResource.ID.actionStep._1st) {
            class_1st = "btnActionStep " + uis.class1st + " " + uis.isActive;
        } else if (this.props.sopData.currentActionStep.stepName === SopSimulatorResource.ID.actionStep._2nd) {
            /*class_2nd = "btnActionStep " + uis.class2nd + " " + uis.isActive;*/
            class_2nd = "btnActionStep " + uis.class2nd + " " + uis.isActive + " " + uis.circle;
        } else if (this.props.sopData.currentActionStep.stepName === SopSimulatorResource.ID.actionStep._3rd) {
            class_3rd = "btnActionStep " + uis.class3rd + " " + uis.isActive + " " + uis.circle;
        } else if (this.props.sopData.currentActionStep.stepName === SopSimulatorResource.ID.actionStep._4th) {
            class_4th = "btnActionStep " + uis.class4th + " " + uis.isActive;
        }
        ...
        actionStepArea = <>
            ...
            <li className={class_2nd}><button type="button" className={"value" + " " + uis.isActive + " " + uis.circle} onClick={(e) => this.onClickStep(e.target)}>{SopSimulatorResource.ID.actionStep._2nd}</button></li>
            {/*<li className={class_2nd}><button type="button" className={"value" + " " + uis.isActive + " " + uis.circle} onClick={(e) => this.onClickStep(e.target)}>{SopSimulatorResource.ID.actionStep._2nd}</button></li>*/}
                ...
                <section className={uis.subSection + " " + uis.progressViewWrap} >
                    <div className={uis.tit + " " + uis.clfix}>
                        ...
                        <div className={uis.btnArea}>
                            <button className={uis.btnMod}><i className={uis.iconMod}></i></button>
                            <button className={uis.btnPlay} onClick={this.props.beginSopData}><i className={uis.iconPlay}></i></button>
                            <button className={uis.btnEnd} onClick={this.props.closeSopData}><i className={uis.iconEnd}></i></button>
                        </div>
                    </div>
...
export default SopSimulatorFlowChart;
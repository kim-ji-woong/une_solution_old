...
class ProcessList extends Component {
    ...
    componentDidMount() {
        ...
        this.requestSensorName();
    }

    async requestSensorName() {
        let sensorName = '';
        if (this.props.sopRunData.sensorZoneHistoryID === null || !this.props.sopRunData.sensorZoneHistoryID) {
            sensorName = '수동';
        }
        else {
            sensorName = await SopSimulatorController.requestSensorName(this.props.sopRunData.sensorZoneHistoryID);
        }

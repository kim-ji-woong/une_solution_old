    ...
    public class TeamRollbackData : IRollbackData
    {
        ...
        public bool Rollback(SDMS.IDAL.IDataManager sdmsDataManager, TeamEditor.IDAL.IDataManager teamDataManager)
        {
            ...
            if (m_insertMembers != null)
            {
                ...
                {
                    if (teamDataManager.GetCreateManager().AddRegularMember(member, out strErrorMessage) == false)
                        return false;
                }
            }
            ...
            if (m_insertTeams != null)
            {
                ...
                {
                    if (teamDataManager.GetCreateManager().AddRegular(team, out strErrorMessage) == false)
                        return false;
                }
            }
            ...
            if (m_insertTemporaryMembers != null)
            {
                ...
                {
                    if (teamDataManager.GetCreateManager().AddTemporaryMember(member, out strErrorMessage) == false)
                        return false;
                }
            }

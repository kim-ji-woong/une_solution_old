...
namespace SDMS.BLL.Excel.Reader
{
    public class BuildingGroupReader : ExcelReader
    {
        ...
        public BuildingGroupReader(string strFilePath, IDataManager dataManager)
        ...
        protected override bool UpdateData(List<SheetData> sheetDatas, out string strErrorMessage)
        {
            ...
            {
                strErrorMessage = "m_dataManager 값이 null";
                return false;
            }
        ...
        private bool CheckData(Dictionary<string, List<BuildingGroupData>> dicDBBuildingGroupDatas, Dictionary<string, List<BuildingGroupData>> dicSheetBuildingGroupDatas, out string strErrorMessage)
        {
            ...
            foreach (KeyValuePair<string, List<BuildingGroupData>> pair in dicSheetBuildingGroupDatas)
            {
                if (dicDBBuildingGroupDatas.TryGetValue(pair.Key, out buildingGroupDatas) == false)
                {
                    ...
                    {
                        buildingGroupData.OrderIndex = nOrderIndex++;
        ...
        public static Dictionary<string, List<BuildingGroupData>> ReadDB(IDataManager dataManager, out Dictionary<int, BuildingGroup> dicBuildingGroups, out Dictionary<string, BuildingGroup> dicBuildingGroupNames, out string strErrorMessage)
        {

...
namespace SDMS.BLL.Excel.Reader
{
    public class BuildingReader : ExcelReader
    {
        ...
        public BuildingReader(string strFilePath, IDataManager dataManager)
        ...
        private bool CheckData(Dictionary<string, List<BuildingData>> dicDBBuildingDatas, Dictionary<string, List<BuildingData>> dicSheetBuildingDatas, out string strErrorMessage)
        {
            ...
            foreach (KeyValuePair<string, List<BuildingData>> pair in dicSheetBuildingDatas)
            {
                if (dicDBBuildingDatas.TryGetValue(pair.Key, out buildingDatas) == false)
                {
                    ...
                    {
                        buildingData.OrderIndex = nOrderIndex++;
        ...
        public static Dictionary<string, List<BuildingData>> ReadDB(IDataManager dataManager, out Dictionary<int, Building> dicBuildings, out Dictionary<string, Building> dicBuildingNames, out string strErrorMessage)
        {
            dicBuildings = null;

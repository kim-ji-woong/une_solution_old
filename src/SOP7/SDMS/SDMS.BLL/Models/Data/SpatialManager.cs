...
namespace SDMS.BLL.Models.Data
{
    ...
    public class SpatialManager
    {
        ...
        public bool LoadSpatial(IDataManager dataManager)
        {
            ...
            List<Model.Spatial.ZoneData> zoneDatas = dataManager.GetSelectManager().SelectZoneDatas(null, null, out strErrorMessage);
            ...
            foreach (Model.Spatial.ZoneData zoneData in zoneDatas)
            {
                ZoneData data;
    ...
    public class ZoneData : Zone
    {
        ...
        private Model.Spatial.ZoneData m_zoneData = new Model.Spatial.ZoneData();
        ...
        public Model.Spatial.ZoneData Datas
        {

...
namespace SDMS.DAL
{
    public class QueryManager
    {
        ...
        protected string VertexToString(Vertex3D vertex)
        {
            if (vertex == null)
                return null;
        ...
        protected Vertex3D StringToVertex3D(string strVertex)
        {
            ...
            if (double.TryParse(tokens[0].Trim(), out x) &&
                double.TryParse(tokens[1].Trim(), out y) &&
                double.TryParse(tokens[2].Trim(), out z))
        ...
        protected Polygon StringToPolygon(string strVertices)
        {

...
namespace TeamEditor
{
    public partial class FormFrame : UnE.GUI.FormNoFrameSizableRibbon
    {
        ...
        private void FormFrame_Load(object sender, EventArgs e)
        {
            ...
            //폰트설정
            this.TitleTextFont = new Font(Program.prgFont, 9f, FontStyle.Bold);
            this.TitlePosition = new Point(30, 7);
            this.Text = m_strAppName;

            this.ShowPictureBoxTitle = true;
            this.PictureBoxSize = new Size(22, 22);
            this.PictureBoxTitle.Location = new Point(3,3);
            
            this.PictureBoxTitleImage = global::TeamEditor.Properties.Resources.teamEdit_logo_small;
        ...
        {
            double dWinWidthRate = FormMain.Instance.WindowWidthRate;
            double dWinHeightRate = FormMain.Instance.WindowHeightRate;

            this.TitleBarHeight = (int)(TitleBarHeight * dWinWidthRate);

            this.SystemButtonSize = new Size((int)(SystemButtonSize.Width * dWinWidthRate), (int)(SystemButtonSize.Height * dWinHeightRate));

            this.PictureBoxTitle.Size = new Size((int)(PictureBoxTitle.Width * dWinWidthRate), (int)(PictureBoxTitle.Height * dWinHeightRate));
            this.PictureBoxTitle.Location = new Point((int)(this.PictureBoxTitle.Location.X * dWinWidthRate), (int)(this.PictureBoxTitle.Location.Y * dWinHeightRate));

            this.TitlePosition = new Point((int)(TitlePosition.X * dWinWidthRate), (int)(TitlePosition.Y * dWinHeightRate));
            this.TitleTextFont = new Font(TitleTextFont.FontFamily, (float)(TitleTextFont.Size * dWinWidthRate), TitleTextFont.Style);
        ...
        {
            if (this.Width > Screen.FromControl(this).WorkingArea.Width)
                this.Width = Screen.FromControl(this).WorkingArea.Width;
     
            if (this.Height > Screen.FromControl(this).WorkingArea.Height)

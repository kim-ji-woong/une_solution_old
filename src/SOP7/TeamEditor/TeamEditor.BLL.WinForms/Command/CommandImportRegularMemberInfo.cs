...
namespace TeamEditor.BLL.WinForms.Command
{
    ...
    public class CommandImportRegularMemberInfo : CommandEx
    {
        ...
        private class InsertMemberInfo : IMemberInfo
        {
            ...
            public string GetInsertCompanyMemberSQL(WebDBManager dbMgr, CompanyMember member)
            {
            ...
            public string GetInsertRegularMemberSQL(WebDBManager dbMgr, CompanyMember member)
            {
                string strSQL = string.Empty;
            ...
            public string[] GetDeleteSQL(WebDBManager dbMgr, CompanyMember member)
            {
        ...
        private class UpdateMemberInfo : IMemberInfo
        {
            ...
            public string[] GetUpdateSQL(WebDBManager dbMgr, CompanyMember member)
            {
        ...
        private class DeleteMemberInfo : IMemberInfo
        {
            ...
            public string[] GetDeleteCompanyMemberSQL(WebDBManager dbMgr, CompanyMember member)
            {
                string[] arrSQL = new string[8] { string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty };
            ...
            public string[] GetReverseSQL(WebDBManager dbMgr, CompanyMember member)
            {
            ...
            private void AddReverseSQL_RegularMemberList(WebDBManager dbMgr, int nID)
            {
            ...
            private void AddReverseSQL_FacilityManager(WebDBManager dbMgr, int nID)
            {
                ...
                {
                    int nMgrID = WebDBManager.GetIntField(arrResult[i].ToString(), -1);
            ...
            private void AddReverseSQL_EquipZoneFacilityManager(WebDBManager dbMgr, int nID)
            {
            ...
            private void AddReverseSQL_BuildingFacilityManager(WebDBManager dbMgr, int nID)
            {
            ...
            private void AddReverseSQL_TemporaryMemberList(WebDBManager dbMgr, int nID)
            {
                ...
                for (int i = 0; i < nResultCount - 8; i += 9)
                {
                    int nTempID = WebDBManager.GetIntField(arrResult[i].ToString(), -1);
            ...
            //private void AddReverseSQL_Duty(WebDBManager dbMgr, int nID)
            //{
            ...
            //    {
            //        int nDutyID = WebDBManager.GetIntField(arrResult[i].ToString(), -1);
            //        int nMemberID = WebDBManager.GetIntField(arrResult[i + 1].ToString(), -1);
            ...
            private void AddReverseSQL_SOPGenUser(WebDBManager dbMgr, int nID)
            {
                ...
                {
                    int nGenID = WebDBManager.GetIntField(arrResult[i].ToString(), -1);
                    int nMemberID = WebDBManager.GetIntField(arrResult[i + 1].ToString(), -1);
            ...
            private void AddReverseSQL_CompanyMember(WebDBManager dbMgr, int nID)
            {
        ...
        public CommandImportRegularMemberInfo(TreeView tree, ArrayList arrHeaderPosition, ArrayList arrImportData)
        {
        ...
        private bool Import(WebDBManager dbMgr)
        {
            // 저장 성공 여부
            bool rtnSave = true;
                                        ...
                                        )
            {
                ...
                team.TeamID = WebDBManager.GetIntField(arrResult[0].ToString(), 0);
            ...
            else
            {
                ...
                {
                    SetManager.SetRegularTeam(team.TeamID, team);
                }
        ...
        private bool UnImport(WebDBManager dbMgr)
        {
            // 저장 성공 여부
            bool rtnSave = true;
        ...
        private RegularTeam RegistRegularTeam(string strDeptName, RegularTeam parentTeam)
        {
            ...
            SetManager.SetRegularMembers(team);
        ...
        private bool CheckNAddTeam(WebDBManager dbMgr, int nTeamID)
        {

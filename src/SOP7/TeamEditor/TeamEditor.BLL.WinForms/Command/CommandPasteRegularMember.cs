...
namespace TeamEditor.BLL.WinForms.Command
{
    public class CommandPasteRegularMember : CommandEx
    {
        ...
        public CommandPasteRegularMember(TreeView tree, MergedDataGridView grid, string[] strPastedRows, int rowMinIdx, int colMinIdx)
        {
            this.m_tree = tree;
            this.m_grid = grid;
        ...
        {
            if (infoType == (int)ChangeMemberInfo.InfoType.TeamName)
            { 
            ...
            else if (infoType == (int)ChangeMemberInfo.InfoType.Name)
            {
                if (originData == null)
                    member.Name = "";
                else
            ...
            else if (infoType == (int)ChangeMemberInfo.InfoType.MemberID)
            {
                if (originData == null)
                    member.MemberID = "";
            ...
            else if (infoType == (int)ChangeMemberInfo.InfoType.SubLevel)
            {
            ...
            else if (infoType == (int)ChangeMemberInfo.InfoType.OfficePhoneNumber)
            {
            ...
            else if (infoType == (int)ChangeMemberInfo.InfoType.GroupPosition)
            {

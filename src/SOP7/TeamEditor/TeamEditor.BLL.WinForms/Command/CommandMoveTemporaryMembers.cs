...
namespace TeamEditor.BLL.WinForms.Command
{
    public class CommandMoveTemporaryMembers : CommandEx
    {
        ...
        public CommandMoveTemporaryMembers(Team teamOrigin, Team teamMoved, List<TemporaryMemberNIndex> rows, MergedDataGridView grid, TreeView tree)
        {
        ...
        private void UpdateTemporaryMemberList(WebDBManager dbMgr, Team team)
        {
            if (team == null)
                return;

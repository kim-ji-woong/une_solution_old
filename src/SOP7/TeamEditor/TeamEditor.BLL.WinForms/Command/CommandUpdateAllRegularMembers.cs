...
namespace TeamEditor.BLL.WinForms.Command
{
    ...
    public class CommandUpdateAllRegularMembers : CommandEx
    {
        ...
        private void LoadOldTemporaryMembers(TreeView tree, Dictionary<Team, List<TemporaryMember>> dicTemporaryMembers, bool isNormal)
        {
            foreach (KeyValuePair<Team, List<TemporaryMember>> pair in dicTemporaryMembers)
            {
        ...
        private void DeleteOldTemporaryMembers(TreeView tempTree, bool isNormal)
        {

...
namespace FireManagement
{
    public partial class FormEquipList : Form
    {
        ...
        private object m_selectedShape = null;
        ...
        private void InitControls()
        {
            ...
            colFREquipID.HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            colFRRFID.HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            colFRStatus.HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
        }
            ...
            try
            {
                foreach (FireEquipment equip in arrEquipments)
                {
                    if (equip.Type == FireEquipment.EquipmentType.FE)
                        ...
                        AddEquipment(equip, dataGridFR, m_dicFRShape);
                }
            }
            catch (Exception e)
            {
        ...
        private void AddEquipment(FireEquipment equip,  DataGridView grid, Dictionary<object, DataGridViewRow> dicShape)
        {
        ...
        public bool SelectShape(object shape)
        {
            ...
            else if (m_dicFRShape.ContainsKey(shape))
            {
                ...
                if (!dataGridFR.Visible)
                    btnFireReciver_Click(null, null);
            }

            m_selectedShape = shape;

            if (shape != null)
                FormMain2.Instance.DrawingControl.SelectShape(m_selectedShape, true);
        ...
        public void ClearSelection(bool refresh = false)
        {
            ...
            if (m_selectedShape != null)
                FormMain2.Instance.DrawingControl.SelectShape(m_selectedShape, false);
        ...
        {
            for (int i = 0; i < m_arrEquipmentType.Length; i++)
            {
        ...
        {
            DataGridVisible(btnFireReciver);
        }
        ...
        private void dataGridFR_MouseMove(object sender, MouseEventArgs e)
        {
            FormEquipList_MouseMove(sender, e);
        }

        private void dataGridFR_MouseDown(object sender, MouseEventArgs e)
        {
            FormEquipList_MouseDown(sender, e);

        }

        private void dataGridFR_MouseUp(object sender, MouseEventArgs e)
        {
            FormEquipList_MouseUp(sender, e);
        }
        ...
        private void SetGridViewSize()
        {
            ...
            dataGridFR.ColumnHeadersDefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            dataGridFR.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.DisableResizing;
            dataGridFR.ColumnHeadersHeight = 30;

            dataGridFR.ForeColor = System.Drawing.Color.FromArgb(1, 1, 1);
            dataGridFR.Font = new Font("맑은 고딕", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(129)));
        }

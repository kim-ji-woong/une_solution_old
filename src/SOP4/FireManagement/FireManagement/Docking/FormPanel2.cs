...
namespace FireManagement.Docking
{
    ...
    public partial class FormPanel2 : Form, IRibbonButtonOwner, Ubists.IReaderOwner
    {
        ...
        private ShapeGroupOption m_optFE = null;
        private ShapeGroupOption m_optFA = null;
        private ShapeGroupOption m_optHD = null;
        private ShapeGroupOption m_optFR = null;
        ...
        private ControlText m_textSelected = null;
        ...
        {
            get { return (RibbonButtonFireManagement)btnHome; }
            set { btnHome = value; }
        }
        public RibbonButtonFireManagement BtnFireExtinguisher
        {
            get { return (RibbonButtonFireManagement)btnFireExtinguisher; }
            set { btnFireExtinguisher = value; }
        }
        public RibbonButtonFireManagement BtnFirePlug
        {
            get { return (RibbonButtonFireManagement)btnFirePlug; }
            set { btnFirePlug = value; }
        }
        public RibbonButtonFireManagement BtnFireAlarm
        {
            get { return (RibbonButtonFireManagement)btnFireAlarm; }
            set { btnFireAlarm = value; }
        }

        public RibbonButtonFireManagement BtnFireReceiver
        {
            get { return (RibbonButtonFireManagement)btnFireReciver; }
            set { btnFireReciver = value; }
        }
        ...
        {
            get { return (RibbonButtonFireManagement)btnGroup; }
            set { btnGroup = value; }
        }

        public ShapeGroupOption FEGroupOption
        {
            get { return m_optFE; }
        }

        public ShapeGroupOption FAGroupOption
        {
            get { return m_optFA; }
        }

        public ShapeGroupOption HDGroupOption
        {
            get { return m_optHD; }
        }

        public ShapeGroupOption FRGroupOption
        {
            get { return m_optFR; }
        }
        ...
        public FormPanel2()
        {
            ...
            m_frmEquipZoneText = new FormEquipZoneText(m_drawingControl);
        ...
        {
            m_drawingControl = new Control2D(FormMain2.Instance.DrawingControlMode, this);

            m_drawingControl.Control.KeyDown += new System.Windows.Forms.KeyEventHandler(this.dxfControl1_KeyDown);
            m_drawingControl.Control.MouseDoubleClick += new System.Windows.Forms.MouseEventHandler(this.dxfControl1_MouseDoubleClick);
            m_drawingControl.Control.MouseDown += new System.Windows.Forms.MouseEventHandler(this.dxfControl1_MouseDown);
            m_drawingControl.Control.MouseMove += new System.Windows.Forms.MouseEventHandler(this.dxfControl1_MouseMove);
            m_drawingControl.Control.MouseUp += new System.Windows.Forms.MouseEventHandler(this.dxfControl1_MouseUp);
        }

        public Control2D DrawingControl
        {
            get { return m_drawingControl; }
        }
        /*public ImageViewCtrl DXFControl
        {
        ...
        { 
            ...
            InitRibbonButton(btnFireReciver, ID.ID_FIRERECEIVER_VISIBLE, global::FireManagement.Properties.Resources.FireReciver_86_82, global::FireManagement.Properties.Resources.FireReciver__Icon, null, global::FireManagement.Properties.Resources.FireReciver_mouseover, global::FireManagement.Properties.Resources.click_FireManagement, global::FireManagement.Properties.Resources.FireReciver_disabled);
            ...
            switch (nButtonID)
            {
                case ID.ID_HOME_SCREEN :
                    ...
                    if (DrawingControl != null)
                        DrawingControl.LoadHome(true);
                    break;
                case ID.ID_FIREEXTINGUISHER_VISIBLE :
                    btnCheck(btnFireExtinguisher);
                    LeftBar.Rearrange(FireEquipment.EquipmentType.FE, btnFireExtinguisher.IsChecked, btnFirePlug.IsChecked, btnFireAlarm.IsChecked, btnFireReciver.IsChecked);
                ...
                case ID.ID_FIREALARM_VISIBLE :
                    ...
                    break;
                case ID.ID_FIRERECEIVER_VISIBLE:
                    btnCheck(btnFireReciver);
                    FormMain2.Instance.EquipmentLayerOn(FireEquipment.EquipmentType.FR, btnFireReciver.IsChecked);
                    break;
        ...
        {
            ControlLayer layerFE = FormMain2.Instance.GetEquipmentLayer(FireEquipment.EquipmentType.FE);
            ControlLayer layerHD = FormMain2.Instance.GetEquipmentLayer(FireEquipment.EquipmentType.HD);
            ControlLayer layerFA = FormMain2.Instance.GetEquipmentLayer(FireEquipment.EquipmentType.FA);
            ControlLayer layerFR = FormMain2.Instance.GetEquipmentLayer(FireEquipment.EquipmentType.FR);
        ...
        public void OnReadTag(string strTag)
        {
            ...
            else
            {
                ...
                if (equip == null || equip.LinkedShape == null)
                {
                    ...
                    if (equip != null)
                    {
                        if (FormMain2.Instance.FormFileLoad.LoadZone(equip.Zone, FormMain2.Instance.CurrentZone))
                        {
                            ShowCheckEquipTab();
                        }
                    }
        ...
        private void ShowCheckEquipTab()
        {
            FormMain2.Instance.SelectFireManagerTab(2);
            FormMain2.Instance.SelectCheckEquipTab();
        }

        private object m_tmpshape = null;
        ...
        private void dxfControl1_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                ...
                {
                    UnE.Geometry.Vertex2D vPos = m_drawingControl.ScreenToGlobal(e.X, e.Y);
                    UnE.Geometry.Vertex2D vMove = m_drawingControl.MovedVertex;

                    float fUnitFlag = frmMain.GetUnitFlag(UnitOfLength.METER);
                ...
                {
                    UnE.Geometry.Vertex2D vPos = m_drawingControl.ScreenToGlobal(e.X, e.Y);
                    object shape = m_drawingControl.PickObject(vPos.x, vPos.y);
        ...
        {
            _x = _y = 0.0;
            UnE.Geometry.Vertex2D vertex = m_drawingControl.ScreenToGlobal(x, y);

            if (vertex != null)
            {
                UnE.Geometry.Vertex2D vMove = new UnE.Geometry.Vertex2D();// dxfControl1.MovedVertex;
                float fFlag = FormMain2.Instance.GetUnitFlag(UnitOfLength.METER);
            ...
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                ...
                else if (m_dockEquipList.IsOpened)
                {
                    ...
                    if (Mode == Mode.EDIT)
                    {
                        if (m_dockEquipList.SelectedEquipment != null)
                        {
                            object shape = m_dockEquipList.SelectedEquipment.LinkedShape;
                            FormMain2.Instance.DrawingControl.MoveShape(shape, vPos);
                            UnE.Geometry.Vertex2D shapePosition = FormMain2.Instance.DrawingControl.GetShapePosition(shape);

                            if (shapePosition != null)
                                m_dockEquipList.SelectedEquipment.Position = new PointF((float)shapePosition.x, (float)shapePosition.y);
        ...
        private void dxfControl1_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            else if (m_dockEquipList.IsOpened)
            {
                ...
                if (shape != null)
                {
                    ...
                    //form.Show();
                    ControlLayer layer = FormMain2.Instance.DrawingControl.GetShapeLayer(shape);

                    if (FormMain2.Instance.GetEquipmentLayerType(layer) == FireEquipment.EquipmentType.UNKNOWN)
                    {
        ...
        private void OnRButtonClick(int x, int y)
        {
            ...
            UnE.Geometry.Vertex2D vPos = m_drawingControl.ScreenToGlobal(x, y);

            ControlLayer layerSensor = DXFManager.GetLayer(EquipmentZone.EquipZoneType.SENSOR_TYPE, m_drawingControl);
            ControlLayer layerFA = DXFManager.GetLayer(EquipmentZone.EquipZoneType.FA_TYPE, m_drawingControl);

            ControlText textSelected = PickText(layerSensor, vPos);
        ...
        private ControlText PickText(ControlLayer layer, UnE.Geometry.Vertex2D vPos)
        {
            if (layer == null)
                return null;
        ...
        private void OnRButtonMove(int x, int y)
        {
            ...
            UnE.Geometry.Vertex2D vPos = m_drawingControl.ScreenToGlobal(x, y);
            FormMain2.Instance.DrawingControl.MoveShape(m_textSelected.Text, new UnE.Geometry.Vertex2D(vPos.x - m_vRClickOrigin.x, vPos.y - m_vRClickOrigin.y));
        ...
        private void OnRButtonDoubleClick(int x, int y)
        {
            ...
            if (m_drawingControl.IsOpened == false)
                return;

            m_nEditEquipZoneTextX = x;
            m_nEditEquipZoneTextY = y;
            contextMenuStripEditEquipZoneText.Show(m_drawingControl.Control, x, y);
        }
        ...
        private void SaveToDBNewEquipZone()
        {
            ...
            foreach (Text text in m_arrNewText)
            {
                if (text.Tag == null)
                    continue;
                ...
                strSQL = "Insert into EquipmentZone (ID, ZoneName, SiteID, Boundary, LinkedZoneIDList, Type, BroadcastName, TextCenter, Description) values ";
                strSQL += string.Format("({0}, '{1}', {2}, '{3}', '{4}', {5}, '{1}', '{6}', NULL)", 
                    nID, equipZone.ZoneName, FormMain2.Instance.SiteID, strBoundary, zone.ID, (int)equipZone.ZoneType, strTextCenter);
        ...
        {
            // 좌표 변경
            UnE.Geometry.Vertex2D vMove = FormMain2.Instance.DrawingControl.MovedVertex;
        ...
        {
            ControlLayer layerSensor = DXFManager.GetLayer(EquipmentZone.EquipZoneType.SENSOR_TYPE, m_drawingControl);
            ControlText text = MakeText(layerSensor, m_nEditEquipZoneTextX, m_nEditEquipZoneTextY);
        ...
        private ControlText MakeText(ControlLayer layer, int x, int y)
        {
            UnE.Geometry.Vertex2D vPos = m_drawingControl.ScreenToGlobal(x, y);
            ...
            ControlText textTrg = new ControlText(m_drawingControl);
        ...
        private bool SaveToDBEquipZoneText(ControlLayer layer)
        {
        ...
        private void SaveToDBRemovedEquipZone(ControlLayer layer1, ControlLayer layer2)
        {
            Zone zoneCurrent = FormMain2.Instance.CurrentZone;
        ...
        private bool ContainsEquipZone(EquipmentZone equipZone, ControlLayer layer)
        {
            foreach (Shape shape in layer.Shapes)
            {
                if (shape.GetType() != typeof(Text))
                    continue;
        ...
        private void dxfControl1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Delete)
            {
                if (m_textSelected != null)
                {
                    FormMain2.Instance.DrawingControl.GetShapeLayer(m_textSelected.Text).Remove(m_textSelected);
                    m_drawingControl.Refresh();
                }
            }
        }
        ...
        private void Init()
        {
            ...
            Image imgFR = global::FireManagement.Properties.Resources.visible_FireReciver_52_52;

            m_optFE = new ShapeGroupOption(imgFE, 52, 52);
            m_optFA = new ShapeGroupOption(imgFA, 52, 52);
            m_optHD = new ShapeGroupOption(imgHD, 52, 52);
            m_optFR = new ShapeGroupOption(imgFR, 52, 52);
        }
        ...
        public void SetGroupOption()
        {
            ...
            SetGroupOption(layerFR, m_optFR);

            //dxfControl1.CalcShapeGroup();
        }

        private void SetGroupOption(ControlLayer layer, ShapeGroupOption opt)
        {
            if (layer == null)
                return;
        ...
        public void ResizeControls()
        {
            ...
            m_drawingControl.Location = new Point(0, FormMain2.Instance.ZoneNameText.Size.Height);
            m_drawingControl.Size = new Size(Widthdxf, Heightdxf);
        ...
        private void btnEquipDel_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            Point pt = m_drawingControl.PointToClient(pt2);

...
namespace TeamEditor.Command
{
    public class CommandRemoveRegularTeam : CommandEx
    {
        ...
        {
            m_removeTeamList = DataManager.GetRegularTeams(m_team.TeamID);
            ...
            TeamNDepth team = new TeamNDepth(m_team, 0);
            teams.Add(team);

            foreach (TreeNode node in m_node.Nodes)
            {
                GetTeamList(node, 1, teams);
            }

            teams.Sort();
            m_removeTeamList.Clear();

            string strTeamIDs = "";

            foreach (TeamNDepth _team in teams)
            {
                m_removeTeamList.Add(_team.Team);

                if (strTeamIDs.Length == 0)
                    strTeamIDs = _team.Team.TeamID.ToString();
                else
                    strTeamIDs += ", " + _team.Team.TeamID.ToString();
            }*/
        ...
        public static List<string> RemoveCompanyMembers(DBUtility.WebDBManager dbMgr, string strCompanyMemberIDs)
        {
        ...
        // RollBack을 위하여 삭제한 데이터들의 Insert 구문 리스트를 반환한다.
        private List<string> RemoveRegularTeams(DBUtility.WebDBManager dbMgr, string strTeamIDs)
        {
            List<string> insertList = new List<string>();
        ...
        private List<string> UpdateInternalTransmissionDatas(DBUtility.WebDBManager dbMgr, string strTeamIDs)
        {
            ...
            {
                int nID = DBUtility.WebDBManager.GetIntField(arrResult[i].ToString(), -1);
                string strTeamList = DBUtility.WebDBManager.GetStringField(arrResult[i + 1], "");
                int nCommanderType = DBUtility.WebDBManager.GetIntField(arrResult[i + 2].ToString(), -1);
                int nCommanderMemberID = DBUtility.WebDBManager.GetIntField(arrResult[i + 3].ToString(), -1);
                string strCommanderDisplayText = DBUtility.WebDBManager.GetStringField(arrResult[i + 4], "");
        ...
        // RollBack을 위하여 수정한 데이터들의 Update 구문 리스트를 반환한다.
        private List<string> UpdateProcessDatas(DBUtility.WebDBManager dbMgr, string strTeamIDs)
        {
            // 2015-08-07 mwkim 변경사항
        ...
        // RollBack을 위하여 수정한 데이터들의 Update 구문 리스트를 반환한다.
        public static List<string> UpdateSOPGenUsers(DBUtility.WebDBManager dbMgr, string strCompanyMemberIDs)
        {
            List<string> updateList = new List<string>();
            ...
            {
                int nSOPGenUserID = DBUtility.WebDBManager.GetIntField(arrResult[i].ToString(), -1);
                int nDayLight = DBUtility.WebDBManager.GetIntField(arrResult[i + 1].ToString(), -1);
                int nMemberType = DBUtility.WebDBManager.GetIntField(arrResult[i + 2].ToString(), -1);
                int nMemberID = DBUtility.WebDBManager.GetIntField(arrResult[i + 3].ToString(), -1);
                string strDisplayText = DBUtility.WebDBManager.GetStringField(arrResult[i + 4]);
                string strCallerPhoneNumber = DBUtility.WebDBManager.GetStringField(arrResult[i + 5]);
        ...
        // RollBack을 위하여 삭제한 데이터들의 Insert 구문 리스트를 반환한다.
        /*private List<string> RemoveDuty(DBUtility.WebDBManager dbMgr, string strTeamIDs)
        {
            List<string> insertList = new List<string>();
        ...
        // RollBack을 위하여 삭제한 데이터들의 Insert 구문 리스트를 반환한다.
        private List<string> RemoveTemporaryMembers(DBUtility.WebDBManager dbMgr, string strTeamIDs, string strPlusMinusTeamIDs, string strCompanyMemberIDs)
        {
            List<string> insertList = new List<string>();
        ...
        /*private bool RemoveTemporaryTeam(DBUtility.WebDBManager dbMgr, string strTeamIDs, bool isNormal, List<string> insertList)
        {
            if (strTeamIDs.Length == 0)
                return true;
            ...
            for (int i = 0; i < nResultCount - 5; i += 6)
            {
                ...
                int nParentTeamID = DBUtility.WebDBManager.GetIntField(arrResult[i + 2].ToString(), -1);
                string strGroupName = DBUtility.WebDBManager.GetStringField(arrResult[i + 3].ToString(), null);
                string strDesc = DBUtility.WebDBManager.GetStringField(arrResult[i + 4].ToString(), null);
                int nSiteID = DBUtility.WebDBManager.GetIntField(arrResult[i + 5].ToString(), -1);
        ...
        private bool RemoveTemporaryMemberList(DBUtility.WebDBManager dbMgr, string strPlusMinusTeamIDs, string strCompanyMemberIDs, List<string> insertList)
        {
            string strDeleteSQL = "";
        ...
        // RollBack을 위하여 삭제한 데이터들의 Insert 구문 리스트를 반환한다.
        private List<string> RemoveFacilityManagers(DBUtility.WebDBManager dbMgr, string strTeamIDs, string strCompanyMemberIDs)
        {
            List<string> insertList = new List<string>();
        ...
        private bool RemoveFacilityManagers(DBUtility.WebDBManager dbMgr, string strTeamIDs, string strCompanyMemberIDs, List<string> insertList)
        {
            string strDeleteSQL = "";
        ...
        private bool RemoveEquipZoneFacilityManagers(DBUtility.WebDBManager dbMgr, string strTeamIDs, string strCompanyMemberIDs, List<string> insertList)
        {
            string strDeleteSQL = "";
        ...
        private bool RemoveBuildingFacilityManagers(DBUtility.WebDBManager dbMgr, string strTeamIDs, string strCompanyMemberIDs, List<string> insertList)
        {
            string strDeleteSQL = "";
        ...
        // RollBack을 위하여 삭제한 데이터들의 Insert 구문 리스트를 반환한다.
        private List<string> RemoveRegularMemberList(DBUtility.WebDBManager dbMgr, string strTeamIDs, out string strCompanyMemberIDs)
        {
            strCompanyMemberIDs = "";
        ...
        private void AddTeam(DBUtility.WebDBManager dbMgr)
        {
        ...
        private bool IsExist(DBUtility.WebDBManager dbMgr)
        {

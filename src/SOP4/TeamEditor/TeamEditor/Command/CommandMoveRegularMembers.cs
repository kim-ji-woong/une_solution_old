...
namespace TeamEditor.Command
{
    public class CommandMoveRegularMembers : CommandEx
    {
        ...
        public CommandMoveRegularMembers(RegularTeam teamOrigin, RegularTeam teamMoved, List<CompanyMemberNIndex> rows, TeamGrid grid, TeamTreeView tree)
        {
        ...
        private void UpdateRegularMemberList(DBUtility.WebDBManager dbMgr, RegularTeam team)
        {
            if (team == null)
                return;

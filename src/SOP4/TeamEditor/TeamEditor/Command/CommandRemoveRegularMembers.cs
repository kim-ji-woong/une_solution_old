...
namespace TeamEditor.Command
{
    public class CommandRemoveRegularMembers : CommandEx
    {
        ...
        public CommandRemoveRegularMembers(RegularTeam team, List<CommandMoveRegularMembers.CompanyMemberNIndex> rows, TeamGrid grid)
        {
            m_team = team;
            SetRows(rows);
            m_grid = grid;
        ...
        public List<string> RemoveDB(DBUtility.WebDBManager dbMgr, string strCompanyMemberIDs)
        {
            m_rollbackSQLs.Clear();
        ...
        /*private List<string> RemoveDuty(DBUtility.WebDBManager dbMgr, string strCompanyMemberIDs)
        {

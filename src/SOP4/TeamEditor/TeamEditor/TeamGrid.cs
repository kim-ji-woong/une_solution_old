...
namespace TeamEditor
{
    public class TeamGrid : MergedDataGridView
    {
        ...
        private const int SubPositionIndex = 3;
        ...
        private const int MemberIDIndex = 8;
        private const int OfficePhoneNumberIndex = 9;
        ...
        // gridExternal
        private const int ExternalCompanyMemberNameIndex = 1;
        private const int ExternalCompanyMemberLevelIndex = 2;
        private const int ExternalCompanyMemberPositionIndex = 3;
        private const int ExternalCompanyMemberPhoneNumberIndex = 4;
        ...
        private const int ExternalCompanyMemberDescriptionIndex = 5;
        ...
        public void RefreshGrid()
        {
            ...
            if (m_teamCurrent == null && m_gridType == GridType.UserDefinedTeam)
                ...
                SelectRegularTeam((RegularTeam)m_teamCurrent);
                ...
                SelectExternalCompanyTeam((ExternalTeam)m_teamCurrent);
        }
        ...
        public void SelectTeam(Team team, bool alwaysDo = false)
        {
            ...
            if (team == null && m_gridType == GridType.UserDefinedTeam)
                ...
                SelectRegularTeam((RegularTeam)team);
                ...
                SelectExternalCompanyTeam((ExternalTeam)team);
        }
        ...
        private void SelectExternalCompanyTeam(ExternalTeam team)
        {
        ...
        private void SelectRegularTeam(RegularTeam team)
        {
            ...
            foreach (CompanyMember member in members)
            {
                ...
                row.Cells[OfficePhoneNumberIndex].Value = member.OfficePhoneNumber;
                row.Cells[OfficePhoneNumberIndex].Tag = member.OfficePhoneNumber;
        ...
        {
            if (!this.ReadOnly && e.KeyCode == Keys.Delete)
            {
        ...
        private Command.CommandMoveRegularMembers MakeMoveRegularMembersCommand(out string strMemberNames)
        {
            ...
            Command.CommandMoveRegularMembers cmd = new Command.CommandMoveRegularMembers((RegularTeam)m_teamCurrent, null, memberIndeces, this, m_linkedTree);
            return cmd;
        }
        ...
        private CompanyMember GetRowCompanyMember(DataGridViewRow row, out bool isNewMember)
        {
            ...
            if (row.Tag == null)
            {
                ...
                List<CompanyMember> members = DataManager.GetRegularMembers((RegularTeam)this.m_teamCurrent);

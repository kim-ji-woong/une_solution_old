...
namespace AccessSecurityServer
{
    public partial class FormMain : Form, AccessWatcherOwner, LocationManagerOwner
    {
        ...
        private void FormMain_Load(object sender, EventArgs e)
        {
            ...
            //if (ReadSiteID())
            {
                m_dbMgr = NetworkManager.Instance.DBManager;
                ...
                if (tokens.Count() >= 5)
                {
                    ...
                    if (m_watcher != null)
                    {
                        ...
                        NetworkManager.Instance.LocationManagerOwner = this;
                        m_watcher.Run();
                    }
                }
            }
        ...
        public void AddAlarm(Alarm alarm)
        {
            ...
            this.Invoke((MethodInvoker)delegate
            {
                ...
                NetworkManager.Instance.SendAlarm(alarm);
            });
        }
                    ...
                    for (int i = 0; i < nRowCount; i++)
                    {
                        ...
                        else
                        {
                            ...
                            if (row.Tag == device)
                            {
                                ...
                                NetworkManager.Instance.SendAlarmClear(device);
                                device = null;
                            }
                        }
                    }
        ...
        private void btnUpdateLocation_Click(object sender, EventArgs e)
        {
            ...
            LocationManager.Instance.CheckLocation(NetworkManager.Instance.AccessDBConnectionString, NetworkManager.Instance.DBManager, this);

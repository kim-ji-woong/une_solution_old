...
namespace AccessSecurityServer
{
    ...
    public class Alarm
    {
        ...
        private DBUtility.VariousData<DateTime> m_dtEvent = null;
        // 알람을 받은 시간
        private DBUtility.VariousData<DateTime> m_dtReceived = null;
        ...
        // 알람이 발생한 시간(Device 시간)
        public DBUtility.VariousData<DateTime> EventTime
        {
        ...
        // 알람을 받은 시간
        public DBUtility.VariousData<DateTime> ReceivedTime
        {

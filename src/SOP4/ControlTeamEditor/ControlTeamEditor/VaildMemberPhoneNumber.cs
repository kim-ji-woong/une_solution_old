...
namespace ControlTeamEditor
{
    public static class VaildMemberPhoneNumber
    {
        ...
        /// <returns></returns>
        public static bool IsVaildPhoneNumber(string strPhoneNumber, DBUtility.WebDBManager dbMgr)
        {
            bool bReturn = true;
        ...
        /// <returns></returns>
        public static ArrayList IsVaildPhoneNumber(ArrayList arrPhoneNumbers, DBUtility.WebDBManager dbMgr)
        {
        ...
        /// </summary>
        /// <returns></returns>
        private static Dictionary<bool, ArrayList> GetValidPhoneNumbers(DBUtility.WebDBManager dbMgr)
        {
            ...
            //DBUtility.WebDBManager dbMgr = FormMemberWorkSchedule.Instance.DBManager;
            ...
            if (arrResult != null)
            {
                ...
                {
                    string strPhoneNumber = DBUtility.WebDBManager.GetStringField(arrResult[nIndex + 1], "");

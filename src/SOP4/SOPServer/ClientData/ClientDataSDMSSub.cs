...
namespace SDMSServer
{
    ...
    {
        // SDMS로 데이터를 송신하기 위한 Sub 채널 Data를 수신하는경우는 현재 없으나 있다면, 발신부를 변경하여 ClientDataSDMS로 송신하도록 변경할것
        // skkim 2017-03-26
        ...
        public ClientDataSDMSSub(ServiceProvider provider)
        {
            ...
            m_provider = provider;
            ClientType = TCP_CLIENT.SDMS_CLIENT_SECOND;
        }
        ...
        {
            ConnectionLogEx.Instance.WriteLine("ClientSDMSSub Reciver"+ nHeader.ToString());           
            return true;
        }
        ...
        //{
        //    m_provider.SendDataToOther(bytes, this, false, TCP_CLIENT.SDMS_CLIENT_SECOND);
        //}
        ...
        //            log.Message = string.Format("[{0}]에서 탐지된 화재가 오작동으로 신고되었습니다", szLocationName);
        //        }
        ...
        //                log.Message = string.Format("[{0}]에서 화재발생이 신고되었습니다", szLocationName);
        //            }
        //            log.Param1 = nEquipZoneID.ToString();
        //        }
        //        else
        ...
        //                string szZoneName = equipZone.DisplayText;

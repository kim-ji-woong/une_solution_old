...
namespace SDMSServer
{
    public class ClientDataAsinFireMonitor : ClientData
    {
        ...
        {
            ReciverManager.Instance.UpdateState(ReciverType.ASIN_RECIVER, true);
            return base.ProcessFirstConnection(state);
        }

        public override void CloseClient()
        {
            ReciverManager.Instance.UpdateState(ReciverType.ASIN_RECIVER, false);
            base.CloseClient();
        }
        ...
        public static string GetSecurityEventTypeName(int nEventType)
        {
            ...
            switch (eventType)
            {
                ...
                case UnE.Sensor.IFacility.FacilityType.SecomWomenAlarmBell:
                    resultMsg = ClientDataS1SecomEventReceiver.ServerTypeName;
                    break;
                default:
                    break;
            }
        ...
        private SensorReactionLog.ReactionType GetTestServerIgnoreAccessLogType(int nEventType)
        {
            UnE.Sensor.IFacility.FacilityType eventType = UnE.Sensor.IFacility.ToFacilityType(nEventType);
            ...
            switch (eventType)
            {
                ...
                case UnE.Sensor.IFacility.FacilityType.FireSensor_AnalogSmokeType:
                case UnE.Sensor.IFacility.FacilityType.FireSensor_MonitoringType:
                    return SensorReactionLog.ReactionType.IGNORE_FIRE;
                ...
                case UnE.Sensor.IFacility.FacilityType.VirtualFence_S1:
                case UnE.Sensor.IFacility.FacilityType.EmergencyBell_S1:
                    return SensorReactionLog.ReactionType.IGNORE_S1SVMS_STATUS;
                ...
                case UnE.Sensor.IFacility.FacilityType.LeakAbnormalityU4_S1:
                case UnE.Sensor.IFacility.FacilityType.SynthesisAlertAbnormalityU8_S1:
                    return SensorReactionLog.ReactionType.IGNORE_S1ACCESS_STATUS;
        ...
        private SensorReactionLog.ReactionType GetTestServerAccessEventLogType(int nEventType)
        {
            UnE.Sensor.IFacility.FacilityType eventType = UnE.Sensor.IFacility.ToFacilityType(nEventType);
            ...
            switch (eventType)
            {
                ...
                case UnE.Sensor.IFacility.FacilityType.FireSensor_AnalogSmokeType:
                case UnE.Sensor.IFacility.FacilityType.FireSensor_MonitoringType:
                    return SensorReactionLog.ReactionType.BEGIN_STATUS;
                ...
                case UnE.Sensor.IFacility.FacilityType.VirtualFence_S1:
                case UnE.Sensor.IFacility.FacilityType.EmergencyBell_S1:
                    return SensorReactionLog.ReactionType.BEGIN_S1SVMS_STATUS;
                ...
                case UnE.Sensor.IFacility.FacilityType.LeakAbnormalityU4_S1:
                case UnE.Sensor.IFacility.FacilityType.SynthesisAlertAbnormalityU8_S1:
                    return SensorReactionLog.ReactionType.BEGIN_S1ACCESS_STATUS;

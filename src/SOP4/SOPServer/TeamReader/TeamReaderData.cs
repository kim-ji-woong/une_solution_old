...
namespace TeamReader
{
    public class RegularTeam
    {
        ...
        private List<CompanyMember> m_members = new List<CompanyMember>();
    ...
    public class CompanyMember
    {
        ...
        // 한 개인은 여러 팀에 속해있을수 있음
        // 팀별 직위
        // Value : 직위(0:알수 없음, 1:팀원, 2:팀장, 3:파트장, 4:센터장, 100:육아휴직, 101:군휴직, 102:휴직)
        private Dictionary<RegularTeam, int> m_dicTeamPositions = new Dictionary<RegularTeam, int>();
        ...
        // 팀별 직위
        // Value : 직위(0:알수 없음, 1:팀원, 2:팀장, 3:파트장, 4:센터장, 100:육아휴직, 101:군휴직, 102:휴직)
        public Dictionary<RegularTeam, int> TeamPositions
        {

...
namespace SDMSServer
{
    ...
    public class SensorZone : Object
    {
        ...
        public override string ToString()
        {
            ...
            if (type == IFacility.FacilityType.FIRE_SENSOR || (type >= IFacility.FacilityType.FireSensor_TypeA && type <= IFacility.FacilityType.FireSensor_MonitoringType))
                strResult = "화재 탐지";
    ...
    public class FacilityEx
    {
        ...
        private static Dictionary<IFacility.FacilityType, string> m_dicFacilityTypeTable = new Dictionary<IFacility.FacilityType, string>();
        ...
        public static void SetFacilityTypeTable(int nFacilityType, string strTableName)
        {
            ...
            if (type == IFacility.FacilityType.NONE)
                return;
        ...
        // FacilityType별 DB Table 이름 지정
        public static void SetFacilityTypeTable(IFacility.FacilityType type, string strTableName)
        {
            m_dicFacilityTypeTable[type] = strTableName;
        }

        public static string GetFacilityTypeTable(IFacility.FacilityType type)
        {
            string strTableName;
        ...
        public static int ToIntType(IFacility.FacilityType type)
        {
            return (int)type;
        }
    }
    ...
    */
    ...
    public class PSMSensor : IFacility
    {
        ...
        override public string DisconnectIconPath
        {
            get { return ""; }
        }
    ...
    public class SensorZoneGroup
    {
        ...
        public static long ToID(EquipmentZone equipZone, IFacility.FacilityType sensorType)
        {
            int nEquipZoneID = equipZone == null ? -1 : equipZone.ID;
            return ToID(nEquipZoneID, sensorType);
        }

        public static long ToID(int nEquipZoneID, IFacility.FacilityType sensorType)
        {
        ...
        public static void GetIDInfo(long nID, out int nEquipZoneID, out IFacility.FacilityType sensorType)
        {
            nEquipZoneID = (int)(nID >> 32);
            sensorType = IFacility.ToFacilityType((int)(nID & 0xffffffff));
        }
    }
}

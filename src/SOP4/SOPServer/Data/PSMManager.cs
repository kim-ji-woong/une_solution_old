    ...
    public class PSMManager
    {
        ...
        private bool LoadSensors(WebDBManager dbMgr)
        {
            ...
            for (int i = 0; i < nResultCount - 18;i+=19 )
            {
                ...
                if (x != null && y != null)
                    sensor.Position = new VariousData<System.Drawing.PointF>(new System.Drawing.PointF(x.Data, y.Data));
                ...
                sensor.EquipmentZone = ZoneManager.Instance.GetEquipmentZone(nEquipZoneID);

...
namespace GasLevelServer
{
	...
	class ConManager
	{
		...
		public ConManager()
		{
            ...
            GasLevelMeterServer.WriteLine("READ IP : " + m_strServerIP);
			try
			{
                ...
                GasLevelMeterServer.WriteLine("READ ID : " + m_strServerID);
                GasLevelMeterServer.WriteLine("READ PASS : " + m_strServerPW);
			}
			catch (System.Exception e)
			{
                GasLevelMeterServer.WriteLine(e.Message);
			}
            
			m_strConnection = GetConnectionInfo();
            GasLevelMeterServer.WriteLine(m_strConnection);

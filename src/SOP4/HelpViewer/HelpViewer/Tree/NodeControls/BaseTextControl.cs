...
namespace Aga.Controls.Tree.NodeControls
{
	public abstract class BaseTextControl : EditableControl
	{
        ...
        private static SolidBrush m_textBrush = new SolidBrush(Color.Black);
		...
		{
			SizeF s = _measureGraphics.MeasureString(label, this.Parent.Font);
			if (!s.IsEmpty)
				return new Size((int)s.Width, (int)s.Height);
			else
				return new Size(10, this.Parent.Font.Height);
		}
		...
		public override void Draw(TreeNodeAdv node, DrawContext context)
		{
            ...
            m_textBrush.Color = this.Parent.CurrentTextColor;
			...
			context.Graphics.DrawString(label, context.Font, m_textBrush, clipRect, _format);
		}

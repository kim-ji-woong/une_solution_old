    ...
    public partial class FormMain : Form, SensorWatcherOwner
    {
        ...
        public void AddAlarm(ExternalFireSensor sensor)
        {
            this.Invoke((MethodInvoker)delegate
            {
                ...
                NetworkManager.Instance.SendAlarm(sensor.SensorZoneID, sensor.SensorTagInfoID);
            ...
            this.Invoke((MethodInvoker)delegate
            {
                foreach (DataGridViewRow row in dataGridView1.Rows)
                {
                    if (row.Tag == sensor)
                    {
                        ...
                        NetworkManager.Instance.SendAlarmClear(sensor.SensorZoneID, sensor.SensorTagInfoID);

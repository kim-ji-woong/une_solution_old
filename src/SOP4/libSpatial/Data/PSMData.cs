...
namespace UnE
{
    namespace PSM
    {
        public class PSMTank
        {
            ...
            private DBUtility.VariousData<float> m_fRemains = null;
            private DBUtility.VariousData<float> m_fCapacity = null;
            ...
            // 이 값이 0보다 작으면 수동으로 입력한 값이다.
            // 0보다 같거나 크면 외부 시스템으로부터 전달받은 값이다.
            public DBUtility.VariousData<float> Remains
            {
            ...
            // 최대 용량
            public DBUtility.VariousData<float> Capacity
            {
        ...
        public class PSMSensor //: UnE.Sensor.IFacility
        {
            ...
            private DBUtility.VariousData<int> m_nCurrentAlarmDepth = null;
            // 망번호
            ...
            private DBUtility.VariousData<DateTime> m_installDate = null;
            ...
            public DBUtility.VariousData<int> CurrentAlarmDepth
            {
            ...
            public DBUtility.VariousData<DateTime> InstallDate
            {
        ...
        public class PSMSensorZone : UnE.Sensor.ISensor
        {
            ...
            {
                get { return m_originSensor == null ? "" : m_originSensor.IconPath; }
            }

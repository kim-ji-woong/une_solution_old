...
namespace SVMSEventReciver
{
    ...
    public class CameraManager
    {
        ...
        public CameraManager(int nSiteID, DBUtility.LocalDBManager dbMgr)
        {
            m_nSiteID = nSiteID;
            m_dbMgr = dbMgr;
        }
        ...
        {
            DBUtility.LocalDBManager dbMgr = m_dbMgr;
        ...
        public void LoadCCTV()
        {
            ...
            for( i = 0 ; i < nResultCount - 16 ; i+=17)
            {
                ...
                int nReversPtz = DBUtility.WebDBManager.GetIntField(arrResult[i + 16].ToString(), 0);

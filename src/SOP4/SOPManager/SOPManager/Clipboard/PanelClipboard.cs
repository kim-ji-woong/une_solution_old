...
namespace SOPManager
{
	public class PanelClipboard
	{
		...
		public bool PastePanel(PanelSectionEx page)
		{
			...
			{
				UnE.Utility.UMessageBox.Show("같은 패널끼리는 복사할 수 없습니다.", "복사 오류", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
				return false;
			}
			...
			if (UnE.Utility.UMessageBox.Show(szMessage, "붙여넣기", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
			{

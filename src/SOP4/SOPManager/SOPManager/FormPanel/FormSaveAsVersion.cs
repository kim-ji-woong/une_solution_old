...
namespace SOPManager
{
    public partial class FormSaveAsVersion : Form, IRibbonButtonOwner
    {
        ...
        private void AddNewSubCategory(string strValue)
        {
            if (strValue == "")
            {
                UnE.Utility.UMessageBox.Show("재난종류 이름을 설정하십시오.", "오류", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            ...
            {
                UnE.Utility.UMessageBox.Show("같은 이름의 재난종류를 사용할 수 없습니다.", "오류", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
        ...
        private void btnChnageSubCateogryName_Click(object sender, EventArgs e)
        {
            ...
            if (UnE.Utility.UMessageBox.Show(this, szMsg, "확인", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.No)
            {
                return;
            }
        ...
        private void btnChangeDisaster_Click(object sender, EventArgs e)
        {
            ...
            //            //UnE.Utility.UMessageBox.Show(this, szMsg2, "확인", MessageBoxButtons.OK, MessageBoxIcon.Error);
            //            //return;
            //        }
            //    }				
            //}

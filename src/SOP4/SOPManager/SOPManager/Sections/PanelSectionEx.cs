...
namespace Sections
{
    public partial class PanelSectionEx : PanelSection
    {
        ...
        private UnE.GUI.DialogFormFrame m_MissionFrame = null;
        ...
        public void insertFrontToolStripMenuItem_Click(object sender, System.EventArgs e)
        {
			...
			if (UnE.Utility.UMessageBox.Show(this, szMsg, "알림", MessageBoxButtons.YesNo, MessageBoxIcon.Information)
                == DialogResult.Yes)
            {
	   ...
	   this.TeamName);
			...
			if (UnE.Utility.UMessageBox.Show(strMsg, "알림", MessageBoxButtons.YesNo) == DialogResult.Yes)
			{           
                TabPage tabPage = (TabPage)this.Parent;
        ...
        private void ShowEdit(Section section)
        {
            if (section != null)
            {
            ...
            else
            {
                using (PopupNote form = new PopupNote())
                {
                    ...
                    form.InitText();
                    UnE.GUI.DialogFormFrame frame = new UnE.GUI.DialogFormFrame(form);
                    frame.Sizable = true;
                    if (frame.ShowDialog(this) == DialogResult.OK)
                    {
        ...
        private UnE.GUI.DialogFormFrame m_EndpointFrame = null;
        ...
        private void PopupEndPointEdit()
        {
            if (m_EndpointForm == null || m_EndpointForm.IsDisposed == true || m_EndpointForm.IsHandleCreated == false)
            {
                ...
                m_EndpointFrame = new UnE.GUI.DialogFormFrame(m_EndpointForm);
        ...
        private PopupNoteDecision m_decisionForm = null;
        private UnE.GUI.DialogFormFrame m_decisionFrame = null;
        ...
        private void PopupDecisionEdit(SectionDecision section)
        {
            ...
            {
                m_decisionForm = new PopupNoteDecision();
                m_decisionForm.StartPosition = FormStartPosition.Manual;

                m_decisionForm.TopMost = true;
                m_decisionFrame = new UnE.GUI.DialogFormFrame(m_decisionForm);
        ...
        private UnE.GUI.DialogFormFrame m_AnnotationFrame = null;
        ...
        private void PopupNoteEdit()
        {
            if (m_AnnotationForm == null || m_AnnotationForm.IsDisposed == true || m_AnnotationForm.IsHandleCreated == false)
            {
                ...
                m_AnnotationFrame = new UnE.GUI.DialogFormFrame(m_AnnotationForm);
        ...
        private UnE.GUI.DialogFormFrame m_InternalFrame = null;
        ...
        private void PopupInternalEdit()
        {
            if (m_InternalForm == null || m_InternalForm.IsDisposed == true || m_InternalForm.IsHandleCreated == false)
            {
                ...
                m_InternalFrame = new UnE.GUI.DialogFormFrame(m_InternalForm);
        ...
        private void PopupMissionEdit()
        {
            if (m_MissionForm == null || m_MissionForm.IsDisposed == true || m_MissionForm.IsHandleCreated == false)
            {
                ...
                m_MissionFrame = new UnE.GUI.DialogFormFrame(m_MissionForm);

...
namespace SDMS
{
    public partial class NotOperationPage : Form
    {
        ...
        {
            dataGridView1.Columns[NO_INDEX].Width = 80;
            dataGridView1.Columns[SENSOR_TYPE_INDEX].Width = 100;
            dataGridView1.Columns[BUILDING_GROUP_INDEX].Width = 300;
            dataGridView1.Columns[BUILDING_INDEX].Width = 600;
            dataGridView1.Columns[FLOOR_INDEX].Width = 70;
            dataGridView1.Columns[DETECT_INDEX].Width = 80;
            dataGridView1.Columns[FIRE_INDEX].Width = 80;
            dataGridView1.Columns[MALFUNCTION_INDEX].Width = 80;
            dataGridView1.Columns[FIELD_RECOVERY_INDEX].Width = 80;
            dataGridView1.Columns[MALFUNCTION_RATE_INDEX].Width = 80;
        ...
        public void Load_DataGrid(bool isLoad = false)
        {
            ...
            foreach (MulFunctionLog mulFunctionLog in m_detectMgr.MulFunctionList)
            {
                ...
                if (ManagerGroup == null)
                    ManagerGroup = FormMain.Instance.DataManager.GetBuildingFacilityManagerGroup(IFacility.FacilityType.FIRE_SENSOR, equipZone.LinkedZone.Building, true);

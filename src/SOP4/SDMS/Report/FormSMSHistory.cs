...
namespace SDMS
{
    public partial class FormSMSHistory : Form
    {
        ...
        private void btnSendSMS_Click(object sender, EventArgs e)
        {
            ...
            {
                string szServerIP = SDMS.NetworkManager.Instance.ServerIP;
                // send SMS    

                using(libSMS.IMessageClient client = libSMS.MessageClientFactory.CreateMessageClient(UnE.SOP.ProxySOP.Instance.SiteID, szServerIP))
                {

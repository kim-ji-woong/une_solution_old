...
namespace SDMS.PopupDialog.DisasterPrevention
{
    public partial class FormDisasterPreventionManagement : Form, IChildControl
    {
        ...
        {
            ArrayList arrResult = m_dbMgr.GetResultData("SELECT ID, Name FROM DisasterPreventionEquipmentType", 0);
            if (arrResult == null)
                return;
        ...
        { 
            ...
            for (int i = 0; i < arrResult.Count; i += 10)
            {
                ...
                int nEquipmentZoneID = DBUtility.WebDBManager.GetIntField(arrResult[i + 2].ToString(), -1);
                string strTypeName = DBUtility.WebDBManager.GetStringField(arrResult[i + 3], "");
                int nStandardQuantity = DBUtility.WebDBManager.GetIntField(arrResult[i + 4].ToString(), -1);
                int nStatusQuantity = DBUtility.WebDBManager.GetIntField(arrResult[i + 5].ToString(), -1);
                string strCheckCycle = DBUtility.WebDBManager.GetStringField(arrResult[i + 6], "");
                string strCheckWay = DBUtility.WebDBManager.GetStringField(arrResult[i + 7], "");
                string strValidityDate = DBUtility.WebDBManager.GetStringField(arrResult[i + 8], "");
                int nLocationID = DBUtility.WebDBManager.GetIntField(arrResult[i + 9].ToString(), -1);
        ...
        private bool SaveHWPForDPMgr()
        {
            ...
            SDMS.Report.HwpCtrlData data = new Report.HwpCtrlData();
        ...
        private bool InsertDB(DisasterPrevention dp)
        {
            ...
            int nLocationID = DBUtility.WebDBManager.GetIntField(arrResult[0].ToString(), -1) + 1;
            dp.LocationID = nLocationID;
            ...
            int nID = DBUtility.WebDBManager.GetIntField(arrResult[0].ToString(), -1) + 1;
            dp.ID = nID;
        ...
        private int InsertTypeDB(DisasterType type)
        {
            ...
            int nTypeID = DBUtility.WebDBManager.GetIntField(arrResult[0].ToString(), -1) + 1;
        ...
        private bool DeleteDB(int nID)
        {
            ...
            nLocationID = DBUtility.WebDBManager.GetIntField(arrResult[0].ToString(), -1);

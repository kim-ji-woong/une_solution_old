...
{
    public partial class FormPSMTankDetail : Form, UnE.Control.ICCTVCtrlOwner
    {
        ...
        private DBUtility.VariousData<float> m_fInitRemains = null;
                ...
                if (m_tank != value)
                {
                    ...
                    else
                    {
                        if (m_tank.Remains == null)
                            ...
                            m_fInitRemains = new DBUtility.VariousData<float>(m_tank.Remains.Data < 0.0f ? -m_tank.Remains.Data : m_tank.Remains.Data);
                    }
        ...
        private void InitEvent()
        {
            ...
            this.btnPSMMaterial.Click += btnPSMMaterial_Click;
            this.btnMSDS.Click += btnMSDS_Click;
        ...
        private void LoadManualPath()
        {
            ...
            ////m_strPSMManualPath = System.IO.Path.GetDirectoryName(Application.ExecutablePath) + "\\" + DBUtility.WebDBManager.GetStringField(arrResult[0]);
        ...
        private void SaveRemains()
        {
            if (textBoxRemains.Visible)
            {
                ...
                DBUtility.VariousData<float> remains = null;
                float fRemains = -1.0f;
                ...
                if (float.TryParse(textBoxRemains.Text.Trim(), out fRemains))
                {
                    ...
                    remains = new DBUtility.VariousData<float>(fRemains);
                }

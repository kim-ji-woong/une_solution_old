...
namespace SDMS
{
    public partial class FormSensorMgrList : Form
    {
        ...
        private enum SensorType { ALL = 0, DETECT_FIRE = 1, COOLER, PUMP, PSM_SENSOR, DETECT_PROTECT }
        ...
        private void editCheck_CheckedChanged(object sender, EventArgs e)
        {
            if (editCheck.Checked) 
            {
               ...
               // colDeActivated.DefaultCellStyle.BackColor = Color.White;
            }
            else
            {
                editable = false;

...
namespace SDMS
{
	public partial class FormSensorList : Form
	{
        ...
        private enum SensorType { ALL = 0, DETECT_FIRE = 1, COOLER, PUMP, CCTV, FE, HD, FA, FR, PSM_SENSOR, DISASTER_PREVENTION_EQUIPMENT, SVMS, S1ACCESS, EMPOLL }
        ...
        private void LoadCCTVData(ref int no, Dictionary<int, Zone> dicZones)
        {
            ...
            for (int i = 0; i < nResultCount - 2; i += 3)
            {
                ...
                string szName = DBUtility.WebDBManager.GetStringField(arrResult[i + 2], "");
        ...
        private void LoadSensorData(ref int no, Dictionary<int, EquipmentZone> dicEquipZones, SensorType sensorType)
        {
            ...
            for (int i = 0; i < nResultCount - 6; i += 7)
            {
                ...
                string szSensorName = DBUtility.WebDBManager.GetStringField(arrResult[i + 6], "");
                if (nID == 0)
                    continue;

    ...
    public partial class FormEarthquakeOption : Form
    {
        private class OptionGroup
        {
            ...
            public bool Visible
            {
                ...
                set { m_labelTitle.Visible = m_panelIntens.Visible = m_panelInitAction.Visible = m_panelSOP.Visible = value; }
            }
            ...
            public OptionGroup(Label title, Panel intens, Panel initAction, Panel sop, TextBox textBoxMin, TextBox textBoxMax, Label labelMin, Label labelMax, PictureBox pbPrev, PictureBox pbNext, TextBox textBoxSMS, TextBox textBoxBroadcast, TextBox textBoxSOP, CheckBox checkBoxSMS, CheckBox checkBoxBroadcast, CheckBox checkBoxSOP, Button btnSOP)
            {
                m_labelTitle = title;
        ...
        public FormEarthquakeOption(WebDBManager dbMgr)
        {
            ...
            m_optionGroups.Add(new OptionGroup(labelStep1, panelStep1, panelStep1InitAction, panelStep1SOP, textBoxStep1Min, textBoxStep1Max, labelStep1Min, labelStep1Max, pbStep1Prev, pbStep1Next, textBoxStep1SMS, textBoxStep1Broadcast, textBoxStep1SOP, checkBoxStep1SMS, checkBoxStep1Broadcast, checkBoxStep1SOP, btnStep1SOP));
            m_optionGroups.Add(new OptionGroup(labelStep2, panelStep2, panelStep2InitAction, panelStep2SOP, textBoxStep2Min, textBoxStep2Max, labelStep2Min, labelStep2Max, pbStep2Prev, pbStep2Next, textBoxStep2SMS, textBoxStep2Broadcast, textBoxStep2SOP, checkBoxStep2SMS, checkBoxStep2Broadcast, checkBoxStep2SOP, btnStep2SOP));
            m_optionGroups.Add(new OptionGroup(labelStep3, panelStep3, panelStep3InitAction, panelStep3SOP, textBoxStep3Min, textBoxStep3Max, labelStep3Min, labelStep3Max, pbStep3Prev, pbStep3Next, textBoxStep3SMS, textBoxStep3Broadcast, textBoxStep3SOP, checkBoxStep3SMS, checkBoxStep3Broadcast, checkBoxStep3SOP, btnStep3SOP));
        }

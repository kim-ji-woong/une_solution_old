...
namespace SOPMonitoringSystem
{
    public partial class PageBackstageSOP : Form, IRibbonButtonOwner, Sections.ISectionListener, ITabPageSpecialWorker
    {
        ...
        private bool m_isCallingSelf = false; 
        ...
        private void SelectComponentContents(SectionTabPage page, ComponentContents frmContents)
        {
            ...
            if (m_dicSelectedComponentContents.TryGetValue(nKey, out currentContents))
            {
                ...
                {
                    if (frmContents.Section != null && frmContents.Section.GetColor(Section.ColorTarget.FILL) == SelectedComponentContentsColor &&
                        frmContents.BackColor == SelectedComponentContentsColor && frmContents.GetTitleColor() == SelectedComponentContentsColor)
                        return;
                }
            }
        ...
        public ComponentContents GetCurrentSelectedComponentContents()
        {
            ...
            foreach (Control ctrl in panel.Controls)
            {
                if (ctrl is ComponentContents)
                {
                    ...
                    if (contents.Section.GetColor(Section.ColorTarget.FILL) == SelectedComponentContentsColor)
                        return contents;
                }
            }

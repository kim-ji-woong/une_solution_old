...
namespace SOPMonitoringSystem
{
    public class SupervisorSOPClose : IDisposable
    {
        ...
        public bool CheckSensorClose(int nSensorHistoryID)
        {
            ...
            szSQL += " WHERE SensorHistoryID in (  SELECT srh2.SensorHistoryID FROM SensorReactionHistory as srh2 WHERE srh2.ReactionType in ( 0, 60, 62, 898, 899, 921 ) ) ";
            szSQL += " AND SensorHistoryID not in (  SELECT srh3.SensorHistoryID FROM SensorReactionHistory as srh3 WHERE srh3.ReactionType in (21, 23, 33, 50, 70, 919, 920,939,940 )) ";

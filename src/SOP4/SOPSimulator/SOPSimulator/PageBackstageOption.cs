...
namespace SOPMonitoringSystem
{
    ...
    public partial class PageBackstageOption : Form, IOptionChanged
    {
        ...
        private void ReadConfigFile()
        {
            ...
            Color colwait = strwait.Length == 0 ? Color.FromArgb((int)UInt32.Parse("4294957567")) : Color.FromArgb((int)UInt32.Parse(strwait));
        ...
        private void SaveAutoCloseConfig(UnE.SOP.SOPCloseOption option2)
        {
        ...
        private void btnInitialize_Click(object sender, EventArgs e)
        {
            ...
            FormSOP.Instance.GetPageHome().changecolor(0, btnWait.BackColor);
        ...
        private void ColorButton_Click(object sender, EventArgs e)
        {
            ...
            {
                ColorTranslator.ToOle(btnWait.BackColor),
            ...
            if (btn == btnWait)
            {                
                colorDialog.Color = btnWait.BackColor;     
            }

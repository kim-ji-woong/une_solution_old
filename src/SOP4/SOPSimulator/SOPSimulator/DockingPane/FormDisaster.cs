...
namespace SOPMonitoringSystem
{
    public partial class FormDisaster : Form, IRibbonButtonOwner
    {
        ...
        private Dictionary<int, DateTime> m_dicSOPButtonClickedTime = new Dictionary<int, DateTime>();
        ...
        private void InitPanels()
        {
            ...
            btnTerror.Enabled = /*btnSavingLife.Enabled = */btnETC.Enabled = btnExplosion.Enabled = btnSecurity.Enabled = false;
        ...
        private void InitButtons()
        {
            ...
            m_dicCategoryButton["방범"] = btnSecurity;
            ...
            m_dicSubCategoryImage["기타"] = global::SOPMonitoringSystem.Properties.Resources.btnEtc_User;
            ...
            m_dicSubCategoryImage["유출사고"] = global::SOPMonitoringSystem.Properties.Resources.btn_sub_spill;
            ...
            m_dicSubCategoryImage["방범_침입"] = global::SOPMonitoringSystem.Properties.Resources.btn_sub_security;
            m_dicSubCategoryImage["방범_배회"] = global::SOPMonitoringSystem.Properties.Resources.btn_sub_security;
            m_dicSubCategoryImage["방범_쓰러짐"] = global::SOPMonitoringSystem.Properties.Resources.btn_sub_security;
            m_dicSubCategoryImage["방범_도난"] = global::SOPMonitoringSystem.Properties.Resources.btn_sub_security;
            m_dicSubCategoryImage["방범_방지"] = global::SOPMonitoringSystem.Properties.Resources.btn_sub_security;
            m_dicSubCategoryImage["방범_가상펜스"] = global::SOPMonitoringSystem.Properties.Resources.btn_sub_security;
            m_dicSubCategoryImage["방범_내부비상벨"] = global::SOPMonitoringSystem.Properties.Resources.btn_sub_security;
            m_dicSubCategoryImage["방범_외부비상벨"] = global::SOPMonitoringSystem.Properties.Resources.btn_sub_security;
            m_dicSubCategoryImage["방범_기타"] = global::SOPMonitoringSystem.Properties.Resources.btn_sub_security;
            ...
            SetButtonInfo(btnSecurity, m_nCategoryFontSize, m_colorButton, m_strFontName, m_ptCategoryTextLocation);
        ...
        private void btn_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            if (m_frmOwner != null)
            {
                m_frmOwner.OnTreeViewDoubleClicked(node);
            }
        }

        public void SelectCurrentSOP()
        {
            if (m_btnSelectedDisaster != null)
                OnRibbonButtonMouseUp(m_btnSelectedDisaster, null);
        }
        ...
        public void OnRibbonButtonMouseUp(object sender, MouseEventArgs e)
        {
            ...
            {
                if (IsDoubleClicked(btn, (int)node.Tag))
                    btn_MouseDoubleClick(btn, null);
                else
        ...
        private bool IsDoubleClicked(RibbonButton btn, int nActionStepID)
        {
            DateTime dtNow = DateTime.Now;
            DateTime dtPrev;

            if (m_dicSOPButtonClickedTime.TryGetValue(nActionStepID, out dtPrev))
            {
                m_dicSOPButtonClickedTime[nActionStepID] = dtNow;
        ...
        private void _LoadSOP(TreeNodeCollection nodes, bool noModeChange)
        {
            ...
            foreach (TreeNode node in nodes)
            {
                ...
                RibbonButton btnCategory = null;
                if (m_dicCategoryButton.ContainsKey(node.Text))
                {
                    btnCategory = m_dicCategoryButton[node.Text];                    
                }
                else
                {
                    btnCategory = m_dicCategoryButton["기타"] = btnETC;
                }
        ...
        private void LoadCategory(RibbonButton btnCategory, TreeNodeCollection nodes)
        {
            ...
            foreach (TreeNode node in nodes)
            {
                ...
                Image img = null;
                if (m_dicSubCategoryImage.ContainsKey(btnCategory.Text))
                    img = m_dicSubCategoryImage[btnCategory.Text];
                else
                {

                    if(m_dicSubCategoryImage.ContainsKey(node.Text))
                        img = m_dicSubCategoryImage[node.Text];
                    else
                        img = m_dicSubCategoryImage["기타"];
                }
        ...
        public bool SelectSOP(TreeNode node)
        {
            ...
            foreach (Control ctrl in panelDisaster.Controls)
            {
                ...
                if (ctrl.Tag == node)
                {
                    ...
                    if (ctrl.Location.Y >= panelDisaster.VerticalScroll.Minimum && ctrl.Location.Y <= panelDisaster.VerticalScroll.Maximum)
    ...
    public interface IFormDisasterOwner
    {
        ...
        void OnTreeViewDoubleClicked(TreeNode node);

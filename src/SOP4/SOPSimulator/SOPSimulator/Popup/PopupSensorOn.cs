...
namespace SOPMonitoringSystem.Popup
{
    public partial class PopupSensorOn : Form, IFormDisasterOwner
    {
        ...
        private FireDetectSignal m_detectSignal = null;
        public FireDetectSignal DetectSignal
        {
        ...
        public static void PopUpForm(WebDBManager dbMgr, FireDetectSignal signal, bool bHasControl)
		{

...
namespace SOPMonitoringSystem
{
		...
		, IWorkflowContainer
	{
        ...
        private PageBackStageCCTV m_pageCCTV = null;
        ...
        private SOPMonitoringSystem.NetworkManager_Internal m_netMgrInternal = null;
        ...
        public SDMS.DataManager SDMSDataManager
        {
            get { return m_frmMain2.DataManager; }
        }
		...
		public FormSOP(int nSOPGenUserID, string strSOPGenUserRealName, bool isSimulationMode, bool onlySDMS, int nTargetMonitor, bool bSituationRoomMode)
		{
            ...
            UnE.Util.UtilMethods.KillProcess("CCTVViewer");
            UnE.Util.UtilMethods.KillProcess("UnitySam");
            UnE.Util.UtilMethods.KillProcess("UnitySamInside");
            UnE.Util.UtilMethods.KillProcess("UnityA10");
            UnE.Util.UtilMethods.KillProcess("libCCTV");
            UnE.Util.UtilMethods.KillProcess("EnergyOutside");
            UnE.Util.UtilMethods.KillProcess("SeoulUnv");
            UnE.Util.UtilMethods.KillProcess("BusanUnv");
        ...
        public void ShowMonitoringSystem()
        {
            // SOP Simulator는 한 PC에서 동시에 2개 이상 실행되면 안되므로, 통합관리자를 통하여 한 곳에서만 실행되도록 한다.
            ArrayList arrDatas = new ArrayList();
            arrDatas.Add(IntegratedManagement2.InternalMessage.REQUEST_PERMISSION_SOP_SIMULATOR);
            if (m_netMgrInternal != null)
                m_netMgrInternal.SendMessage(SDMS.TCP_ID.INTERNAL_MESSAGE, arrDatas);
        }
        ...
        public void ShowMonitoringSystem(bool visible)
        {
            this.Invoke((MethodInvoker)delegate
            {
                ...
                // OnlySDMS 가 설정되면 서버와 소켓연결이 끊어지므로 이전에 제어권 처리를 한다.
                // added 2018-01-08 skkim 
                try
                {
                    if (HasControl == true && visible == false)
                    {
                        // UI에 제어권 없음 처리
                        SetControl(false);
                        // 서버로 제어권 없음 요청
		...
		private void InitTab()
		{
            ...
            {
                m_pageCCTV = new PageBackStageCCTV();
                m_pageCCTV.TopLevel = false;
                m_pageCCTV.FormBorderStyle = System.Windows.Forms.FormBorderStyle.None;
                m_pageCCTV.Location = m_pageHome.Location;
                m_pageCCTV.Size = m_pageHome.Size;
                m_pageCCTV.BackColor = Color.White;
            }           
		...
		private void InitButtons()
		{
            ...
            InitRibbonButton(btnSOP, 0,
                global::SDMS.Properties.Resources.sop_normal_03,
                global::SDMS.Properties.Resources.sop_checked_03,
                global::SDMS.Properties.Resources.sop_disable_03,
                imgMouseOverBkgnd, imgCheckedBkgnd, null
                );

            InitRibbonButton(btnBulletin, 0,
                global::SDMS.Properties.Resources.상황판_normal_03,
                global::SDMS.Properties.Resources.상황판_checked_03,
                global::SDMS.Properties.Resources.상황판_disable_03,
                imgMouseOverBkgnd, imgCheckedBkgnd, null
                );
            InitRibbonButton(btnMissionStatus, 0,
                global::SDMS.Properties.Resources.임무_normal_04,
                global::SDMS.Properties.Resources.임무_checked_04,
                global::SDMS.Properties.Resources.임무_disable_04,
                imgMouseOverBkgnd, imgCheckedBkgnd, null
                );
            InitRibbonButton(btnSDMS, 0,
                global::SDMS.Properties.Resources.화재_normal_03,
                global::SDMS.Properties.Resources.화재_checked_03,
                global::SDMS.Properties.Resources.화재_disable_03,
                imgMouseOverBkgnd, imgCheckedBkgnd, null
                );
            InitRibbonButton(btnDefaultCCTV, 0,
                global::SDMS.Properties.Resources.SOPcctv_normal,
                global::SDMS.Properties.Resources.SOPcctv_checked,
                global::SDMS.Properties.Resources.SOPcctv_disable,
                imgMouseOverBkgnd, imgCheckedBkgnd, null
                );
        ...
        public PageBackStageCCTV GetPageCCTV()
        {
            return m_pageCCTV;
        }
		...
		public void RunWorkflowWithoutEvent(int nZoneID, int nSensorID, int nSensorHistoryID)
		{
            try
            {
                ...
                if (signal != null)
                {
                    ...
                    Process.WorkFlowStartNotifyProcess start = new Process.WorkFlowStartNotifyProcess(strCategoryName, sopName);
        ...
        public void SelectCCTVTab()
        {
            ...
            pictureBoxCCTV.BackgroundImage = global::SOPMonitoringSystem.Properties.Resources.Tab_Pressed;

            m_pageCCTV.Visible = true;
		...
		//public WorkFlow RunWorkflow(bool bSendSMS = false, VariousData<DateTime> dtDetect = null, string strPosition = null, string strBroadcastPositionName = null, string strPSMMaterialName = null, VariousData<int> psmDistance = null, string strAmountSnowfall = null)
		{
            ...
            SOPScenarioManager.Instance.AddSOPScenario(szPath.Replace("\\", szDeli.ToString()), page.ActionStepID, !page.VirtualMode, -1, nSensorZoneHistoryID);
        ...
        public void EnableOptions(bool enabled)
        {
            ...
            /*radioNonRegistMode.Enabled = */
            
            
            //radioNormal.Enabled = radioHoliday.Enabled = enabled;
        }
		...
		private void FormMain_FormClosing(object sender, FormClosingEventArgs e)
		{
            ...
            if (m_netMgrInternal != null)
                m_netMgrInternal.ReleaseThread();
        ...
        internal void OnNewActionStepHistory(SOPScenario sco)
        {
            try
            {
                ...
                if( work != null && work.Option != null)
                {
                    ...
                    System.Diagnostics.Trace.WriteLine("Form SOP Check  : " + nActionStepHistoryID + ", " + nSensorZoneID + ", " + nSensorHistoryID);

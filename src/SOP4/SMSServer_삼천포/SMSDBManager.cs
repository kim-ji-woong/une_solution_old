...
namespace MessageServer
{
    public class SMSDBManager
    {
        ...
        public System.IO.StreamWriter m_writer = null;
        ...
        public bool InsertMessage(MessageContent content)
        {
            ...
            try
            {
                using (MySqlCommand cmd = new MySqlCommand(strSQL, m_DBConn))
                {
                    ...
                    WriteLog("SQL Result : " + result);

                    /*strSQL = "Select * from LOG_SMS where destination = '" + strReciver + "'";
                    ...
                    while (reader.Read())
                    {
                        for (int i = 0; i < nColumnCount; i++)
                        {
                            if (reader.IsDBNull(i))
                                ...
                                WriteLog(i + ", " + reader.GetValue(i).ToString());
                        }
                    }

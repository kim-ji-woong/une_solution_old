...
namespace WeatherSimulator
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            int nSOPGenUserID = -1, nSiteID = -1, nSimulationMode = -1;
            ...
            if (!int.TryParse(args[0], out nSOPGenUserID) || !int.TryParse(args[1], out nSiteID) || !int.TryParse(args[2], out nSimulationMode))
            {
            ...
            Application.Run(new FormMain(nSOPGenUserID, nSiteID, isSimulationMode));
        }

...
namespace FireSignalReciver
{
    public class IOManager
    {
        ...
        public void LoadBuildings()
        {
            ...
            WebDBManager m_dbMgr = FireSignalReciver.Instance.DbMgr;
...
//" FROM SensorZone as sz, EquipmentZone as ez WHERE sz.EquipZoneID = ez.ID and ez.SiteID = {0}";
		...
		public void LoadReciverList()
		{
            ...
            string strSQL =
                "SELECT ID,Place, IP, MacAddr, Baudrate, Mode, FlowCtrl, Multiport, Timeout, Description, ReciverID FROM SensorServerInfo " 

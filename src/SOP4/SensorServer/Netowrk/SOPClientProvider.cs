    ...
    public class SOPClientProvider : ClientServiceProvider
    {
        ...
        private void ProcessEditSensorZone(ArrayList arrDatas)
        {
            ...
            for (int i = 0; i < nDataCount; i += 4)
            {
                ...
                EquipmentZone equipZoneOrigin = NetworkServer.Instance.IOManager.GetEquipmentZone(nOriginEquipZoneID);
                EquipmentZone equipZoneChanged = NetworkServer.Instance.IOManager.GetEquipmentZone(nChangedEquipZoneID);
        ...
        private void SendWhoIam()
        {
            ...
            byte[] dataBytes = MakeBytes((int)TCP_CLIENT.SENSOR_MONITOR2);

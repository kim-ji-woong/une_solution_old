...
namespace SensorServer
{
    public class NetworkServer
    {
        ...
        private SimensServiceProvider m_provider = null;//new ServiceProvider();
        ...
        public SimensServiceProvider ServiceProvider
        {
        ...
        public NetworkServer(DBUtility.WebDBManager dbMgr = null)
        {
            ...
            m_provider = new SimensServiceProvider();
            ...
            //m_nPort = 5000;
            SensorService.WriteLine("PORT : " + m_nPort.ToString());
        ...
        {
            string strSQL = string.Format("Select Max(Port) from SensorServerPort WHERE Name='FireSensor'");
            ...
            {
                strSQL = string.Format("Insert into SensorServerPort (Name, Port, SiteID) values ('{0}', {1}, {2})", "FireSensor", m_nPort, m_nSiteID);
                m_dbMgr.GetResultData(strSQL, 0);
            }
            else
            {
                strSQL = string.Format("Update SensorServerPort Set Port = {0} WHERE SiteID = {1} AND Name='{2}'", m_nPort, m_nSiteID, "FireSensor");
                m_dbMgr.GetResultData(strSQL, 0);
            }
        }		
    }

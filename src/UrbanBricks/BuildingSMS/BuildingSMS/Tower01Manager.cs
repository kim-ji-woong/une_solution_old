...
namespace BuildingSMS
{
    ...
    public class Tower01Manager : SendManager
    {
        ...
        private const int MaxFloorIndex = 21;
        ...
        public override bool GetNext(List<int> floors, int nReceiverIndex, out bool isLast)
        {
            ...
            {
                SetFirst(floors);
                m_dicStairs[nReceiverIndex] = "18번 계단실";
            }
            else
            {
                if (SetSecond(floors))
                ...
                if (m_nTimes % 2 == 1)
                    ...
                    m_dicStairs[nReceiverIndex] = "19번 계단실";
            }
        ...
        /*private bool SetThird(List<int> floors)
        {
            ...
            else
            {
                ...
                int nFloorIndex2 = 21 - 3 * m_nThirdTimes;
        ...
        private bool SetSecond(List<int> floors)
        {
            ...
            /*if (m_nFloorIndex >= 0)
            {
                ...
                int nFloorIndex3 = 21 - 3 * m_nSecondTimes;

    ...
    public class NetworkManager
    {
        ...
        public bool SendSMS(string strCaller, List<string> phoneNumbers, string strMessage)
        {
            ...
            foreach (string strPhoneNumber in phoneNumbers)
            {
                ...
                {
                    arrDatas.Add(TeamSMS.TeamManager.GetPhoneNumber(strPhoneNumber));
                    nCount++;
                }
            }
            ...
            return m_postManEtc.SendMessage(SOPWebServer.Header.SEND_SMS, bytes);
        }
    }
}

    ...
    public class ServiceManager
    {
        ...
        public static void RestartService(string serviceName, int timeoutMilliseconds)
        {
            ...
            catch (Exception e)
            {
                ...
                Logger.Instance.Write("[ERROR] RestartService : " + serviceName);
        ...
        public static bool StartService(string serviceName, int timeoutMilliseconds)
        {
            ...
            {
                Debug.WriteLine(e.Message);
                Logger.Instance.Write("[ERROR] StartService : " + serviceName);
                Logger.Instance.Write("[ERROR] " + e.Message);
                return false;
            }
        ...
        public static bool StopService(string serviceName, int timeoutMilliseconds)
        {
            ...
            {
                Debug.WriteLine(e.Message);
                Logger.Instance.Write("[ERROR] StopService : " + serviceName);
                Logger.Instance.Write("[ERROR] " + e.Message);

...
namespace Aga.Controls.Tree
{
	public class TreeNodeAdv
	{
        ...
        public bool IsSelectedChild
        {
            get
            {
                TreeNodeAdv parent = this._parent;
		...
		private Color m_clrStatus = Color.White;
		public Color ClrStatus
		{
			get { return m_clrStatus; }
			set { m_clrStatus = value; }
		}

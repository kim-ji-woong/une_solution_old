...
namespace CrisisAlertAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                //WebDBManager dbManager = new WebDBManager(strDBName, nDBType, nSiteID, strWebServerURL);
                services.AddTransient<global::dnsDBUtil.WebDBManager>(service => new global::dnsDBUtil.WebDBManager(strDBName, nDBType, nSiteID, strWebServerURL));
            }
        }

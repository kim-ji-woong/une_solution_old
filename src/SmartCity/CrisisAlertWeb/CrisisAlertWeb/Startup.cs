...
namespace CrisisAlertWeb
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                services.AddTransient<global::SmartCity.IDAL.IDataManager>(service => new global::SmartCity.DAL.DataManager(strDBName, nDBType, nSiteID, strWebServerURL));
            }
        }

...
namespace CrisisAlertManager.Popup_Dialog.Message
{
    public partial class FormMessageBox : Form
    {
        ...
        public FormMessageBox(string title, string msg, MessageBoxButtons msgButton)
        {
            InitializeComponent();
        ...
        private int m_nBtnLocationY = 179;
        private void SetButton()
        {
            if (m_msgButtons == MessageBoxButtons.YesNo)
            {
                btnConfirm.Size = new Size(100, 45);
                btnConfirm.Location = new Point(80, m_nBtnLocationY);

                btnCancel.Size = new Size(100, 45);
                btnCancel.Location = new Point(195, m_nBtnLocationY);
            }

...
namespace SOPManager
{
	public class PropertiesProcess : SectionPropertiesBase
	{
        ...
        public bool SelectedTeamUpdateUserDefine = false;
				...
				if (mSection != null)
				{
					...
					{						
						if (mSelectedTeamList != null)
						{
                            ...
                            if (CompareTeamList(arrTeamList, mSelectedTeamList) || SelectedTeamUpdateUserDefine)
                            {
                                if (m_bEnabledSnapshot == true)
                                    UndoRedoManager.Instance.SaveSnapshot("대상 팀 편집");
                                arrTeamList.Clear();
                                ...
                                // 사용자 정의조직이 수정됐을 경우 처리한 뒤 false로 바꿔줌
                                if (SelectedTeamUpdateUserDefine)
                                    SelectedTeamUpdateUserDefine = false;
                            }							
						}
					}
				}

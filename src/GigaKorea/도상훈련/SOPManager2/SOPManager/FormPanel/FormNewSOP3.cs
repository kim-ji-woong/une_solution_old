...
namespace SOPManager
{
	...
	public partial class FormNewSOP3 : Form, IRibbonButtonOwner
	{
        // "새 SOP" 인지 변경인지 체크
        ...
        public FormNewSOP3(bool bNew = true)
		{
            m_bNew = bNew;
            ...
            {
                // 모든 Level ID를 선택한다.
                m_usingLevelIDs = ReadUserLevels();
            }
        }

        private  List<int> ReadUserLevels()
        {
		...
		private void FormNewSOP_Load(object sender, EventArgs e)
		{
            ...
            dataGridViewDisaster.AlternatingRowsDefaultCellStyle.SelectionBackColor = FormMain.Instance.ColCustomOrange;
            dataGridViewSubDisaster.AlternatingRowsDefaultCellStyle.SelectionBackColor = FormMain.Instance.ColCustomOrange;

            UpdateControlSize();

			btnCategoryFire.Location = btnCategoryNetural.Location;
		}
        ...
        public void UpdateControlSize()
        {
            ...
            FormMain.Instance.UpdateWindowRate(pnlCategory, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(dataGridViewDisaster, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(dataGridViewSubDisaster, WindowRateWidth, WindowRateHeight);

            FormMain.Instance.UpdateWindowRate(btnAddDisaster, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(btnEditDisaster, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(btnDelDisaster, WindowRateWidth, WindowRateHeight);

            FormMain.Instance.UpdateWindowRate(btnAddSubDisaster, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(btnEditSubDisaster, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(btnDelSubDisaster, WindowRateWidth, WindowRateHeight);

            FormMain.Instance.UpdateWindowRate(btnReload, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(btnCreateSOP, WindowRateWidth, WindowRateHeight);

            FormMain.Instance.UpdateWindowRate(btnCategoryNetural, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(btnCategoryFire, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(btnCategorySpill, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(btnCategoryTerror, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(btnCategoryEtc, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(btnCategroyExplosion, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(btnCategorySecurity, WindowRateWidth, WindowRateHeight);
        }
		...
		private void InitRibbonButton()
		{
            ...
            btnCategroyExplosion.Font = new System.Drawing.Font(Program.prgFont, 12f, FontStyle.Bold);

			btnCategoryEtc.ID = ID.ID_BUTTON_ETC;
			btnCategoryEtc.IsChecked = false;
			btnCategoryEtc.Owner = this;
            btnCategoryEtc.Font = new System.Drawing.Font(Program.prgFont, 12f, FontStyle.Bold);
            ...
            btnCategoryTerror.Font = new System.Drawing.Font(Program.prgFont, 12f, FontStyle.Bold);

			btnCategorySpill.ID = ID.ID_BUTTON_SPILL;
			btnCategorySpill.IsChecked = false;
			btnCategorySpill.Owner = this;
            btnCategorySpill.Font = new System.Drawing.Font(Program.prgFont, 12f, FontStyle.Bold);

			btnCategoryFire.ID = ID.ID_BUTTON_FIRE;
			btnCategoryFire.IsChecked = false;
			btnCategoryFire.Owner = this;
            btnCategoryFire.Font = new System.Drawing.Font(Program.prgFont, 12f, FontStyle.Bold);

			btnCategoryNetural.ID = ID.ID_BUTTON_NATURAL;
			btnCategoryNetural.IsChecked = false;
			btnCategoryNetural.Owner = this;
            btnCategoryNetural.Font = new System.Drawing.Font(Program.prgFont, 12f, FontStyle.Bold);

            btnCategorySecurity.ID = ID.ID_BUTTON_SECURITY;
            btnCategorySecurity.IsChecked = false;
            btnCategorySecurity.Owner = this;
            btnCategorySecurity.Font = new System.Drawing.Font(Program.prgFont, 12f, FontStyle.Bold);
		}
        ...
        private Image imgFireNormal = global::SOPManager.Properties.Resources.@__CATEGORY_Fire2;
        private Image imgFireClick = global::SOPManager.Properties.Resources.@__CATEGORY_FireClick2;

        private Image imgSpillNormal = global::SOPManager.Properties.Resources.@__CATEGORY_Spill2;
        private Image imgSpillClick = global::SOPManager.Properties.Resources.@__CATEGORY_SpillClick2;

        private Image imgTerrorNormal = global::SOPManager.Properties.Resources.@__CATEGORY_Terror2;
        private Image imgTerrorClick = global::SOPManager.Properties.Resources.@__CATEGORY_TerrorClick2;

        private Image imgEtcNormal = global::SOPManager.Properties.Resources.@__CATEGORY_Etc;
        private Image imgEtcClick = global::SOPManager.Properties.Resources.@__CATEGORY_EtcClick;

        private Image imgExplosionNormal = global::SOPManager.Properties.Resources.@__CATEGORY_Explosion2;
        private Image imgExplosionClick = global::SOPManager.Properties.Resources.@__CATEGORY_ExplosionClick2;

        private Image imgNeturalNormal = global::SOPManager.Properties.Resources.@__CATEGORY_Natural2;
        private Image imgNeturalClick = global::SOPManager.Properties.Resources.@__CATEGORY_NaturalClick2;

        private Image imgSecurityNormal = global::SOPManager.Properties.Resources.@__CATEGORY_SecurityClick2;
        private Image imgSecurityClick = global::SOPManager.Properties.Resources.@__CATEGORY_Security2;

        // 선택한 카테고리의 버튼 이미지 유지
        private void SetButtonImage()
        {
            if (btnCategoryFire.IsChecked)  
                btnCategoryFire.NormalImage = imgFireClick; 
            else 
                btnCategoryFire.NormalImage = imgFireNormal;

            if (btnCategorySpill.IsChecked)
                btnCategorySpill.NormalImage = imgSpillClick;
            else
                btnCategorySpill.NormalImage = imgSpillNormal;

            if (btnCategoryTerror.IsChecked)
                btnCategoryTerror.NormalImage = imgTerrorClick;
            else
                btnCategoryTerror.NormalImage = imgTerrorNormal;

            if (btnCategoryEtc.IsChecked)
                btnCategoryEtc.NormalImage = imgEtcClick;
            else
                btnCategoryEtc.NormalImage = imgEtcNormal;

            if (btnCategroyExplosion.IsChecked)
                btnCategroyExplosion.NormalImage = imgExplosionClick;
            else
                btnCategroyExplosion.NormalImage = imgExplosionNormal;

            if (btnCategoryNetural.IsChecked)
                btnCategoryNetural.NormalImage = imgNeturalClick;
            else
                btnCategoryNetural.NormalImage = imgNeturalNormal;

            if (btnCategorySecurity.IsChecked)
                btnCategorySecurity.NormalImage = imgSecurityClick;
            else
                btnCategorySecurity.NormalImage = imgSecurityNormal;
		...
		private void btnDeleteUserType_Click(object sender, EventArgs e)
		{
			...
			try
			{
                ...
                // DisasterType 삭제
                string strCondition = string.Format("where name = '{0}' and SubDisasterID = {1}", szOrgSelectName, nID);
                string szSQL1 = "delete from DisasterType " + strCondition;

                UnE.SOP.RollbackData rollbackData = new UnE.SOP.RollbackData();

                if (rollbackData.AddInsertRollback(m_dbMgr, "Select ID, Name, SubDisasterID from DisasterType " + strCondition, 0, 1, 0))
                {
                ...
                foreach (Data_Disaster data in FormMain.Instance.DetailDisasterCategory)
				{
					if (data.DisasterName == szOrgSelectName && data.SubDisasterID == nID)
					{
						...
						if (data.VersionID != -1 && nID != -1)
						{
							...
							{
								if (!ioMgr.DeleteSOPVersion(m_dbMgr, data.VersionID, true, rollback, true))
								{
		...
		private void AddTeamRow(string strValue, bool isUser)
		{
			...
			if (!isCheck)
			{
				if (isUser)
				{
					...
					int nID = mgr.AddUserDefinedTeam(m_dbMgr, strValue, null);
					if (nID == -1)
						return;
				...
				{
					IOManager mgr = new IOManager();
					int nID = mgr.AddExternalTeam(m_dbMgr, strValue, null);
					if (nID == -1)
						return;
        ...
        private void SelectedTeamsNoStepMember()
        {
            ...
            {
                if (dataGridViewTeam.Rows.Count == 0)
                    m_arrSelectedTeam.Add(MakeNewTeamGridRow());
                else
                    m_arrSelectedTeam.Add(dataGridViewTeam.Rows[0]);
            }
            //////////////////////////////////////////////////////////////
        ...
        private DataGridViewRow MakeNewTeamGridRow()
        {
            DataGridViewRow row = new DataGridViewRow();
		...
		private void btnDeleteUserTeam_Click(object sender, EventArgs e)
		{
			...
			foreach (DataGridViewRow row in rows)
			{
				...
				if (data != null)
				{
					...
					{
						if (m_ioMgr.DeleteUserDefinedTeam(dbMgr, data.TeamName, null))
						{
							grid.Rows.Remove(row);
						}
					}
		...
		private void SetRadioImage()
        {
            ...
            rdPictureBox3.Refresh();
            rdPictureBox4.Refresh();
		}
            ...
            if (frame.ShowDialog() == DialogResult.OK)
            {
                ...
                if (szValue != szOrgSelectName)
                {
                    ...
                    try
                    {
                        ...
                        string strCondition = string.Format("where name= '{0}' and SubDisasterID = {1}", szValue, szOrgSelectName, nID);
                        string szSQL1 = string.Format("update DisasterType set name = '{0}' {1}", szValue, strCondition);

                        UnE.SOP.RollbackData rollbackData = new UnE.SOP.RollbackData();

                        if (rollbackData.AddUpdateRollback(m_dbMgr, "Select name from DisasterType " + strCondition, 1))
                        {
                            if (m_dbMgr.GetResultData(szSQL1) != null)
                            {
                                rollback.AddData(rollbackData);

                                strCondition = string.Format("where DisasterName= '{0}' and SubDisasterID = {1}", szOrgSelectName, nID);
                                string szSQL2 = string.Format("update Disaster set DisasterName = '{0}' {1}", szValue, strCondition);

                                rollbackData = new UnE.SOP.RollbackData();

                                if (rollbackData.AddUpdateRollback(m_dbMgr, "Select DisasterName from Disaster " + strCondition, 1))
                                {
                                    if (m_dbMgr.GetResultData(szSQL1) != null)
                                    {
                                        rollback.AddData(rollbackData);
                    ...
                    if (bResult == true)
                    {
                        ...
                        foreach (ArrayListEx arrCategory in m_arrDisaster)
                        {
                            if (arrCategory.Title == m_strCategory)
                            {
                                foreach (ArrayListEx arrSub in arrCategory)
                                {
                                    if (arrSub.Title == szOrgSubCategory)
                                    {
                                        arrSub.Title = szValue;
                                        break;
                                    }
                                }
                            }
                        ...
                        FormMain.Instance.ChangeSubCategoryName(szOrgSubCategory, szValue);
                    }
                }
            }
        }
        ...
        private void dataGridViewSubDisaster_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            btnCreateSOP_Click(null, null);
        }

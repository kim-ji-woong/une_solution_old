...
namespace SOPManager
{
	public partial class BarLevelTree : Form
	{
        ...
        {
            this.leveMenuItem1.Text = Data_ActionStep.StandardActionStepNames[0];
            this.leveMenuItem2.Text = Data_ActionStep.StandardActionStepNames[1];
            this.leveMenuItem3.Text = Data_ActionStep.StandardActionStepNames[2];
            this.leveMenuItem4.Text = Data_ActionStep.StandardActionStepNames[3];
        }
	}
}
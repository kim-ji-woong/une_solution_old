...
namespace SOPManager
{
    public partial class PopupUserDisaster : Form
    {
        ...
        public void UpdateControlSize()
        {
            ...
            FormMain.Instance.UpdateWindowRate(lblDisasterName, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(textDisaster, WindowRateWidth, WindowRateHeight);
        ...
        public void ChangeTitle(int nMode)
        {
            switch (nMode)
            {
                case 1:
                    //this.Text = "재난 이름 설정";
                    this.Text = "훈련 시나리오 이름 설정";
                    //lblDisasterName.Text = "재난명";
                    lblDisasterName.Text = "시나리오";
                    break;
                case 2:
                    this.Text = "조직 이름 설정";
                    lblDisasterName.Text = "조직명";
                    break;
                case 3:
                    this.Text = "외부기관 이름 설정";
                    lblDisasterName.Text = "외부기관";
					break;
				case 4:
                    //this.Text = "재난종류 이름 설정";
                    this.Text = "훈련위치 이름 설정";
                    //lblDisasterName.Text = "재난종류";
                    lblDisasterName.Text = "훈련위치";
                    break;
            }
        }
        ...
        {
			textDisaster.Text = m_strDisaster;
            textDisaster.Select();
        }

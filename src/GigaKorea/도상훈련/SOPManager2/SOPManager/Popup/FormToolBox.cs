...
namespace SOPManager
{
	public partial class FormToolBox : Form
	{
		public FormToolBox()
		{
            ...
            btnZoomIn.UseToolTip = true;
            btnZoomOut.UseToolTip = true;
            btnFitView.UseToolTip = true;
            btnResetView.UseToolTip = true;
            btnSaveHome.UseToolTip = true;
            btnHomeView.UseToolTip = true;
            btnScreenShot.UseToolTip = true;
            btnPrint.UseToolTip = true;
            btnSpaceX.UseToolTip = true;
            btnSpaceY.UseToolTip = true;
            btnArrangeY.UseToolTip = true;
            btnArrangeX.UseToolTip = true;
            btnMiddleX.UseToolTip = true;
            btnMiddleY.UseToolTip = true;
        ...
        {       
            btnZoomIn.WindowRateWidth = (float)FormMain.Instance.WindowWidthRate;
            btnZoomOut.WindowRateWidth = (float)FormMain.Instance.WindowWidthRate;
            btnFitView.WindowRateWidth = (float)FormMain.Instance.WindowWidthRate;
            btnResetView.WindowRateWidth = (float)FormMain.Instance.WindowWidthRate;
            btnSaveHome.WindowRateWidth = (float)FormMain.Instance.WindowWidthRate;
            btnHomeView.WindowRateWidth = (float)FormMain.Instance.WindowWidthRate;
            btnScreenShot.WindowRateWidth = (float)FormMain.Instance.WindowWidthRate;
            btnPrint.WindowRateWidth = (float)FormMain.Instance.WindowWidthRate;
            btnSpaceX.WindowRateWidth = (float)FormMain.Instance.WindowWidthRate;
            btnSpaceY.WindowRateWidth = (float)FormMain.Instance.WindowWidthRate;
            btnArrangeY.WindowRateWidth = (float)FormMain.Instance.WindowWidthRate;
            btnArrangeX.WindowRateWidth = (float)FormMain.Instance.WindowWidthRate;
            btnMiddleX.WindowRateWidth = (float)FormMain.Instance.WindowWidthRate;
            btnMiddleY.WindowRateWidth = (float)FormMain.Instance.WindowWidthRate;

            List<Control> mctlList = new List<Control>(13);

            //Int32 iAddWidth = 0;
            //Int32 iAddHeight = 0;

            this.Parent.Size = new Size((int)((float)this.Parent.Size.Width * FormMain.Instance.WindowWidthRate),
            ...
            for (Int32 index = 0; index < this.Controls.Count; index++)
            {
                ...
                //iAddWidth = ((int)((float)ctl.Size.Width * FormMain.Instance.WindowWidthRate)) - ctl.Size.Width;
                //iAddHeight = ((int)((float)ctl.Size.Height * FormMain.Instance.WindowHeightRate)) - ctl.Size.Height;
                ctl.Size = new Size(((int)((float)ctl.Size.Width * FormMain.Instance.WindowWidthRate))
                                           ,((int)((float)ctl.Size.Height * FormMain.Instance.WindowHeightRate)));
            }
            ...
            Int32 iCtlDistance = 6;
            for (Int32 index = 0; index < mctlList.Count; index++)
            {
                mctlList[index].Location = new Point(4, iCtlDistance);
                iCtlDistance += mctlList[index].Size.Width + mctlList[index].Margin.Top;
            }

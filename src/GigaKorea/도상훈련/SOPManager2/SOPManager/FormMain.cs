...
{
    public enum LevelDisasterOption { Unknown = 0, Use, NotUse };
    ...
    public partial class FormMain : Form, ITextPictureBoxOwner, IRibbonButtonOwner, IMenuCommandOwner
	{
        ...
        {
            CurWinBoundsWidth = 1920;
            CurWinBoundsHeight = 1040;
        ...
        private float m_fRowsDefaultCellStyleFontSize = 12.75f;

        public void UpdateWindowRate(Control ctl, double pWindowRateWidth, double pWindowRateHeight, String pFontFamily = "나눔스퀘어")
        {
            if (ctl == null)
                return;
            ...
            else if (ctl is DataGridView || ctl.GetType().Name == "DataGridView")
            {
                ...
                columnHeaderCellStyle.BackColor = Color.FromArgb(((int)(((byte)(237)))), ((int)(((byte)(237)))), ((int)(((byte)(237)))));
                ...
                dgv.ColumnHeadersDefaultCellStyle = columnHeaderCellStyle;
                dgv.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
                dgv.SelectionMode = DataGridViewSelectionMode.FullRowSelect;

                float fFontSize = (float)(12.5f * pWindowRateWidth);

                // 기본 Cell Style
                DataGridViewCellStyle rowCellStyle = new DataGridViewCellStyle();
                rowCellStyle.Font = new Font(pFontFamily, fFontSize, FontStyle.Regular, GraphicsUnit.Point);
                rowCellStyle.ForeColor = Color.Black;
                rowCellStyle.BackColor = Color.White;                
                rowCellStyle.SelectionBackColor = Color.FromArgb(((int)(((byte)(247)))), ((int)(((byte)(169)))), ((int)(((byte)(43)))));
                rowCellStyle.SelectionForeColor = Color.Black;
                dgv.RowsDefaultCellStyle = rowCellStyle;

                // 홀수행 Cell Style
                DataGridViewCellStyle alternatingRowsCellStyle = new DataGridViewCellStyle();
                alternatingRowsCellStyle.Font = new Font(pFontFamily, fFontSize, FontStyle.Regular, GraphicsUnit.Point);
                alternatingRowsCellStyle.ForeColor = Color.Black;
                alternatingRowsCellStyle.BackColor = /*회색*/Color.FromArgb(((int)(((byte)(237)))), ((int)(((byte)(237)))), ((int)(((byte)(237)))));
                alternatingRowsCellStyle.SelectionBackColor = /*주황색*/Color.FromArgb(((int)(((byte)(247)))), ((int)(((byte)(169)))), ((int)(((byte)(43)))));
                alternatingRowsCellStyle.SelectionForeColor = Color.Black;
                dgv.AlternatingRowsDefaultCellStyle = alternatingRowsCellStyle;
                ...
                dgv.RowTemplate.Height = (int)(fFontSize * 2 * pWindowRateHeight);

                dgv.Size = new Size((int)(ctl.Width * pWindowRateWidth), (int)(ctl.Height * pWindowRateHeight));
            }
        ...
        private FormRibbon mRibbonForm = null;
        private FormOpenDB form = null;
        //private FormFrameDialog mOpenForm = null;
        private DialogFormFrameRibbon mOpenForm = null;
        private UnE.GUI.DialogFormFrameRibbon frameNewSOP = null;
        ...
        private LevelDisasterOption m_levelOption = LevelDisasterOption.Unknown;
        // Key : SOPGenLevel에 대한 별칭
        // Value : SOPGenLevel ID List
        private Dictionary<string, List<int>> m_dicLevelItems = new Dictionary<string, List<int>>();

        public LevelDisasterOption LevelDisasterOption
        {
            get { return m_levelOption; }
        }

        public Dictionary<string, List<int>> LevelItems
        {
            get { return m_dicLevelItems; }
        }
		...
		{
            //ReadSiteID();
            Data_ActionStep.ReadStandardActionStepName(m_dbMgr);
		...
		public FormMain(int nSOPGenUserID, string strSOPGenUserID/*, string strSOPGenUserRealName*/)
		{
            ...
            UnE.Utility.UMessageBoxRibbon.CloseButtonImage = global::SOPManager.Properties.Resources.Close_40_40_Default;
            UnE.Utility.UMessageBoxRibbon.CloseButtonOverImage = global::SOPManager.Properties.Resources.Close_40_40_Click;
            ...
            m_netMgr = new Network.NetworkWebManager(m_dbMgr);
            ...
            UnE.GUI.DialogFormFrameRibbon.BorderColor = ColCustomBlack;
            UnE.GUI.DialogFormFrameRibbon.TitleBarColor = ColCustomOrange;

            event_WinRateChanged += FormMain_event_WinRateChanged;

            ReadSOPGenUserLevelOptions();

        }

        private void ReadSOPGenUserLevelOptions()
        {
            string strUse = "UseSOPGenLevelDisaster";
            string strItems = "SOPGenLevelDisasterItems";

            string strSQL = "Select PropertyName, PropertyValue from OptionSOPSimulator where (PropertyName = '" + strUse + "' or PropertyName = '" + strItems + "') and SiteID = " + m_dbMgr.SiteID.ToString();
            ...
            for (int i = 0; i < nResultCount - 1; i += 2)
            {
                ...
                if (string.Compare(strUse, strName, true) == 0)
                {
                    if (strValue == "1" || strValue.ToLower() == "true")
                        m_levelOption = LevelDisasterOption.Use;
                    else if (strValue == "0" || strValue.ToLower() == "false")
                        m_levelOption = LevelDisasterOption.NotUse;
                }
                else if (string.Compare(strItems, strName, true) == 0)
                {
                    List<string> items = SplitLevelItems(strValue);
                    ...
                    foreach (string strItem in items)
                    {
                        ...
                        {
                            m_levelOption = LevelDisasterOption.Unknown;
                            return;
                        }
        ...
        /// <summary>윈도우 해상도 변경시 진입</summary>
        void FormMain_event_WinRateChanged()
        {
            ...
            UnE.GUI.DialogFormFrameRibbon.WindowRateWidth = WindowRateWidth;
            UnE.GUI.DialogFormFrameRibbon.WindowRateHeight = WindowRateHeight;

            WindowRateWidth = FormMain.Instance.WindowWidthRate;
            WindowRateHeight = FormMain.Instance.WindowHeightRate;

            panelStatus.Height = (int)(panelStatus.Height * WindowRateHeight);

            UpdateToolStripItem(mStatusWork, WindowRateWidth, WindowRateHeight);
            UpdateToolStripItem(mStatusClock, WindowRateWidth, WindowRateHeight);
            UpdateToolStripItem(mStatsCaps, WindowRateWidth, WindowRateHeight);
            UpdateToolStripItem(mStatusNum, WindowRateWidth, WindowRateHeight);
            UpdateToolStripItem(mStatusHanguel, WindowRateWidth, WindowRateHeight);
            UpdateToolStripItem(toolStripStatusLabel4, WindowRateWidth, WindowRateHeight);
            UpdateToolStripItem(toolStripStatusLabel5, WindowRateWidth, WindowRateHeight);
            UpdateToolStripItem(mStatusProgress, WindowRateWidth, WindowRateHeight);
        }

        private void UpdateToolStripItem(ToolStripItem pLabel, double pWindowRateWidth, double pWindowRateHeight)
        {
            pLabel.Font = new Font(pLabel.Font.FontFamily, (float)(pLabel.Font.Size * pWindowRateWidth), pLabel.Font.Style);
            pLabel.Size = new Size((int)(pLabel.Size.Width * pWindowRateWidth), (int)(pLabel.Size.Height * pWindowRateHeight));
        }
		...
		{	
            ...
            UnE.GUI.DialogFormFrameRibbon frame = new UnE.GUI.DialogFormFrameRibbon(start);
			...
			if (frame.ShowDialog(this) == DialogResult.OK)
			{
				...
				if (nSelected == 1)
				{
                    frameNewSOP = new UnE.GUI.DialogFormFrameRibbon(new FormNewSOP3());
                    frameNewSOP.ShowIcon = false;
                    frameNewSOP.StartPosition = FormStartPosition.CenterScreen;
				...
				{
                    mOpenForm = new UnE.GUI.DialogFormFrameRibbon(new FormOpenDB());
					mOpenForm.StartPosition = FormStartPosition.CenterScreen;
		...
		{
            mRibbonForm = new FormRibbon();

            panelTop.Controls.Add(mRibbonForm);

			mRibbonForm.RibbonButtonOwner = this;
			mRibbonForm.Show();
            mRibbonForm.SelectedTabColor = this.ColCustomOrange;
            mRibbonForm.Dock = DockStyle.Fill;
		...
		private void FormMain_FormClosing(object sender, FormClosingEventArgs e)
		{
            ...
            m_pageSOP.GetBarConfig().CheckChangedData();
		...
		public void CreateSOP(List<SelectTeamInfo> arSelectedTeamList)
		{
			...
			this.Text = "시나리오 생성기  V 2.0 - " + strRegular + ", " + strWeekday;
        ...
        private void OnRibbonButtonExecute(object sender, int nID)
		{
			...
			switch (nID)
			{
				...
				case ID.ID_FILE_OPEN:	
					...
					{
                        mOpenForm = new UnE.GUI.DialogFormFrameRibbon(new FormOpenDB());
                        mOpenForm.ShowIcon = false;
                        mOpenForm.StartPosition = FormStartPosition.CenterScreen;
                        mOpenForm.Text = "시나리오 열기";
                        mOpenForm.ForeColor = Color.Black;
                        mOpenForm.ShowMaxButton = false;
                        mOpenForm.ShowMinButton = false;
                        mOpenForm.Sizable = false;
                        mOpenForm.ShowDialog(this);                        
					}					
					break;
				case ID.ID_FILE_DELETE:
                    ...
                    mOpenForm = new UnE.GUI.DialogFormFrameRibbon(dbOpenForm);
					mOpenForm.StartPosition = FormStartPosition.CenterScreen;
				...
				case ID.ID_FILE_NEWSOP:
					if (m_pageSOP.InitSectionPanel())
					{
						...
						frameNewSOP.Text = "새 시나리오";
                        frameNewSOP.ForeColor = Color.Black;
		...
		{
            if (m_pageSOP.GetTabPage().Count == 4)
            {
                UnE.Utility.UMessageBoxRibbon.Show("모든 단계가 이미 추가되었습니다. ", "오류");
                return;
            }

			PopupSelectLevel form = new PopupSelectLevel();
            UnE.GUI.DialogFormFrameRibbon frame = new DialogFormFrameRibbon(form);
            frame.TitleTextColor = System.Drawing.Color.Black;
            frame.StartPosition = FormStartPosition.CenterScreen;
			if (frame.ShowDialog(this) == DialogResult.OK)
			{
        ...
        {
            BarLevelTree tree = m_pageSOP.GetBarLevelTree();
            tree.ChangeSubCategoryName(szOrgName, szNewName);
		...
		private void ReadDisasterType()
		{
            ...
            /*string szText = "SELECT dt.ID, dt.Name, dt.SubDisasterID " +
                            ...
                            "    group by b.ID, b.Name, b.SubDisasterID, c.SubDisasterID, c.DisasterName " +
                            "    having b.Name = c.DisasterName AND b.SubDisasterID = c.SubDisasterID" +
                            "   )" +
                            " AND dt.SubDisasterID = sdc.ID and sdc.DisasterID = dc.ID and dc.SiteID = {0}";*/
            string szText = "SELECT dt.ID, dt.Name, dt.SubDisasterID " +
                            " FROM DisasterType as dt, SubDisasterCategory as sdc , DisasterCategory as dc" +
                            " group by dt.ID, dt.Name, dt.SubDisasterID, sdc.ID, sdc.DisasterID, dc.ID, dc.SiteID " +
                            " having dt.ID NOT IN " +
                            "  ( SELECT b.ID FROM DisasterType as b , Disaster as c " +
                            "    group by b.ID, b.Name, b.SubDisasterID, c.SubDisasterID, c.DisasterName " +
                            "    having b.Name = c.DisasterName AND b.SubDisasterID = c.SubDisasterID" +
                            "   )" +
                            " AND dt.SubDisasterID = sdc.ID and sdc.DisasterID = dc.ID and dc.SiteID = {0} " +
                            " order by dt.SubDisasterID, dt.Name";
		...
		private void ReadRegularTeam()
		{
            ...
            ArrayList arrResult1 = m_dbMgr.GetResultData(szSQL);
		...
		private bool OpenSOPXML()
		{
			...
			if (dlg.ShowDialog(this) == System.Windows.Forms.DialogResult.OK)
			{
				...
				else
				{
                    ...
                    UnE.Utility.UMessageBoxRibbon.Show(this, strError, "불러오기 오류", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
					return false;
				}
				return true;
			}
		...
		public void OpenSOP(FormOpenDB frm)
		{
			...
			if (!mgr.Load(this, m_dbMgr, version, arrActionSteps, strCategoryName, strSubCategoryName, strDisasterName))
			{
                FormFrame.Instance.Text = FormFrame.Instance.Title;
				m_versionCurrent = null;
                UnE.Utility.UMessageBoxRibbon.Show("SOP 불러오기가 실패하였습니다.", "불러오기 오류", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
				return;
			}
		...
		public bool SaveAsSOPXML()
		{
			...
			if (dlg.ShowDialog(this) == System.Windows.Forms.DialogResult.OK)
			{
				...
				{
                    UnE.Utility.UMessageBoxRibbon.Show(szError, "저장 오류", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
					return false;
				}
        ...
        public int GetMaxTableID(string strTableName)
        {
            ...
            ArrayList arrResult = m_dbMgr.GetResultData(strSQL);
            //ArrayList arrResult = nTransaction != 0 ? m_dbMgr.GetBatchData(strSQL) : m_dbMgr.GetResultData(strSQL);
		...
		internal bool RemoveSubCategory(Data_SubDisasterCategory data , ArrayList arrDisaster)
		{
			try
			{
				...
				foreach (Data_Disaster disaster in arrDisaster)
				{
					...
					if (nVersionID != -1)
					{
						if (!ioMgr.DeleteSOPVersion(m_dbMgr, nVersionID, true, rollback, true))
						{
                            rollback.Rollback(m_dbMgr);
                ...
                string strCondition = string.Format("where id = {0}", data.ID);
                string szSQL1 = "delete from SubDisasterCategory " + strCondition;

                if (m_dbMgr.GetResultData(szSQL1) == null)
                {
                    rollback.Rollback(m_dbMgr);
                    return false;
                }
		...
		internal Data_SubDisasterCategory AddSubCategory(string szName, string szCategoryName)
		{
			...
			int nCategoryID = WebDBManager.GetIntField(arResult[0].ToString(), -1);


			string szSQL2 = "SELECT MAX(id) FROM SubDisasterCategory";
            ArrayList arResult2 = m_dbMgr.GetResultData(szSQL2);
			...
			int nMaxID = WebDBManager.GetIntField(arResult2[0].ToString(), 0);
			nMaxID += 1;

            // 171204 KYJ
            // 사용자 정의일 경우 UserCategory = 1
            /*string query = "select UserCategory from SubDisasterCategory";
            ArrayList arrRes = m_dbMgr.GetResultData(query);
        ...
        private bool SaveAsSOP()
        {
            ...
            if (strCategory != null && strSubCategory != null && strDisaster != null && m_nSOPGenUserID > 0)
            {
                ...
                UnE.GUI.DialogFormFrameRibbon frameVersion = new UnE.GUI.DialogFormFrameRibbon(saveVersion);
                frameVersion.Sizable = false;
                frameVersion.StartPosition = FormStartPosition.CenterScreen;
                if (frameVersion.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    List<int> usingLevelIDs = saveVersion.UsingLevelIDs;
                    ...
                    if (!CheckSubCategory(strNewSubCategory, strNewCategory))
                    {
                        ...
                        if (newCategory == null)
                        {
                            ...
                            UnE.Utility.UMessageBoxRibbon.Show(this, szMsg, "저장 실패", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    ...
                    int nDisasterID;
                    if (mgr.Save(this, m_dbMgr, strVersionName, nVersionID, m_nSOPGenUserID, strDescription, usingLevelIDs, ref version, out nDisasterID))
                    {
			...
			if (strCategory != null && strSubCategory != null && strDisaster != null && m_nSOPGenUserID > 0)
			{
				...
				if(mgr.IsMonitoringDiaster(m_dbMgr, strDisaster))
				{
					if (m_versionCurrent!= null )
					{
						...
						{
							if(mgr.IsMonitoringSOPVersion(m_dbMgr, m_versionCurrent.VersionID, null))
							{
                ...
                UnE.GUI.DialogFormFrameRibbon frameVersion = new UnE.GUI.DialogFormFrameRibbon(saveVersion);
                frameVersion.ForeColor = System.Drawing.Color.Black;
                frameVersion.StartPosition = FormStartPosition.CenterScreen;
				if (frameVersion.ShowDialog() == System.Windows.Forms.DialogResult.OK)
				{
					int nVersionID = saveVersion.VersionID;
        ...
        public void SaveLastAccessedSOPTime(DateTime time)
        {
            ...
            {
                int nID = GetMaxTableID("OptionSOPSimulator") + 1;
		...
		private bool CheckDisasterType(int nSubCategoryID, string szName)
		{
			try
			{
				...
				ArrayList arResult = m_dbMgr.GetResultData(strSQL);
				if (arResult == null)
					return true;
			}
			catch (Exception)
		...
		private bool CheckProcess(Sections.SectionProcess section)
		{
			...
			{
                UnE.Utility.UMessageBoxRibbon.Show("임무를 수행할 대상이 지정되지 않은 [프로세스] 태그가 존재합니다.\r\n확인후 저장하십시오.", "오류", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
		...
		private bool CheckTransSOP(Sections.SectionTransSOP section, ref bool useTransSOP)
		{
			...
			{
                UnE.Utility.UMessageBoxRibbon.Show("전환할 SOP 대상이 지정되지 않은 [SOP 전환] 태그가 존재합니다.\r\n확인후 저장하십시오.", "오류", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
				ZoomNSelectSection(section);
				return false;
			}
			else
		...
		private bool CheckLink(Sections.SectionLink section)
		{
			...
			{
                UnE.Utility.UMessageBoxRibbon.Show("링크될 대상이 지정되지 않은 [Link] 태그가 존재합니다.\r\n확인후 저장하십시오.", "오류", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
				ZoomNSelectSection(section);
				return false;
			}
			else
		...
		private bool CheckExternal(Sections.SectionExternal section)
		{
			...
			if (data.UseSMS)
			{
				...
				{
                    UnE.Utility.UMessageBoxRibbon.Show("SMS 메시지 내용이 비어 있는 [외부 상황전파] 태그가 존재합니다.\r\n확인후 저장하십시오.", "오류", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
					ZoomNSelectSection(section);
					return false;
				}
				else if (data.SMSReceivers.Count == 0)
				{
                    UnE.Utility.UMessageBoxRibbon.Show("SMS 수신처가 비어 있는 [외부 상황전파] 태그가 존재합니다.\r\n확인후 저장하십시오.", "오류", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
					ZoomNSelectSection(section);
					return false;
				}
			}
			...
			if (data.UseFax)
			{
				...
				{
                    UnE.Utility.UMessageBoxRibbon.Show("Fax 수신처가 비어 있는 [외부 상황전파] 태그가 존재합니다.\r\n확인후 저장하십시오.", "오류", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
					ZoomNSelectSection(section);
					return false;
				}
			}
		...
		private bool CheckTransmission(Sections.SectionTransmission section)
		{
			...
			if (external.UseSMS)
			{
				...
				{
                    UnE.Utility.UMessageBoxRibbon.Show("SMS 메시지 내용이 비어 있는 [상황전파] 태그가 존재합니다.\r\n확인후 저장하십시오.", "오류", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
					ZoomNSelectSection(section);
					return false;
				}
				else if (external.SMSReceivers.Count == 0)
				{
                    UnE.Utility.UMessageBoxRibbon.Show("SMS 수신처가 비어 있는 [상황전파] 태그가 존재합니다.\r\n확인후 저장하십시오.", "오류", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
					ZoomNSelectSection(section);
					return false;
				}
			}
			...
			if (external.UseFax)
			{
				...
				{
                    UnE.Utility.UMessageBoxRibbon.Show("Fax 수신처가 비어 있는 [상황전파] 태그가 존재합니다.\r\n확인후 저장하십시오.", "오류", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
					ZoomNSelectSection(section);
					return false;
				}
			}
		...
		private bool CheckSOP()
		{
			...
			foreach (TabPage page in ctrl.TabPages)
			{
				...
				if (nStart == 0)
				{
                    ...
                    UnE.Utility.UMessageBoxRibbon.Show(szHeader + "[시작] 태그가 없습니다.\r\n확인후 저장하십시오.", "오류", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
					return false;
				}
				else if (nStart > 1)
				{
				...
				if (nEnd == 0)
				{
					...
					if (!useTransSOP)
					{
                        ...
                        UnE.Utility.UMessageBoxRibbon.Show(szHeader + "[종료] 태그가 없습니다.\r\n확인후 저장하십시오.", "오류", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
						return false;
					}
				}
			}
		...
		{
			IOManager mgr = new IOManager();
			mgr.AddExternalTeam(m_dbMgr, strTeamName, null);
		}
            ...
            try
            {
                this.Invoke(new MethodInvoker(delegate()
                {
                    if (m_frmForMessage == null || m_frmForMessage.IsDisposed == true)
                    {
                        ...
                        m_frmSpecialMessage.BtnOkNormalImg = global::SOPManager.Properties.Resources.__COMMON_Ok;
                        m_frmSpecialMessage.BtnOkClickedImg = global::SOPManager.Properties.Resources.__COMMON_OkClick;
                        m_frmSpecialMessage.BtnOkMouseOverImg = global::SOPManager.Properties.Resources.__COMMON_OkClick;
                        m_frmSpecialMessage.TopMost = true;

                        double[] dWinRate = FormMain.Instance.GetCurWindowRate();
                        m_frmSpecialMessage.WindowWidthRate = dWinRate[0];
                        m_frmSpecialMessage.WindowHeightRate = dWinRate[1];
                        m_frmSpecialMessage.UpdateControl();
        ...
        private void ReadSOPOptions()
        {
            string strSQL = "Select PropertyValue from OptionSOPSimulator where PropertyName = 'StandardActionStepNames' and SiteID = " + m_nSiteID.ToString();
            ArrayList arrResult = m_dbMgr.GetResultData(strSQL);
            ...
            Data_ActionStep.SetStandardActionStepNames(actionStepNames);
        }

        public void SendDeletedActionStepIDs(string strActionStepIDs)
        {
            if (m_netMgr != null)
                m_netMgr.SendDeletedActionStepIDs(strActionStepIDs);
        }
	}

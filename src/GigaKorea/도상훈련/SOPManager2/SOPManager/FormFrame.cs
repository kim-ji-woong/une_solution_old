...
namespace SOPManager
{
    public partial class FormFrame : UnE.GUI.FormNoFrameSizableRibbon
    {
        ...
        private string m_strTitle = "시나리오 생성기  V 2.0";
        ...
        void FormFrame_Load(object sender, EventArgs e)
        {
            ...
            //폰트설정
            this.TitleTextFont = new Font(Program.prgFont, 9, FontStyle.Bold);
            this.TitlePosition = new Point(25, 6);
            this.Text = m_strTitle;

            this.ShowPictureBoxTitle = true;
            this.PictureBoxSize = new Size(24, 24);
			//this.PictureBoxTitleImage = global::SOPManager.Properties.Resources.__App_Icon_Small2;
        ...
        void Instance_event_WinRateChanged()
        {
            ...
            this.PictureBoxSize = new Size((int)(PictureBoxSize.Width * dWinWidthRate), (int)(PictureBoxSize.Height * dWinHeightRate));

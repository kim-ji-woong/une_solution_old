...
namespace SOPManager
{
    public partial class PopupSelectTeam : Form
    {
        ...
        {                
            ...
            FormMain.Instance.ReadTeamInfo();
        ...
        public void UpdateControlSize()
        {
            ...
            FormMain.Instance.UpdateWindowRate(treeViewTeam, WindowRateWidth, WindowRateHeight, "나눔스퀘어 Bold");
            FormMain.Instance.UpdateWindowRate(dataGridViewUserDefined, WindowRateWidth, WindowRateHeight, "나눔스퀘어 Bold");
            ...
            FormMain.Instance.UpdateWindowRate(dataGridView, WindowRateWidth, WindowRateHeight, "나눔스퀘어 Bold");
        ...
        private void SelectCommander()
        {
            ...
            {
                if ((treeViewTeam.SelectedNode == null || treeViewTeam.SelectedNode.Tag == null || (treeViewTeam.SelectedNode.Tag is int) == false) &&
                    mSelectedRow == null)
                {

...
{
    public partial class PopupNoteDecision4 : Form
    {
        private static PopupNoteDecision4 m_instance = null;
        public static PopupNoteDecision4 Instance { get { return m_instance; } }
        ...
        #region 초기화
        public PopupNoteDecision4(string strCategoryName, string strSubCategoryName)
        {
            InitializeComponent();
        ...
        private void PopupNoteDecision4_Load(object sender, EventArgs e)
        {
            m_instance = this;
        ...
        private void PopupNoteDecision4_FormClosed(object sender, FormClosedEventArgs e)
        {
            m_instance = null;
        }
        ...
        public bool CheckExpression(string strExpression, bool popupErrorMessage = true)
        {
            ...
            while (nIndex >= 0)
            {
                ...
                Sections.SectionDataDecision.VariableType type = Sections.SectionDataDecision.VariableType.UNKNOWN;
        ...
        private Panel AddSubPanel(int pnSubX, int pnSubY)
        {
            ...
            pnSub.Size = new Size(100 + m_nSpace * 2/*앞 뒤 공백 width 더해줌*/, m_nPanelHeight + m_nSpace);
        ...
        private float mOutLineThick = 4.0f;

...
namespace SOPManager
{
	public partial class FormPageSOP : Form, Sections.ISectionListener
	{
        ...
        private void SetSectionColor()
		{
            ...
            Arrow.TextFont = new Font("나눔스퀘어", 12, FontStyle.Regular);
        ...
        private void CreateShortcutBar()
        {
            ...
            m_barConfig.ChangeUserConfig += barConfig_ChangeUserConfig;
        ...
        private void barConfig_ChangeUserConfig(int changeColumnIndex, SOPParameter param, object rollbackData)
        {
            foreach (PanelSectionEx item in m_arrPanel)
            {
                item.test(changeColumnIndex, param, rollbackData);   
            }
        }

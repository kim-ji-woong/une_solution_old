...
namespace SOPManager
{
	public partial class BarPage : Form
	{
        ...
        public void event_WinRateChanged()
        {
            ...
            label1.Font = new Font("나눔스퀘어", (float)fLabelFontSize, FontStyle.Bold);

            panelTop.Size = new Size(panelTop.Size.Width, (int)((float)panelTop.Size.Height * FormMain.Instance.WindowHeightRate));

            dataGridView.Location = new Point(0, panelTop.Size.Height + 1);

            dataGridView.Font = new System.Drawing.Font("나눔스퀘어", dataGridView.Font.Size * (float)FormMain.Instance.WindowWidthRate, FontStyle.Bold);

            DataGridViewCellStyle grid_ColumnHeaderStyle = new DataGridViewCellStyle();
            grid_ColumnHeaderStyle.Alignment = System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
            grid_ColumnHeaderStyle.BackColor = System.Drawing.SystemColors.Control;
            grid_ColumnHeaderStyle.Font = dataGridView.Font;
            grid_ColumnHeaderStyle.ForeColor = System.Drawing.SystemColors.WindowText;
            grid_ColumnHeaderStyle.SelectionBackColor = System.Drawing.SystemColors.Highlight;
            grid_ColumnHeaderStyle.SelectionForeColor = System.Drawing.SystemColors.HighlightText;
            grid_ColumnHeaderStyle.WrapMode = System.Windows.Forms.DataGridViewTriState.True;
            dataGridView.ColumnHeadersDefaultCellStyle = grid_ColumnHeaderStyle;

            DataGridViewCellStyle grid_DefaultRowsCellStyle = new DataGridViewCellStyle();
            grid_DefaultRowsCellStyle.Alignment = System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
            grid_DefaultRowsCellStyle.BackColor = System.Drawing.Color.White;
            grid_DefaultRowsCellStyle.Font = dataGridView.Font;
            grid_DefaultRowsCellStyle.ForeColor = System.Drawing.Color.Black;
            grid_DefaultRowsCellStyle.SelectionBackColor = System.Drawing.Color.FromArgb(((int)(((byte)(246)))), ((int)(((byte)(169)))), ((int)(((byte)(43)))));
            grid_DefaultRowsCellStyle.SelectionForeColor = System.Drawing.Color.Black;
            dataGridView.RowsDefaultCellStyle = grid_DefaultRowsCellStyle;

            DataGridViewCellStyle grid_AlternatingRowsCellStyle = new DataGridViewCellStyle();
            grid_AlternatingRowsCellStyle.Alignment = System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
            grid_AlternatingRowsCellStyle.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(224)))), ((int)(((byte)(224)))), ((int)(((byte)(224)))));
            grid_AlternatingRowsCellStyle.Font = dataGridView.Font;
            grid_AlternatingRowsCellStyle.ForeColor = System.Drawing.Color.Black;
            grid_AlternatingRowsCellStyle.SelectionBackColor = System.Drawing.Color.FromArgb(((int)(((byte)(244)))), ((int)(((byte)(169)))), ((int)(((byte)(43)))));
            grid_AlternatingRowsCellStyle.SelectionForeColor = System.Drawing.Color.Black;
            dataGridView.AlternatingRowsDefaultCellStyle = grid_AlternatingRowsCellStyle;
		...
		public void InsertDataGrid(int nRowIndex, StepMemberData team)
		{
			...
			checkTeam.TeamID = team.TeamID;
			checkTeam.TeamType = team.TeamType;
		...
		public void SetDataGrid()
		{
			...
			foreach (StepMemberData row in arrTeam)
			{
				...
				checkTeam.TeamID = row.TeamID;
				checkTeam.TeamType = row.TeamType;
				checkTeam.Check = true;
		...
		private void dataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
		{
			...
			CheckTeam checkTeam = FindTeam(team.TeamName, team.TeamID, team.TeamType);
        ...
        private CheckTeam FindTeam(string strValue, int nTeamID, Sections.SOPTeam.SOPTeamType nTeamType)
		{
			foreach (CheckTeam team in m_arrCheckTeam)
			{
				if (team.TeamName == strValue && team.TeamType == nTeamType && team.TeamID == nTeamID)
				{
					return team;
				}
			}

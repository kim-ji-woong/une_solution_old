...
namespace SOPManager
{
	public partial class FormNewSOP3 : Form, IRibbonButtonOwner
	{
		...
		private void InitRibbonButton()
		{
            ...
            btnCategroyExplosion.Font = new System.Drawing.Font("나눔스퀘어", 12f, FontStyle.Bold);

			btnCategoryEtc.ID = ID.ID_BUTTON_ETC;
			btnCategoryEtc.IsChecked = false;
			btnCategoryEtc.Owner = this;
            btnCategoryEtc.Font = new System.Drawing.Font("나눔스퀘어", 12f, FontStyle.Bold);
        ...
        private void btnAddSubDisaster_Click(object sender, EventArgs e)
		{
        ...
        private void SelectedTeamsNoStepMember()
        {
            ...
            if (m_arrSelectedTeam.Count == 0 && dataGridViewTeamETC.Rows.Count > 0 && dataGridViewTeam.Rows.Count > 0)
                m_arrSelectedTeam.Add(dataGridViewTeam.Rows[0]);

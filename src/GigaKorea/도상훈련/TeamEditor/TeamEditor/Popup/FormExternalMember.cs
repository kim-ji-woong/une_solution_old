    ...
    public partial class FormExternalMember : Form
    {
        ...
        private void _ShowGrid(bool showGrid)
        {
            if (showGrid)
            {
                ...
                treeExternalCompanyTeam.Location = m_initTreeLocation;
                treeExternalCompanyTeam.Size = new Size(m_initTreeSize.Width, this.Size.Height - 6);
            ...
            else
            {
                ...
                treeExternalCompanyTeam.Location = new Point(m_initTreeLocation.X, m_initGridLocation.Y);

        ...
        class TransmissionNotifyProcess : ProcessSectionIF
        {
            ...
            public override void Progress()
            {
                ...
                if (m_workFlow != null)
                {
                    ...
                    dialogForm.SystemMessage = ParseSpecialMessage(MakeMessage(), m_workFlow.Option.DetectTime.Data, strLocation, !isVirtual, FormSOP.Instance.IsNormal, m_workFlow.Option.LastPosition);
                    m_dialogForm.SenarioMessage = ParseSpecialMessage(data.DataInternal.BroadcastMessage, m_workFlow.Option.DetectTime.Data, strLocation, !isVirtual, FormSOP.Instance.IsNormal, m_workFlow.Option.LastPosition);
                }
                else
                {

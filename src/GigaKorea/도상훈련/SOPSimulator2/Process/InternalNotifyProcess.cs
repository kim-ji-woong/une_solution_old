        ...
        public class InternalNotifyProcess : ProcessSectionIF
        {
            ...
            public override void Progress()
            {
                ...
                if (m_workFlow != null)
                {
                    ...
                    m_dialogForm.SenarioMessage = ParseSpecialMessage(data.BroadcastMessage, m_workFlow.Option.DetectTime.Data, strLocation, !isVirtual, FormSOP.Instance.IsNormal, m_workFlow.Option.LastPosition);
                    m_dialogForm.SystemMessage = ParseSpecialMessage(MakeMessage(), m_workFlow.Option.DetectTime.Data, strLocation, !isVirtual, FormSOP.Instance.IsNormal, m_workFlow.Option.LastPosition);
                }
                else
                {
                ...
                ((Form)m_dialogForm).Location = new Point(FormFrame.Instance.Location.X + ptCurrent.X, FormFrame.Instance.Location.Y + ptCurrent.Y);

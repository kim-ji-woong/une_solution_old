        ...
        private void LocateButtons()
        {
            ...
            //if (UnE.SOP.ProxySOP.Instance.SiteID == 101)
            {
                ...
                for (int i = 0; i < nButtonCount; i++)
                {
                    ...
                    if (i == 0)
                    {
                        y = centerBtnptY + backImgHeight - 160;
                        x = centerBtnPtX - betweenWidth - 105;
                        
                    }
                    else if (i == 1)
                    {
                        RibbonButtonQuick temp = (RibbonButtonQuick)m_arrButtons[0];
                        y = centerBtnptY + backImgHeight - 40;
                        x = temp.Location.X + betweenWidth;
                    }
                    else if (i == 2)
                    {
                        RibbonButtonQuick temp = (RibbonButtonQuick)m_arrButtons[1];
                        y = centerBtnptY + backImgHeight - 40;
                        x = temp.Location.X + betweenWidth;
                    }
                    else if (i == 3)
                    {
                        RibbonButtonQuick temp = (RibbonButtonQuick)m_arrButtons[2];
                        y = centerBtnptY + backImgHeight - 160;
                        x = temp.Location.X + betweenWidth - 20;
                    }

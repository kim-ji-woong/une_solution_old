...
namespace SOPMonitoringSystem
{
	public class DataManager
	{
        ...
        //                    strPositionName, m_nSiteID);
        //            }
        //            else if (dbMgr.DatabaseType == DBUtility.WebDBManager.DBType.sqlite)
        //            {
        //                strSQL += string.Format("from HistoryDisasterPos Where Description = '{0}' and SiteID = {1} order by ID Desc LIMIT 1",
        //                    strPositionName, m_nSiteID);
        //            }
        //            else
        ...
        {
            m_dicTemporaryNormalTeams.Clear();
            m_dicTemporaryEmergencyTeams.Clear();

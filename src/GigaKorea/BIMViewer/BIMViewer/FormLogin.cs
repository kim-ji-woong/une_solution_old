...
namespace BIMViewer
{
    public partial class FormLogin : Form
    {
        ...
        public FormLogin(Dictionary<string, string> poiUserList)
        {
            InitializeComponent();
        ...
        private void FormLoginLoad(object sender, EventArgs e)
        {
            ...
            //txtUserID.Text = "ACC_0001_20190822153807522";
            //txtUserKey.Text = "poiInfo100";
        }
        private void RbtnOK_Click(object sender, EventArgs e)
        {
            ...
            //사용자 목록 체크
            //if (!m_poiUserList.ContainsKey(sID))
            //{
            //    MessageBox.Show("POI정보 사용자가 아닙니다.", "로그인오류");
            //    return;
            //}
            string tmpValue;
            //m_poiUserList.TryGetValue(sID, out tmpValue);
            //if (sPW != tmpValue)
            //{

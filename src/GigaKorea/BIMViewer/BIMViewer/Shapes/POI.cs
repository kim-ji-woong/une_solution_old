    ...
    public class POI : Shape
    {
        private class Icon
        {
            ...
            private void SetTextBoundary(Graphics g, POIType.TextData text)
            {
                ...
                double tlX = text.Position.x - size.Width / 2 +5;//
                double tlY = text.Position.y + size.Height / 2 +5;
        ...
        private string m_strRx = "";
        private string m_strLoop = "";
        private string m_strAddress = "";
        private string m_strChannel = "";

        private bool m_bPOIVisible = true;
        public bool POIVisible
        {
            get { return m_bPOIVisible; }
            set { m_bPOIVisible = value; }
        }

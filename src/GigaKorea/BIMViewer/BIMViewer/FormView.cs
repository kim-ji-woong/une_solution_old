...
namespace BIMViewer
{
    ...
    public partial class FormView : Form, IGDIOwner, IComparable
    {
        ...
        public POI SelectedPOIInfo()
        {
            if (m_master != null)
                return m_master.SelectedPOIInfo;
        ...
        private void checkBoxOrthoSnap_CheckedChanged(object sender, EventArgs e)
        {
            panelBody.UseOrthoSnap = checkBoxOrthoSnap.Checked;
            checkBoxObjectSnap.Enabled = checkBoxOrthoSnap.Checked;
        }

        private void checkBoxObjectSnap_CheckedChanged(object sender, EventArgs e)
        {
            panelBody.UseObjectSnap = checkBoxOrthoSnap.Checked;
        }

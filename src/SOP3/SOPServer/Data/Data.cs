...
namespace SDMSServer
{
    ...
    public class SensorReactionLog
    {
        ...
        {         
			...
			byte[] param3Bytes = ServiceProvider.MakeBytes(m_strParam3);
			byte[] param4Bytes = ServiceProvider.MakeBytes(m_strParam4);
			byte[] param5Bytes = ServiceProvider.MakeBytes(m_strParam5);
			...
			CopyBytes(bytes, ref nIndex, param3Bytes);
			CopyBytes(bytes, ref nIndex, param4Bytes);
			CopyBytes(bytes, ref nIndex, param5Bytes);
        ...
        public static ReactionType ToReactionType(int nType, out bool isSuccess)
        {
            ...
            else if (nType == (int)ReactionType.END_STATUS)
                return ReactionType.END_STATUS;

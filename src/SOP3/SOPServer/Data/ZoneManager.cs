...
namespace SDMSServer
{
	class ZoneManager
	{
		...
		public void LoadZones()
		{
            ...
            string szText = "select id, ZoneName, BuildingID, FloorIndex, Boundary, DXFFileName, DXFAccessedTime, _3DFileName, _3DAccessedTime, BroadcastName, AddFloor " +
        ...
        public void LoadEquipmentZones()
        {
            ...
            //string strSQL = "select ID, ZoneName, LinkedZoneIDList, Type, BroadcastName from EquipmentZone where ID > 0";
            string szText = "SELECT ID, ZoneName, LinkedZoneIDList, Type, BroadcastName FROM EquipmentZone where ID > 0 AND SiteID = {0}";

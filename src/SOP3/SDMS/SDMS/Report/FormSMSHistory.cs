...
namespace SDMS
{
    public partial class FormSMSHistory : Form
    {
        ...
        private void LoadData()
        {
            ...
            string szSQL2 = "SELECT PropertyValue FROM OptionSDMS where PropertyName='SMSCaller'";
        ...
        private void UpdateGrid()
        {
            ...
            {                
                ...
                cell4.Value = member.Team.TeamName;
                row.Cells.Add(cell4);
        ...
        private void btnSendSMS_Click(object sender, EventArgs e)
        {
            ...
            {                
                string szServerIP = NetworkManager.Instance.ServerIP;
                // send SMS                
                libSMS.MessageClient client = new libSMS.MessageClient(szServerIP);

...
namespace SDMS.Report
{
    class ReportData
    {
        ...
        public void LoadReactionHistory()
        {
            ...
            strSQL += "From EquipmentZone, SensorZone, SensorZoneHistory, SensorReactionHistory ";
            strSQL += "where EquipmentZone.ID = SensorZone.EquipZoneID And SensorZone.ID = SensorZoneHistory.SensorID ";
            ...
            if (btnSelect == false)
            {
                ...
                strSQL += "And SensorReactionHistory.Time Between'" + strBeforeDate + "'And '" + strNowDate + "'";
                strSQL += "group by SensorZone.Type, EquipmentZone.ID, ReactionType";

...
namespace SDMS
{
    public partial class DockingFormCCTVProperties : Form, IFormControl
    {
        ...
        public void _Update(POI poi)
        {
            ...
            if (poi == null || poi.Type != Facility.FacilityType.CCTV)
            {
                labelCCTVID.Text = "";
                labelType.Text = "";
                textBoxManager.Text = "";
        ...
        private string GetCCTVManagerName(CCTV cctv, ref string strPhoneNumber)
        {
            ...
            if (cctv.POI.Zone != null)
            {
                if (cctv.POI.Zone.Building != null)
                    group = FormMain.Instance.DataManager.GetBuildingFacilityManagerGroup(Facility.FacilityType.CCTV, cctv.POI.Zone.Building);
                else
                    group = FormMain.Instance.DataManager.GetOutdoorFacilityManagerGroup(Facility.FacilityType.CCTV, cctv.POI.Zone);
            }

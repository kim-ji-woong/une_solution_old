...
namespace SDMS
{
    ...
    {
        public enum SelectMode { REGULAR_TEAM = 0, REGULAR_MEMBER, EXTERNAL_TEAM, EXTERNAL_MEMBER, DUTY_MEMBER, NONE };
        ...
        public FormEditManager(Facility.FacilityType type, FacilityManagerGroup group = null, Building building = null, Zone zone = null, EquipmentZone equipZone = null)
        {
            InitializeComponent();
        ...
        private void AddManager(DataCompanyMember member, FacilityManager mgr)
        {
            ...
            cell = new DataGridViewTextBoxCell();
            cell.Value = member.Team.TeamName;
            row.Cells.Add(cell);
        ...
        private void AddManager(DataExternalMember member, FacilityManager mgr)
        {
            ...
            cell = new DataGridViewTextBoxCell();
            cell.Value = member.Team.CompanyName;
            row.Cells.Add(cell);
        ...
        private void GetMemberType(DataTeam team, FacilityManager mgr, out int nMemberID, out int nMemberType)
        {
            ...
            if (team.GetType() == typeof(DataTeamDuty))
            {
                nMemberType = 6;
            }
            else

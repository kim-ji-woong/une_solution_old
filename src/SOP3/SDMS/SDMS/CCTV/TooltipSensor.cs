...
namespace SDMS
{
	...
	{		
		...
		private SDMS.SensorZone m_Sensor = null;
		...
		private int m_nSenstorType = 1;
		public TooltipSensor(BaseViewEx view, SDMS.SensorZone sensor, int nType)
		{
			InitializeComponent();
		...
		public void SetStatus()			
		{
			...
			{
				m_viewOwner.EnablePOI(m_Sensor.POI.ID, true);
				if (m_nSenstorType == 1)
				{				
			...
			else
			{
				...
				{
					m_viewOwner.EnablePOI(m_Sensor.POI.ID , false);				
				}
			}
		}
	...
	public partial class FireSensor : SensorZone
	{
		...
		{
			return new TooltipSensor(view, (SDMS.SensorZone)this, 1);
		}
	}
	...
	public partial class SpringCooler : SensorZone
	{
		public override IPOIPopup CreatePopup(BaseViewEx view)
		{
			return new TooltipSensor(view, (SDMS.SensorZone)this, 2);
		}
	}
	...
	public partial class PumpPressureSensor : SensorZone
	{
		public override IPOIPopup CreatePopup(BaseViewEx view)
		{
			return new TooltipSensor(view, (SDMS.SensorZone)this, 3);
		}
	}
	...
	public partial class FireAlarm : SensorZone
	{
		public override IPOIPopup CreatePopup(BaseViewEx view)
		{
			return new TooltipSensor(view, (SDMS.SensorZone)this, 4);
		}
	}
}

    ...
    public class DataManager
    {
		...
		public static DataManager Instance
		{
			get 
			{
				if (m_Instance == null)
				{
					m_Instance = new DataManager(FormMain.Instance.DBManager);
				}
				return m_Instance; 
			}
		}
        ...
        public void LoadFacilityManager()
        {
            ...
            string strSQL = "select id, MemberID, MemberType, FacilityType, LevelLimit, Description from FacilityManager order by FacilityType";
            ArrayList arrResult = dbMgr.GetResultData(strSQL, 0);
            ...
            for (int i = 0; i < nResultCount - 5; i += 6)
            {
                ...
                AddFacilityManager(nID, nMemberID, nMemberType, nFacilityType, nLevelLimit, strDescription, group);
            }

            strSQL = "select id, MemberID, MemberType, FacilityType, LevelLimit, BuildingID, Description from BuildingFacilityManager order by FacilityType";
        ...
        private void AddFacilityManager(int nID, int nMemberID, int nMemberType, int nFacilityType, int nLevelLimit, string strDescription, FacilityManagerGroup group)
        {

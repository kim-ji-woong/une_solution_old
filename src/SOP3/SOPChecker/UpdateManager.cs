        ...
        public static UpdateManager Instance
        {
            get
            {
                if (m_instance == null)
                {
                    ...
                    m_instance.m_strUpdateSrcPath = dbMgr.LoadIni("update_src", "SDMS");
                    m_instance.m_strUpdateTrgPath = dbMgr.LoadIni("update_trg", "SDMS");
                    m_instance.m_strUpdateTempPath = dbMgr.LoadIni("update_temp", "SDMS");
                }

...
namespace SOPManager
{
    public partial class FormSaveAsVersion : Form, IRibbonButtonOwner
    {
        ...
        private void InitData()
        {
            ...
            btnCategoryFire.Tag = "화재";
            btnCategoryEtc.Tag = "일반재해";
        }
        ...
        private void SetSubCategory(string szValue, DataGridViewRow row)
        {
            foreach (ArrayListEx arrCategory in m_arrDisaster)
            {
                if (arrCategory.Title == SelectedCategory)
            ...
            if (frame.ShowDialog() == DialogResult.OK)
            {
                ...
                if (szValue != szOrgSelectName)
                {
                    ...
                    try
                    {
                        ...
                        m_dbMgr.GetResultData(szSQL2, 1);
                        m_dbMgr.BatchCommit();
                        bResult = true;
                    }
                    catch (Exception)

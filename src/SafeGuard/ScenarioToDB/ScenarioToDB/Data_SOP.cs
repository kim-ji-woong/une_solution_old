...
namespace ScenarioToDB
{
    ...
    class Data_TemporaryTeam
    {
        public enum TeamType
        {
            ...
            RegularTeam = 0,        // 정규조직
            CompanyMember,          // 정직원
            ExternalCompanyTeam,    // 외부 협력업체 팀
            ExternalTeam,           // 외부 협력업체 회사
    ...
    class Data_NormalTeam : Data_TemporaryTeam
    {
    }

    class Data_EmergencyTeam : Data_TemporaryTeam
    {
    }

...
namespace SOPManager
{
    ...
    public class IOManager : IDisposable
    {
        ...
        public void SetProcessButton(Sections.Arrow arrow)
        {
            ...
            if (arrow.BeginLink.GetSectionPainter(0) == null)
            {
                ...
                Sections.PanelSection panel = arrow.BeginLink.GetParent();

                if (panel != null)
                    panel.ProcessManagers.Add(mgr);
            }
            else
            {
        ...
        private ProcessButton GetProcessButton(Sections.Arrow arrow, ProcessButtonManager mgr)
        {
            ...
            btn = new ProcessButton(SOPSimulator.Instance);
            ...
            ArrayList arrSections)
        {
			...
			if (!LoadArrow(dbMgr, dicProcessSections, dicAnnotationSections, dicEndPointSections, data, panel))
                return false;

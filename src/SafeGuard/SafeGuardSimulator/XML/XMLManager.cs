...
namespace SOPManager
{
    ...
    public class XMLManager
    {
        ...
        private bool GetTeamInfo(ActionStep actionStep, out string strTeamName, out int nTeamID)
        {
            strTeamName = "";
            nTeamID = -1;
        ...
        private void LoadBarPage(FormMain frm, ArrayList arrActionSteps)
        {
            ...
            {
                GetTeamInfo(actionStep, out strTeamName, out nTeamID);

                foreach (StepMember stepMember in actionStep.StepMemberList)
                {
                    StepMemberData data = new StepMemberData(stepMember.TeamName);
                    data.ID = nTeamID;
                    arrTeams.Add(data);
                }
            }
        ...
        private bool LoadTabPages(FormMain frm)
        {
            ...
            foreach (ActionStep actionStep in m_arrActionSteps)
            {
                ...
                if (!AddPanels(tabPage, actionStep, pageLevel, ref dicNormal, ref dicEmergency, ref dicUserDefined, ref dicExternal, ref dicRegular))
                    return false;
            }
        ...
        private StepMember FindStepMember(ActionStep actionStep, int nTeamID, string strTeamName)
        {
            foreach (StepMember stepMember in actionStep.StepMemberList)
            {
                if (stepMember.TeamName == strTeamName && stepMember.ID == nTeamID)
                    return stepMember;
            }
		...
		private bool AddPanels(TabPage tabPage, ActionStep actionStep, FormPageSOP pageLevel, ref Dictionary<int, string> dicNormal, ref Dictionary<int, string> dicEmergency, ref Dictionary<int, string> dicUserDefined, ref Dictionary<int, Sections.ExternalTeamData> dicExternal, ref Dictionary<int, string> dicRegular)
        {
            ArrayList arrStepMemberDatas = new ArrayList();

            foreach (StepMember stepMember in actionStep.StepMemberList)
            {
                SOPManager.StepMemberData data = new StepMemberData(stepMember.TeamName);
                data.ID = stepMember.ID;
                data.ActionStepID = stepMember.ActionStepID;
            ...
            {
                StepMember stepMember = FindStepMember(actionStep, panel.TeamID, panel.TeamName);
                if (stepMember == null)
                    return false;

				if (!AddComponents(panel, stepMember, nStepMemberIndex, dicSections, dicLinkSections, ref dicNormal, ref dicEmergency, ref dicUserDefined, ref dicExternal, ref dicRegular, ref dicCompSection))
                    return false;

                if (!AddArrows(stepMember, (long)nStepMemberIndex, dicSections, ioMgr))
                    return false;
        ...
        private bool AddArrows(StepMember stepMember, long nStepMemberIndex, Dictionary<long, Sections.Section> dicSections, IOManager ioMgr)
        {
            foreach (Arrow arrow in stepMember.ArrowList)
            {
                ...
                ioMgr.SetProcessButton(sectionArrow);
            }
        ...
        private bool AddComponents(Sections.PanelSectionEx panel, StepMember stepMember, long nStepMemberIndex, Dictionary<long, Sections.Section> dicSections, Dictionary<PropertyLink, Sections.SectionLink> dicLinkSections, ref Dictionary<int, string> dicNormal, ref Dictionary<int, string> dicEmergency, ref Dictionary<int, string> dicUserDefined, ref Dictionary<int, Sections.ExternalTeamData> dicExternal, ref Dictionary<int, string> dicRegular, ref Dictionary<int, Sections.Section> dicCompSection)
        {
            foreach (Component component in stepMember.ComponentList)
            {
				...
				Sections.Section section = ToSection(panel, component.X, component.Y, property, dicLinkSections, ref dicNormal, ref dicEmergency, ref dicUserDefined, ref dicExternal, ref dicRegular, dicCompSection);
        ...
        private Sections.Section ToSection(Sections.PanelSectionEx panel, float x, float y, ComponentProperty property, Dictionary<PropertyLink, Sections.SectionLink> dicLinkSections, ref Dictionary<int, string> dicNormal, ref Dictionary<int, string> dicEmergency, ref Dictionary<int, string> dicUserDefined, ref Dictionary<int, Sections.ExternalTeamData> dicExternal, ref Dictionary<int, string> dicRegular, Dictionary<int, Sections.Section> dicCompSection)
        {
            ...
            {
                return ToSectionProcess(panel,x, y, (PropertyProcess)property, ref dicNormal, ref dicEmergency, ref dicUserDefined, ref dicExternal, ref dicRegular);
            }
		...
		private Sections.SectionProcess ToSectionProcess(Sections.PanelSectionEx panel, float x, float y, PropertyProcess property, ref Dictionary<int, string> dicNormal, ref Dictionary<int, string> dicEmergency, ref Dictionary<int, string> dicUserDefined, ref Dictionary<int, Sections.ExternalTeamData> dicExternal, ref Dictionary<int, string> dicRegular)
        {
            ...
            section.TextDown = IOManager.GetTeamList(FormMain.Instance.DBManager, property.TeamList, ref sectionData, ref dicNormal, ref dicEmergency, ref dicUserDefined, ref dicExternal, ref dicRegular);
        ...
        class StepMember : SOPManager.StepMemberData
        {

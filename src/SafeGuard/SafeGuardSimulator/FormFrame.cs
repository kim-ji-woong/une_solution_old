...
namespace SOPManager
{
    public partial class FormFrame : UnE.GUI.FormNoFrameSizable 
    {
        ...
        private string m_strTitle = "SafeGuard Simulator  V1.0";
        ...
        void FormFrame_Load(object sender, EventArgs e)
        {
			...
			this.PictureBoxTitleImage = global::SOPManager.Properties.Resources.App_Icon_Small;


			this.CloseButtonImage = global::SOPManager.Properties.Resources.CloseWindow_Normal;

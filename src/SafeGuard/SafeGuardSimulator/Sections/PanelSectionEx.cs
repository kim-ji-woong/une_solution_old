    ...
    public partial class PanelSectionEx : PanelSection
    {
        ...
        protected void OnLazyPaint(int nCount1, int nCount2 , bool bArrow)
        {
            ...
            foreach (Section section in m_arrSection)
            {
                ...
                UnE.SOP.Workstate.ProcessButtonManager mgr = (UnE.SOP.Workstate.ProcessButtonManager)section.GetSectionPainter(0);
        ...
        protected override void OnMouseDown(object sender, MouseEventArgs e)
        {
            ...
            else
            {
                ...
                SOPSimulator.Instance.FocusSection(m_sectionSelected);
        ...
        protected bool ProcessButtonClick(MouseButtons mouseButton, float x, float y, out ProcessButton btn)
        {
            btn = null;

            if (SOPSimulator.Instance.RunningSOP == false)
                return false;
        ...
        protected override void OnMouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                if (SOPSimulator.Instance.RunningSOP)
	   ...
	   this.TeamName);
        ...
        public override bool CompleteSection(Section section, int nDir = 0, bool refresh = true, Section sectionNext = null)
        {
            if (section != null)
            {
                ActionStepTabPage page = (ActionStepTabPage)Parent;
                SectionState state = WorkFlowManager.Instance.Find(section, true);
                if (state != null)
                {
                    ...
                    int nProcessDirections = state.ProcessDirections | (int)nDir;

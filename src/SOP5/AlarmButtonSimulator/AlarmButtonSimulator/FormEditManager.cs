...
namespace AlarmButtonSimulator
{
    public partial class FormEditManager : Form
    {
        ...
        {
            MakeTeam(treeViewTeam.Nodes, DataManager.Instance.RegularTeamRoot);
            // 교대 근무자
            MakeControlRoomMembers(treeViewTeam.Nodes);
            MakeExternalTeams(treeViewTeam.Nodes, DataManager.Instance.ExternalTeamRootList);
        ...
        {
            DataTeamControlRoom teamRoot = DataManager.Instance.GetRootControlRoomTeam();

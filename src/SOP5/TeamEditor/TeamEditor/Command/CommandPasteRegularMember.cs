...
namespace TeamEditor.Command
{
    public class CommandPasteRegularMember : CommandEx
    {
        ...
        private bool CheckTeamNAdd(DBUtility.WebDBManager dbMgr, int teamID)
        {
            string strSQL = "Select id from RegularTeam where ID = " + teamID;
            ArrayList arrResult = dbMgr.GetBatchData(strSQL, 0);
        ...
        private bool CheckMemberNAdd(DBUtility.WebDBManager dbMgr, int memberID)
        {
        ...
        private bool RedoDB(DBUtility.WebDBManager dbMgr)
        {
            dbMgr.BeginBatch();
            ...
            int nTeamID = arrResult.Count == 0 ? 1 : DBUtility.WebDBManager.GetIntField(arrResult[0].ToString(), 0) + 1;
            ...
            int nMemberID = arrResult.Count == 0 ? 1 : DBUtility.WebDBManager.GetIntField(arrResult[0].ToString(), 0) + 1;
        ...
        private string UpdateDB(DBUtility.WebDBManager dbMgr, int memberID, ChangeMemberInfo.InfoType infoType, object changedData, ref bool suc)
        {
            string strSet = "";
        ...
        private List<string> UndoDB(DBUtility.WebDBManager dbMgr)
        {
        ...
        private List<string> RemoveRegularMemberList(DBUtility.WebDBManager dbMgr, string strCompanyMemberIDs)
        {
        ...
        // RollBack을 위하여 삭제한 데이터들의 Insert 구문 리스트를 반환한다.
        private List<string> RemoveFacilityManagers(DBUtility.WebDBManager dbMgr, string strCompanyMemberIDs)
        {
            List<string> insertList = new List<string>();
        ...
        private bool RemoveFacilityManagers(DBUtility.WebDBManager dbMgr, string strCompanyMemberIDs, List<string> insertList)
        {
            string strDeleteSQL = "";
        ...
        private bool RemoveEquipZoneFacilityManagers(DBUtility.WebDBManager dbMgr, string strCompanyMemberIDs, List<string> insertList)
        {
            string strDeleteSQL = "";
        ...
        private bool RemoveBuildingFacilityManagers(DBUtility.WebDBManager dbMgr, string strCompanyMemberIDs, List<string> insertList)
        {
            string strDeleteSQL = "";
        ...
        // RollBack을 위하여 삭제한 데이터들의 Insert 구문 리스트를 반환한다.
        private List<string> RemoveTemporaryMembers(DBUtility.WebDBManager dbMgr, string strCompanyMemberIDs)
        {
            List<string> insertList = new List<string>();
        ...
        private bool RemoveTemporaryMemberList(DBUtility.WebDBManager dbMgr, string strCompanyMemberIDs, List<string> insertList)
        {
            string strDeleteSQL = "";

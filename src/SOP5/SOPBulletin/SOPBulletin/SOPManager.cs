...
namespace SOPBulletin
{
    public class SOPManager
    {
       ...
       // private string m_selectedSubCategoryName = "";
        ...
        {
            string strSql = "SELECT * FROM DisasterCategory WHERE SiteID = " + m_nSiteID.ToString();
        ...
        private bool LoadTemporaryTeam()
        {
            ...
            strSQL += "where l.TemporaryTeamID = t.ID and l.IsNormal = 1 and t.SiteID = " + m_nSiteID.ToString();
            ...
            strSQL += "where l.TemporaryTeamID = t.ID and l.IsNormal = 0 and t.SiteID = " + m_nSiteID.ToString();
        ...
        {
            string strSQL = string.Format("select id, TeamName, PhoneNumber, FaxNumber from {0} WHERE SiteID = {1}", strTableName, m_nSiteID);

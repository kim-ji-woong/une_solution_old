...
namespace ColorProgressBar
{
	...
	{	
        ...
        private Color _ValueColor = Color.FromArgb(99, 37, 35);
		...
		protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
		{
            ...
            Color darkValueColor = ControlPaint.Dark(_ValueColor);
			...
			brush = new LinearGradientBrush(new Point(0, 0),
                new Point(0, this.Height / 2), darkValueColor, _ValueColor);
			...
			brush = new LinearGradientBrush(new Point(0, this.Height / 2 - 1),
                new Point(0, this.Height), _ValueColor, darkValueColor);

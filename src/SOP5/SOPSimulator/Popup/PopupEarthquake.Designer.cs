namespace SOPMonitoringSystem
{
    partial class PopupEarthquake
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PopupEarthquake));
			...
			this.textMessage.Location = new System.Drawing.Point(14, 110);
			this.textMessage.Name = "textMessage";
			this.textMessage.ReadOnly = true;
			this.textMessage.Size = new System.Drawing.Size(612, 262);
			this.textMessage.TabIndex = 45;
			this.textMessage.Text = resources.GetString("textMessage.Text");
			// 
			// btnCancel
			// 
			this.btnCancel.Location = new System.Drawing.Point(537, 29);
			...
			// btnOK
			// 
			this.btnOK.Location = new System.Drawing.Point(442, 29);
            ...
            "7",
            "상황 종료시까지 무한 반복"});
			this.cmbAnnoCount.Location = new System.Drawing.Point(246, 55);
			this.cmbAnnoCount.Name = "cmbAnnoCount";
			this.cmbAnnoCount.Size = new System.Drawing.Size(161, 20);
			this.cmbAnnoCount.TabIndex = 42;
			this.cmbAnnoCount.SelectedIndexChanged += new System.EventHandler(this.cmbAnnoCount_SelectedIndexChanged_1);
			// 
			// label2
			// 
            ...
            "사용자 입력",
            "시나리오"});
			this.m_comboDisaster.Location = new System.Drawing.Point(112, 29);
			this.m_comboDisaster.Name = "m_comboDisaster";
			this.m_comboDisaster.Size = new System.Drawing.Size(295, 20);
			this.m_comboDisaster.TabIndex = 39;
			this.m_comboDisaster.SelectedIndexChanged += new System.EventHandler(this.m_comboDisaster_SelectedIndexChanged_1);
			// 
			// btnBack
			// 
			...
			this.Name = "PopupEarthquake";
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "지진 및 지진해일 안내방송";

...
namespace SOPMonitoringSystem
{
    public partial class PopupProgressReport : Form
    {
        ...
        public PopupProgressReport(FormSOP frmParent)
        {
            InitializeComponent();
            InitRemoveImg();
        }
        ...
        {
            if (SOPScenarioManager.Instance.CurrentScenario == null)
                return -1;

			string strTitle = SOPScenarioManager.Instance.CurrentScenario.ActionStepFullPath;

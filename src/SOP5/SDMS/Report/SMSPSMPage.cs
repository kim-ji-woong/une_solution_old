...
namespace SDMS
{
    public partial class SMSPSMPage : FormReportBase
    {
        ...
        public SMSPSMPage()
        {
            ...
            this.Resize += SMSPSMPage_Resize;

            m_manualManager = new ManualManager(this);
            SetManualID();
        }

        void SMSPSMPage_Resize(object sender, EventArgs e)
        {
        ...
        private void SetManualID()
        {
            ...
            m_manualManager.SetID(this, "SDMS_Report_SMS_PSM");
            m_manualManager.SetID(label2, "SDMS_Report_SMS_PSM");
            m_manualManager.SetID(m_dataGridView, "SDMS_Report_SMS_PSM");

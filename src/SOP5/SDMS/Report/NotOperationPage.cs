...
namespace SDMS
{
    public partial class NotOperationPage : FormReportBase
    {
        ...
        private void SetManualID()
        {
            ...
            m_manualManager.SetID(this, "SDMS_Report_Process_Fire");
            m_manualManager.SetID(label2, "SDMS_Report_Process_Fire");
            m_manualManager.SetID(btnSaveHWP, "Process_Fire_ExportReport");
            m_manualManager.SetID(panelChart, "Process_Fire_Graph");
            m_manualManager.SetID(btnPreviousIndex, "Process_Fire_Graph");
            m_manualManager.SetID(btnNextIndex, "Process_Fire_Graph");
            m_manualManager.SetID(lblTotalPage, "Process_Fire_Graph");
            m_manualManager.SetID(dataGridView1, "Process_Fire_Grid");

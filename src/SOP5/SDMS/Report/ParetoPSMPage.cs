...
namespace SDMS
{
    public partial class ParetoPSMPage : FormReportBase, SDMS.Data.IParetoPage
    {
        ...
        private const string SensorChartTag = "탐\r\n지\r\n횟\r\n수";
        private const string TankChartTag = "탐\r\n지\r\n횟\r\n수";
        private const string EquipZoneChartTag = "탐\r\n지\r\n횟\r\n수";
        private const string MaterialChartTag = "탐\r\n지\r\n횟\r\n수";
        ...
        public ParetoPSMPage(Report.ReactionPSMManager detectMgr, DetectPSMPage detectPage)
        {
            ...
            FormMain.Instance.CustomizeGridView(dataGridViewTank);
            FormMain.Instance.CustomizeGridView(dataGridViewMaterial);
        ...
        private void SetSize()
        {
            ...
            foreach (DataGridViewTextBoxColumn col in dataGridViewSensor.Columns)
            {
                ...
                else if (col.Name == "colMaterial")
                    col.Width = (int)(390 * sizePer); 
            ...
            foreach (DataGridViewTextBoxColumn col in dataGridViewTank.Columns)
            {
                if (col.Name == "colNo")
                    col.Width = (int)(180 * sizePer);
                else if (col.Name == "colSensorName")
            ...
            dataGridViewTank.Font = new Font(Program.prgFont, 24.0f * sizePer);
            ...
            foreach (DataGridViewTextBoxColumn col in dataGridViewMaterial.Columns)
            {
                if (col.Name == "colNo")
                    col.Width = (int)(180 * sizePer); 
                else if (col.Name == "colMaterial")
            ...
            dataGridViewMaterial.Font = new Font(Program.prgFont, 24.0f * sizePer);
        }
        ...
        private bool GetDataFromDetectPage(ArrayList arrSelectZoneList, int nSplitUnitOfMeasure, int nSplitUnitOfMeasureDetail, DateTime startDate, DateTime endDate, int nViewCount)
        {
            ...
            if (m_detectPSMMgr.NeedRefresh(arrSelectZoneList, startDate, endDate, m_detectPSMPage.RefreshCheckData))
            {
                ...
                //그래프그리기
                m_detectPSMPage.CreateBarChart(startDate, endDate, nSplitUnitOfMeasure, nSplitUnitOfMeasureDetail);
            }
        ...
        private void EmptyChart(WinChartViewer chartViewer, DataGridView grid, string strChartTag)
        {
            ...
            int nSpace = (int)(60 * sizePer), nLeftSpace2 = (int)(160 * sizePer);
            ...
            c.xAxis().setLabelStyle(Program.prgFont, 22 * sizePer, 0xfffff);
            c.xAxis2().setLabelStyle(Program.prgFont, 22 * sizePer, 0xfffff);
            c.yAxis().setLabelStyle(Program.prgFont, 22 * sizePer, 0xfffff);
            c.yAxis2().setLabelStyle(Program.prgFont, 22 * sizePer, 0xfffff);
        ...
        private void btnPreviousIndex_Click(object sender, EventArgs e)
        {
            ...
            if (sender == m_pageSensor.NextButton)
                pageData = m_pageSensor;
            else if (sender == m_pageTank.NextButton)
                pageData = m_pageTank;
            else if (sender == m_pageEquipZone.NextButton)
                pageData = m_pageEquipZone;
            else if (sender == m_pageMaterial.NextButton)
                pageData = m_pageMaterial;
            else
                return;
        ...
        private void ParetoPSMPage_Resize(object sender, EventArgs e)
        {
            ...
            dataGridViewSensor.Size = new Size(this.Width, dataGridViewSensor.Height);
            dataGridViewMaterial.Size = new Size(this.Width, dataGridViewMaterial.Height);
            dataGridViewEquipZone.Size = new Size(this.Width, dataGridViewEquipZone.Height);
            dataGridViewTank.Size = new Size(this.Width, dataGridViewTank.Height);
            ...
            lblTotalPageMaterial.Location = new Point(panel1.Location.X + panel1.Width - lblTotalPageMaterial.Width, panel1.Location.Y + panel1.Height + 5);
            lblTotalPageTank.Location = new Point(panel1.Location.X + panel1.Width - lblTotalPageTank.Width, panel1.Location.Y + panel1.Height + 5);
        ...
        private void SetManualID()
        {
            ...
            m_manualManager.SetID(this, "SDMS_Report_Pareto_PSM");
            m_manualManager.SetID(lblTitle, "SDMS_Report_Pareto_PSM");
            m_manualManager.SetID(btnSaveHWP, "Pareto_PSM_ExportReport");
            m_manualManager.SetID(winChartViewerEquipZone, "Pareto_PSM_Graph");
            m_manualManager.SetID(winChartViewerMaterial, "Pareto_PSM_Graph");
            m_manualManager.SetID(winChartViewerTank, "Pareto_PSM_Graph");
            m_manualManager.SetID(winChartViewerSensor, "Pareto_PSM_Graph");
            m_manualManager.SetID(btnPreviousIndexEquipZone, "Pareto_PSM_Graph");
            m_manualManager.SetID(btnNextIndexEquipZone, "Pareto_PSM_Graph");
            m_manualManager.SetID(lblTotalPageEquipZone, "Pareto_PSM_Graph");
            m_manualManager.SetID(lblTotalPageSensor, "Pareto_PSM_Graph");
            m_manualManager.SetID(dataGridViewEquipZone, "Pareto_PSM_Grid");
            m_manualManager.SetID(dataGridViewSensor, "Pareto_PSM_Grid");
            m_manualManager.SetID(dataGridViewMaterial, "Pareto_PSM_Grid");
            m_manualManager.SetID(dataGridViewTank, "Pareto_PSM_Grid");

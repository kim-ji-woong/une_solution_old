...
namespace SDMS
{
    public partial class DetectIntrusionPage : FormReportBase
    {
        ...
        private Dictionary<int, Report.DetectIntrusionLog> m_dicDetectLog = null;
        ...
        public DetectIntrusionPage(Report.ReactionIntrusionManager detectMgr)
        {
            InitializeComponent();
        ...
        public void ControllCapture()
        {
            ...
            Bitmap bmp = null;
            if (m_chartDatas.Count <= 8)
            {
                // 갯수가 적어서 이미지 찌그러지는거 방지
                bmp = new Bitmap(panelChart.Width, panelChart.Height + 150);
                panelChart.DrawToBitmap(bmp, new Rectangle(0, 75, panelChart.Width, panelChart.Height));
            }
            else
            {
                bmp = new Bitmap(panelChart.Width, panelChart.Height);
        ...
        public void CreateBarChart(DateTime StartDate, DateTime EndDate, int nSplitUnitOfMeansure, int nSplitUnitOfMeansureDetail, int nViewCount, bool isLoad = false)
        {
            ...
            int nCount = (from logs in m_detectMgr.DectectList.ToArray().Cast<Report.DetectIntrusionLog>()
        ...
        */ 
        ...
        private void SetChart2()
        {
            ...
            if (m_nCurrentPage > 0)
            {
                ...
                {
                    liDatas.Add((from logs in m_detectMgr.DectectList.ToArray().Cast<Report.DetectIntrusionLog>()
            ...
            c.yAxis().setTitle("방범 탐지 횟수", "Arial Bold", 11.25);
        ...
        private void SetChart()
        {
            ...
            for (int nIndex = 0; nIndex < dicStartDetectDates[m_nCurrentPage].Length; nIndex++)
            {
                m_chartDatas.Add((from logs in m_detectMgr.DectectList.ToArray().Cast<Report.DetectIntrusionLog>()
                             where logs.Time >= dicStartDetectDates[m_nCurrentPage][nIndex]
                             && logs.Time < dicEndDetectDates[m_nCurrentPage][nIndex]
                             select logs).Count());
            }
        ...
        private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Report.DetectIntrusionLog detectLog = m_dicDetectLog[Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells[0].Value)];
        ...
        public void Load_DataGrid(Dictionary<SensorTagInfo, int> dicSensorHistories, Dictionary<UnE.Spatial.EquipmentZone, int> dicEquipZoneHistories)
        {
            ...
            if (m_dicDetectLog == null) m_dicDetectLog = new Dictionary<int, DetectIntrusionLog>();
            ...
            foreach (Report.DetectIntrusionLog historyData in from historyData in arrSensorZoneHistory.Cast<Report.DetectIntrusionLog>()
        ...
        private Dictionary<int, int> GetSensorReactionLogs()
        {
            ...
            foreach (SensorReactionIntrusionLog log in m_detectMgr.AllReactionLog)
            {
                int nSensorZoneID;
        ...
        private void comboBox_Leave(object sender, EventArgs e)
        {
            ...
            Report.DetectIntrusionLog detectLog = m_dicDetectLog[Convert.ToInt32(dataGridView1.Rows[cell.RowIndex].Cells[0].Value)];
        ...
        private void dataGridView1_MouseUp(object sender, MouseEventArgs e)
        {
            if (e.Button == System.Windows.Forms.MouseButtons.Right)
            {
                ...
                if (hitInfo.RowIndex >= 0 && hitInfo.ColumnIndex >= 0)
                {
                    ...
                    Report.DetectIntrusionLog detectLog;
        ...
        {
            Report.DetectIntrusionLog log = (Report.DetectIntrusionLog)popupMenu.Tag;

            if (log != null)
                FormMain.Instance.SelectActionIntrusionPage(log.HistoryID);
        }
        ...
        private void dataGridView1_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                if (e.ColumnIndex >= 0 && e.ColumnIndex < STATUS_INDEX && e.RowIndex >= 0)
                {
                    ...
                    if (m_dicDetectLog.TryGetValue(nLogIndex, out detectLog))
                    { 
                        FormMain.Instance.SelectActionIntrusionPage(detectLog.HistoryID);
                        int nSpace3 = 26;
                        if (FormMain.Instance.Resolution == Resolution.FullHD)
                        {
                        ...
                        FormMain.Instance.FromDetectIntrusionPageToActionIntrusionPage();
                    }
                }
            }
        }
        ...
        private void SetManualID()
        {
            ...
            m_manualManager.SetID(this, "SDMS_Report_Detect_Security");
            m_manualManager.SetID(label2, "SDMS_Report_Detect_Security");
            m_manualManager.SetID(btnSaveHWP, "Detect_Security_ExportReport");
            m_manualManager.SetID(panelChart, "Detect_Security_Graph");
            m_manualManager.SetID(btnPreviousIndex, "Detect_Security_Graph");
            m_manualManager.SetID(btnNextIndex, "Detect_Security_Graph");
            m_manualManager.SetID(lblTotalPage, "Detect_Security_Graph");
            m_manualManager.SetID(dataGridView1, "Detect_Security_Grid");

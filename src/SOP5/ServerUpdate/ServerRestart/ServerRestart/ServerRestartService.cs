...
{
    partial class ServerRestartService : ServiceBase
    {
        ...
        private System.IO.StreamWriter m_writer = new System.IO.StreamWriter("C:/temp/test.log", false, System.Text.Encoding.UTF8);
        ...
        {
            string strSQL = "Select ID, Command, TimeStamp, SearchPath, IsStop, IsStopService, StopName, IsUpdate, UpdateName, IsStart, IsStartService, StartName from SDMSCommand where Command in (3,8,9)";
            ...
            WriteLog(arrResult.Count.ToString());
        ...
        public bool Execute(SDMSAgent.CommandItem commandItem)
        {
            ...
            try
            {
                ...
                else if (type == SDMSAgent.CommandType.UPDATE)
                {
        ...
        public void RestartService(string serviceName, int timeoutMilliseconds)
        {
            ...
            catch (Exception e)
            {
                ...
                WriteLog("[ERROR] RestartService Stop: " + e.Message);
            }
            ...
            {
                WriteLog("[ERROR] RestartService Start: " + e.Message);
            }
        ...
        private bool InsertCommandHistory(SDMSAgent.CommandItem commandItem)
        {
            ...
            {
                WriteLog("[ERROR] InsertCommandHistory : " + ex.Message);
                return false;
            }
        }
        private bool RemoveCommand(SDMSAgent.CommandItem commandItem)
        {
            ...
            {
                WriteLog("[ERROR] RemoveCommand : " + ex.Message);
                return false;
            }
        }
        ...
        private bool ProcessKill(string strProcName)
        {
            ...
            {
                process[0].Kill();
                WriteLog("[INFO] Kill " + strProcName);
        ...
        private bool ProcessStart(string strProcName)
        {
            ...
            if (GetFolderNFile2(strProcName, ref strFolderPath, ref strFileName))
            {
                ...
                try
                {
                    ...
                    WriteLog("[INFO] Process Start : " + strFolderPath + strFileName);
                }
                catch (Exception ex)
                {
                    WriteLog("[ERROR] Process Start : " + ex.Message);
                    return false;
                }
            ...
            {
                WriteLog("[ERROR] Process Start : 경로 확인");
                return false;
            }
        }
        private bool ServiceStop(string strServiceName)
        {
            ...
            if (SOPChecker.ServiceManager.IsRunningSerivce(strServiceName))
            {
                ...
                WriteLog("[INFO] Service Stop : " + strServiceName);
            }
        ...
        private bool ServiceStart(string strServiceName)
        {
            try
            {
                ...
                WriteLog("[INFO] Service Start : " + strServiceName);
            }
            catch (Exception ex)
            {
                WriteLog("[ERROR] Service Start : " + ex.Message);
                return false;
            }

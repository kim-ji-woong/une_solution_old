...
namespace SOPManager
{
    public partial class PopupProcessTerm : Form
    {
        ...
        public void UpdateControlSize()
        {
            ...
            FormMain.Instance.UpdateWindowRate(groupYear, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(cboBeginYear, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(label15, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(label11, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(cboEndYear, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(label13, WindowRateWidth, WindowRateHeight);

            FormMain.Instance.UpdateWindowRate(groupDate, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(cboBeginMonth, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(label1, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(cboBeginDay, WindowRateWidth, WindowRateHeight);
            ...
            FormMain.Instance.UpdateWindowRate(cboEndMonth, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(label4, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(cboEndDay, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(label5, WindowRateWidth, WindowRateHeight);

            FormMain.Instance.UpdateWindowRate(groupTime, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(cboBeginHour, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(label10, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(cboBeginMinute, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(label8, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(label6, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(cboEndHour, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(label9, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(cboEndMinute, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(label7, WindowRateWidth, WindowRateHeight);

            FormMain.Instance.UpdateWindowRate(groupWeek, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(picSun, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(lblSun, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(picMon, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(lblMon, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(picTue, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(lblTue, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(picWed, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(lblWed, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(picThu, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(lblThu, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(picFri, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(lblFri, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(picSat, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(lblSat, WindowRateWidth, WindowRateHeight);
            ...
            FormMain.Instance.UpdateWindowRate(picYear, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(lblYear, WindowRateWidth, WindowRateHeight);

            FormMain.Instance.UpdateWindowRate(picDate, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(lblDate, WindowRateWidth, WindowRateHeight);

            FormMain.Instance.UpdateWindowRate(picTime, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(checkTime, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(lblTime, WindowRateWidth, WindowRateHeight);
        }
		...
		private PropertiesLevel m_propertiesLevel = null;
		public void SetTerm(PropertiesLevel propertiesLevel, string strValue)
        {			
			...
			m_propertiesLevel = propertiesLevel;
            UpdateCheckBox();
        }
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            if(rdoUse.Checked)
            {
                ...
                {
					UnE.Utility.UMessageBoxRibbon.Show(this, "날짜 또는 시간 옵션이 체크되어 있지 않습니다.", "확인");
                    return;
                }
            }

			PropertiesLevel propertiesLevel = m_propertiesLevel;
			if(propertiesLevel != null)
			{
				...
				m_szTerm = GetTerm(dtBeginTime, dtEndTime, nType);
        ...
        private string GetTerm(DateTime dtBegin, DateTime dtEnd, int nType)
        {
            ...
            else
            {
                ...
                {
                    case 1:
						strBegin = strBeginMonth + "/" + strBeginDay;
						strEnd = strEndMonth + "/" + strEndDay;
                        break;
                    case 2:
						strBegin = strBeginHour + ":" + strBeginMinute;
						strEnd = strEndHour + ":" + strEndMinute;
                        break;
                    case 3:
						strBegin = strBeginMonth + "/" + strBeginDay + " " + strBeginHour + ":" + strBeginMinute;
						strEnd = strEndMonth + "/" + strEndDay + " " + strEndHour + ":" + strEndMinute;
                        break;
                    case 11:
						strBegin = dtBegin.Year.ToString() + "/" + strBeginMonth + "/" + strBeginDay;
						strEnd = dtEnd.Year.ToString() + "/" + strEndMonth + "/" + strEndDay;
                        break;
                    case 12:
						strBegin = dtBegin.Year.ToString() + " " + strBeginHour + ":" + strBeginMinute;
						strEnd = dtEnd.Year.ToString() + " " + strEndHour + ":" + strEndMinute;
                        break;
                    case 13:
						strBegin = dtBegin.Year.ToString() + "/" + strBeginMonth + "/" + strBeginDay + " " + strBeginHour + ":" + strBeginMinute;
						strEnd = dtEnd.Year.ToString() + "/" + strEndMonth + "/" + strEndDay + " " + strEndHour + ":" + strEndMinute;
                        break;
                }
        ...
        {
            if (checkYear.Enabled == false) return;

            checkYear.Checked = !checkYear.Checked;
        ...
        {
            if (checkDate.Enabled == false) return;

            checkDate.Checked = !checkDate.Checked;
        ...
        {
            if (checkTime.Enabled == false) return;

            checkTime.Checked = !checkTime.Checked;
        ...
        private void UpdateCheckBox()
        {
            ...
            {
                picYear.BackgroundImage = global::SOPManager.Properties.Resources.__COMMON_ckb_enable;
            }
            else
            {
                picYear.BackgroundImage = global::SOPManager.Properties.Resources.__COMMON_ckb_disable;
            }

            if (checkYear.Enabled == true)
            {
            ...
            {
                picDate.BackgroundImage = global::SOPManager.Properties.Resources.__COMMON_ckb_enable;
            }
            else
            {
                picDate.BackgroundImage = global::SOPManager.Properties.Resources.__COMMON_ckb_disable;
            }

            if (checkDate.Enabled == true)
            {
            ...
            {
                picTime.BackgroundImage = global::SOPManager.Properties.Resources.__COMMON_ckb_enable;
            }
            else
            {
                picTime.BackgroundImage = global::SOPManager.Properties.Resources.__COMMON_ckb_disable;
            }

            if (checkTime.Enabled == true)
            {
            ...
            //Days
            if (groupWeek.Enabled == true)
            {
                this.lblSun.ForeColor = Color.White;
                this.lblMon.ForeColor = Color.White;
                this.lblTue.ForeColor = Color.White;
                this.lblWed.ForeColor = Color.White;
                this.lblThu.ForeColor = Color.White;
                this.lblFri.ForeColor = Color.White;
                this.lblSat.ForeColor = Color.White;
            }
            else
            {
                this.lblSun.ForeColor = Color.DimGray;
                this.lblMon.ForeColor = Color.DimGray;
                this.lblTue.ForeColor = Color.DimGray;
                this.lblWed.ForeColor = Color.DimGray;
                this.lblThu.ForeColor = Color.DimGray;
                this.lblFri.ForeColor = Color.DimGray;
                this.lblSat.ForeColor = Color.DimGray;
            }

            if (checkSun.Checked == true)
                picSun.BackgroundImage = global::SOPManager.Properties.Resources.__COMMON_ckb_enable;
            else
                picSun.BackgroundImage = global::SOPManager.Properties.Resources.__COMMON_ckb_disable;

            if (checkMon.Checked == true)
                picMon.BackgroundImage = global::SOPManager.Properties.Resources.__COMMON_ckb_enable;
            else
                picMon.BackgroundImage = global::SOPManager.Properties.Resources.__COMMON_ckb_disable;

            if (checkTue.Checked == true)
                picTue.BackgroundImage = global::SOPManager.Properties.Resources.__COMMON_ckb_enable;
            else
                picTue.BackgroundImage = global::SOPManager.Properties.Resources.__COMMON_ckb_disable;

            if (checkWed.Checked == true)
                picWed.BackgroundImage = global::SOPManager.Properties.Resources.__COMMON_ckb_enable;
            else
                picWed.BackgroundImage = global::SOPManager.Properties.Resources.__COMMON_ckb_disable;

            if (checkThu.Checked == true)
                picThu.BackgroundImage = global::SOPManager.Properties.Resources.__COMMON_ckb_enable;
            else
                picThu.BackgroundImage = global::SOPManager.Properties.Resources.__COMMON_ckb_disable;

            if (checkFri.Checked == true)
                picFri.BackgroundImage = global::SOPManager.Properties.Resources.__COMMON_ckb_enable;
            else
                picFri.BackgroundImage = global::SOPManager.Properties.Resources.__COMMON_ckb_disable;

            if (checkSat.Checked == true)
                picSat.BackgroundImage = global::SOPManager.Properties.Resources.__COMMON_ckb_enable;
            else
                picSat.BackgroundImage = global::SOPManager.Properties.Resources.__COMMON_ckb_disable;
        }

        private void Sun_Click(object sender, EventArgs e)
        {
            if (groupWeek.Enabled == false) return;

            checkSun.Checked = !checkSun.Checked;
            UpdateCheckBox();
        }
        ...
        private void Mon_Click(object sender, EventArgs e)
        {
            ...
            checkMon.Checked = !checkMon.Checked;
            UpdateCheckBox();
        }
        ...
        private void Tue_Click(object sender, EventArgs e)
        {
            ...
            checkTue.Checked = !checkTue.Checked;
            UpdateCheckBox();
        }
        ...
        private void Wed_Click(object sender, EventArgs e)
        {
            ...
            checkWed.Checked = !checkWed.Checked;
            UpdateCheckBox();
        }
        ...
        private void Thu_Click(object sender, EventArgs e)
        {
            ...
            checkThu.Checked = !checkThu.Checked;
            UpdateCheckBox();
        }
        ...
        private void Fri_Click(object sender, EventArgs e)
        {
            ...
            checkFri.Checked = !checkFri.Checked;
            UpdateCheckBox();
        }
        ...
        private void Sat_Click(object sender, EventArgs e)
        {
            ...
            checkSat.Checked = !checkSat.Checked;
            UpdateCheckBox();
        }
    }
}

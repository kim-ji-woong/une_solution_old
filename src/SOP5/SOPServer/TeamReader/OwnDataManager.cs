...
namespace TeamReader
{
    ...
    public class OwnDataManager
    {
        ...
        {
            bool isDeleted = SDMSServer.DataManager.Instance.RemoveEquipZoneFacilityManagers(arrMemberIDs, UnE.Sensor.IFacility.FacilityType.FIRE_SENSOR, nMemberType);
        ...
        {
            bool isDeleted = SDMSServer.DataManager.Instance.RemoveBuildingFacilityManagers(arrMemberIDs, UnE.Sensor.IFacility.FacilityType.FIRE_SENSOR, nMemberType);
        ...
        {
            bool isDeleted = SDMSServer.DataManager.Instance.RemoveEntireFacilityManagers(arrMemberIDs, UnE.Sensor.IFacility.FacilityType.FIRE_SENSOR, nMemberType);

...
namespace libSensorProcess
{
    ...
    public class FireDetectProcess : IDisposable, ProcessIF
    {
        ...
        private ProcessType mType = ProcessType.FireAlarm;
        ...
        public override string ToString()
        {
            if (TargetZone != null && TargetZone.LinkedZone != null)
            {
                ...
                if (szZoneName == TargetZone.ZoneName)
                    return "[화재]" + TargetZone.ZoneName;

                return "[화재]" + szZoneName + "/" + TargetZone.ZoneName;
            }
        ...
        public void BeginProcess()
        {
            ...
            m_FireAlarmThread.Name = "FireAlarm_ConfirmFire";
        ...
        public void ReadyProcess()
        {
            try
            {
                ProcessManager.Instance.ProcessOwner.ShowSensorAlarmInvoke(this, ReactionType.NOTIFY_FIRE);
        ...
        public void ConfirmFire()
        {
            ...
            m_arCCTVs = ProcessManager.Instance.ProcessOwner.ConfirmDisasterInvoke(this, ShowFireDetectTooltipCCTV, m_nSensorID, ReactionType.NOTIFY_FIRE, 1);
            try
            {
                /*FormMain.Instance.Invoke((MethodInvoker)delegate
                {
                ...
                try
                {
                    /*FormMain.Instance.Invoke((MethodInvoker)delegate
                    {
                        ...
                        //else
                        //{
                        //FormMain.Instance.PageHome.ShowBigCCTV(m_TargetZone.LinkedZone, 1);
                        //	PageBackstageHome.Instance.ShowBigCCTV(m_TargetZone, 1);
                        //}
                        //}
        ...
        {
            if (owner != null)
                owner.SetFireDetectModeInvoke(log);
        }
    ...
    {
        private System.Threading.Thread beepThread = null;
        ...
        public void Play()
        {
            ...
            m_bRunThread = true;
            beepThread = new Thread(RunThread);
            beepThread.Name = "BEEPThread";
            beepThread.Start();
        }

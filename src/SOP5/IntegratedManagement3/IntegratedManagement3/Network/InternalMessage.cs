...
namespace IntegratedManagement3
{
    public class InternalMessage
    {
        ...
        public static int GetInternalServerPort(DBUtility.WebDBManager dbMgr, int nSiteID)
        {
            ...
            int nPort = DBUtility.WebDBManager.GetIntField(arrResult[0].ToString(), nDefaultPort);
            return nPort;
        }
    }
}

...
namespace IntegratedManagement3
{
    public class NetworkManager
    {
        ...
        public bool RegisterUser(int nMemberID, string szID, string szPass, string szNickName, IntegratedManagement3.PopupDialog.Chief chief)
        {
            if (m_provider != null)
            {
        ...
        public bool ChangeSOPGenCommander(int szID,IntegratedManagement3.PopupDialog.Chief pchief)
        {
            if (m_provider != null)
            {
                return m_provider.SendChangeSOPGenCommander(szID,pchief);
            }
            return false;
        }

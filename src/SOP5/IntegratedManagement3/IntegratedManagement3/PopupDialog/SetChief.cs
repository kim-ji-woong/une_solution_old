...
namespace IntegratedManagement3.PopupDialog
{
    public partial class SetChief : Form
    {
        ...
        private void UpdateRadioButtons()
        {
            ...
            {
                picDay.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__COMMON_ckb_enable;                
            }
            else
            {
                picDay.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__COMMON_ckb_disable;
            }

            if (m_chief.DayLight_Night == true)
            {
                picNight.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__COMMON_ckb_enable;  
            }
            else
            {
                picNight.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__COMMON_ckb_disable;  
            }
            ...
            if(m_chief.SOPTYPE == PopupDialog.SOPTeamType.Regular || m_chief.SOPTYPE == SOPTeamType.RegularMember)
            {
                ...
                picRegular.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Enable2;
                picExternal.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
                picUserDefined.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
                picNormal.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
                picHoliday.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
            }
            else if(m_chief.SOPTYPE == PopupDialog.SOPTeamType.External || m_chief.SOPTYPE == SOPTeamType.ExternalMember)
            {
                treeViewTeam.Size = new Size((int)(189*WindowRateWidth), (int)(321*WindowRateHeight));
                picRegular.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
                picExternal.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Enable2;
                picUserDefined.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
                picNormal.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
                picHoliday.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
            }
            else if(m_chief.SOPTYPE == PopupDialog.SOPTeamType.UserDefined)
            {
                ...
                picRegular.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
                picExternal.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
                picUserDefined.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Enable2;
                picNormal.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
                picHoliday.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
            }
            else if(m_chief.SOPTYPE == PopupDialog.SOPTeamType.Normal)
            {
                ...
                picExternal.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
                picUserDefined.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
                picNormal.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Enable2;
                picHoliday.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
            }
            else if(m_chief.SOPTYPE == PopupDialog.SOPTeamType.Holiday)
            {
                ...
                picUserDefined.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
                picNormal.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
                picHoliday.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Enable2;
            }
        }
        ...
        private void DisplayExternalTeam()
        {
            ...
            for (int i = 0; i < nResultCount - 3; i += 4)
            {
                ...
                string szTeamName = DBUtility.WebDBManager.GetStringField(arrResult[i + 1], "");
                int nParentTeamID = DBUtility.WebDBManager.GetIntField(arrResult[i + 2].ToString(), -1);
                String nPhoneNumber = DBUtility.WebDBManager.GetStringField(arrResult[i + 3].ToString(), "");
        ...
        private bool LoadUserDefinedTeam()
        {
            ...
            ArrayList arrResults = m_dbMgr.GetResultData(strSQL, 0);

...
using DBUtility;
using System.IO;
using IntegratedManagement3.PopupDialog;
...
namespace IntegratedManagement3
{
	public partial class FormMain : Form
	{
        ...
        public IntegratedManagement3.ExecuteManager ExecuteManager
        {
            get { return m_exeMgr; }
        }
		...
		public FormMain()
		{
            ...
            UnE.Utility.UMessageBoxRibbon.CloseButtonImage = global::IntegratedManagement3.Properties.Resources.Close_40_40_Default;
            UnE.Utility.UMessageBoxRibbon.CloseButtonOverImage = global::IntegratedManagement3.Properties.Resources.Close_40_40_Click;
        ...
        private bool CheckSDMSwithSOPSimulator()
        {
            ...
            string strValue = DBUtility.WebDBManager.GetStringField(arrResult[0].ToString());
        ...
        {
            EtcButton btnMessenger = //new EtcButton(this, global::IntegratedManagement3.Properties.Resources.sopmessanger, "메시지 전송", m_btnFirst, m_labelFirst, 70, 0, IntegratedManagement3.ExecuteManager.APP_TYPE.SOP_MESSANGER);
                new EtcButton(
                    this,
                    global::IntegratedManagement3.Properties.Resources.sopmessanger,
                    global::IntegratedManagement3.Properties.Resources.sopmessanger,
                    "메세지 전송",m_btnFirst, m_labelFirst, 0, 0, IntegratedManagement3.ExecuteManager.APP_TYPE.SOP_MESSANGER
                    );

            EtcButton btnWeather = //new EtcButton(this, global::IntegratedManagement3.Properties.Resources.weather, "기후입력", m_btnSecond, m_labelSecond, 65, 18, IntegratedManagement3.ExecuteManager.APP_TYPE.SOP_WEATHER);
                new EtcButton(
                    this,
                     global::IntegratedManagement3.Properties.Resources.weather,
                      global::IntegratedManagement3.Properties.Resources.weather,
                      "기후입력", m_btnSecond, m_labelSecond, 0, 0, IntegratedManagement3.ExecuteManager.APP_TYPE.SOP_WEATHER
                    );
        ...
        private void InitPosition()
		{
			...
			btnEtc.Tag = ExecuteManager.APP_TYPE.ETC;
            btnSDMS.Tag = SDMSwithSOPSimulator ? ExecuteManager.APP_TYPE.SOP_SIMULATOR : ExecuteManager.APP_TYPE.SDMS;     //변경
		...
		private void SetFindPasswordControlMode(bool initMode)
		{
			...
			if (initMode)
			{
				...
				labelID2.Text = "아 이 디";				
                btnFindPasswordNext.NormalImage = global::IntegratedManagement3.Properties.Resources.btnNext;
                btnFindPasswordNext.MouseOverImage = global::IntegratedManagement3.Properties.Resources.btnNextClick;
                btnFindPasswordNext.ClickedImage = global::IntegratedManagement3.Properties.Resources.btnNextClick;
			...
			else
			{
                ...
                btnFindPasswordNext.NormalImage = global::IntegratedManagement3.Properties.Resources.btnOK;
                btnFindPasswordNext.MouseOverImage = global::IntegratedManagement3.Properties.Resources.btnOKClick;
                btnFindPasswordNext.ClickedImage = global::IntegratedManagement3.Properties.Resources.btnOKClick;
		...
		private void SetRegistControlMode(bool initMode)
		{
			...
			if (initMode)
			{
                ...
                btnRegistNext.NormalImage = global::IntegratedManagement3.Properties.Resources.btnNext;
                btnRegistNext.MouseOverImage = global::IntegratedManagement3.Properties.Resources.btnNextClick;
                btnRegistNext.ClickedImage = global::IntegratedManagement3.Properties.Resources.btnNextClick;
        ...
        {
            if (type == IntegratedManagement3.ExecuteManager.APP_TYPE.SOP_MANAGER)
            {
                btn = btnSOPManager;
                label = labelSOPManager;
            }
            //else if (type == IntegratedManagement3.ExecuteManager.APP_TYPE.SOP_SIMULATOR)
            //{
            //    btn = btnSOPSimulator;
            //    label = labelSOPSimulator;
            //}
            else if (type == IntegratedManagement3.ExecuteManager.APP_TYPE.TEAM_MANAGER)
            {
                btn = btnTeamManager;
                label = labelTeamManager;
            }
            else if (type == IntegratedManagement3.ExecuteManager.APP_TYPE.ETC)
            {
                btn = btnEtc;
                label = labelEtc;
            }
            else if (type == IntegratedManagement3.ExecuteManager.APP_TYPE.SDMS)
            {
                btn = btnSDMS;
                label = labelSDMS;
            }
		...
		{
            //((RibbonButton)btnLogin).NormalImage = global::IntegratedManagement3.Properties.Resources.button;
            //((RibbonButton)btnRegist).NormalImage = global::IntegratedManagement3.Properties.Resources.button;
            //((RibbonButton)btnFindPassword).NormalImage = global::IntegratedManagement3.Properties.Resources.button;
            //((RibbonButton)btnSOPManager).NormalImage = global::IntegratedManagement3.Properties.Resources.sopmanager2;
            //((RibbonButton)btnSOPSimulator).NormalImage = global::IntegratedManagement3.Properties.Resources.sopsimulator;
            //((RibbonButton)btnTeamManager).NormalImage = global::IntegratedManagement3.Properties.Resources.teammanager;
            //((RibbonButton)btnEtc).NormalImage = global::IntegratedManagement3.Properties.Resources.etc;
            //((RibbonButton)btnSDMS).NormalImage = global::IntegratedManagement3.Properties.Resources.sdms;
            //((RibbonButton)btnLogout).NormalImage = global::IntegratedManagement3.Properties.Resources.button;
            //((RibbonButton)btnChangePassword).NormalImage = global::IntegratedManagement3.Properties.Resources.button;
            //((RibbonButton)btnRegistOK).NormalImage = global::IntegratedManagement3.Properties.Resources.button;
            //((RibbonButton)btnRegistCancel).NormalImage = global::IntegratedManagement3.Properties.Resources.button;

            ////btnRegist.Size = new Size(135, 44);
            //((RibbonButton)btnLogin).MouseOverBkgndImage = global::IntegratedManagement3.Properties.Resources.RibbonMouseOver_bkgnd;
            //((RibbonButton)btnRegist).MouseOverBkgndImage = global::IntegratedManagement3.Properties.Resources.RibbonMouseOver_bkgnd;
            //((RibbonButton)btnFindPassword).MouseOverBkgndImage = global::IntegratedManagement3.Properties.Resources.RibbonMouseOver_bkgnd;
            //((RibbonButton)btnSOPManager).MouseOverBkgndImage = global::IntegratedManagement3.Properties.Resources.RibbonMouseOver_bkgnd;
            //((RibbonButton)btnSOPSimulator).MouseOverBkgndImage = global::IntegratedManagement3.Properties.Resources.RibbonMouseOver_bkgnd;
            //((RibbonButton)btnTeamManager).MouseOverBkgndImage = global::IntegratedManagement3.Properties.Resources.RibbonMouseOver_bkgnd;
            //((RibbonButton)btnEtc).MouseOverBkgndImage = global::IntegratedManagement3.Properties.Resources.RibbonMouseOver_bkgnd;
            //((RibbonButton)btnSDMS).MouseOverBkgndImage = global::IntegratedManagement3.Properties.Resources.RibbonMouseOver_bkgnd;
            //((RibbonButton)btnLogout).MouseOverBkgndImage = global::IntegratedManagement3.Properties.Resources.RibbonMouseOver_bkgnd;
            //((RibbonButton)btnChangePassword).MouseOverBkgndImage = global::IntegratedManagement3.Properties.Resources.RibbonMouseOver_bkgnd;
            //((RibbonButton)btnRegistOK).MouseOverBkgndImage = global::IntegratedManagement3.Properties.Resources.RibbonMouseOver_bkgnd;
            //((RibbonButton)btnRegistCancel).MouseOverBkgndImage = global::IntegratedManagement3.Properties.Resources.RibbonMouseOver_bkgnd;
        ...
        private System.Windows.Forms.Timer m_loginTimer = null;
        private int m_nLoginTimer = 60;
		...
		private void btnLogin_Click(object sender, EventArgs e)
		{
			...
			if (!m_logInMgr.LogIn(textBoxID.Text, textBoxPassword.Text))
			{
                ...
                {
                    DialogResult dialog = UnE.Utility.UMessageBoxRibbon.Show("SOP서버가 연결되어 있지 않습니다.\n서버를 재시작하시겠습니까?", "로그인 경고", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                    ...
                    System.Diagnostics.Trace.WriteLine(DateTime.Now.ToString("HH:mm:ss") + " Form Start");
                    restartPop.StartPosition = FormStartPosition.CenterParent;
                    restartPop.TopLevel = true;
                    restartPop.ShowDialog();
                    
                    //int timerInterval = 0;
                    //m_loginTimer = new System.Windows.Forms.Timer();
                    //m_loginTimer.Interval = 1000;
                    //m_loginTimer.Start();
                    //m_loginTimer.Tick += (se, ee) =>
                    //{
                    //    timerInterval++;
                    //    if (timerInterval >= m_nLoginTimer || m_NetMgr.ClientProvider.IsConnected)
                    //    {
                    //        m_loginTimer.Stop();
                    ...
                    //System.Diagnostics.Trace.WriteLine(DateTime.Now.ToString("HH:mm:ss") + " ReleaseThread");
                    //m_NetMgr.ReleaseThread();
                    //System.Diagnostics.Trace.WriteLine(DateTime.Now.ToString("HH:mm:ss") + " ReleaseThread End");
                    

                    //System.Diagnostics.Trace.WriteLine(DateTime.Now.ToString("HH:mm:ss") + " StartThread");
                    //m_NetMgr.StartThread();
                    //System.Diagnostics.Trace.WriteLine(DateTime.Now.ToString("HH:mm:ss") + " StartThread End");
                    //System.Diagnostics.Trace.WriteLine(DateTime.Now.ToString("HH:mm:ss") + " " + m_NetMgr.ClientProvider.IsConnected);

                    if (!restartPop.IsServerRestarted)
                    {
                        UnE.Utility.UMessageBoxRibbon.Show("SOP서버 재시작 실패", "로그인 경고", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);                        
                    }
                    else
                    {
                        m_needLogin = true;
        ...
        public void FailChangeSOPGenUserCommander(int nType)
        {
            if (nType == -1)
            {                
        ...
        private void UpdateRadioButtonImage()
        {
            if (radioChangePassword.Checked)
            {
                picChangePassword.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Enable2;
                picChangeNickName.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
                picChiefChange.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
            }
            else if (radioChangeNickName.Checked)
            {
                picChangePassword.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
                picChangeNickName.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Enable2;
                picChiefChange.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
            }
            else if(rdoChiefChange.Checked)
            {
                picChangePassword.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
                picChangeNickName.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Disable2;
                picChiefChange.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__SOPEDIT_Enable2;
            }
        }
        ...
        private void ckbSaveID_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                picSaveID.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__COMMON_ckb_disable;
            ...
            {
                picSaveID.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__COMMON_ckb_enable;
        ...
        private void ckbAutoLogin_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                picAutoLogin.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__COMMON_ckb_enable;

                DBUtility.RegUtil.WriteRegValue("IntegratedManager", "AutoLogin", "1", m_nSiteID);
            }
            else
            {
                picAutoLogin.BackgroundImage = global::IntegratedManagement3.Properties.Resources.__COMMON_ckb_disable;
        ...
        private void btnRegNext(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (txtAddNickName.Text.Length == 0)
                {
                    txtAddNickName.Focus();
                    throw new ApplicationException("별명이 설정되지 않았습니다.");
                }
                ...
                m_strNickName = txtAddNickName.Text.Trim();

                pnlMemberAdd.Visible = false;
                pnlMemberAdd2.Visible = true;
            }
            catch (Exception ex)
            {
                UnE.Utility.UMessageBoxRibbon.Show(ex.Message, "알림", MessageBoxButtons.OK, MessageBoxIcon.Information);

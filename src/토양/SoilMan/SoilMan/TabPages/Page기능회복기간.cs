...
{
    public partial class Page기능회복기간 : Form, IGridPage
    {
        ...
        private GridManager기능회복기간 m_gridMgr = null;
        ...
        public Page기능회복기간()
        {
            ...
            m_gridMgr = new GridManager기능회복기간("[토양정화기술별 기능회복기간]", dataGridView1);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            GridManager기능회복기간 m_gridMgr2 = new GridManager기능회복기간("[토양정화기술별 기능회복기간_Default]", dataGridView1);
        ...
        private void Page기능회복기간_Load(object sender, EventArgs e)
        {
    ...
    class GridManager기능회복기간 : GridManager
    {
        public GridManager기능회복기간(string strSectionName, UnE.Controls.MergedDataGridView grid)
        ...
        public override void ResetAmount(int nRowIndex)
        {
            ...
            for (int i = Page기능회복기간.BioIndex; i <= Page기능회복기간.HeatIndex; i++)
            {
                DataGridViewCell cell = row.Cells[i];

...
{
    public partial class Page가구수면적 : Form, IGridPage
    {
        ...
        private GridManager가구수면적 m_gridMgr = null;
        ...
        public Page가구수면적()
        {
            ...
            m_gridMgr = new GridManager가구수면적("[지역별가구수및면적]", dataGridView1);
            m_gridMgr.ReadConfig(Application.StartupPath + "\\Config.ini");
            TabPageManager.Instance.InitStyle(this, dataGridView1, checkBoxEditMode, btnSave, labelUnitInfo, "단위 : 호");
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            GridManager가구수면적 m_gridMgr2 = new GridManager가구수면적("[지역별가구수및면적_Default]", dataGridView1);
    ...
    class GridManager가구수면적 : GridManager
    {
        public GridManager가구수면적(string strSectionName, UnE.Controls.MergedDataGridView grid)
        ...
        public override void ResetAmount(int nRowIndex)
        {
            ...
            for (int i = Page가구수면적.계량지표NameIndex; i <= Page가구수면적.RiceFieldIndex; i++)
            {
                DataGridViewCell cell = row.Cells[i];

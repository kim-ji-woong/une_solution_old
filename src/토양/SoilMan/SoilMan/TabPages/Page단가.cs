...
{
    public partial class Page단가 : Form, IGridPage
    {
        ...
        private GridManager단가 m_gridMgr = null;
        ...
        public Page단가()
        {
            ...
            m_gridMgr = new GridManager단가("[토양정화기술 단가]", dataGridView1);
            m_gridMgr.ReadConfig(Application.StartupPath + "\\Config.ini");
            TabPageManager.Instance.InitStyle(this, dataGridView1, checkBoxEditMode, btnSave, labelUnitInfo, "단위 : 억원/ha");
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            GridManager단가 m_gridMgr2 = new GridManager단가("[토양정화기술 단가_Default]", dataGridView1);
        ...
        public DataGridViewCell GetFunctionData(TechType techType)
        {
            ...
            return dataGridView1.Rows[0].Cells[nColumnIndex];
        }

        private void Page단가_Load(object sender, EventArgs e)
        {
    ...
    class GridManager단가 : GridManager
    {
        public GridManager단가(string strSectionName, UnE.Controls.MergedDataGridView grid)
        ...
        public override void ResetAmount(int nRowIndex)
        {
            ...
            for (int i = Page단가.BioIndex; i <= Page단가.HeatIndex; i++)
            {
                DataGridViewCell cell = row.Cells[i];

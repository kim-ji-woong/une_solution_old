...
namespace SOPManager
{
    public partial class PopupBroadcastMessage : Form
    {
        ...
        private void InitText()
        {
            ...
            SetSiren(sectionData.UseSiren);
            picUseSiren.Visible = lblSiren.Visible = rbBtnBroadcast.Checked;
        ...
        public void SaveData()
        {
            ...
            if (sectionData.UseSiren != m_useSiren)
            {
                SaveSnapShot("내부상황전파 변경");
                m_propertiesInternal.SirenConfig = m_useSiren ? UsingType.TypeList[1] : UsingType.TypeList[0];
                bChangedData = true;
            }
        ...
        private void MobileMessage_Click(object sender, EventArgs e)
        {
            ...
            picUseSiren.Visible = lblSiren.Visible = false;
        ...
        private void BroadcastMessage_Click(object sender, EventArgs e)
        {
            ...
            rbBtnBroadcast.Checked = true;
            picUseSiren.Visible = lblSiren.Visible = true;
        ...
        private void UseSiren_Click(object sender, EventArgs e)
        {
            SetSiren(!m_useSiren);
        }

        public void SetSiren(bool use)
        {
            m_useSiren = use;
            
            if (m_useSiren)
                picUseSiren.BackgroundImage = global::SOPManager.Properties.Resources.__COMMON_ckb_enable;
            else
                picUseSiren.BackgroundImage = global::SOPManager.Properties.Resources.__COMMON_ckb_disable;

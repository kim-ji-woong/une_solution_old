...
namespace SensorMonitor
{
	...
	public class Reciver
	{
		...
		private Dictionary<int, Curcuit> m_dicCurcuitList = new Dictionary<int, Curcuit>();
		public Dictionary<int, Curcuit> Curcuits
		{
        ...
        // 서버에게 마지막으로 발송한 Poll 상태
        // -1 : 발송한적 없음
        // 0 : Poll 수신 안됨
        // 1 : Poll 수신 완료
        private int m_nPrevPoll = -1;
        public int PrevPoll
        {
            get { return m_nPrevPoll; }
            set { m_nPrevPoll = value; }
        }
    }

...
namespace TeamEditor.Command
{
    public class CommandChangeExternalMemberInfo : CommandEx
    {
        ...
        private void UpdateDB(WebDBManager dbMgr)
        {
            ...
            ArrayList arrResult = dbMgr.GetResultData(_strSQL);
        }
        ...
        private string GetJobLevelIDString(WebDBManager dbMgr, string strJobLevel, int nTransaction)
        {
            ...
            arrResult = nTransaction != 0 ? dbMgr.GetBatchData(strSQL) : dbMgr.GetResultData(strSQL);//dbMgr.GetResultData(strSQL, nTransaction);
        ...
        private string GetJobPositionIDString(WebDBManager dbMgr, string strJobPosition, int nTransaction)
        {
        ...
        private int GetExternalJobLevel(WebDBManager dbMgr, int nTransaction, ExternalCompanyMember.ExternalJobLevelInfo externalJobLevel)
        {
        ...
        private int GetExternalJobPosition(WebDBManager dbMgr, int nTransaction, ExternalCompanyMember.ExternalJobPositionInfo externalJobPosition)
        {
        ...
        private bool ReadExternalCompanyMemberInfo(WebDBManager dbMgr, string strSQLLower)
        {

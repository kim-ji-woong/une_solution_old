...
namespace TeamEditor.Command
{
    public class CommandRemoveUserDefinedTeam : CommandEx
    {
        ...
        public List<string> RemoveDB(WebDBManager dbMgr, string strUserDefinedTeamIDs)
        {
            m_rollbackSQLs.Clear();
        ...
        private List<string> RemoveUserDefinedTeam(WebDBManager dbMgr, string strUserDefinedTeamIDs)
        {
            ...
            for (int i = 0; i < nResultCount - 3; i += 4)
            {
                ...
                string strPhoneNumber = WebDBManager.GetStringField(arrResult[i + 2].ToString(), null);
                string strFaxNumber = WebDBManager.GetStringField(arrResult[i + 3].ToString(), null);
        ...
        private List<string> RemoveActionStepUsingUserDefinedTeam(WebDBManager dbMgr, string strUserDefinedTeamIDs)
        {
            List<string> insertList = new List<string>();
            ...
            {
                int nID = WebDBManager.GetIntField(arrResult[i].ToString(), -1);
                int nActionStepHistoryID = WebDBManager.GetIntField(arrResult[i + 1].ToString(), -1);
                int nUserDefinedTeamID = WebDBManager.GetIntField(arrResult[i + 2].ToString(), -1);
                string strPhoneNumber = WebDBManager.GetStringField(arrResult[i + 3], null);
                string strUserName = WebDBManager.GetStringField(arrResult[i + 4], null);

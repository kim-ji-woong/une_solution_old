...
namespace TeamEditor.Command
{
    public abstract class CommandEx : UnE.Command.Command
    {
        ...
        public abstract void SaveDB(WebDBManager dbMgr, bool dir);

        // TeamEditor에서 변경사항이 생겼음을 SOP Server에게 알린다.
        protected void UpdateConfig(WebDBManager dbMgr, SOP.SDMSConfig.ConfigType type)
        {
        ...
        // TeamEditor에서 변경사항이 생겼음을 SOP Server에게 알린다.
        /*protected bool UpdateConfig(WebDBManager dbMgr, SOP.SDMSConfig.ConfigType type)
        {

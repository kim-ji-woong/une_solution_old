...
namespace TeamEditor.Command
{
    public class CommandMoveExternalMembers : CommandEx
    {
        ...
        public override void Do()
        {
            ...
            foreach (ExternalCompanyMember item in members2)
            {
        ...
        public override void RollBack()
        {
            ...
            foreach (ExternalCompanyMember item in members)
            {
        ...
        private void UpdateExternalMemberList(WebDBManager dbMgr, ExternalTeam team)
        {
            if (team == null)
                return;

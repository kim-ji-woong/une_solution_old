...
namespace TeamEditor.Command
{
    ...
    public class CommandUpdateRegularMembers : CommandEx
    {
        ...
        private void AddTemporaryTeams(List<Team> newTemporaryTeams, bool isNormal)
        {
            ...
            TeamTreeView teamTreeView = isNormal ? FormMain.Instance.TemporaryNormalTeamTree : FormMain.Instance.TemporaryEmergencyTeamTree;
        ...
        private TreeNode AddTemporaryTeam(Team team, bool isNormal, TeamTreeView tree)
        {
        ...
        private bool RemoveTemporaryTeam(Team team, bool isNormal, TeamTreeView tree)
        {
            List<Team> teamList = new List<Team>();

        ...
        public override void RollBack()
        {
            ...
            if (m_isNewMember)
            {
                ...
                { 
                    ...
                    if (m_team == null)
                        members = DataManager.GetRegularMembers(TempTeam);
                    else
                        members = DataManager.GetRegularMembers(m_team);
                ...
                case InfoType.OfficePhoneNumber:
                     {
                         if (data is TeamGrid.OfficePhoneNumber)
                        {
                            ...
                            DataManager.SetCompanyMemberOfficePhoneNumberChanged(m_member, phone.IsChanged);
                        }
                        else // if(data == null)
                        {
                            m_member.OfficePhoneNumber = null;

                            DataManager.SetCompanyMemberOfficePhoneNumberChanged(m_member, !DataManager.GetCompanyMemberOfficePhoneNumberChanged(m_member));
                        }
                    }
                    break; 

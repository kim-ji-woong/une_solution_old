...
namespace TeamEditor.Popup
{
    public partial class FormRegularMember : Form
    {
        ...
        {
            FormMain.Instance.UpdateWindowRate(treeRegularTeam, WindowRateWidth, WindowRateHeight);
            FormMain.Instance.UpdateWindowRate(gridCompanyMember, WindowRateWidth, WindowRateHeight);
        ...
        private void _ShowGrid(bool showGrid)
        {
            if (showGrid)
            {
                ...
                treeRegularTeam.Location = new Point((int)(m_initTreeLocation.X * WindowRateWidth), (int)(m_initTreeLocation.Y * WindowRateHeight));
                treeRegularTeam.Size = new Size((int)(m_initTreeSize.Width * WindowRateWidth), this.Size.Height - 6);
            ...
            else
            {
                ...
                treeRegularTeam.Location = new Point((int)(m_initTreeLocation.X * WindowRateWidth), (int)(m_initGridLocation.Y * WindowRateHeight));
            ...
            gridCompanyMember.Location =new Point((int)(m_initGridLocation.X * WindowRateWidth) , (int)(m_initGridLocation.Y * WindowRateHeight));
        }

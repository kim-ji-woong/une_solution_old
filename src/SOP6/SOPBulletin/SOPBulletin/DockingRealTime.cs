...
namespace SOPBulletin
{
    public partial class DockingRealTime : Form
    {
        ...
        {
            string strSQL = "Select PropertyName, PropertyValue from OptionSOPSimulator where SiteID = " + FormMain.Instance.DBManager.SiteID.ToString();
        ...
        public void WriteGridSize(int nMonitor)
        {
            ...
            writer.WriteLine(string.Format("siteid ={0}", FormMain.Instance.DBManager.SiteID));
            writer.Close();
        }
        ...
        private void SaveHwp_ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialog1.ShowDialog() == DialogResult.OK)*/
            {
                ...
                info.Arguments = SavePath + " " + logoFileName + " " + FormMain2.Instance.DBManager.SiteID; 

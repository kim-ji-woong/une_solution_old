...
namespace SOPBulletin
{
    ...
    public class IOManager
    {
        ...
        private string GetTeamList(WebDBManager dbMgr, string strTeamList, Sections.SectionData sectionData, ref Dictionary<int, string> dicNormal, ref Dictionary<int, string> dicEmergency, ref Dictionary<int, string> dicUserDefined, ref Dictionary<int, Sections.ExternalTeamData> dicExternal, ref Dictionary<int, string> dicRegular, ref Dictionary<int, string> dicControlRoom)
        {
            int nBeginIndex = 0;
        ...
        private bool ReadTeamList(WebDBManager dbMgr, string strTableName, Dictionary<int, string> dicTeamName)
        {
            ...
            {
                Dictionary<int, Data_ControlRoom> dicControlRoom = FormMain.Instance.SOPManager.ControlRoom;
        ...
        private SectionCommanderEx GetSectionCommander(WebDBManager dbMgr, int nCommanderMemberType, int nCommanderMemberID, string strDisplayText)
        {
            ...
            else
            {
                ...
                else if (nCommanderMemberType == 4)
                {
                    ...
                    if(commander.DisplayText.Length > 0)
                    {
        ...
        public bool LoadSections(WebDBManager dbMgr, int nStepMemberID, Dictionary<int, Sections.Section> dicSections, Sections.PanelSection panel)
        {
            ...
            if (!LoadProcess(dbMgr, nStepMemberID, dicSections, panel, ref dicNormal, ref dicEmergency, ref dicUserDefined, ref dicExternal, ref dicRegular, ref dicControlRoom))
                return false;
            ...
            if (!LoadTransSOP(dbMgr, nStepMemberID, dicSections, panel))
                return false;
            if (!LoadInternal(dbMgr, nStepMemberID, dicSections, panel, ref dicNormal, ref dicEmergency, ref dicUserDefined, ref dicExternal, ref dicRegular, ref dicControlRoom))
                return false;

...
namespace CCTVAlarmWatcher
{
    public class NetworkWebManager : IPostMan
    {
        ...
        private int m_nClientSubType = SOPWebServer.ClientSubType.EMPOLL;
        ...
        private const string APP_NAME = "SaintopEventReceiver";
        ...
        protected NetworkWebManager()
        {
            ...
            if (ReadSiteID())
            {
                ...
                AlarmManager.Instance.ReadCCTVList(m_dbMgr, m_nSiteID);
            }
        ...
        {
            int nSensorType = CCTVAlarm.SensorType;
            int nData = 1;

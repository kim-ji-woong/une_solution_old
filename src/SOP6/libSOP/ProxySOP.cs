...
namespace UnE
{
    namespace SOP
    {
        ...
        public class ProxySOP
        {
            ...
            /// <summary>
            /// 센서탐지시 실행중인 SOP가 없는경우 연결된 SOP 자동 열기
            /// </summary>
            private bool bOpenSOPOnSensorDetect = true;
            public bool OpenSOPOnSensorDetect
            {
                get { return bOpenSOPOnSensorDetect; }
                set { bOpenSOPOnSensorDetect = value; }
            }
            ...
            /// <summary>
            /// SDMS에서 온/습도 관련 기능 사용 여부
            /// </summary>
            private bool bUseTH = false;
            public bool UseTH
            {
                get { return bUseTH; }
                set { bUseTH = value; }
            ...
            /// SDMS에서 방화벽 기능 사용 여부
            /// </summary>
            private bool bUseFirewall = false;
            public bool UseFirewall
            {
                get { return bUseFirewall; }
                set { bUseFirewall = value; }
            }

            /// <summary>
            /// SDMS에서 출입문 기능 사용 여부
            /// </summary>
            private bool bUseDoor = false;
            public bool UseDoor
            {
                get { return bUseDoor; }
                set { bUseDoor = value; }
            ...
            /// SDMS에서 정전 기능 사용 여부
            /// </summary>
            private bool bUseBlackout = false;
            public bool UseBlackout
            {
                get { return bUseBlackout; }
                set { bUseBlackout = value; }
            }

            /// <summary>
            /// SDMS에서 강풍 기능 사용 여부
            /// </summary>
            private bool bUseStrongWind = false;
            public bool UseStrongWind
            {
                get { return bUseStrongWind; }
                set { bUseStrongWind = value; }
            }

            /// <summary>
            /// SDMS에서 테러 기능 사용 여부
            /// </summary>
            private bool bUseTerror = false;
            public bool UseTerror
            {
                get { return bUseTerror; }
                set { bUseTerror = value; }
            }

            /// <summary>
            /// SDMS에서 침수 기능 사용 여부
            /// </summary>
            private bool bUseSubmergency = false;
            public bool UseSubmergency      
            {
                get { return bUseSubmergency; }
                set { bUseSubmergency = value; }
            }

            private bool bUseCorona = false;
            public bool UseCorona
            {
                get { return bUseCorona; }
                set { bUseCorona = value; }
            }

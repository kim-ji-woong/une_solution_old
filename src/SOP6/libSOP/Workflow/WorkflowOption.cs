...
namespace UnE.SOP.Workstate
{
    public class WorkflowOption
    {
        ...
        // SOP 시작/종료시 전체 안내 문자메시지를 보낼것인가?
        protected bool m_useSmsMessage = false;
        ...
        protected string m_strAlarmMessage = "";
    ...
    public class WorkflowOptionPSM : WorkflowOption
    {
        ...
        private PSMMaterial LoadPSMMaterial(string strMaterialName)
        {
            ...
            System.Collections.ArrayList arrResult = UnE.SOP.ProxySOP.Instance.DBManager.GetResultData(strSQL);
    ...
    // 강풍
    public class WorkflowOptionWind : WorkflowOption
    {
        ...
        public WorkflowOptionWind()
        {
            m_strDisasterName = "강풍";
        }
        ...
        public override string GetDisasterTypeString()
        {
            ...
            strDisasterType = "[" + m_strDisasterName + ":wSpeed/" + m_fWindSpeed.ToString() + "]";
        ...
        public override void SetDisasterOptions(string strDisasterOptions)
        {
            ...
            for (int i = 0; i < nTokenCount; i++)
            {
                if (GetDisasterTypeInfo(tokens[i], out strDisasterName, out strTagName, out strTagValue))
                {
                    ...
                    {
                        if (strTagName == "wSpeed")
                        {
                            float.TryParse(strTagValue.Trim(), out m_fWindSpeed);
                        }
                    }
                }
            }

...
namespace UnE.SOP.Log
{
    public interface ISOPLogContainer
    {
        ...
        /// </param>
        void AddSOPSectionLog(int nActionStepID, int nActionStepHistoryID, ArrayList arrComponentHistoryID, ArrayList arrSections, ArrayList arrStatus, ArrayList arrProcessDirections, ArrayList arrTask, ArrayList arrTime, ArrayList arrDescription, ArrayList arrShowBoard, ArrayList arrCheckedNotify1, ArrayList arrCheckedNotify2, ArrayList arrCheckedRun, ArrayList arrCheckedComplete, ArrayList arrAccessedUserID, bool isRealMode, Dictionary<int, List<HistorySectionData.DetailData>> dicDetailDatas, WorkFlow workFlow);

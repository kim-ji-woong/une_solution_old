...
namespace UnE.SOP.Sections
{
    ...
    //public partial class SectionTabControl : TabControl
    {
        ...
        public void AddTabPage(SectionTabPage page)
        {
            ...
            if ( page.Text == SectionTabControl.StandardActionStepName[0]/*"예방"*/)
            {
                this.TabPages.Insert(0, page);
            }
            else if( page.Text == SectionTabControl.StandardActionStepName[1]/*"대비"*/)
            {
                this.TabPages.Insert(1, page);
            }
            else if( page.Text == SectionTabControl.StandardActionStepName[2]/*"대응"*/)
            {              
                this.TabPages.Insert(2, page);
            }
            else if( page.Text == SectionTabControl.StandardActionStepName[3]/*"복구"*/)
            {

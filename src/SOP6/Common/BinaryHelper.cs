...
namespace SOPWebServer
{
    public class BinaryHelper
    {
        ...
        public static byte[] MakeBytes(ArrayList arrDatas)
        {
            ...
            _bytes[0] = lengthBytes[0];
            _bytes[1] = lengthBytes[1];
            _bytes[2] = lengthBytes[2];
            _bytes[3] = lengthBytes[3];
        ...
        public static ArrayList ReadBytes(byte[] bytes)
        {
            ...
            int nChunkCount = BitConverter.ToInt32(bytes, 0);
            ...
            for (int i = 0; i < nChunkCount; i++)
            {
                ...
                else if (type == BinaryType.BOOLEAN)
                {

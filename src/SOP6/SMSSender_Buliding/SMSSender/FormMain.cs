...
namespace SMSSender
{
    public partial class FormMain : Form
    {
        ...
        private WebDBManager m_dbMgr = new WebDBManager(LoadSiteID());
        ...
        private VariousData<Point> m_startLocation = null;
        ...
        {
            set { m_startLocation = new DBUtility2.VariousData<Point>(value); }
        }
        ...
        public FormMain()
        {
            ...
            UnE.SOP.ProxySOP.Instance.SiteID = m_dbMgr.SiteID;
        ...
        {
            string strServerURL = RegUtil.ReadRegValue("Server Connection Info", "webserver_url", m_dbMgr.SiteID);
            if (strServerURL == null || strServerURL == "")
                strServerURL = "127.0.0.1";
        ...
        {                       
            ...
            // libSMS2 대신 SOPWebServer에게 보낸다.
            m_netMgr.SendSMS(szCaller, szMessage, memberList);
            // 1. 메시지는 libSMS2에서 알아서 쪼개도록 한다.
            ...
            /*using (libSMS.IMessageClient client = libSMS.MessageClientFactory.CreateMessageClient(UnE.SOP.ProxySOP.Instance.SiteID))
            {
                ...
                content.Caller = szCaller;
                content.Message = szMessage;

                for (int i = 0; i < memberList.Count; i++)
                {
                    content.PhoneNumbers.Add((string)memberList[i]);
                }
        ...
        {
            string strSQL = "Select PropertyValue from OptionSDMS where PropertyName = 'SMSCaller' and SiteID = " + m_dbMgr.SiteID.ToString();
        ...
        public void SetStartLocation(string[] args)
        {
            ...
            if (nCount >= 2)
            {
                ...
                m_startLocation = new VariousData<Point>(new Point(x, y));

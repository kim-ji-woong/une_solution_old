...
namespace SDMS
{
    public class SplashManager
    {
        ...
        private class SplashData
        {
            ...
            private VariousData<int> width = null;
            ...
            public bool Parse(string strData)
            {
                ...
                if (nTokenCount == 6)
                {
                    ...
                    {
                        width = new VariousData<int>(nWidth);
                    }
        ...
        private List<SplashData> ReadSplashOption(ref string strTextColorOption)
        {
            ...
            {
                string strPropertyValue = WebDBManager.GetStringField(arrResult[i]);
            ...
            for (int i = 0; i < nResultCount; i++)
            {
                strTextColorOption = WebDBManager.GetStringField(arrResult[i]);
            }

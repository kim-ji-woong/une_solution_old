...
namespace SDMS
{
    public partial class ActionPage : FormReportBase
    {
        ...
        public string GetReactionString(int nReactionType)
        {
            ...
            switch (nReactionType)
            {
                ...
                case (int)libSensorProcess.ReactionType.BEGIN_STATUS: strType = "화재 탐지";
                    break;
        ...
        public void Function_cboFireSelect(int nReactionType = 23)
        {
            ...
            foreach (Report.ReactionLog log in arrComboData)
            {
                ...
                {
                    if (log.Type == 0 || log.Type == 22 || log.Type == 21 || log.Type == 23 || log.Type == 50)
                        reactionLogBindingSource.Add(log);
                        //cboFireSelect.Items.Add(log);
                }
        ...
        private void SetManualID()
        {
            ...
            m_manualManager.SetID(lblEquipZone, "Action_Fire_Grid");

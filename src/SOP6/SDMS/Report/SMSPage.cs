...
namespace SDMS
{
    public partial class SMSPage : FormReportBase
    {
        ...
        private Report.ReactionManager.RefreshCheckData m_checkData = new Report.ReactionManager.RefreshCheckData();
        ...
        { 
            ...
            this.Resize += SMSPage_Resize;

            m_manualManager = new ManualManager(this);
            SetManualID();
        }

        void SMSPage_Resize(object sender, EventArgs e)
        { 
        ...
        public void ZoneSubmit(ArrayList arZoneList, DateTime dtStart, DateTime dtEnd)
        {
            ...
            m_HistoryManager.ZoneSubmit(m_arrSelectedZone, arZoneList, dtStart, dtEnd, UnE.Sensor.IFacility.FacilityType.FIRE_SENSOR);
...
//            Font font = m_dataGridView.Font;
        ...
        private void SetManualID()
        {
            ...
            m_manualManager.SetID(label2, "SDMS_Report_SMS_Fire");
            m_manualManager.SetID(m_dataGridView, "SDMS_Report_SMS_Fire");

    ...
    namespace Report
    {
        public class ReactionManager
        {
            ...
            private ArrayList GetManualReactionHistory(ArrayList arrZoneList, string startDate, string endDate)
            {
                ...
                int nSensorZoneID = SOPWebServer.Header.ManualReportDefaultID + (int)IFacility.FacilityType.FIRE_SENSOR;
                ...
                string strSQL = "select ID,SensorHistoryID,ReactionType, Time, Message, Param1, Param2, Param3, Param4, Param5, DetectionStatus From SensorReactionHistory where SensorHistoryID in "
                         + "(select SensorHistoryID from SensorReactionHistory where param1 in(" + strZoneList + ") And ReactionType = 22 And Param2 = " + nSensorZoneID + " And Time Between '" + startDate + "' and '" + endDate + "')";
            ...
            private Dictionary<int, ISensor> FindSensorZone(List<EquipmentZone> arrEquipZoneList)
            {
                ...
                {
                    List<ISensor> arSensors = SensorManager.Instance.FindZoneInSensor(equip.ID, IFacility.FacilityType.FIRE_SENSOR);

...
namespace SDMS
{
    public partial class ParetoPage : FormReportBase, SDMS.Data.IParetoPage
    {
        ...
        private void SetManualID()
        {
            ...
            m_manualManager.SetID(this, "SDMS_Report_Pareto_Fire");
            m_manualManager.SetID(lblTitle, "SDMS_Report_Pareto_Fire");
            m_manualManager.SetID(btnSaveHWP, "Pareto_Fire_ExportReport");
            m_manualManager.SetID(winChartViewerEquipZone, "Pareto_Fire_Graph");
            m_manualManager.SetID(winChartViewerSensor, "Pareto_Fire_Graph");
            m_manualManager.SetID(btnPreviousIndexEquipZone, "Pareto_Fire_Graph");
            m_manualManager.SetID(btnNextIndexEquipZone, "Pareto_Fire_Graph");
            m_manualManager.SetID(lblTotalPageEquipZone, "Pareto_Fire_Graph");
            m_manualManager.SetID(lblTotalPageSensor, "Pareto_Fire_Graph");
            m_manualManager.SetID(dataGridViewEquipZone, "Pareto_Fire_Grid");
            m_manualManager.SetID(dataGridViewSensor, "Pareto_Fire_Grid");

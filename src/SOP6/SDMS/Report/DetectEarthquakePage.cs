...
namespace SDMS
{
    public partial class DetectEarthquakePage : FormReportBase
    {
        private const int NO_INDEX = 0;
        private const int TIME_STAMP_INDEX = 1;
        private const int SENSOR_DATA_INDEX = 2;
        private const int ALARM_DEPTH_INDEX = 3;
        private const int MEMO_INDEX = 4;
        ...
        private Dictionary<int, Report.DetectEarthquakeLog> m_dicDetectLog = null;

        private Report.ReactionEarthquakeManager m_detectMgr = null;
        private Report.ReactionEarthquakeManager.RefreshCheckData m_checkData = new ReactionEarthquakeManager.RefreshCheckData();

        public Report.ReactionEarthquakeManager.RefreshCheckData RefreshCheckData
        {
        ...
        public DetectEarthquakePage(Report.ReactionEarthquakeManager detectMgr)
        {
            InitializeComponent();
        ...
        private void InitLoadData()
        {
            ...
            m_detectMgr.Submit(startDate, EndDate);
            //SetupDataGrid();
        ...
        public void CreateBarChart(DateTime StartDate, DateTime EndDate, int nSplitUnitOfMeansure, int nSplitUnitOfMeansureDetail, int nViewCount, bool isLoad = false)
        {
            ...
            int nCount = (from logs in m_detectMgr.DectectList.ToArray().Cast<Report.DetectEarthquakeLog>()
        ...
        private void SetChart()
        {
            ...
            for (int nIndex = 0; nIndex < dicStartDetectDates[m_nCurrentPage].Length; nIndex++)
            {
                m_chartDatas.Add((from logs in m_detectMgr.DectectList.ToArray().Cast<Report.DetectEarthquakeLog>()
                                  where logs.Time >= dicStartDetectDates[m_nCurrentPage][nIndex]
                                  && logs.Time < dicEndDetectDates[m_nCurrentPage][nIndex]
                                  select logs).Count());
            }
        ...
        private void SetupDataGrid()
        {
            ...
            dataGridView1.Columns[SENSOR_DATA_INDEX].Width = (int)(180 * sizePer);
            dataGridView1.Columns[ALARM_DEPTH_INDEX].Width = (int)(200 * sizePer);
        ...
        private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Report.DetectEarthquakeLog detectLog = m_dicDetectLog[Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells[0].Value)];
        ...
        public void Load_DataGrid(Dictionary<SensorTagInfo, int> dicSensorHistories)
        {
            ...
            if (m_dicDetectLog == null)
                m_dicDetectLog = new Dictionary<int, DetectEarthquakeLog>();
            else
            ...
            foreach (Report.DetectEarthquakeLog historyData in from historyData in arrSensorZoneHistory.Cast<Report.DetectEarthquakeLog>()
                                                              orderby historyData.Time descending
                                                              select historyData
                                                     )
            {
                string strDetectionStatusName = historyData.DetectionStatusName;
                string strType = historyData.DetectType;
                ...
                // Data Binding
                DetectPageEarthquakeGridData data = new DetectPageEarthquakeGridData();
                data.No = ++count;
                data.TimeStamp = historyData.Time;
                data.SensorData = historyData.SensorData;
                data.AlarmDepth = historyData.AlarmDepth;
        ...
        private void SaveHwpCrtl()
        {
            ...
            for (int index = 0; index < dataGridView1.RowCount; index++)
            {
                ...
                SaveArr.Add(row.Cells[SENSOR_DATA_INDEX].Value.ToString());
                SaveArr.Add(row.Cells[ALARM_DEPTH_INDEX].Value.ToString());
        ...
        private void comboBox_Leave(object sender, EventArgs e)
        {
            ...
            Report.DetectEarthquakeLog detectLog = m_dicDetectLog[Convert.ToInt32(dataGridView1.Rows[cell.RowIndex].Cells[0].Value)];
        ...
        private void btnSaveHWP_Click(object sender, EventArgs e)
        {
            ...
            PageBackstageHome.Instance.FrmReport.SaveHWPForDetectEarthquake();
        ...
        private void dataGridView1_MouseUp(object sender, MouseEventArgs e)
        {
            if (e.Button == System.Windows.Forms.MouseButtons.Right)
            {
                ...
                if (hitInfo.RowIndex >= 0 && hitInfo.ColumnIndex >= 0)
                {
                    ...
                    Report.DetectEarthquakeLog detectLog;
        ...
        {
            Report.DetectEarthquakeLog log = (Report.DetectEarthquakeLog)popupMenu.Tag;

            // 추후 구현해야함
            /*if (log != null)
                FormMain.Instance.SelectActionEarthquakePage(log.HistoryID);*/
        }
        ...
        private void dataGridView1_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                if (e.ColumnIndex >= 0 && e.ColumnIndex < STATUS_INDEX && e.RowIndex >= 0)
                {
                    ...
                    {
                        // 추후 구현해야함
                        FormMain.Instance.SelectActionEarthquakePage(detectLog.HistoryID);
                        int nSpace3 = 26;
                        if (FormMain.Instance.Resolution == Resolution.FullHD)
                        {
                        ...
                        FormMain.Instance.FromDetectEarthquakePageToActionEarthquakePage();
                    }
                }
            }
        }

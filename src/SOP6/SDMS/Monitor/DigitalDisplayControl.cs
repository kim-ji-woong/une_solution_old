...
namespace SDMS
{
	public partial class DigitalDisplayControl : UserControl
	{
		...
		private void DigitalControl_Paint(object sender, PaintEventArgs e)
		{
			...
			using (SolidBrush brush = new SolidBrush(_digitColor))
			{
				...
				{
					sevenSegmentHelper.DrawDigits(_digitText, font, brush, lightBrush,
												(ClientSize.Width - digitSizeF.Width) / 2 - 9,

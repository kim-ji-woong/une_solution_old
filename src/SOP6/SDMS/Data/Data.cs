...
namespace SDMS
{
	...
	public abstract class Facility
	{
        ...
        public virtual IPOIPopup CreatePopup(ISensorTooltipOwner view)
		{
			return null;
		}
	...
	public abstract class SensorZone : Facility
	{
        ...
        override public IPOIPopup CreatePopup(ISensorTooltipOwner view)
		{
			return null;
		}
	...
	public partial class FireAlarm : SensorZone
	{
		...
		public SDMS.FireEquipment AlarmStation
		{
		...
		{
			get { return FormMain.EnginPath() + "\\Media\\icons\\발신기.ico"; }
		}
	...
	public partial class PumpPressureSensor : SensorZone
	{
		...
		public override string IconPath
		{
			get { return FormMain.EnginPath() + "\\Media\\icons\\펌프압력.ico"; }
		}

		public override string DisconnectIconPath
		{
			get { return FormMain.EnginPath() + "\\Media\\icons\\펌프압력_disconnected.ico"; }
		}
	}
	...
	public partial class SpringCooler : SensorZone
	{
		...
		public override string IconPath
		{
			get { return FormMain.EnginPath() + "\\Media\\icons\\스프링쿨러.ico"; }
		}

		public override string DisconnectIconPath
		{
			get { return FormMain.EnginPath() + "\\Media\\icons\\스프링쿨러_disconnected.ico"; }
		}
	}
	...
	public partial class FireSensor : SensorZone
	{
		...
		public override string IconPath
		{
			get { return FormMain.EnginPath() + "\\Media\\icons\\화재탐지.ico"; }
		}

		public override string DisconnectIconPath
		{
			get { return FormMain.EnginPath() + "\\Media\\icons\\화재탐지_disconnected.ico"; }
		}
	}
	...
	public partial class CCTV : Facility
	{
		...
		public override string IconPath
		{
			get
            {
                ...
                return FormMain.EnginPath() + "\\Media\\icons\\cctv.ico";
            }
		}
		...
		public override string IconPath
		{
			get
			{
				if (m_type == FacilityType.FE)
					return FormMain.EnginPath() + "\\Media\\icons\\소화기.ico";
				else if (m_type == FacilityType.HD)
					return FormMain.EnginPath() + "\\Media\\icons\\소화전.ico";
				else if (m_type == FacilityType.FA)
					return FormMain.EnginPath() + "\\Media\\icons\\발신기.ico";
	...
	public class POI
	{
		...
		public virtual Facility.FacilityType Type
		{
	...
	public class EquipmentZoneObjectList
	{
		...
		public SDMS.EquipmentZone Zone
		{
			get { return m_Zone; }
			set { m_Zone = value; }
		}
	...
	public class FacilityManager
	{
		...
		public SDMS.EquipmentZone EquipZone
		{
    ...
    public class SensorZoneUpdateData
    {
        ...
        public SensorZoneUpdateData(SensorZone sensorZone, int equipZoneOrigin, int equipZoneChanged)
        {

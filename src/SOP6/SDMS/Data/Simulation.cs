...
namespace SDMS
{
    public class Simulation
    {
        ...
        public void SendSimulationSMS(FormBroadcastConfig.SituationType type, int nEquipZoneID)
        {
            ...
            byte[] bytes = NetworkWebManager.MakeBytes(SOPWebServer.Header.TRAINING_SIMULATOR_COMMAND, arrDatas);
            SDMS.NetworkWebManager.Instance.SendMessage(SOPWebServer.Header.TRAINING_SIMULATOR_COMMAND, bytes);
        }

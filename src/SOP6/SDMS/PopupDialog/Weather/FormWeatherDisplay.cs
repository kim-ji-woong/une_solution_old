...
namespace SDMS.WeatherDisplay
{
    public partial class FormWeatherDisplay : Form
    {
        ...
        public void UpdateData(DBUtility2.WebDBManager dbMgr, int nSiteID)
        {
            // 재난 정보 초기화
        ...
        private bool LoadWeatherLog(WebDBManager dbMgr, int nID, ref DateTime dtCreate, ref int nAvailablePeriodDay)
        {
        ...
        private void LoadWeatherList(WebDBManager dbMgr, int nLogID)
        {
            if (nLogID < 0)
                return;
        ...
        private void LoadRain(WebDBManager dbMgr, string strRainIDs)
        {
        ...
        private void LoadTyphoon(WebDBManager dbMgr, string strTyphoonIDs)
        {
        ...
        private void LoadEarthquake(WebDBManager dbMgr, string strEarthquakeIDs)
        {
        ...
        private bool LoadWeatherDatas(WebDBManager dbMgr, string strWeatherIDs, ref string strRainIDs, ref string strTyphoonIDs, ref string strEarthquakeIDs)
        {
        ...
        private int ReadLogID(WebDBManager dbMgr, int nSiteID)
        {
            int nLogID = -1;

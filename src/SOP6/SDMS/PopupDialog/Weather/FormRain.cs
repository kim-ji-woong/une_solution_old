...
namespace SDMS.WeatherDisplay
{
    public partial class FormRain : Form, IWeatherForm
    {
        ...
        public void ReadOptions(WebDBManager dbMgr, int nSiteID)
        {
        ...
        public static void ReadWindSpeedLevel(WebDBManager dbMgr, int nSiteID, string strPropertyName, float[] arrLevels)
        {
            ...
            else
            {
                ...
                string strLevels = WebDBManager.GetStringField(arrResult[0], "");
        ...
        private void ReadHeavyRainOption(WebDBManager dbMgr, int nSiteID)
        {
            ...
            string strCondition = WebDBManager.GetStringField(arrResult[0], "");

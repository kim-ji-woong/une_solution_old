...
namespace SDMS
{
	public partial class FormManager : PopupFormBase
	{
        ...
        private string[] m_strTHType = { "전체 시설물" };

        protected enum ManagerType { Entire = 0, Building, EquipmentZone, SecuritySensor, THSensor };
		...
		{            
            ...
            btnShowSimulationModeManager.Visible = false;
		...
		private void InitComboBox()
		{
            ...
            if (FormMain.Instance.UseTH)
            {
                cboSensorType.Items.Add("온도/습도 센서");
                TH_SENSOR = nItemIndex++;
            }
        ...
        private void cboSensorType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (cboSensorType.SelectedIndex == TH_SENSOR)
            {
                labelDescription.Text = "";
                mCurrentType = IFacility.FacilityType.TEMPERATURE_HUMIDITY;

                cmbType.Items.Clear();
                cmbType.Items.AddRange(m_strTHType);
        ...
        private void LoadSecurityTypes()
        {
            ...
            for (int i=0;i<nResultCount-2;i+=3)
            {
                ...
                string strFacilityTypeIDs = WebDBManager.GetStringField(arrResult[i + 1]);
		...
		private void cmbType_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			else if (nSelectIdx == 1)
			{
                ...
                else if (mCurrentType == IFacility.FacilityType.PSM_SENSOR)
                {
                    ...
                    cmbFloor.Visible = false;
                    cboAdditional.Visible = false; 
                    cmbEquipZone.Location = new Point((int)(204 * sizePer), (int)(77 * sizePer));
                ...
                else if (mCurrentType == IFacility.FacilityType.Security_Sensor)
                {
                    ...
                    cmbEquipZone.Location = new Point((int)(204 * sizePer), (int)(109 * sizePer));
        ...
        private void ResizeGridView(int nMode)
        {
            ...
            if (nMode == 1)
            {
                gridManager.Location = new Point((int)(12 * sizePer), (int)(109 * sizePer));
                gridManager.Size = new Size((int)(710 * sizePer), (int)(433 * sizePer));
            }
            else if (nMode == 2)
            {
                gridManager.Location = new Point((int)(12 * sizePer), (int)(141 * sizePer));
                gridManager.Size = new Size((int)(710 * sizePer), (int)(401 * sizePer));
            }
        }
        ...
        private void SetManualID()
        {
            ...
            m_manualManager.SetID(this, "SDMS_EditManager");
            m_manualManager.SetID(btnEdit, "SDMS_Admin_Manager_Edit");

...
namespace SDMS
{
	public partial class FormEditManager : PopupFormBase
	{
		...
		public FormEditManager(IFacility.FacilityType type, FacilityManagerGroup group = null, Building building = null, Zone zone = null, EquipmentZone equipZone = null)
		{
            ...
            FormMain.Instance.CustomizeGridView(gridMember);
		...
		private void FormEditManager_Load(object sender, EventArgs e)
		{
            ...
            treeViewTeam.Font = new System.Drawing.Font(Program.prgFont, 18F * sizePer, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(129)));
		}
        ...
        private void SetManualID()
        {
            ...
            m_manualManager.SetID(this, "SDMS_Admin_Manager_Edit");
            m_manualManager.SetID(btnAdd, "SDMS_Admin_Manager_Edit_SetRemove");
            m_manualManager.SetID(btnRemove, "SDMS_Admin_Manager_Edit_SetRemove");

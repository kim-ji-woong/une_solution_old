...
{
    public partial class FormPSMSensorTrendData : PopupFormBase
    {
        ...
        private Color m_clrLeftMouseDragging = Color.DarkOrange;
        ...
        public void ChangeSensor(UnE.PSM.PSMSensor sensor, VariousData<DateTime> dtStartTime, VariousData<DateTime> dtEndTime)
        {
        ...
        private void DrawChart()
        {
            ...
            float fXFontHeight = 13.0f * sizePer;
            ...
            Font f = new System.Drawing.Font(Program.prgFont, fXFontHeight, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(129)));
            ...
            foreach (string item in this.m_liDateLabel)
            {
                ...
                {
                    nHeightLength = Convert.ToInt32(Math.Ceiling(this.CreateGraphics().MeasureString(item, f).Width) * 1.45);
                    break;
                }
            }
            ...
            XYChart xyChart = new XYChart(this.chart.Width, this.chart.Height, this.BackColor.ToArgb(), this.BackColor.ToArgb());

            xyChart.xAxis().setColors(0xffffff);
            xyChart.xAxis2().setColors(0xffffff);
            xyChart.yAxis().setColors(0xffffff);
            xyChart.yAxis2().setColors(0xffffff);

            xyChart.setPlotArea((int)(80 * sizePer), (int)(40 * sizePer), this.chart.Width - (int)(220 * sizePer), this.chart.Height - nHeightLength);
            xyChart.yAxis().setTitle(strTitle, "돋움", fXFontHeight, 0xffffff);
            xyChart.yAxis().setLabelStyle("돋움", fXFontHeight, 0xffffff); 
            ...
            xyChart.xAxis().setLabelStyle("돋움", fXFontHeight, 0xffffff, 90);

            LegendBox legendBox = xyChart.addLegend(xyChart.getWidth() - (int)(4 * sizePer), (int)(90 * sizePer), true, Program.prgFont, fXFontHeight);
            legendBox.setAlignment(Chart.TopRight);
            legendBox.setFontColor(0xffffff);
            legendBox.setBackground(this.BackColor.ToArgb(), 0xffffff);
            if (this.SensorMaterial.Name != "가성소다")
            {
                ...
                int nLineWidth = (int)(3 * sizePer);

                layerAlarm3.setLineWidth(nLineWidth);
                layerAlarm2.setLineWidth(nLineWidth);
                layerAlarm1.setLineWidth(nLineWidth);
            }

            xyChart.addTitle("유해화학물질 측정 데이터 추이", Program.prgFont, 20 * sizePer, 0xffffff);

            LineLayer layer = xyChart.addLineLayer(this.m_liSensorData.ToArray(), 0xFF0000, "측정 데이터");
            layer.setLineWidth((int)(2 * sizePer));
        ...
        private void TrackLineAxis(XYChart c, int nX)
        {
            ...
            drawArea.vline(Math.Max(minY, plotArea.getTopY()), plotArea.getBottomY() + 6, xCoor, drawArea.dashLineColor(0xfffffff, 0x0101));
        ...
        private void SetManualID()
        {
            ...
            m_manualManager.SetID(this, "PSMSensorGraph");
            m_manualManager.SetID(lblTitle, "PSMSensorGraph");
            m_manualManager.SetID(chart, "PSMSensorGraph_AlarmInfo");
            m_manualManager.SetID(btnUndo, "PSMSensorGraph_Zoom");
            m_manualManager.SetID(btnRedo, "PSMSensorGraph_Zoom");

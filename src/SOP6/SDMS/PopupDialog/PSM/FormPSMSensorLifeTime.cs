...
{
    public partial class FormPSMSensorLifeTime : PopupFormBase
    {
        ...
        private void btnApply_Click(object sender, EventArgs e)
        {
            if (m_sensor != null)
            {
                ...
                m_sensor.InstallDate = new VariousData<DateTime>(dtpIntallDate.Value);

                if (SaveSensorLifeTime(m_sensor))
                {
                    if (FormPSMList.Instance != null && FormPSMList.Instance.IsDisposed == false)
                    {
                        NetworkWebManager.Instance.SendRefreshSensorLifeTime();
        ...
        private void btnNewType_Click(object sender, EventArgs e)
        {
            ...
            frm.SetChildCtrlResize(frm, 270, 212);
        ...
        private void SetManualID()
        {
            ...
            m_manualManager.SetID(this, "PSMSensor_LifeCycle");
            m_manualManager.SetID(label7, "SensorLifeCycle_Set");
            m_manualManager.SetID(btnNewType, "SensorLifeCycle_Set");

...
{
    public partial class FormPSMSensorType : PopupFormBase
    {
        private class Month
        {
            private int data = 0;
        ...
        private void SetManualID()
        {
            ...
            m_manualManager.SetID(this, "SensorLifeCycle_Set");
            m_manualManager.SetID(btnRemoveType, "SensorLifeCycle_Delete"); 

...
namespace SDMSAgent
{
    public enum CommandType { NONE = -1, AGENT_UPDATE = 0, GET_SERVICE_LIST, GET_FILE_LIST, UPDATE, GET_PROC_LIST, GET_ALL_PROC_LIST, DOWNLOAD, SDMS_UPDATE, SOP_SERVER_RESTART, SERVER_STATUS, FILE_COPY, IIS_RESET }

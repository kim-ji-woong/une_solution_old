...
namespace UnE.CCTV
{
    ...
    public class EquipmentZone : IComparable
    {
        ...
        public enum EquipZoneType { FIRE_SENSOR_TYPE = 0, FA_TYPE, PSM_TYPE, SECURITY_TYPE=9, UNKOWN };
        ...
        private string[] m_preset = new string[6];
    ...
    public partial class CCTV : Facility
    {
        ...
        private string m_strBigURLDB = "";
        private string m_strSmallURLDB = "";
        ...
        public string BigURLDB
        {
            get { return m_strBigURLDB; }
            set { m_strBigURLDB = value; }
        }

        public string SmallURLDB
        {
            get { return m_strSmallURLDB; }
            set { m_strSmallURLDB = value; }
        }

...
{	
	public class ProcessManager
	{
		...
		{
            string[] szTarget = { "SOPSimulator", "SDMS", "SMSSender", "ControlTeamEditor", "TeamEditor", "SOPManager", "CCTVViewer" ,
            "SensorTester", "HwpReport", "SOPBulletin", "libCCTV" };
		...
		public bool RunCheckProcess(string strProcessName)
		{

...
{
    internal class Supervisor_Urbanbrix : Supervisor
    {
        ...
        public Supervisor_Urbanbrix()
        {
        }

        public Supervisor_Urbanbrix(DirectDBManager dbMgr)
            : base(dbMgr)
        {
        }
        ...
        protected override Dictionary<int, string> SortStandardActionStepNames(int nSensorType)
        {
            ...
            {
                if (sensorType == IFacility.FacilityType.BLACKOUT || sensorType == IFacility.FacilityType.CORONA)
                {

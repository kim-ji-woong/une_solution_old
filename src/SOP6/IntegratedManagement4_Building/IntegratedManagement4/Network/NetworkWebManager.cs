...
namespace IntegratedManagement4
{
    public class NetworkWebManager : IPostMan
    {
        ...
        public bool RegisterUser(int nMemberID, string szID, string szPass, string szNickName, int nLevel)
        {
            if (m_isConnected == false)
                return false;

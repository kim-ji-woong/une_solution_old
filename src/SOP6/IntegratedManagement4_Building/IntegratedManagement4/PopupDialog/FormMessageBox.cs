...
namespace IntegratedManagement4.PopupDialog
{
    public partial class FormMessageBox : Form
    {
        ...
        public FormMessageBox(string msg, string title, MessageBoxButtons msgButton)
        {
            InitializeComponent();
        ...
        private int m_nBtnLocationY = 105;
        private void SetButton()
        {
            if (m_msgButtons == MessageBoxButtons.YesNo)
            {
                btnConfirm.Size = new Size(135, 40);
                btnConfirm.Location = new Point(40, m_nBtnLocationY);

                btnCancel.Size = new Size(135, 40);
                btnCancel.Location = new Point(200, m_nBtnLocationY);
            }

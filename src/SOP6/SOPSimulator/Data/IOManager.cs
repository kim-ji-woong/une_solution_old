...
namespace SOPMonitoringSystem
{
	...
	public class IOManager
	{
		...
		public bool Load(FormSOP frm, WebDBManager dbMgr, VersionInfo version, ArrayList arrActionSteps, string strCategoryName, string strSubCategoryName, string strDisasterName, List<TabPage> tabPages)
		{
			...
			if (!LoadPane(dbMgr, pageHome, arrActionSteps, arrTeams, tabPages))
			{
				frm.Cursor = Cursors.Arrow;
				return false;
			}
		...
		private ArrayList LoadActionSteps(WebDBManager dbMgr, ArrayList arrActionSteps)
		{
            ...
            string strFormat = "Select step.ID, StepName, PeriodType, BeginTime, EndTime, WeekDayOption, Iteration, IterationType, ProcessTime, ProcessTimeType, ParentStepID, UserDefinedConfigID, v.isNormal ";
		...
		private bool LoadPane(WebDBManager dbMgr, PageBackstageSOP pageHome, ArrayList arrActionSteps, ArrayList arrTeams, List<TabPage> tabPages)
		{

...
namespace SOPMonitoringSystem.Popup.MissionMessage
{
    public partial class FormMissionMessage : Form
    {
        ...
        public abstract class Disaster
        {
            ...
            protected virtual string GetScenarioMessage(string strLocation, VariousData<DateTime> dtStart, bool isRealMode, string strPSMMaterialName, int nPSMDistance, string strAmountSnowfall, string strAlarmMessage)
            {
                ArrayList strings = null;
                ...
                UnE.SOP.Utility.SOPSimulatorScript.DataParameter param = new UnE.SOP.Utility.SOPSimulatorScript.DataParameter(strMsg, dtTime, strLocation, strAlarmMessage);
            ...
            public abstract string GetMessage(string strLocation, VariousData<DateTime> dtStart, MessageType type, bool isRealMode, string strPSMMaterialName, int nPSMDistance, string strAmountSnowfall, string strAlarmMessage);
        ...
        public class Fire : Disaster
        {
            ...
            public override string GetMessage(string strLocation, VariousData<DateTime> dtStart, MessageType type, bool isRealMode, string strPSMMaterialName, int nPSMDistance, string strAmountSnowfall, string strAlarmMessage)
            {
                if (type == MessageType.DisasterType)
                    ...
                    return GetScenarioMessage(strLocation, dtStart, isRealMode, strPSMMaterialName, nPSMDistance, strAmountSnowfall, strAlarmMessage);
            ...
            set
            {
                ...
                if (cboDisaster.SelectedIndex >= 0 && m_disaster != null)
                {
                    ...
                    if ((MessageType)data.Data == MessageType.Scenario)
                    {
                        ...
                        string strMessage = m_disaster.GetMessage(strLocation, m_dtStart, (MessageType)data.Data, m_isRealMode, m_strPSMMaterialName, m_nPSMDistance, m_strAmountSnowfall, m_strAlarmMessage);
        ...
        public void Init()
        {
            ...
            checkBoxSiren.Checked = data.UseSiren;
        }
        ...
        private void GetAllOffDutyMembers()
        {
            ...
            {
                int nTeamType = WebDBManager.GetIntField(arrResult[i].ToString(), -1);
        ...
        private void comboDisaster_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string strMessage = m_disaster.GetMessage(m_strLocation, m_dtStart, (MessageType)data.Data, m_isRealMode, m_strPSMMaterialName, m_nPSMDistance, m_strAmountSnowfall, m_strAlarmMessage);
            textBoxMessage.Text = strMessage;
        }

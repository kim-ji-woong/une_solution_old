...
namespace SOPMonitoringSystem.Popup
{
    public partial class PopupSensorOn : Form, IFormDisasterOwner
    {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            bool isRealMode = FormSOP.Instance.IsReal;
			...
			if (m_detectSignal.SensorID == 0)
			{
				...
				if (!frmMain.PlayWithDisasterPosition(DateTime.Now, zone.ID, this.SensorID, m_detectSignal.SensorHistoryID, isRealMode))
				{
					// 이미 실행중인 경우

...
namespace SOPMonitoringSystem
{
    public partial class PopupRequestProgress : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            NetworkWebManager.Instance.SendMessage(SOPWebServer.Header.STEAL_CONTROL, null);
            timer1.Stop();
            this.Close();
        }
        ...
        {
            NetworkWebManager.Instance.SendMessage(SOPWebServer.Header.CANCEL_REQUEST_CONTROL, null);
            timer1.Stop();
            this.Close();
        }

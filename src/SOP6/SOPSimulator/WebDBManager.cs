...
{
    public class WebDBManager : DBUtility2.WebDBManager
    {
        private FormSOP m_Main = null;
        ...
        public WebDBManager(FormSOP main, int nSiteID)
            : base(nSiteID)
        {
            m_Main = main;
            ...
            m_strDatabaseName = DBUtility2.RegUtil.ReadRegValue("Server Connection Info", "db_name", nSiteID);
        ...
        public string LoadIni(string strTargetName)
        {
            ...
            return util.getinivalue(strSection, strTargetName);
        }

        public string LoadIni(string strTargetName, string strSectionName)
        {
            DBUtility2.Utility util = new DBUtility2.Utility();
            return util.getinivalue(strSectionName, strTargetName);
        }
        ...
        private void EncryptExternalCompanyMember()
        {
            ...
            ArrayList arrResult = GetResultData(strSQL);
            if (arrResult == null)
                return;
            ...
            for (int i = 0; i < nResultCount - 1; i += 2)
            {
                ...
                string strEncrypt = strPhoneNumber.Length == 0 ? "" : DBUtility2.AES256Cipher.AES_encrypt(strPhoneNumber, key);
    ...
    internal abstract class DirectDBManager
    {
        ...
        public DirectDBManager(WebDBManager dbMgr)
        {
            m_dbMgr = dbMgr;
            Init();
        }
        ...
        {
            string key = new string(new char[] { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z', '1', '2', '3', '4', '5', '6' });
            m_strUser = DBUtility2.AES256Cipher.AES_decrypt("GUk6cJACqVBoIFh7ny7mqQ==", key);
            m_strPW = DBUtility2.AES256Cipher.AES_decrypt("SezOwMM9A2mIbUk5DCW/eQ==", key);
        }
    ...
    internal class SQLServerManager : DirectDBManager
    {
        ...
        public SQLServerManager(WebDBManager dbMgr)
            : base(dbMgr)
        {
        }
    ...
    internal class MySQLManager : DirectDBManager
    {
        ...
        public MySQLManager(WebDBManager dbMgr)
            : base(dbMgr)
        {
        }

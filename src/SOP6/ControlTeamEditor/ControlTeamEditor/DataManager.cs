    ...
    public class DataManager
    {
        ...
        private bool LoadControlRoom()
        {
            ...
            for (int i = 0; i < nCount - 4; i += 5)
            {
                ...
                string szLocationName = WebDBManager.GetStringField(arrResult[i + 2], "");            
                string szDisplayText = WebDBManager.GetStringField(arrResult[i + 3], "");
                string szDescription = WebDBManager.GetStringField(arrResult[i + 4], "");
        ...
        private bool LoadControlTeam()
        {
            ...
            for (int i = 0; i < nCount - 4; i += 5)
            {
                int nID = WebDBManager.GetIntField(arrResult[i].ToString(), 0);
                int nRoomTypeID = WebDBManager.GetIntField(arrResult[i + 1].ToString(), -1);
                string szTeamName = WebDBManager.GetStringField(arrResult[i + 2], "");
                string szDisplayText = WebDBManager.GetStringField(arrResult[i + 3], "");
                string szDescription = WebDBManager.GetStringField(arrResult[i + 4], "");
        ...
        private bool LoadControlJobPosition()
        {
            ...
            {
                int nID = WebDBManager.GetIntField(arrResult[i].ToString(), 0);
                string szJobName = WebDBManager.GetStringField(arrResult[i + 1], "");
                int nRoomTypeID = WebDBManager.GetIntField(arrResult[i + 2].ToString(), -1);
                string szDescription = WebDBManager.GetStringField(arrResult[i + 3], "");
        ...
        private bool LoadContorlWorkingTeam()
        {
            ...
            for (int i = 0; i < nCount - 3; i += 4)
            {
                ...
                int nRoomID = WebDBManager.GetIntField(arrResult[i+2].ToString(), 0);
                string szDescription = WebDBManager.GetStringField(arrResult[i + 3], "");
        ...
        public void SaveControlTeamBasicMember(DataControlRoom room, DataControlTeam team, DataControlTeamJobPosition job)
        {
            ...
            ArrayList arrResult = m_dbMgr.GetResultData(strSameMemberFindSQL);
            if (arrResult != null)
            {
                if (arrResult.Count > 0)
                {
        ...
        private void LoadControlMembers()
        {
            ...
            if (strRoomIDs.Length > 0)
            {
                ...
                if (arrResult != null && arrResult.Count > 0)
                {
                    ...
                    {
                        int nID = WebDBManager.GetIntField(arrResult[i].ToString(), -1);
                        int nRoomID = WebDBManager.GetIntField(arrResult[i + 1].ToString(), -1);
                        int nTeamID = WebDBManager.GetIntField(arrResult[i + 2].ToString(), -1);
                        int nJobID = WebDBManager.GetIntField(arrResult[i + 3].ToString(), -1);
                        int nMemberType = WebDBManager.GetIntField(arrResult[i + 4].ToString(), -1);
                        int nMemberID = WebDBManager.GetIntField(arrResult[i + 5].ToString(), -1);
        ...
        public bool LoadCompanyMember(DBUtility2.WebDBManager dbMgr, Dictionary<int, DataTeam> dicTeams)
        {
            string strSQL = string.Format("SELECT TeamID FROM Site WHERE ID = {0}", m_nSiteID);
            ArrayList arrResult1 = dbMgr.GetResultData(strSQL);
            if (arrResult1 == null || arrResult1.Count == 0)
            ...
            for (int i = 0; i < nCount - 8; i += 9)
            {
                ...
                int nSubPositionID = WebDBManager.GetIntField(arrResult[i + 3].ToString(), 0);
                string strMemberName = WebDBManager.GetStringField(arrResult[i + 4], "");
                int nLevelID = WebDBManager.GetIntField(arrResult[i + 5].ToString(), 0);
                string strMemberID = WebDBManager.GetStringField(arrResult[i + 6], "");
                ...
                string strOfficePhoneNumber = WebDBManager.GetStringField(arrResult[i + 7], "");
        ...
        private string LoadExternalTeam(WebDBManager dbMgr, Dictionary<int, DataTeam> dicTeams)
        {
        ...
        private bool LoadExternalCompanyMember(WebDBManager dbMgr, Dictionary<int, DataTeam> dicTeams, string strExternalTeamIDs)
        {
            ...
            for (int i = 0; i < nCount - 3; i += 4)
            {
                int nExternalTeamID = WebDBManager.GetIntField(arrResult[i].ToString(), 0);
                int nID = WebDBManager.GetIntField(arrResult[i + 1].ToString(), 0);
                int nPositionID = WebDBManager.GetIntField(arrResult[i + 2].ToString(), 0);

    ...
    public partial class PopupStartEvent : Form, IWorkflowStartOption
	{
        ...
        private void SetPosition(bool showShelter, bool showUserDefinedConfig)
        {
            if (showShelter)
            {
                ...
                {
                    this.Size = new Size(454, 688);
                    labelUserDefinedParameters.Location = new Point(12, 425);
                    gridUserDefinedParameters.Location = new Point(12, 447);
                    btnRun.Location = new Point(12, 608);
                    btnCancel.Location = new Point(95, 608);
                }
                else
                {
                    this.Size = new Size(454, 565);
                    btnRun.Location = new Point(12, 485);
                    btnCancel.Location = new Point(95, 485);
                }
            }
            else
            {
                ...
                {
                    this.Size = new Size(454, 565);
                    labelUserDefinedParameters.Location = new Point(12, 302);
                    gridUserDefinedParameters.Location = new Point(12, 324);
                    btnRun.Location = new Point(12, 485);
                    btnCancel.Location = new Point(95, 485);
                }
                else
                {
                    this.Size = new Size(454, 388);
                    btnRun.Location = new Point(12, 308);
                    btnCancel.Location = new Point(95, 308);
                }
            }
		...
		public void SetRecentPosition(ArrayList arList)
		{
			...
			for( int i = 0 ; i < recentList.Count; i++)
			{
				...
				SetRecentPosition(pos.PoistionName.Trim());
			}
		}
        ...
        {
            if ((this.ActiveControl == cboPositionHistory) && (keyData == Keys.Return))
            {
                NewComboBoxText();
                return true;
            }
        ...
        private void NewComboBoxText()
        {
            string str = cboPositionHistory.Text.Trim();

            foreach (object item in cboPositionHistory.Items)
            {
                if (item is string && (string)item == str)
                {
                    // 이미 같은 값이 존재한다.
                    return;
                }
            ...
            SetRecentPosition(str);
            cboPositionHistory.SelectedIndex = cboPositionHistory.Items.Count - 1;
        }
    }
}

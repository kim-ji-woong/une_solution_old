...
namespace SOPMonitoringSystem
{
    public partial class FormEditExteranlTeam : Form
    {
        ...
        private static List<DataRoleMember> GetTemporaryRoleMembers(List<DataRoleMember> roleMembers, int nTemporaryTeamID, bool isNormal)
        {
            if (roleMembers == null)
            {
                ...
                if (members != null)
                {
                    ...
                    {
                        if (SectionCommanderInfo.GetTemporaryMemberInfo(member, ref strDisplayName, ref strPhoneNumber, ref strMemberName))
                        {
        ...
        private static List<TemporaryMember> GetTemporaryMembers(int nTeamID, bool isNormal)
        {
            ...
            List<TemporaryMember> members = SectionCommanderInfo.GetTemporaryMembers(nTeamID, isNormal, includeMain, includeSub, includeTeamLeader, includeOthers);
            return members;
        }

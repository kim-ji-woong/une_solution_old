...
namespace SOPMonitoringSystem.Popup
{
    public partial class PopupWorkflowOption : Form
    {
        ...
        public PopupWorkflowOption(List<SOPParameter> userDefinedParameters)
        {
            InitializeComponent();
            ...
            SetPosition(false, true, m_userDefinedParameters != null && m_userDefinedParameters.Count > 0);
        }
        ...
        public void SetShelters(List<UnE.Spatial.Shelter> shelters, bool checkUseShelter)
        {
            ...
            if (shelters == null || shelters.Count == 0)
            {
                ...
                bool showOption = panelOption.Controls.Count > 0;
                ...
                SetPosition(false, showOption, showUserDefinedConfig);
            }
            else
            {
                ...
                SetPosition(true, true, showUserDefinedConfig);
            }
        }
        ...
        private void SetPosition(bool showShelter, bool showOption, bool showUserDefinedConfig)
        {
            if (showShelter)
            {
                if (showUserDefinedConfig)
                {
                    this.Size = new Size(465, 626);
                    labelUserDefinedParameters.Location = new Point(20, 347);
                    gridUserDefinedParameters.Location = new Point(22, 369);
                    btnRun.Location = new Point(22, 548);
                    btnCancel.Location = new Point(105, 548);
                }
                else
                {
                    this.Size = new Size(465, 420);
                    btnRun.Location = new Point(22, 342);
                    btnCancel.Location = new Point(105, 342);
                }
            }
            else
            {
                if (showOption)
                {
                    ...
                    {
                        this.Size = new Size(465, 420);
                        labelUserDefinedParameters.Location = new Point(22, 141);
                        gridUserDefinedParameters.Location = new Point(22, 163);
                        btnRun.Location = new Point(22, 342);
                        btnCancel.Location = new Point(105, 342);
                    }
                    else
                    {
                        this.Size = new Size(465, 241);
                        btnRun.Location = new Point(90, 162);
                        btnCancel.Location = new Point(173, 162);
                    }
                }
                else
                {
            ...
            if (m_option != null)
            {
                ...
                else
                {
                    ...
                    if (DateTime.TryParse(labelManualTime.Text, out time))
                        m_option.DetectTime = new VariousData<DateTime>(time);
                }
            }
            /*if (radioAuto.Checked)
        ...
        private void PopupWorkflowOption_Load(object sender, EventArgs e)
        {
            if (m_frmOption != null)
                m_frmOption.Show();
        }

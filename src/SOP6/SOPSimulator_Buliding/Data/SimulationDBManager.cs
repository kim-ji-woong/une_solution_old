...
{
    public class SimulationDBManager : SOPMonitoringSystem.WebDBManager
    {
        private SQLiteConnection m_connection = null;

        public SimulationDBManager(FormSOP main, int nSiteID)
            : base(main, nSiteID)
        {
            MakeConnection();
        }
        ...
        public override ArrayList GetResultData(string strSQLQuery, int nTransaction, string szDBName = null)
        {
            ...
            return _GetResultData(strSQLLower, strSQLQuery);
        }
        ...
        private ArrayList _GetResultData(string strSQLLower, string strSQLQuery)
        {

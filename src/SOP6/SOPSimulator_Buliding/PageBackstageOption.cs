...
namespace SOPMonitoringSystem
{
    ...
    public partial class PageBackstageOption : Form, IOptionChanged
    {
        ...
        private Font m_fontCloseButton = new System.Drawing.Font("나눔바른고딕", 15F, System.Drawing.FontStyle.Bold);
        ...
        {
            get { return cbBroadcast.Checked; }
        }

        public bool UseSMS
        {
            get { return cbSMS.Checked; }
        }

        public bool UseExternalMemberSMS
        {
            get { return cbExternalMemberSMS.Checked; }
        }

        public bool ConfirmSendSMS
        {
            get { return ckbConfirmSendSMS.Checked; }
        }
        ...
        public string ExternalFolderPath
        {
            get
            {
                ...
                return m_strExternalFolderPath;
            }
        }
        ...
        public PageBackstageOption()
        {
            ...
            if (UnE.SOP.ProxySOP.Instance.UseBlackout || UnE.SOP.ProxySOP.Instance.UseStrongWind)
            {
                btnETCSensorSOPLink.Visible = true;
            }

            btnETCSensorSOPLink.Location = new Point(20, 175);
            ...
            if (UnE.SOP.ProxySOP.Instance.UsePSM && !UnE.SOP.ProxySOP.Instance.UseIntrusion)
            {
                ...
                btnIntrusionSensorSOPLink.Visible = false;
                btnETCSensorSOPLink.Location = new Point(20, 225);
            }
            if (!UnE.SOP.ProxySOP.Instance.UsePSM && UnE.SOP.ProxySOP.Instance.UseIntrusion)
            {
                //groupBox_sopCfg.Size = new System.Drawing.Size(200, 163);
                ...
                btnIntrusionSensorSOPLink.Location = new Point(20, 175);
                btnPSMSensorSOPLink.Visible = false;
        ...
        {
            btnSave.Font = m_fontCloseButton;
            btnSaveSOPWaitTimeCloseOption.Font = m_fontButton; 
            btnSaveSOPSensorCloseOption.Font = m_fontButton;
            btnQuickMenu.Font = m_fontButton;
            btnFireSensorSOPLink.Font = m_fontButton;
            btnPSMSensorSOPLink.Font = m_fontButton;
            btnIntrusionSensorSOPLink.Font = m_fontButton;
            btnETCSensorSOPLink.Font = m_fontButton;
        }
        ...
        private void ReadSOPPlayOnDetectSensor()
        {
            ...
            {
                // SOP 자동실행
                ProxySOP.Instance.OpenSOPOnSensorDetect = true;
            ...
            {
                // 센서신호 신경안씀
                ProxySOP.Instance.OpenSOPOnSensorDetect = false;
                FormSOP.Instance.SensorDetectLoadAndPlay = false;
        ...
        public void Initialize()
        {
            ...
            if (GetWorkingHours(ref nBeginHour, ref nBeginMinute, ref nEndHour, ref nEndMinute))
            {
                ...
                m_nBeginHour = nBeginHour;
                m_nBeginMinute = nBeginMinute;
                m_nEndHour = nEndHour;
            ...
            else
            {
                ...
                m_nBeginHour = m_nDefaultBeginHour;
                m_nBeginMinute = m_nDefaultBeginMinute;
                m_nEndHour = m_nDefaultEndHour;
                m_nEndMinute = m_nDefaultEndMinute;
            }
            ...
            ckbConfirmSendSMS.Checked = FormSOP.Instance.LoadDBOption(SOP.SOPSimulatorConfig.GetPropertyName(SOP.SOPSimulatorConfig.ConfigType.USE_CONFIRMSENDSMS), "문자전송확인 사용여부");
            m_virtualModeInSensor = checkBoxVirtualModeInSensor.Checked = FormSOP.Instance.LoadDBOption(SOP.SOPSimulatorConfig.GetPropertyName(SOP.SOPSimulatorConfig.ConfigType.USE_VIRTUALMODE_IN_SENSOR), "센서신호 받으면 훈련모드로 SOP 동작하는가?");
        ...
        private void ReadAutoCloseDB(Data_DisasterCategory category, UnE.SOP.SOPCloseOption option = null)
        {
            ...
            if (arrResult != null && arrResult.Count > 0)
            {
                ...
                if (strValue != null)
                {
                    ...
                    if (tokens.Count() == 5)
                    {
                        // 입력대기로 인한 SOP 자동종료 대기시간(분)
                        int nCloseWaitTime = 0;
                        // 센서신호 복구시 일정시간 이후 종료할 때 지연시간(분)
                        int nCloseSensorWaitTime = 0;
                        // 입력대기로 인한 SOP 자동종료 사용할 것인가?
                        int nUseCloseWaitTime = 0;
                        // 센서신호 복구시 SOP 즉시 종료할 것인가 ?
                        int nUseCloseSensorReset = 0;
                        // 센서신호 복구시 일정시간 이후 종료할 것인가?
                        int nUseCloseSensorResetWaitTime = 0;
        ...
        private void SaveAutoCloseDB(UnE.SOP.SOPCloseOption option, int nCategoryID)
        {
            ...
            if (FormSOP.Instance.NetworkManager != null)
                FormSOP.Instance.NetworkManager.SendChangedConfig(SOPWebServer.ClientType.SOP_SIMULATOR, strPropertyTag, nCategoryID.ToString() + ";" + option.CategroyName + ";" + strPropertyValue);
        }
        ...
        {
            int nBeginHour, nBeginMinute, nEndHour, nEndMinute;

            if (int.TryParse(strBeginHour.Trim(), out nBeginHour) == false || int.TryParse(strBeginMinute.Trim(), out nBeginMinute) == false)
                return false;

            if (int.TryParse(strEndHour.Trim(), out nEndHour) == false || int.TryParse(strEndMinute.Trim(), out nEndMinute) == false)
                return false;
        ...
        public int BeginHour
        {
            ...
            set
            {
                cboBeginHour.Text = value.ToString();
                m_nBeginHour = value;
            }
        }

        // 0 ~ 59
        private int m_nBeginMinute = 0;
        public int BeginMinute
        {
            ...
            set
            {
                cboBeginMinute.Text = value.ToString();
                m_nBeginMinute = value;
            }
        }

        // 0 ~ 23
        private int m_nEndHour = 9;
        public int EndHour
        {
            ...
            set
            {
                cboEndHour.Text = value.ToString();
                m_nEndHour = value;
            }
        }

        // 0 ~ 59
        private int m_nEndMinute = 0;
        public int EndMinute
        {
            ...
            set
            {
                cboEndMinute.Text = value.ToString();
                m_nEndMinute = value;
            }
        }
        ...
        private void cbBroadcast_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (!m_ignoreChanged)
            {
                this.BeginInvoke(new Action(() =>
                {
                    ...
                    if (FormSOP.Instance.NetworkManager != null)
                        FormSOP.Instance.NetworkManager.SendChangedConfig(SOPWebServer.ClientType.SOP_SIMULATOR, SOP.SOPSimulatorConfig.GetPropertyName(SOP.SOPSimulatorConfig.ConfigType.USE_BROADCAST), strUse);
        ...
        private void cbSMS_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (!m_ignoreChanged)
            {
                ...
                this.BeginInvoke(new Action(() =>
                {
                    ...
                    if (FormSOP.Instance.NetworkManager != null)
                        FormSOP.Instance.NetworkManager.SendChangedConfig(SOPWebServer.ClientType.SOP_SIMULATOR, SOP.SOPSimulatorConfig.GetPropertyName(SOP.SOPSimulatorConfig.ConfigType.USE_SMS), strUse);
        ...
        private void cbExternalMemberSMS_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (!m_ignoreChanged)
            {
                this.BeginInvoke(new Action(() =>
                {
                    string strUse = bUse ? "1" : "0";
                    if (FormSOP.Instance.NetworkManager != null)
                        FormSOP.Instance.NetworkManager.SendChangedConfig(SOPWebServer.ClientType.SOP_SIMULATOR, SOP.SOPSimulatorConfig.GetPropertyName(SOP.SOPSimulatorConfig.ConfigType.SMS_TO_EXTERNAL_MEMBER), strUse);
        ...
        private void checkBoxVirtualModeInSensor_CheckedChanged(object sender, EventArgs e)
        {
            bool bUse = checkBoxVirtualModeInSensor.Checked;
            m_virtualModeInSensor = FormSOP.Instance.VirtualModeInSensor = bUse;
            ...
            if (!m_ignoreChanged)
            {
                this.BeginInvoke(new Action(() =>
                {
                    string strUse = bUse ? "1" : "0";
                    if (FormSOP.Instance.NetworkManager != null)
                        FormSOP.Instance.NetworkManager.SendChangedConfig(SOPWebServer.ClientType.SOP_SIMULATOR, SOP.SOPSimulatorConfig.GetPropertyName(SOP.SOPSimulatorConfig.ConfigType.USE_VIRTUALMODE_IN_SENSOR), strUse);
                    SaveDBOption(FormSOP.Instance.DBManager, SOP.SOPSimulatorConfig.GetPropertyName(SOP.SOPSimulatorConfig.ConfigType.USE_VIRTUALMODE_IN_SENSOR), strUse, "센서신호 받으면 훈련모드로 SOP 동작하는가?");
                }));
            }
        }
            ...
            if (!m_ignoreChanged)
            {
                if (FormSOP.Instance.NetworkManager != null)
                {
                    this.BeginInvoke(new Action(() =>
                    {
                        ...
                        {
                            FormSOP.Instance.NetworkManager.SendChangedConfig(SOPWebServer.ClientType.SOP_SIMULATOR, SOP.SOPSimulatorConfig.GetPropertyName(SOP.SOPSimulatorConfig.ConfigType.WORKING_BEGIN_HOUR), cboBeginHour.Text + ":" + cboBeginMinute.Text);
                        }
                        else
                        {
                            FormSOP.Instance.NetworkManager.SendChangedConfig(SOPWebServer.ClientType.SOP_SIMULATOR, SOP.SOPSimulatorConfig.GetPropertyName(SOP.SOPSimulatorConfig.ConfigType.WORKING_END_HOUR), cboEndHour.Text + ":" + cboEndMinute.Text);
                        }
                    }));
                }
        ...
        private void radioSOP_CheckedChanged(object sender, EventArgs e)
        {
            ...
            int nMode = 0;
            bool openSOPOnSensorDetect = ProxySOP.Instance.OpenSOPOnSensorDetect;
            ...
            {
                FormSOP.Instance.NetworkManager.SendChangedConfig(SOPWebServer.ClientType.SOP_SIMULATOR, strPropertyName, nMode.ToString());

                if (openSOPOnSensorDetect != ProxySOP.Instance.OpenSOPOnSensorDetect)
        ...
        private void ckbConfirmSendSMS_CheckedChanged(object sender, EventArgs e)
        {
            ...
            bool bUse = ckbConfirmSendSMS.Checked;
            ...
            if (!m_ignoreChanged)
            {
                ...
                this.BeginInvoke(new Action(() =>
                {
                    ...
                    SaveDBOption(FormSOP.Instance.DBManager, SOP.SOPSimulatorConfig.GetPropertyName(SOP.SOPSimulatorConfig.ConfigType.USE_CONFIRMSENDSMS), strUse, "문자전송확인 사용여부");
                    
                    if (FormSOP.Instance.NetworkManager != null)
                        FormSOP.Instance.NetworkManager.SendChangedConfig(SOPWebServer.ClientType.SOP_SIMULATOR, SOP.SOPSimulatorConfig.GetPropertyName(SOP.SOPSimulatorConfig.ConfigType.USE_CONFIRMSENDSMS), strUse);
                }));
        ...
        private void btnETCSensorSOPLink_Click(object sender, EventArgs e)
        {
            FormSOP.Instance.PopupSelectETCSensorSOPLink();
        }
        ...
        {
            btnSaveSOPSensorCloseOption.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(0)))), ((int)(((byte)(140)))), ((int)(((byte)(255)))));
            ...
            btnSaveSOPSensorCloseOption.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(234)))), ((int)(((byte)(234)))), ((int)(((byte)(234)))));
        }
        ...
        private void PageBackstageOption_Load(object sender, EventArgs e)
        {
        ...
        {
            btnSaveSOPWaitTimeCloseOption.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(0)))), ((int)(((byte)(140)))), ((int)(((byte)(255)))));

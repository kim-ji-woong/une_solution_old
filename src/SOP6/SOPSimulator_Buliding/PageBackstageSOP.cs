...
{
    public partial class PageBackstageSOP : Form, IRibbonButtonOwner, Sections.ISectionListener, ITabPageSpecialWorker, ISectionContentsOwner
    {
        public class QuickSOPButton
        {
            ...
            private void InitButtonStatus()
            {
                ...
                if (m_btnSOP != null)
                {
                    m_btnSOP.Enabled = enableSOP && m_bEnable;
                }

                if (m_rbtnSOP != null)
                {
                    m_rbtnSOP.Enabled = m_bEnable && enableSOP;
                }
            }
        }
        ...
        private class ButtonTabControl
        {
            private ButtonTabPage[] m_tabPages = null;
            private ButtonTabPage m_selectedTabPage = null;
            private SectionTabControl m_tabControl = null;
            private int m_nCurrentDisasterID = -1;

            public ButtonTabPage[] TabPages
            {
                get { return m_tabPages; }
            }

            public ButtonTabPage SelectedTabPage
            {
                get { return m_selectedTabPage; }
                set
                {
                    SelectTabPage(value, true);
                    /*if (m_selectedTabPage != value)
                    {
                        if (m_selectedTabPage != null)
                            m_selectedTabPage.Selected = false;

                        m_selectedTabPage = value;

                        if (m_selectedTabPage != null)
                            m_selectedTabPage.Selected = true;
                    }*/
                }
            }
            ...
            {
                get { return m_nCurrentDisasterID; }
                set
                {
                    if (m_nCurrentDisasterID != value)
                    {
                        foreach (ButtonTabPage btnPage in m_tabPages)
                        {
                            btnPage.Enabled = false;
                            btnPage.SectionTabPage = null;

                            if (btnPage.Selected)
                                btnPage.Selected = false;
                        }

                        m_nCurrentDisasterID = value;
                        m_selectedTabPage = null;
                    }
                }
            }

            public ButtonTabControl(SectionTabControl tabControl)
            {
                m_tabPages = new ButtonTabPage[4]
                {
                    new ButtonTabPage(),
                    new ButtonTabPage(),
                    new ButtonTabPage(),
            ...
            public ButtonTabPage AddTabPage(SectionTabPage tabPage)
            {
                if (tabPage.Tag != null && tabPage.Tag is Data_ActionStep)
                {
                    Data_ActionStep actionStep = (Data_ActionStep)tabPage.Tag;

                    if (m_nCurrentDisasterID >= 0 && actionStep.DisasterID != m_nCurrentDisasterID)
                        return null;

                    m_nCurrentDisasterID = actionStep.DisasterID;

                    for (int i = 0; i < 4; i++)
                    {
                        if (actionStep.StepName == SectionTabControl.StandardActionStepNames[i])
                        {
                            m_tabPages[i].Enabled = true;
                            m_tabPages[i].SectionTabPage = tabPage;
                            return m_tabPages[i];
                        }
                    }
                }
            ...
            public ButtonTabPage SetTabPage(SectionTabPage tabPage, int nIndex)
            {
                m_tabPages[nIndex].Enabled = tabPage != null;
                m_tabPages[nIndex].SectionTabPage = tabPage;
                return m_tabPages[nIndex];
            }

            public SectionTabPage GetSectionTabPage(int nActionStepID, bool realMode)
            {
                if (m_tabPages == null)
                    return null;
                ...
                foreach (ButtonTabPage btnPage in m_tabPages)
                {
                    if (btnPage == null || btnPage.SectionTabPage == null)
                        continue;

                    if (btnPage.SectionTabPage.ActionStepID == nActionStepID && btnPage.SectionTabPage.VirtualMode == !realMode)
                        return btnPage.SectionTabPage;
                }
            ...
            public void InitTabPage()
            {
                /*for (int i = 0; i < 4; i++)
                {
                    m_tabPages[i].Enabled = false;
                    m_tabPages[i].SectionTabPage = null;
                }*/
            }

            public ButtonTabPage ClickButtonPage(RibbonButton btn)
            {
                for (int i = 0; i < 4; i++)
                {
                    ButtonTabPage tabPage = m_tabPages[i];

                    if (tabPage.Button == btn)
                    {
                        if (tabPage.SectionTabPage != null)
                        {
                            SelectTabPage(tabPage.SectionTabPage);
            ...
            public ButtonTabPage SelectTabPage(TabPage page)
            {
                if (page == null)
                    return null;
                ...
                for (int i = 0; i < 4; i++)
                {
                    ...
                    if (tabPage.SectionTabPage == page)
                    {
            ...
            public void SelectTabPage(ButtonTabPage tabPage, bool refresh)
            {
                if (m_selectedTabPage != tabPage)
                {
                    if (m_selectedTabPage != null)
                    {
                        m_selectedTabPage.Select(false, refresh);
                    }

                    m_selectedTabPage = tabPage;

                    if (m_selectedTabPage != null)
                    {
                        m_selectedTabPage.Select(true, refresh);
                    }
                }
            }

            public void EnableTabPages(List<TabPage> tabPages)
            {
                for (int i = 0; i < 4; i++)
                {
                    ButtonTabPage tabPage = m_tabPages[i];

                    if (tabPages.Contains(tabPage.SectionTabPage))
                    {
            ...
            {
                if (m_selectedTabPage != null)
                    m_selectedTabPage.RefreshControl();
            }
        }

        private class ButtonTabPage
        {
            private RibbonButton m_btn = null;
            private Label m_label = null;
            private SectionTabPage m_sectionTabPage = null;

            private bool m_enabled = false;
            private bool m_selected = false;

            private Image m_imgOriginMouseOver = null;

            private static Color m_disabledColor = Color.Black;
            private static Color m_normalColor = Color.FromArgb(132, 154, 214);
            private static Color m_selectedColor = Color.White;
                ...
                set
                {
                    if (m_enabled != value)
                    {
                        ...
                        if (m_enabled == false)
                        {
                            if (m_label != null)
                            {
                                m_label.ForeColor = m_disabledColor;
                                m_label.Refresh();
                            }
                        }
            ...
            public bool Selected
            {
                ...
                set
                {
                    ...
                    /*if (m_selected != value)
                    {
                        ...
                        if (m_btn != null)
                        {
                            m_btn.IsChecked = value;

                            if (m_btn.IsChecked)
                                m_btn.MouseOverImage = m_btn.CheckedImage;
                            else
                                m_btn.MouseOverImage = m_imgOriginMouseOver;
            ...
            public SectionTabPage SectionTabPage
            {
            ...
            public ButtonTabPage(RibbonButton btn, Label label)
            {
                SetButton(btn);
                m_label = label;
            }

            private void SetButton(RibbonButton btn)
            {
                m_btn = btn;

                if (m_btn != null)
                    m_imgOriginMouseOver = m_btn.MouseOverImage;
            }

            private void SetLabelColor(bool refresh = true)
            {
                if (m_selected)
                    m_label.ForeColor = m_selectedColor;
                else if (m_enabled)
                    m_label.ForeColor = m_normalColor;
                else
                    m_label.ForeColor = m_disabledColor;
            ...
            public void Select(bool isSelected, bool refresh)
            {
                if (m_selected != isSelected)
                {
                    ...
                    if (m_btn != null)
                    {
                        ...
                        if (refresh || isSelected == false)
                            m_btn.Refresh();
                    }

                    if (m_label != null)
                    {
                        SetLabelColor(refresh || isSelected == false);
                    }
                }
            }
        ...
        private bool m_allowSectionRefresh = true;
        private Dictionary<ISectionContents, ISectionContents> m_dicNeedRefreshContents2 = new Dictionary<ISectionContents, ISectionContents>();
        private Dictionary<PanelSectionEx, PanelSectionEx> m_dicNeedRefreshPanelSections = new Dictionary<PanelSectionEx, PanelSectionEx>();

        #region FormSOP의 버튼들
        private RibbonButton mainFormButtonLoadSOP = null;
        #endregion

        private Data.SOPScenarioTab m_scenarioTab = null;
        private int m_nTabControlHeight = 0;
        private ButtonTabControl m_btnTabControl = null;

        private WorkflowOption m_workflowOption = null;
        //private SectionTabPage m_currentTabPage = null;

        Dictionary<int, bool> m_dicStartComponentContents = new Dictionary<int, bool>();
        private ConcurrentDictionary<SectionTabPage, WorkflowOption> m_dicWaitForStartTabPages = new ConcurrentDictionary<SectionTabPage, WorkflowOption>();

        private bool m_noChangeSelectedTabPage = false;
        private SectionTabPage m_targetPage = null;
        private bool m_backgroundLoading = false;
        /*private List<TabPage> m_backgroundLoadingTabPages = null;

        public List<TabPage> BackgroundLoadingTabPages
        {
            get { return m_backgroundLoadingTabPages; }
            set { m_backgroundLoadingTabPages = value; }
        }*/

        public bool BackgroundLoading
        {
            get { return m_backgroundLoading; }
            set { m_backgroundLoading = value; }
        }

        public Data.SOPScenarioTab ScenarioTab
        {
            get { return m_scenarioTab; }
        }

        public SectionTabPage TargetPage
        {
            get { return m_targetPage; }
            set { m_targetPage = value; }
        }

        public bool NoChangeSelectedTabPage
        {
            get { return m_noChangeSelectedTabPage; }
            set { m_noChangeSelectedTabPage = value; }
        }

        public int CurrentDisasterID
        {
            get { return m_btnTabControl.CurrentDisasterID; }
            set { m_btnTabControl.CurrentDisasterID = value; }
        }
        ...
        public void SetCurrentWorkflowOption(WorkflowOption option)
        {
            m_workflowOption = option;
        }
        ...
        public bool AllowSectionRefresh
        {
            get { return m_allowSectionRefresh; }
            set { m_allowSectionRefresh = value; }
        }
        ...
        public void OnSelectMission(int nActionStepID, int nReal, int nComponentID, string strRowIndex)
        {
            if (WorkFlowManager.Instance.Get(nActionStepID, (nReal == 1 ? true : false)) != null)
            {
                ...
                {
                    ISectionContents content = GetProcessComponentContents(nActionStepID, (nReal == 1 ? true : false), nComponentID);
                    if (content == null)
                    {
                    ...
                    List<int> rowIndexList = GetRowIndexList(strRowIndex);

                    if (rowIndexList != null)
                        content.SelectRow(rowIndexList);
        ...
        private List<int> GetRowIndexList(string strIndexList)
        {
            string[] tokens = strIndexList.Split(',');
            List<int> indices = new List<int>();
            int nIndex;

            foreach (string strIndex in tokens)
            {
                if (int.TryParse(strIndex.Trim(), out nIndex) == false)
                    return null;
                else
                    indices.Add(nIndex);
            }
        ...
        public Dictionary<Section, ISectionContents> GetComponentContentsList(int nActionStepID, bool isRealMode, out SectionTabPage page)
        {
            page = GetTabPage(nActionStepID, isRealMode);
        ...
        public ISectionContents GetComponentContents(Section section)
        {
            if (section == null)
                return null;
            ...
            ISectionContents contents = null;
            page.SectionContents.TryGetValue(section, out contents);
            return contents;
        }

        public ISectionContents GetProcessComponentContents(int nActionStepID, bool isRealMode, int nComponentID)
        {
            ...
            if (page != null)
            {
                ...
                {
                    if (pair.Key.GetComponentType() == Section.ComponentType.PROCESS)
                    {
                        if (pair.Key.Data.ID == nComponentID)
                            return pair.Value;
                    }
                }
            }
        ...
        private Color m_colorPanel1 = Color.White;
        ...
        public PageBackstageSOP()
        {
            ...
            m_scenarioTab = new Data.SOPScenarioTab(this, panelScenarioTab);
            m_btnTabControl = new ButtonTabControl(tabControl);
            InitButtonTabControl();
            InitRibbonButtonFont();

            panelComponentContentsTitle.Tag = panelComponentContentsTitle.Name;

            Shape.ShapeStyleFactory = new SectionStyle.Fancy.StyleFactory();
            SectionTabPage.SectionContentsFactory = new SectionContents.Fancy.ContentsFactory();

            DeleteAllAIDFiles();
        }

        private void DeleteAllAIDFiles()
        {
            string strFolder = System.IO.Directory.GetCurrentDirectory();
            string[] files = System.IO.Directory.GetFiles(strFolder, "*.aid");
            ...
            System.Diagnostics.Trace.WriteLine(files);
        }

        private void InitRibbonButtonFont()
        {
            rbtnBroadcast.Font = new Font("나눔바른고딕", 14.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(129)));
            rbtnSMS.Font = new Font("나눔바른고딕", 14.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(129)));
        }

        private void InitButtonTabControl()
        {
            m_btnTabControl.TabPages[0].Button = rbtnActionStep1st;
            m_btnTabControl.TabPages[0].Label = labelActionStep1stName;
            m_btnTabControl.TabPages[1].Button = rbtnActionStep2nd;
            m_btnTabControl.TabPages[1].Label = labelActionStep2ndName;
            m_btnTabControl.TabPages[2].Button = rbtnActionStep3rd;
            m_btnTabControl.TabPages[2].Label = labelActionStep3rdName;
            m_btnTabControl.TabPages[3].Button = rbtnActionStep4th;
            m_btnTabControl.TabPages[3].Label = labelActionStep4thName;
        }
        ...
        private void SetSectionColor()
        {
            ...
            Arrow.TextFont = new Font("나눔바른고딕", 12, FontStyle.Regular);
        ...
        private void PageBackstageHome_Load(object sender, EventArgs e)
        {
            ...
            // Key : ButtonID
            // Value : SOP Full Path
            Dictionary<string, int> dicSOPIDs;
            m_dicQuickSOPs = LoadBookMark(out dicSOPIDs);
            AddQuickButtons(m_dicQuickSOPs, dicSOPIDs);
            InitButtons(m_dicQuickSOPs);
            FormSOP.Instance.NetworkManager.ReleaseConnection();
            ...
            if (m_scenarioTab.GetScenarioCount() > 0)
                ShowScenarioData(true);
        ...
        public SizeF GetMeasureString(string txt)
        {
            Graphics g = this.CreateGraphics();
            SizeF ss = g.MeasureString(txt, new System.Drawing.Font("나눔바른고딕", 14.25F, System.Drawing.FontStyle.Bold));
            return ss;
        }

        private void SetActionStepNames()
        {
            if (SectionTabControl.StandardActionStepNames.Count() < 4)
                return;

            labelActionStep1stName.Text = SectionTabControl.StandardActionStepNames[0];
            labelActionStep2ndName.Text = SectionTabControl.StandardActionStepNames[1];
            labelActionStep3rdName.Text = SectionTabControl.StandardActionStepNames[2];
            labelActionStep4thName.Text = SectionTabControl.StandardActionStepNames[3];
        }
        ...
        private void InitSplitSize()
        {
            ...
            this.splitContainerMain.Size = new Size(this.Size.Width - this.splitContainerMain.Location.X, this.Size.Height - splitContainerMain.Location.Y);
        ...
        // Key : ButtonID
        // Value : SOP Full Path        
        private void AddQuickButtons(Dictionary<int, QuickSOPButton> dicQuickSOPs, Dictionary<string, int> dicSOPIDs)
        {
            ...
            {
                ReadSOPQuickButton(dicSOPIDs, dicQuickSOPs);
                /*AddQuickButton2(global::SOPMonitoringSystem.Properties.Resources.Fire_Quick_Normal,
                    global::SOPMonitoringSystem.Properties.Resources.Fire_Quick_MouseOver,
                    global::SOPMonitoringSystem.Properties.Resources.Fire_Quick_Selected,
                    "화재", ID.ID_SOP_FIRE, dicQuickSOPs);

                AddQuickButton2(global::SOPMonitoringSystem.Properties.Resources.Earthquake_Quick_Normal,
                    global::SOPMonitoringSystem.Properties.Resources.Earthquake_Quick_MouseOver,
                    global::SOPMonitoringSystem.Properties.Resources.Earthquake_Quick_Selected,
                    "지진", ID.ID_SOP_EARTHQUAKE, dicQuickSOPs);

                AddQuickButton2(global::SOPMonitoringSystem.Properties.Resources.Terror_Quick_Normal,
                    global::SOPMonitoringSystem.Properties.Resources.Terror_Quick_MouseOver,
                    global::SOPMonitoringSystem.Properties.Resources.Terror_Quick_Selected,
                    "테러", ID.ID_SOP_TERROR, dicQuickSOPs);

                AddQuickButton2(global::SOPMonitoringSystem.Properties.Resources.Typhoon_Quick_Normal,
                    global::SOPMonitoringSystem.Properties.Resources.Typhoon_Quick_MouseOver,
                    global::SOPMonitoringSystem.Properties.Resources.Typhoon_Quick_Selected,
                    "강풍", ID.ID_SOP_TYPHOON, dicQuickSOPs);

                AddQuickButton2(global::SOPMonitoringSystem.Properties.Resources.Flood_Quick_Normal,
                    global::SOPMonitoringSystem.Properties.Resources.Flood_Quick_MouseOver,
                    global::SOPMonitoringSystem.Properties.Resources.Flood_Quick_Selected,
                    "침수", ID.ID_SOP_SUBMERGENCE, dicQuickSOPs);

                AddQuickButton2(global::SOPMonitoringSystem.Properties.Resources.PSM_Quick_Normal,
                    global::SOPMonitoringSystem.Properties.Resources.PSM_Quick_MouseOver,
                    global::SOPMonitoringSystem.Properties.Resources.PSM_Quick_Selected,
                    "유해가스", ID.ID_SOP_POLLUTION, dicQuickSOPs);

                AddQuickButton2(global::SOPMonitoringSystem.Properties.Resources.PowerOff_Quick_Normal,
                    global::SOPMonitoringSystem.Properties.Resources.PowerOff_Quick_MouseOver,
                    global::SOPMonitoringSystem.Properties.Resources.PowerOff_Quick_Selected,
                    "정전", ID.ID_SOP_POWEROFF, dicQuickSOPs);

                AddQuickButton2(global::SOPMonitoringSystem.Properties.Resources.Etc_Quick_Normal,
                    global::SOPMonitoringSystem.Properties.Resources.Etc_Quick_MouseOver,
                    global::SOPMonitoringSystem.Properties.Resources.Etc_Quick_Selected,
                    "기타", ID.ID_SOP_GENERAL_DISASTER, dicQuickSOPs);*/
            } 
        }

        private Dictionary<string, int> ReadSOPQuickButtonIDs(WebDBManager dbMgr)
        {
            Dictionary<string, int> dicSOPIDs = new Dictionary<string, int>();

            string strTag = "SOPQuickButton_";
            string strSQL = string.Format("Select PropertyName, PropertyValue from OptionSOPSimulator where PropertyName like '{0}%' and SiteID = {1} order by PropertyName", strTag, dbMgr.SiteID);
            ...
            for (int i = 0; i < nResultCount - 1; i += 2)
            {
                ...
                string strSOPName = tokens[0].Trim();
                string strSOPID = tokens[1].Trim();
                ...
                dicSOPIDs[strSOPName] = nSOPID;
            }

            return dicSOPIDs;
        }

        private void ReadSOPQuickButton(Dictionary<string, int> dicSOPIDs, Dictionary<int, QuickSOPButton> dicQuickSOPs)
        {
            foreach (KeyValuePair<string, int> pair in dicSOPIDs)
            {
                string strSOPName = pair.Key;
                int nSOPID = pair.Value;

                Bitmap bmpNormal, bmpMouseOver, bmpSelected;

                if (GetSOPImage(strSOPName, nSOPID, out bmpNormal, out bmpMouseOver, out bmpSelected))
                {
                    AddQuickButton2(bmpNormal, bmpMouseOver, bmpSelected, strSOPName, nSOPID, dicQuickSOPs);
                }
            }
        }

        private bool GetSOPImage(string strSOPName, int nSOPID, out Bitmap bmpNormal, out Bitmap bmpMouseOver, out Bitmap bmpSelected)
        {
            bmpNormal = bmpMouseOver = bmpSelected = null;

            if (nSOPID == ID.ID_SOP_FIRE)
            {
                bmpNormal = global::SOPMonitoringSystem.Properties.Resources.Fire_Quick_Normal;
                bmpMouseOver = global::SOPMonitoringSystem.Properties.Resources.Fire_Quick_MouseOver;
                bmpSelected = global::SOPMonitoringSystem.Properties.Resources.Fire_Quick_Selected;

                Popup.PopupQuickButtonSetup.SetSOPBitmap(strSOPName, nSOPID, global::SOPMonitoringSystem.Properties.Resources.화재_03_new);
            }
            else if (nSOPID == ID.ID_SOP_EARTHQUAKE)
            {
                bmpNormal = global::SOPMonitoringSystem.Properties.Resources.Earthquake_Quick_Normal;
                bmpMouseOver = global::SOPMonitoringSystem.Properties.Resources.Earthquake_Quick_MouseOver;
                bmpSelected = global::SOPMonitoringSystem.Properties.Resources.Earthquake_Quick_Selected;

                Popup.PopupQuickButtonSetup.SetSOPBitmap(strSOPName, nSOPID, global::SOPMonitoringSystem.Properties.Resources.지진_03_new);
            }
            else if (nSOPID == ID.ID_SOP_TERROR)
            {
                bmpNormal = global::SOPMonitoringSystem.Properties.Resources.Terror_Quick_Normal;
                bmpMouseOver = global::SOPMonitoringSystem.Properties.Resources.Terror_Quick_MouseOver;
                bmpSelected = global::SOPMonitoringSystem.Properties.Resources.Terror_Quick_Selected;

                Popup.PopupQuickButtonSetup.SetSOPBitmap(strSOPName, nSOPID, global::SOPMonitoringSystem.Properties.Resources.테러_03_new);
            }
            else if (nSOPID == ID.ID_SOP_TYPHOON)
            {
                bmpNormal = global::SOPMonitoringSystem.Properties.Resources.Typhoon_Quick_Normal;
                bmpMouseOver = global::SOPMonitoringSystem.Properties.Resources.Typhoon_Quick_MouseOver;
                bmpSelected = global::SOPMonitoringSystem.Properties.Resources.Typhoon_Quick_Selected;

                Popup.PopupQuickButtonSetup.SetSOPBitmap(strSOPName, nSOPID, global::SOPMonitoringSystem.Properties.Resources.태풍_03_new);
            }
            else if (nSOPID == ID.ID_SOP_SUBMERGENCE)
            {
                bmpNormal = global::SOPMonitoringSystem.Properties.Resources.Flood_Quick_Normal;
                bmpMouseOver = global::SOPMonitoringSystem.Properties.Resources.Flood_Quick_MouseOver;
                bmpSelected = global::SOPMonitoringSystem.Properties.Resources.Flood_Quick_Selected;

                Popup.PopupQuickButtonSetup.SetSOPBitmap(strSOPName, nSOPID, global::SOPMonitoringSystem.Properties.Resources.침수_03_new);
            }
            else if (nSOPID == ID.ID_SOP_POLLUTION)
            {
                bmpNormal = global::SOPMonitoringSystem.Properties.Resources.PSM_Quick_Normal;
                bmpMouseOver = global::SOPMonitoringSystem.Properties.Resources.PSM_Quick_MouseOver;
                bmpSelected = global::SOPMonitoringSystem.Properties.Resources.PSM_Quick_Selected;

                Popup.PopupQuickButtonSetup.SetSOPBitmap(strSOPName, nSOPID, global::SOPMonitoringSystem.Properties.Resources.오염_03_new);
            }
            else if (nSOPID == ID.ID_SOP_POWEROFF)
            {
                bmpNormal = global::SOPMonitoringSystem.Properties.Resources.PowerOff_Quick_Normal;
                bmpMouseOver = global::SOPMonitoringSystem.Properties.Resources.PowerOff_Quick_MouseOver;
                bmpSelected = global::SOPMonitoringSystem.Properties.Resources.PowerOff_Quick_Selected;

                Popup.PopupQuickButtonSetup.SetSOPBitmap(strSOPName, nSOPID, global::SOPMonitoringSystem.Properties.Resources.정전_03_new);
            }
            else if (nSOPID == ID.ID_SOP_GENERAL_DISASTER)
            {
                bmpNormal = global::SOPMonitoringSystem.Properties.Resources.Etc_Quick_Normal;
                bmpMouseOver = global::SOPMonitoringSystem.Properties.Resources.Etc_Quick_MouseOver;
                bmpSelected = global::SOPMonitoringSystem.Properties.Resources.Etc_Quick_Selected;

                Popup.PopupQuickButtonSetup.SetSOPBitmap(strSOPName, nSOPID, global::SOPMonitoringSystem.Properties.Resources.기타_03_new);
            }
            else if (nSOPID == ID.ID_SOP_HEAVY_SNOW)
            {
                bmpNormal = global::SOPMonitoringSystem.Properties.Resources.Etc_Quick_Normal;
                bmpMouseOver = global::SOPMonitoringSystem.Properties.Resources.Etc_Quick_MouseOver;
                bmpSelected = global::SOPMonitoringSystem.Properties.Resources.Etc_Quick_Selected;

                Popup.PopupQuickButtonSetup.SetSOPBitmap(strSOPName, nSOPID, global::SOPMonitoringSystem.Properties.Resources.폭설_03_new);
            }
            else if (nSOPID == ID.ID_SOP_SECURITY)
            {
                ...
                Popup.PopupQuickButtonSetup.SetSOPBitmap(strSOPName, nSOPID, global::SOPMonitoringSystem.Properties.Resources.방범_03_new);
            }
            else if (nSOPID == ID.ID_SOP_CORONA)
            {
                bmpNormal = global::SOPMonitoringSystem.Properties.Resources.Corona_Quick_Normal;
                bmpMouseOver = global::SOPMonitoringSystem.Properties.Resources.Corona_Quick_MouseOver;
                bmpSelected = global::SOPMonitoringSystem.Properties.Resources.Corona_Quick_Selected;
        ...
        private void AddQuickButton(Image cImg, Image norBack, Image ovBack, string strButtonName, int nButtonID, Dictionary<int, QuickSOPButton> dicQuickSOPs, BtnImgStartPosition position = BtnImgStartPosition.NONE)
        {
            ...
            else
            {
                ...
                btn = new RibbonButtonQuick(cImg.Size.Width);
                btn.NormalImage = cImg;
                btn.BackColor = Color.Transparent;
                //btn.BackgroundImage = norBack;
                ...
                btn.Owner = this.panelBackImage;
                btn.Size = cImg.Size;
                btn.CustomImageRect = new Rectangle(0, 0, cImg.Size.Width, cImg.Size.Height);
                btn.InitButtonWidth = cImg.Size.Width;
        ...
        // Key : ButtonID
        // Value : SOP Full Path
        private void AddQuickButton2(Image imgNormal, Image imgMouseOver, Image imgSelected, string strButtonName, int nButtonID, Dictionary<int, QuickSOPButton> dicQuickSOPs, BtnImgStartPosition position = BtnImgStartPosition.NONE)
        {
            RibbonButtonQuick btn = new RibbonButtonQuick(imgNormal.Size.Width);
            btn.NormalImage = imgNormal;
            btn.BackColor = Color.Transparent;
            btn.MouseOverImage = imgMouseOver;
            btn.ClickedImage = imgSelected;
            btn.UseCustomImageRect = true;
            //btn.Name = strButtonName;
            btn.Owner = this.panelBackImage;
            btn.Size = imgNormal.Size;
            btn.CustomImageRect = new Rectangle(0, 0, imgNormal.Size.Width, imgNormal.Size.Height);
            btn.InitButtonWidth = imgNormal.Size.Width;
            btn.UseVisualStyleBackColor = true;
        ...
        private void InitButtons(Dictionary<int, QuickSOPButton> dicQuickSOPs)
        {
            ...
            foreach (KeyValuePair<int, QuickSOPButton> pair in dicQuickSOPs)
            {
                pair.Value.ButtonEnable = true;
            }
        }
        ...
        // Key : ButtonID
        // Value : SOP Full Path
        Dictionary<int, QuickSOPButton> LoadBookMark(out Dictionary<string, int> dicSOPIDs)
        {
            ...
            dicSOPIDs = ReadSOPQuickButtonIDs(dbMgr);

            foreach (KeyValuePair<string, int> pair in dicSOPIDs)
            {
                LoadBookMarkButton(dicQuickSOPs, pair.Value, dbMgr);
            }
            ...
            LoadBookMarkButton(dicQuickSOPs, ID.ID_SOP_POWEROFF, dbMgr);*/
        ...
        private void PageBackstageHome_Resize(object sender, EventArgs e)
        {
            ...
            if (panelTabPage.Visible == true)
            {
                SetTabControlArea();
                //panelLeft.Size = new Size(panelLeft.Size.Width, panelLeft.Parent.ClientSize.Height);
            }

            panelLeft.Size = new Size(panelLeft.Size.Width, panelLeft.Parent.ClientSize.Height);
        }

        private void SetTabControlArea()
        {
            panelScenarioTab.Size = new Size(splitContainerMain.Size.Width, panelScenarioTab.Size.Height);
            //panelTabPage.Location = new Point(panelLeft.Size.Width, tabControl.Location.Y);
            panelTabPage.Size = new Size(splitContainerMain.Panel1.ClientSize.Width, splitContainerMain.Panel1.ClientSize.Height - panelTabPage.Location.Y);
            tabControl.Location = new Point(-m_nTabControlHeight, 0);
            tabControl.Size = new Size(panelTabPage.Size.Width + m_nTabControlHeight, panelTabPage.Size.Height);
        }
        ...
        public void OpenSOP()
        {
            ...
            panelBackImage.UseColorFilter = false;
        }

        // SOP 버전이 바뀌지 않았는지 검사한다.
        public bool CheckSOPVersion()
        {
            VariousData<DateTime> dtSOP = null, dtMember = null;
        ...
        public void ShowComponentContents()
        {
            ...
            {
                m_nInitSplitterDistance = (FormSOP.Instance.Size.Width - this.splitContainerMain.Location.X) / 2 - 2;
        ...
        public TabPage AddTabPage(Data_ActionStep data, int nActionStepHistoryID, bool bReal, bool addTabPage)
        {
            if (m_nTabControlHeight == 0)
            {
                m_nTabControlHeight = tabControl.ItemSize.Height + 3;
                SetTabControlArea();
            }

            ShowScenarioData(true);
            //panelScenarioTab.Visible = panelLeft.Visible = true;

            SectionTabPage tabPage = MakeTabPage(data, nActionStepHistoryID, bReal);
            ...
            if (tabPage == null)
            {
                ...
                //tabPage.PanelComponentContents.Resize += new EventHandler(PanelComponentContents_Resize);
                tabPage.PanelComponentContents.AutoScroll = true;
            ...
            tabPage.Mode = SectionTabPage.SOPMode.Wait_Self;
            tabPage.IsNormal = data.IsNormal;*/

            if (addTabPage)
                tabControl.AddTabPage(tabPage);

            if (GetCurrentTabPage() == null)
            {
                if (tabControl.SelectedTab == null)
                    SelectTabPage(tabPage);
            }

            m_scenarioTab.AddTabPage(tabPage, data.DisasterID, nActionStepHistoryID);
            //tabControl.SelectedTab = tabPage;

            ButtonTabPage btnTabPage = m_btnTabControl.AddTabPage(tabPage);

            //if (btnTabPage != null)
            //    m_btnTabControl.SelectTabPage(btnTabPage, false);
            
            panelBackImage.BackColor = Color.FromArgb(242, 242, 242);
            tabPage.ReSizePanel();

            return tabPage;
        }

        public SectionTabPage MakeTabPage(Data_ActionStep data, int nActionStepHistoryID, bool bReal)
        {
            int ActionStepID = data.ID;
            SectionTabPage tabPage = (SectionTabPage)TabPageManager.Instance.GetPage(ActionStepID, bReal);
            if (tabPage == null)
        ...
        public SectionTabPage GetActionStepPage(string strActionStepName)
        {
            foreach (ButtonTabPage btnPage in m_btnTabControl.TabPages)
            {
                if (btnPage.SectionTabPage != null && btnPage.SectionTabPage.Text == strActionStepName)
                    return btnPage.SectionTabPage;
            }
        ...
        /*private void PanelComponentContents_Resize(object sender, EventArgs e)
        {
            Panel panelComponentContents = (Panel)sender;

            foreach (Control ctrl in panel.Controls)
            {
                if (ctrl is ISectionContents)
                {
                    ctrl.Size = new Size()
                }
            }
        ...
        public TabPage AddTabPage(Data_ActionStep data, bool addTabPage)
        {
            bool bReal = FormSOP.Instance.IsReal;

            if (panelTabPage.Visible == false)
            ...
            return AddTabPage(data, -1, bReal, addTabPage);
        }
        ...
        public ArrayList AddPane(ArrayList arrTeams, int nActionStepID, TabPage tabPage, bool clearAllPanels = true)
        {
            if (clearAllPanels)
                m_arrPanel.Clear();
        ...
        private TabPage GetCurrentButtonPage()
        {
            if (m_btnTabControl.SelectedTabPage == null)
                return null;

            return m_btnTabControl.SelectedTabPage.SectionTabPage;
        }

        public void SelectTab(TabPage tabPage)
        {
            if (tabControl.SelectedTab == tabPage && GetCurrentButtonPage() == tabPage)
                return;

            SelectTabPage((SectionTabPage)tabPage);
            //tabControl.SelectedTab = tabPage;
            ...
            m_btnTabControl.SelectTabPage(tabPage);
        ...
        private ArrayList GetTabPagePanels(SectionTabPage tabPage)
        {
            if (tabPage != null)
            {
                ArrayList arrPanels = new ArrayList();
        ...
        {
            SectionTabPage tabPage = GetTabPage(nActionStepID, true);

            if (tabPage == null)
            {
                tabPage = GetTabPage(nActionStepID, false);
            }
        ...
        public WorkFlow GetWorkflow(Section section)
        {
            if (section == null)
                return null;
        ...
        public void OnSelectedSection(Sections.Section section)
        {
            ...
            int nActionStepHistoryID = GetActionStepHistoryID(section);

            if (nActionStepHistoryID < 0)
                return;

            if (FormSOP.Instance.HasSOPControl(nActionStepHistoryID) && IsWorkingMode(section))
        ...
        private int GetActionStepHistoryID(Sections.Section section)
        {
            if (section == null)
                return -1;
            ...
            return tabPage.ActionStepHistoryID;
        }
        ...
        public void SetBackgroundImage(bool isVisible)
        {
            if (!isVisible)
            {
                if (UnE.SOP.ProxySOP.Instance.SiteID == 100 || UnE.SOP.ProxySOP.Instance.SiteID == 101)
                {
                    if (m_bmpQuickMain == null)
                    {
                        if (UnE.SOP.ProxySOP.Instance.SiteID == 100)
                            m_bmpQuickMain = new Bitmap(global::SOPMonitoringSystem.Properties.Resources.Quick_Main_100, new Size(650, 550));
                        else
                            m_bmpQuickMain = new Bitmap(global::SOPMonitoringSystem.Properties.Resources.Quick_Main, new Size(650, 550));
                    }
                    panelBackImage.BackgroundImage = (Image)m_bmpQuickMain;
                    /*Bitmap bitmap = null;
                    if (UnE.SOP.ProxySOP.Instance.SiteID == 100)
                        bitmap = new Bitmap(global::SOPMonitoringSystem.Properties.Resources.Quick_Main_100, new Size(650, 550));                    
                    else
                        bitmap = new Bitmap(global::SOPMonitoringSystem.Properties.Resources.Quick_Main, new Size(650, 550));
                ...
                else
                {
                    ...
                    panelBackImage.BackgroundImage = m_bmpBackgroundSymbol;
                    panelBackImage.BackgroundImageLayout = ImageLayout.Center;
            ...
            else
            {
                ...
                //panelBackImage.BackgroundImage = bitmap;
                panelBackImage.BackgroundImage = m_bmpBackgroundNon;
                panelBackImage.BackgroundImageLayout = ImageLayout.None;

                if (splitContainerMain.Visible == false)
        ...
        private Bitmap m_bmpQuickMain = null;
        private Bitmap m_bmpBackgroundSymbol = new Bitmap(global::SOPMonitoringSystem.Properties.Resources.Background_Symbol);
        private Bitmap m_bmpBackgroundNon = new Bitmap(global::SOPMonitoringSystem.Properties.Resources.BackgroundNon);

        public void SetBackgroundImage(Bitmap bmp)
        {
            m_bmpBackgroundSymbol = bmp;
        }

        public void GetComponentContents(int nActionStepHistoryID, int nActionStepID, int nComponentHistoryID, Sections.Section.ComponentType componentType, DateTime time, string strComponentType, string strTask, string strStatus, Sections.Section section, State sectionState, int nCheckNotify1, int nCheckNotify2)
        {
            if (section == null)
                return;
            ...
            if (FormSOP.Instance.HasSOPControl(nActionStepHistoryID) == false)
                return;

            WorkFlow currentWork = WorkFlowManager.Instance.Get(nActionStepHistoryID);
            //WorkFlow currentWork = FormSOP.Instance.CurrentWork;

            if (currentWork == null)
                return;

            SectionState state = currentWork.FindState(section);
            Sections.PanelSectionEx panel = (Sections.PanelSectionEx)section.GetParent();
            ...
            ISectionContents frmContents = GetComponentContents(/*nActionStepID, !page.VirtualMode, */section);
            ...
            if (nSelectedActionID == nActionStepID)
            {
                ...
                if (state.State == State.RUN)
                {
                    UpdateComponentContents(frmContents, strTask, time, strStatus, section, sectionState, nCheckNotify1, nCheckNotify2, state.CheckedRun, state.CheckedComplete);
                ...
                else if (state.State == State.DONE)
                {
                    ...
                    if (frmContents != null)
                    {
                        ...
                        {
                            string strOldTitle = frmContents.Title;
                            ...
                            if (strTemp[strTemp.Length - 1] != "실행완료")
                            {
                                if (strTemp.Length > 1)
                                {
                                    ...
                                    frmContents.EnableControl = false;
                                    SectionContentsHelper.ChangeTitle(frmContents, strNewTitle, currentWork.Option);
        ...
        private void UpdateComponentContents(ISectionContents frmContents, string strTask, DateTime time, string strStatus, Sections.Section section, State sectionState, int nCheckNotify1, int nCheckNotify2, int nCheckedRun, int nCheckedComplete)
        {
            if (section.Data.SectionNumber > 0)
                strTask = section.Data.SectionNumber.ToString() + ". " + strTask;
            ...
            SectionContentsHelper.SetTitle(frmContents, strTask, time, strStatus);
            SectionContentsHelper.ChangeTitle(frmContents);
            frmContents.State = sectionState;
        ...
        public void SelectComponentContents(int nActionStepID, bool isRealMode, Sections.Section section)
        {
            this.Invoke((MethodInvoker)delegate
            {
                ...
                if (workFlow != null)
                    workFlow.SelectSection(section);
            });
        ...
        private void SelectComponentContents(SectionTabPage page, ISectionContents contents)
        {
            ...
            work.SelectSection(contents.Section);
            ...
            foreach (Control ctrl in panel.Controls)
            {
                if (ctrl is ComponentContents)
                {
                    ...
                    if (contents != frmContents)
                    {
                        ...
                        if (contents.Section.Shape.ShapeStyler == null)
                        {
        ...
        public void SelectComponentContents(ISectionContents contents, bool callFromInvoke = false)
        {
            if (contents == null || contents.Section == null)
                return;

            if (callFromInvoke)
                SelectComponentContents((SectionTabPage)contents.Section.GetParent().Parent, contents);
            else
            {
                this.Invoke((MethodInvoker)delegate
                {
        ...
        private void SetMissionStatus(int nActionStepID, bool isRealMode, Section currSection)
        {
            ...
            if (page == null || page.SectionContents == null)
            {
            ...
            Dictionary<Section, ISectionContents> dicSectionContents = page.SectionContents;
            WorkFlow work = WorkFlowManager.Instance.Get(nActionStepID, isRealMode);

            if (work != null)
            {
                frmMissionStatus.Title = work.SOPName;
            }
            else
            {
            ...
            if (dicSectionContents.Count >= 2)
            {
                ISectionContents component = null;

                if (work != null)
                {
                    bool hasRunComponent = false;

                    ISectionContents _item = null;
                    DateTime dtLatest = new DateTime();

                    foreach (KeyValuePair<Section, ISectionContents> pair in dicSectionContents)
                    {
                        ISectionContents contents = pair.Value;
                        SectionState state = work.FindState(pair.Key);
                    ...
                    if (hasRunComponent == false)
                    {
                        foreach (KeyValuePair<Section, ISectionContents> pair in dicSectionContents)
                        {
                            ...
                            if (state != null && state.State == State.INPUT)
                            {
                                ...
                                {
                                    component = contents;
                                    frmMissionStatus.SetContents(contents, FormMissionStatus.ItemType.CURRENT_ITEM);
                                    break;
                                }
                            }
                        }
                ...
                if (component != null)
                {
                    frmMissionStatus.SetContents(component.NextContents, FormMissionStatus.ItemType.NEXT_ITEM);
                }
                else
                {
        ...
        /*private void UpdateComponentContents(ISectionContents frmContents, string strTask, DateTime time, string strStatus, Sections.Section section, State sectionState, int nCheckNotify1, int nCheckNotify2, int nCheckedRun, int nCheckedComplete)
        {
            ...
            UpdateComponentContents(frmContents, strTitle, time, strStatus, section, sectionState, nCheckNotify1, nCheckNotify2, nCheckedRun, nCheckedComplete);
        }*/

        public void AddScenario(SOPScenario sopSC, SectionTabPage page)
        {
            string strTrgDisasterPath = GetDisasterPath(sopSC);
            int nScenarioCount = m_scenarioTab.GetScenarioCount();

            for (int i = 0; i < nScenarioCount; i++)
            {
                SOPScenario scenario = m_scenarioTab.GetScenario(i);

                if (scenario != null && scenario.ActionStepID == sopSC.ActionStepID)
                {
                    if (scenario.RealMode == sopSC.RealMode)
                    {
                        m_scenarioTab.RemoveAt(i);
                        i--;
                        nScenarioCount--;
                    }
            ...
            SectionTabPage[] removeTabPages = null;
            ...
            for (int i = 0; i < nScenarioCount; i++)
            {
                ...
                if (scenario.ActionStepID != sopSC.ActionStepID)
                {
                    ...
                    if (strDisasterPath == strTrgDisasterPath)
                    {
                        ...
                        bool isSelectedScenario = scenario == m_scenarioTab.CurrentScenario;

                        removeTabPages = m_scenarioTab.GetTabPages(scenario.DisasterID, scenario.ActionStepHistoryID);

                        SectionTabPage[] pages = m_scenarioTab.GetTabPages(scenario.DisasterID, scenario.ActionStepHistoryID);
                        SectionTabPage scenarioPage = m_scenarioTab.RemoveAt(i);

                        if (scenarioPage != null)
                        {
                            m_scenarioTab.Insert(i, scenario, scenarioPage);

                            // 삭제되었던 페이지들을 다시 복구시킨다.
                            foreach (SectionTabPage _page in pages)
                            {
                                if (_page == null || _page.ActionStepID == scenarioPage.ActionStepID)
                                    continue;

                                m_scenarioTab.AddTabPage(_page, scenario.DisasterID, scenario.ActionStepHistoryID);
                            }

                            if (isSelectedScenario)
                                m_scenarioTab.Select(scenario);
                        }

                        UpdateScenarioPage(scenario, scenarioPage, removeTabPages);
                        break;
                    }
                }
            }

            int idx = m_scenarioTab.Add(sopSC, page);

            // SOP가 진행중인 Page를 m_scenarioTab에 삽입한 이후에는 그 나머지 세개의 탭 페이지도 채워준다.
            if (m_btnTabControl.CurrentDisasterID == sopSC.DisasterID)
            {
                foreach (ButtonTabPage btnPage in m_btnTabControl.TabPages)
                {
                    if (btnPage.SectionTabPage != null && btnPage.SectionTabPage.ActionStepID != page.ActionStepID)
                    {
                        m_scenarioTab.AddTabPage(btnPage.SectionTabPage, sopSC.DisasterID, btnPage.SectionTabPage.ActionStepHistoryID);
                    }
                }
            }
            ...
            // 해당 시나리오를 선택시킨다.
            if (m_scenarioTab.CurrentScenario != null && m_scenarioTab.CurrentScenario.DisasterID == sopSC.DisasterID)
            {
                int nIndex1 = m_scenarioTab.GetActionStepIndex(m_scenarioTab.CurrentScenario.ActionStepName);
                int nIndex2 = m_scenarioTab.GetActionStepIndex(sopSC.ActionStepName);

                if (nIndex2 > nIndex1)
                    m_scenarioTab.Select(sopSC);
            }

            UpdateScenarioPage(sopSC, page, removeTabPages);

            if (NoChangeSelectedTabPage == false && idx == 0)
                m_scenarioTab.Select(idx);
        ...
        private void UpdateScenarioPage(SOPScenario scenario, SectionTabPage scenarioPage, SectionTabPage[] tabPages)
        {
            if (tabPages == null)
                return;
            ...
            foreach (SectionTabPage tabPage in tabPages)
            {
                if (tabPage != null)
                {
                    if (scenarioPage == null || scenarioPage.ActionStepID != tabPage.ActionStepID)
                        m_scenarioTab.AddTabPage(tabPage, scenario.DisasterID, scenario.ActionStepHistoryID);
                }
            }
        }
        ...
        public void RemoveScenario(SOPScenario sopSC, bool bCloseTab = true)
        {
            int nIndex = m_scenarioTab.IndexOf(sopSC);

            if (nIndex >= 0)
            {
                m_scenarioTab.RemoveAt(nIndex);
                ...
                if (nSameCount == 1)
                {
                    ...
                    m_scenarioTab.UpdateText(nOneIndex);
                }

                if (nScenarioCount == 0 && bCloseTab)
                {
                    EmptySOP();
                }
            }
        ...
        {
            ShowScenarioData(false);
            //panelScenarioTab.Visible = panelLeft.Visible = false;
            FormSOP.Instance.EmptySOP();
            m_btnTabControl.CurrentDisasterID = -1;
            //m_currentTabPage = null;
            panelBackImage.BackColor = Color.FromArgb(52, 73, 94);
            panelBackImage.Refresh();
        }

        private void ShowScenarioData(bool visible)
        {
            panelScenarioTab.Visible = panelLeft.Visible = visible;

            foreach (KeyValuePair<int, QuickSOPButton> pair in m_dicQuickSOPs)
            {
                if (pair.Value.SOPRibbonButton != null)
                    pair.Value.SOPRibbonButton.Visible = !visible;
            }
        }

        public void SelectScenario(SOPScenario sopSC)
        {
            SOPScenario currentScenario = m_scenarioTab.CurrentScenario;

            if (currentScenario == sopSC)
            {
        ...
        public void ChangeScenario(SOPScenario scenario, SectionTabPage tabPage)
        {
            SOPScenario currentScenario = m_scenarioTab.CurrentScenario;

            if (currentScenario == scenario)
            {
                if (m_btnTabControl.CurrentDisasterID != scenario.DisasterID)
                {
                    m_btnTabControl.CurrentDisasterID = scenario.DisasterID;
                    SectionTabPage[] tabPages = m_scenarioTab.GetTabPages(scenario.DisasterID, scenario.ActionStepHistoryID);

                    if (tabPages != null)
                    {
                        for (int i = 0; i < tabPages.Count(); i++)
                        {
                            SectionTabPage page = tabPages[i];
                            m_btnTabControl.SetTabPage(page, i);
                        }
                    }
                }
                ...
                if (tabPage != null)
                {
                    ButtonTabPage btnPage = m_btnTabControl.SelectTabPage(tabPage);
                    
                    //if (btnPage == null)
                    //    tabControl.SelectedIndex = nPageIndex;
                    //else
                    {
                        ...
                        {
                            SectionTabPage page = pages[i];

                            if (page != null)
                            {
                                tabControl.AddTabPage(page);
                        ...
                        tabControl.SelectedIndex = nSelectedIndex;
                        //SetComponentContentsPanel(tabPage.PanelComponentContents);
                        //ShowComponentContents();
                    }
                }
        ...
        // 실행중인 새로운 ActionStepHistory들을 열고 나면 실행중인 SOP 이외에 같은 Disaster 안에 있는 다른 ActionStep들도 열어서 TabPage에 저장시킨다.
        public void PostAddNewActionStepHistories(List<Data_ActionStepHistory> newHistories)
        {
            // Key : 상위 4바이트(Disaster ID), 하위 4바이트(ActionStepHistoryID)
            // Value : Disater ID에 대하여 현재 로딩중인 ActionStep ID들
            Dictionary<long, List<int>> dicDisasterActionSteps = new Dictionary<long, List<int>>();
            List<int> actionStepIDs = null;

            foreach (Data_ActionStepHistory actionStepHistory in newHistories)
            {
                ActionStepInfo actionStep = FormSOP.Instance.SOPManager.GetActionStepInfo(actionStepHistory.ActionStepID);

                if (actionStep != null)
                {
                    long key = MakeKey(actionStep.DisasterID, actionStepHistory.ID);

                    if (dicDisasterActionSteps.TryGetValue(key, out actionStepIDs) == false)
                    {
                        actionStepIDs = new List<int>();
                        dicDisasterActionSteps[key] = actionStepIDs;
                    }

                    if (actionStepIDs.Contains(actionStep.ActionStepID) == false)
                        actionStepIDs.Add(actionStep.ActionStepID);
                }
            }

            string strDisasterIDs = "";

            foreach (KeyValuePair<long, List<int>> pair in dicDisasterActionSteps)
            {
                int nDisasterID = (int)(pair.Key >> 32);
                int nActionStepHistoryID = (int)(pair.Key & 0xffffffff);
                SectionTabPage[] tabPages = m_scenarioTab.GetTabPages(nDisasterID, nActionStepHistoryID);
                ...
                if (tabPages != null)
                {
                    foreach (SectionTabPage tabPage in tabPages)
                    {
                        if (tabPage != null)
                        {
                            if (pair.Value.Contains(tabPage.ActionStepID) == false)
                                pair.Value.Add(tabPage.ActionStepID);
                        }
                    }
                }

                if (m_btnTabControl.CurrentDisasterID == nDisasterID)
                {
                    foreach (ButtonTabPage btnPage in m_btnTabControl.TabPages)
                    {
                        if (btnPage.SectionTabPage != null)
                        {
                            if (pair.Value.Contains(btnPage.SectionTabPage.ActionStepID) == false)
                                pair.Value.Add(btnPage.SectionTabPage.ActionStepID);
                        }
                    }
                }
                ...
                if (strDisasterIDs.Length == 0)
                    strDisasterIDs = nDisasterID.ToString();
                else
                    strDisasterIDs += ", " + nDisasterID.ToString();
            }
            ...
            {
                WebDBManager dbMgr = FormSOP.Instance.DBManager;
                string strSQL = "Select ID, DisasterID from ActionStep where DisasterID in (" + strDisasterIDs + ")";
                ArrayList arrResult = dbMgr.GetResultData(strSQL);

                if (arrResult == null)
                    return;

                Dictionary<int, ArrayList> dicDisasterActionStep2 = new Dictionary<int, ArrayList>();
                ArrayList arrActionSteps;
                int nResultCount = arrResult.Count;
                ...
                for (int i=0;i<nResultCount-1;i+=2)
                {
                    ...
                    Data_ActionStepHistory actionStepHistory = GetActionStepHistory(newHistories, disasterID.Data);

                    if (actionStepHistory != null)
                    {
                        long key = MakeKey(disasterID.Data, actionStepHistory.ID);

                        if (dicDisasterActionSteps.TryGetValue(key, out actionStepIDs))
                        {
                            if (actionStepIDs.Contains(actionStepID.Data) == false)
                            {
                                if (dicDisasterActionStep2.TryGetValue(disasterID.Data, out arrActionSteps) == false)
                                {
                                    arrActionSteps = new ArrayList();
                                    dicDisasterActionStep2[disasterID.Data] = arrActionSteps;
                                }

                                ActionStepInfo actionStep = FormSOP.Instance.SOPManager.GetActionStepInfo(actionStepID.Data);

                                if (actionStep != null)
                                    arrActionSteps.Add(actionStep);
                            }
                        }
                    }
                }
                ...
                foreach (KeyValuePair<int, ArrayList> pair in dicDisasterActionStep2)
                {
                    if (pair.Value.Count == 0)
                        continue;

                    int nActionStepCount = pair.Value.Count;

                    for (int i=nActionStepCount-1;i>=0;i--)
                    {
                        ActionStepInfo actionStep = (ActionStepInfo)pair.Value[i];
                        SectionTabPage tabPage = m_scenarioTab.GetTabPage(pair.Key, actionStep.ActionStepID);
                    ...
                    ArrayList arrTeams = ioMgr.LoadBarPage(this, pair.Value, dbMgr);

                    if (arrTeams == null)
                        continue;

                    List<TabPage> tabPages = new List<TabPage>();
                    bool addTabPage = m_btnTabControl.CurrentDisasterID == pair.Key;

                    if (ioMgr.LoadPane(dbMgr, this, pair.Value, arrTeams, tabPages, addTabPage))
                    {
                        if (m_btnTabControl.CurrentDisasterID == pair.Key)
                        {
                            // 하나의 DisasterID에 대하여 여러개의 ActionStepHistoryID가 동시에 존재할 수 있지만 상관없다.
                            // 어차피 모두 같은 SectionTabPage들을 공유한다.
                            Data_ActionStepHistory actionStepHistory = GetActionStepHistory(newHistories, pair.Key);

                            if (actionStepHistory != null)
                            {
                                SectionTabPage[] pages = m_scenarioTab.GetTabPages(pair.Key, actionStepHistory.ID);

                                if (pages != null)
                                {
                                    foreach (SectionTabPage page in pages)
                                    {
                                        if (page == null)
                                            continue;

                                        SectionTabPage _page = null;

                                        foreach (SectionTabPage _tabPage in tabPages)
                                        {
                                            if (_tabPage.ActionStepID == page.ActionStepID)
                                            {
                                                _page = _tabPage;
                                                break;
                                            }
                    ...
                    foreach (TabPage page in tabPages)
                    {
                        ...
                        int nIndex = m_scenarioTab.GetActionStepIndex(page.Text);

                        if (nIndex >= 0)
                            m_btnTabControl.SetTabPage((SectionTabPage)page, nIndex);
                    }
                }
            }

            SectionTabPage selectedTabPage = (SectionTabPage)tabControl.SelectedTab;

            if (selectedTabPage != null && selectedTabPage.ActionStepHistoryID > 0)
            {
                SOPScenario scenario = SOPScenarioManager.Instance.GetSOPScenario(selectedTabPage.ActionStepHistoryID);
        ...
        public void LoadActionStep(ActionStepInfo actionStep)
        {
            SOPScenario scenario = m_scenarioTab.CurrentScenario;
            ...
            ArrayList arrTeams = ioMgr.LoadBarPage(this, arrActionSteps, dbMgr);

            if (arrTeams != null)
            {
                List<TabPage> tabPages = new List<TabPage>();

                if (ioMgr.LoadPane(dbMgr, this, arrActionSteps, arrTeams, tabPages, true))
                {
                    if (tabPages.Count > 0)
                    {
                        m_scenarioTab.AddTabPage((SectionTabPage)tabPages[0], actionStep.DisasterID, scenario.ActionStepHistoryID);
                        m_btnTabControl.CurrentDisasterID = scenario.DisasterID;
                        ...
                        if (pages != null)
                        {
                            ...
                            {
                                if (pages[i] != null)
                                    m_btnTabControl.SetTabPage(pages[i], i);
                            }
                        }
                    }
                }
        ...
        private Data_ActionStepHistory GetActionStepHistory(List<Data_ActionStepHistory> actionStepHistories, int nDisasterID)
        {
            foreach (Data_ActionStepHistory actionStepHistory in actionStepHistories)
            {
                ActionStepInfo actionStep = FormSOP.Instance.SOPManager.GetActionStepInfo(actionStepHistory.ActionStepID);

                if (actionStep != null && actionStep.DisasterID == nDisasterID)
        ...
        private void EnableQuickButton(QuickSOPButton btnSOP, bool enabled)
        {
        ...
        public void OnEnabled(bool isFlag)
        {
            foreach (KeyValuePair<int, QuickSOPButton> pair in m_dicQuickSOPs)
            {
                EnableQuickButton(pair.Value, true);
                //EnableQuickButton(pair.Value, isFlag);
            }
            ...
            m_scenarioTab.Enabled = isFlag;
            //mainFormButtonLoadSOP.Enabled = isFlag;

            foreach (SectionTabPage page in this.TabControls.TabPages)
            {
                if (page.SectionContents == null)
                    continue;

                SOPScenario scenario = SOPScenarioManager.Instance.GetSOPScenario(page.ActionStepHistoryID);

                if (scenario != null)
                    scenario.Enabled = isFlag;

                foreach (KeyValuePair<Section, ISectionContents> pair in page.SectionContents)
                {
                    if (pair.Key is SectionEndPoint)
                    {
                        // SOP 실행중에는 시작 Section은 제어권과 관계없이 항상 Disabled 상태이어야 한다.
                        SectionDataEndPoint data = (SectionDataEndPoint)pair.Key.Data;

                        if (data.IsBegin)
                            continue;
                    }

                    pair.Value.EnableControl = isFlag;
                }
            }
            //foreach (object obj in splitContainerMain.Panel2.Controls)
            //{
        ...
        public void ChangeTabPage(SectionTabPage tabPage, int nDisasterID, int nActionStepHistoryID)
        {
            // m_btnTabControl과 TabControl의 전체 TabPage Set을 바꾼다.
            m_btnTabControl.CurrentDisasterID = nDisasterID;
            SectionTabPage[] tabPages = m_scenarioTab.GetTabPages(nDisasterID, nActionStepHistoryID);
            ...
            for (int i = 0; i < tabPages.Count(); i++)
            {
                m_btnTabControl.SetTabPage(tabPages[i], i);

                if (tabPages[i] != null)
                    tabControl.AddTabPage(tabPages[i]);
            }
            ...
            {
                GetDockSOPLog().UpdateComponentContents(tabPage.ActionStepID, !tabPage.VirtualMode);
            }
            ...
            // 제어권한에 따른 컨트롤 활성화
            //OnEnabled(FormSOP.Instance.HasSOPControl(scenario.ActionStepHistoryID));
            // 실행자 컬럼 가시/비가시
        ...
        public void OnChangeSOPScenario(SOPScenario scenario, bool bNeedChangeSOP)
        {
            if (SOPScenarioManager.Instance.CurrentScenario != scenario || bNeedChangeSOP == true)
            {
                SectionTabPage page = m_scenarioTab.GetTabPage(scenario);

                if (page == null)
                    FormSOP.Instance.SelectedScenario(scenario.ActionStepID, scenario.RealMode);
                else
                    ChangeScenario(scenario, page);
            }

            SectionTabPage tabPage = GetTabPage(scenario.ActionStepID, scenario.RealMode);

            if (tabPage != null && tabPage.PanelComponentContents.Controls.Count == 0)
            {
                GetDockSOPLog().UpdateComponentContents(scenario.ActionStepID, scenario.RealMode);
            }
            ...
            if (scenario != null && WorkFlowManager.Instance.Get(scenario.ActionStepID, scenario.RealMode) != null)
            {
        ...
        {
            SectionTabPage tabPage = m_btnTabControl.GetSectionTabPage(nActionStepID, isRealMode);

            if (tabPage != null)
                return tabPage;

            return m_scenarioTab.GetTabPage(nActionStepID, isRealMode);
        ...
        {
            return m_scenarioTab.GetTabPage(nActionStepHistoryID);
            /*foreach (SectionTabPage tabPage in tabControl.TabPages)
            {
        ...
        // 새로운 ActionStepHistory가 실행되었다.
        // 기존에 있던 TabPage를 불러서 사용해야 하는지 새로 TabPage를 열어야 하는지 판단하기 위해서
        // actionStepHistory에 대한 기존 TabPage가 있는지 조사한다.
        public SectionTabPage GetTabPage(Data_ActionStepHistory actionStepHistory)
        {
            SectionTabPage tabPage = m_scenarioTab.GetTabPage(actionStepHistory.ID);
            ...
            foreach (ButtonTabPage btnPage in m_btnTabControl.TabPages)
            {
                // 열려만 있고 실행되지 않은 상태인 TabPage가 있는가?
                if (btnPage.SectionTabPage != null && btnPage.SectionTabPage.ActionStepID == actionStepHistory.ActionStepID)
                {
                    if (btnPage.SectionTabPage.ActionStepHistoryID <= 0 || btnPage.SectionTabPage.ActionStepHistoryID == actionStepHistory.ID)
                        return btnPage.SectionTabPage;
                }
            }
        ...
        public List<SOPScenario> GetAllScenarios()
        {
            List<SOPScenario> scenarios = new List<SOPScenario>();
            int nScenarioCount = m_scenarioTab.GetScenarioCount();
        ...
        public SOPScenario GetSOPScenario(int nActionStepHistoryID)
        {
            int nScenarioCount = m_scenarioTab.GetScenarioCount();
            ...
            for (int i = 0; i < nScenarioCount; i++)
            {
                ...
                if (scenario != null && scenario.ActionStepHistoryID == nActionStepHistoryID)
                    return scenario;
            }
        ...
        public void CloseSOPScenario(int nActionStepHistoryID)
        {
            if (m_scenarioTab.CurrentScenario == null)
                return;

            if (m_scenarioTab.CurrentScenario.ActionStepHistoryID == nActionStepHistoryID)
            {
                m_scenarioTab.Remove(m_scenarioTab.CurrentScenario);
            }
        }
        ...
        private void SetComponentContentsPanel(Panel panel)
        {
            ...
            if (panel != null)
            {
                ...
                panel.Location = new Point(0, panelComponentContentsTitle.Size.Height);
                panel.Size = new Size(splitContainerMain.Panel2.ClientSize.Width, splitContainerMain.Panel2.ClientSize.Height - panelComponentContentsTitle.Size.Height);
                panel.Anchor = AnchorStyles.Bottom | AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
                panel.AutoScroll = true;

                if (FormSOP.Instance.InitComponentHistoryID == 0)
                {
                    panel.Show();
                    panel.BringToFront();
                }
        ...
        private Panel GetComponentContentsPanel()
        {
            foreach (object obj in splitContainerMain.Panel2.Controls)
            {
                if (obj.GetType() == typeof(Panel))
                {
                    ...
                    if (panel.Tag != null && panel.Tag.ToString() == panelComponentContentsTitle.Name)
                        continue;
        ...
        private int m_nBackgroundImageTimerCount = 0;

        private void timerBackGroundImage_Tick(object sender, EventArgs e)
        {
            if (m_nBackgroundImageTimerCount >= 5)
            {
                ProcessBackgroundImage();
                m_nBackgroundImageTimerCount = 0;
            }

            ProcessComponentContentsSetting();

            m_nBackgroundImageTimerCount++;
        }

        private void ProcessComponentContentsSetting()
        {
            if (tabControl.SelectedTab == null)
                return;

            SectionTabPage tabPage = (SectionTabPage)tabControl.SelectedTab;

            if (tabPage.ActionStepID <= 0)
                return;

            if (tabPage.FinishComponentContentsLoading == false)
            {
                // 속도개선을 위하여 ContentsOwner는 나중에 설정한다.
                tabPage.CreateSectionContentsOneByOne(null);
                //tabPage.CreateSectionContentsOneByOne(this);

                if (tabPage.FinishComponentContentsLoading)
                {
                    foreach (KeyValuePair<Section, ISectionContents> pair in tabPage.SectionContents)
                    {
                        ISectionContents contents = pair.Value;
                        contents.ContentsOwner = this;
                    }

                    WorkflowOption option, temp;

                    if (m_dicWaitForStartTabPages.TryGetValue(tabPage, out option))
                    {
                        // ComponentContents 로딩이 완료되지 않아 펼쳐지지 않았던 ComponentContents를 실행상태로 만든다.
                        m_dicWaitForStartTabPages.TryRemove(tabPage, out temp);
                        StartComponentContents(tabPage, option);
                        ...
                        foreach (KeyValuePair<Section, ISectionContents> pair in tabPage.SectionContents)
                        {
                            ...
                            if (contents.Section is SectionEndPoint)
                            {
                                SectionDataEndPoint data = (SectionDataEndPoint)contents.Section.Data;

                                if (data.IsBegin)
                                {
                                    // SOP가 시작되었으니 시작 Section은 완료 상태로 바꾼다.
                                    contents.State = State.DONE;
                                    contents.EnableControl = false;
                                    continue;
                                }
                            }

                            contents.EnableControl = true;
                        }
                    }
                }
            }
        ...
        public void RefreshSelectedTabPage()
        {
        ...
        private bool SetCurrentScenario(int nActionStepID)
        {
            ...
            for (int i=0;i<nScenarioCount;i++)
            {
                ...
                if (scenario != null && scenario.ActionStepID == nActionStepID)
                {
                    m_scenarioTab.Select(i, true);
                    return true;
                }
            }
            /*for (int i=0;i<cmbScenario.Items.Count;i++)
        ...
        public void CreateComponentContentsSet(SectionTabPage page, bool backgroundLoading = false)
        {
            ...
            ArrayList arrList = GetTabPagePanels(page);
            ...
            // 전체 ComponentContents를 한꺼번에 만들면 시간이 너무 오래 걸리기 때문에 하나씩 만든다.
            page.CreateSectionContentsOneByOne(this, sections);
            //page.CreateSectionContents(sections, this);
        ...
        public void ShowTabPages(List<TabPage> tabPages)
        {
            if (tabPages == null)
                return;

            SectionTabPage selectedPage = null;

            for (int i=0;i<tabPages.Count;i++)
            {
                SectionTabPage tabPage = (SectionTabPage)tabPages[i];

                if (tabPage != null)
                {
                    tabControl.AddTabPage(tabPage);
                    m_btnTabControl.SetTabPage(tabPage, i);
        ...
        {
            if (option != null && option.WorkFlow != null && option.WorkFlow.ActionStepHistoryID > 0)
            {
                bool started;
                if (m_dicStartComponentContents.TryGetValue(option.WorkFlow.ActionStepHistoryID, out started))
                {
                    if (started)
                        return;
                }

                m_dicStartComponentContents[option.WorkFlow.ActionStepHistoryID] = true;
            }
            ...
            Dictionary<Section, ISectionContents> dicSectionContents = GetComponentContentsList(nActionStepID, isRealMode, out page);

            if (page == null)
                return;

            if (page.FinishComponentContentsLoading == false)
            {
                // ComponentContents 로딩이 끝나면 시작시킨다.
                m_dicWaitForStartTabPages[page] = option;
                return;
            }

            System.Diagnostics.Trace.WriteLine("StartComponentContents just in time : " + page.Text + ", " + page.ActionStepHistoryID);
            StartComponentContents(page, option);
        }

        private void StartComponentContents(SectionTabPage page, WorkflowOption option)
        {
            if (page.SectionContents != null)
            {
                // ComponentContents 생성하는 동안 깜빡이는 현상을 없애기 위하여 생성이 끝날때까지 Hide() 시킴
                ...
                foreach (KeyValuePair<Section, ISectionContents> pair in page.SectionContents)
                {
                    pair.Value.Start(option, !page.VirtualMode);
        ...
        //private void ChangeSectionTitle(int nActionStepID, bool isRealMode, VariousData<DateTime> dtDetect, string strPosition, string strPSMMaterialName, VariousData<int> psmDistance, string strAmountSnowfall)
        {
            ...
            UnE.SOP.Utility.SOPSimulatorScript.DataParameter param = new UnE.SOP.Utility.SOPSimulatorScript.DataParameter("", time, strPosition, strAlarmMessage);
        ...
        public void OnCloseWorkFlow(int nActionStepHistoryID, int nActionStepID, bool isRealMode, WorkFlowState state)
        {
            ...
            {
                m_dicStartComponentContents.Remove(nActionStepHistoryID);
        ...
        {
            ISectionContents contents = GetComponentContents(section);

            if (contents != null)
                SectionContentsHelper.SetDetailDatas(contents, detailDatas, nComponentHistory, false);
        }
        ...
        public void NeedRefreshContents(ISectionContents contents)
        {
            m_dicNeedRefreshContents2[contents] = contents;

            if (contents.Section != null)
            {
                PanelSectionEx panel = (PanelSectionEx)contents.Section.GetParent();

                if (panel != null)
                    m_dicNeedRefreshPanelSections[panel] = panel;
            }
        }

        public void BeginHistory()
        {
            m_allowSectionRefresh = false;
            //m_noRefreshComponentContents = true;
        }

        public SectionTabPage GetCurrentTabPage()
        {
            if (m_btnTabControl.SelectedTabPage == null)
                return null;
            ...
            //return (SectionTabPage)tabControl.SelectedTab;
        }

        public void EndHistory(bool showPanel = true)
        {
            m_allowSectionRefresh = true;
            ...
            try
            {
                if (FormSOP.Instance.IsDisposed == false)
                {
                    FormSOP.Instance.Invoke((MethodInvoker)delegate
                    {
                        foreach (KeyValuePair<PanelSectionEx, PanelSectionEx> pair in m_dicNeedRefreshPanelSections)
                        {
                            pair.Value.Refresh();
                        }

                        foreach (KeyValuePair<ISectionContents, ISectionContents> pair in m_dicNeedRefreshContents2)
                        {
                            Control contents = (Control)pair.Value;
                            contents.Refresh();
                        }
                        ...
                        if (showPanel)
                        {
                            ...
                            if (page != null)
                            {
                                if (page.PanelComponentContents.Visible == false)
                                {
                                    page.PanelComponentContents.Show();
                                    WorkFlow work = WorkFlowManager.Instance.Get(page.ActionStepID, !page.VirtualMode);

                                    if (work != null && work.SelectedSectionState != null)
                                    {
                                        if (work.SelectedSectionState.SectionContents != null)
                                            work.SelectedSectionState.SectionContents.FocusContents();

                                        PanelSectionEx panelSection = (PanelSectionEx)work.SelectedSectionState.Section.GetParent();
                                        panelSection.FocusSection(work.SelectedSectionState.Section);
                                    }
                                }
                            }
                        }
            ...
            m_dicNeedRefreshPanelSections.Clear();
            m_dicNeedRefreshContents2.Clear();
        }

        public bool ProcessComponentContents(int nActionStepID, bool isRealMode, int nProcessID, bool isChecked)
        {
            SectionTabPage page;
            Dictionary<Section, ISectionContents> dicSectionContents = GetComponentContentsList(nActionStepID, isRealMode, out page);
            ...
            foreach (KeyValuePair<Section, ISectionContents> pair in dicSectionContents)
            {
                ...
                if (contents.Section != null && contents.Section is SectionProcess && contents.Section.Data.ID == nProcessID)
                {
                    SectionState state = work.FindState(contents.Section);
                    ...
                    //OnSelectedSection(contents.Section);
                    //contents.Checked = isChecked;
                    return true;
                }
            }
        ...
        private void rbtnActionStep_Click(object sender, EventArgs e)
        {
            ButtonTabPage page = m_btnTabControl.ClickButtonPage((RibbonButton)sender);

            if (page != null)
                SelectTabPage(page.SectionTabPage);
        }

        private void rbtnActionStep3rd_Click(object sender, EventArgs e)
        {

        }

        private void rbtnActionStep2nd_Click(object sender, EventArgs e)
        {

        }

        private void rbtnActionStep1st_Click(object sender, EventArgs e)
        {

        }

        private void rbtnActionStep4th_Click(object sender, EventArgs e)
        {

        }

        private void rbtnBroadcast_Click(object sender, EventArgs e)
        {
        ...
        public void SetMainFormButtons(RibbonButton btnLoadSOP)
        {
            mainFormButtonLoadSOP = btnLoadSOP;
        }

        public void OnSectionContentsEvent(SectionContentsEvent e, object arg)
        {
            if (e == SectionContentsEvent.RunSOP)
                FormSOP.Instance.RunWorkflowWithEvent();
            else if (e == SectionContentsEvent.RunMissionExternal)
            {
                if (arg != null && arg is MissionItemExternal)
                {
                    MissionItemExternal item = (MissionItemExternal)arg;

                    if (CheckItemEnable(item))
                        RunMissionExternal(item);
                    else
                        m_dicUnprocessedExternalMissions[item] = item;
                }
            }
        }

        // ActionStepHistory가 생성되기 전에 실행되지 못한 외부실행파일들
        private ConcurrentDictionary<MissionItemExternal, MissionItemExternal> m_dicUnprocessedExternalMissions = new ConcurrentDictionary<MissionItemExternal, MissionItemExternal>();

        public void RunUnprocessedExternalMissions()
        {
            MissionItemExternal temp;
            List<MissionItemExternal> items = m_dicUnprocessedExternalMissions.Keys.ToList();

            foreach (MissionItemExternal item in items)
            {
                if (CheckItemEnable(item))
                {
                    m_dicUnprocessedExternalMissions.TryRemove(item, out temp);
                    RunMissionExternal(item);
                }
                //if (RunMissionExternal(item))
                //    m_dicUnprocessedExternalMissions.TryRemove(item, out temp);
            }
        ...
        private bool CheckItemEnable(MissionItemExternal item)
        {
            if (item.ActionStepHistoryID < 0)
            {
                if (item.TabPage != null && item.TabPage.ActionStepHistoryID > 0)
                {
                    item.ActionStepHistoryID = item.TabPage.ActionStepHistoryID;
                }
                else
                {
                    m_dicUnprocessedExternalMissions[item] = item;
        ...
        private bool RunMissionExternal(MissionItemExternal item)
        {
            /*if (item.ActionStepHistoryID < 0)
            {
                if (item.TabPage != null && item.TabPage.ActionStepHistoryID > 0)
            ...
            string strWorkingDirectory = FormSOP.Instance.GetPageOption().ExternalFolderPath;
            string strExe = item.ExternalExeFilePath;

            int nIndex = item.ExternalExeFilePath.LastIndexOf('\\');

            if (nIndex >= 0)
            {
                if (IsAbsoluteFolder(item.ExternalExeFilePath))
            ...
            if (System.IO.File.Exists(strWorkingDirectory + strExe))
            {
                ...
                WriteActionStepHistoryID(item.ActionStepHistoryID, strProcessName, strWorkingDirectory);
            ...
            {
                // 외부연계 프로그램에서 호출한 SOP에 대한 정보를 알수 있도록 하기 위하여 ActionStepHistoryID를 별도의 파일에 기록해둔다.
                WriteActionStepHistoryID(item.ActionStepHistoryID, strProcessName);

                System.Diagnostics.ProcessStartInfo startInfo = new System.Diagnostics.ProcessStartInfo();
                startInfo.FileName = strExe;
                startInfo.ErrorDialog = true;
                startInfo.Arguments = strArguments;//strArguments.Substring(1, strArguments.Length - 2);
        ...
        private bool IsAbsoluteFolder(string strFolder)
        {
            if (strFolder.Length > 2)
            {
                if (strFolder.ElementAt(1) == ':')
                    return true;
            }
        ...
        // 문자메시지 발신자 번호
        public string GetSMSCaller(ISectionContents contents)
        {
            return SMSHelper.GetSMSCaller(contents);
        }

        // dicPhoneNumbers : Key와 Value가 같은 값이다.
        //                   중복으로 전화번호가 입력되는걸 방지하기 위해 List 대신 Dictioanry를 사용한다.
        public void GetSOPTeamPhoneNumbers(SOPTeam team, bool onlyTeamLeader, Dictionary<string, string> dicPhoneNumbers)
        {
            SMSHelper.GetSOPTeamPhoneNumbers(team, onlyTeamLeader, dicPhoneNumbers);
        }

        // 교대근무자를 감안하여 수신자 리스트를 조정한다.
        public void CheckControlTeamValidPhoneNumbers(ArrayList phoneNumbers)
        {
            SMSHelper.CheckControlTeamValidPhoneNumbers(phoneNumbers);
        }

        public bool OnSendSMSClick(ArrayList phoneNumbers, string strSender, string strMessage, bool needConfirm, out string strErrorMessage)
        {
            strErrorMessage = "";

            if (FormSOP.Instance.SMSOn == false)
            {
                strErrorMessage = "환경설정(SMS 사용안함)";
                return false;
            }

            if (m_workflowOption != null)
                strMessage = SectionContentsHelper.ChangeText(strMessage, m_workflowOption);

            return SMSHelper.OnSendSMSClick(phoneNumbers, strSender, strMessage, needConfirm, out strErrorMessage);
        }

        public bool OnRunBroadcastClick(string strMessage, int nBroadcastCount, bool useSiren, bool needConfirm)
        {
            if (FormSOP.Instance.UseBroadcast == false || strMessage.Length == 0)
                return false;
            ...
            if (needConfirm)
            {
                if (MessageBox.Show("방송을 실행하시겠습니까?", "방송", MessageBoxButtons.YesNo) == System.Windows.Forms.DialogResult.Yes)
                {
                    UnE.SOP.TTS.TTSManager.Instance.AddSpeech(strMessage, nBroadcastCount, useSiren);
                    return true;
                }
            }
            else
        ...
        public void EnableTabPages(List<TabPage> tabPages)
        {
            m_btnTabControl.EnableTabPages(tabPages);
        }

        public void SelectTabPage(SectionTabPage tabPage)
        {
            if (NoChangeSelectedTabPage)
                return;

            tabControl.SelectedTab = tabPage;

            if (tabControl.SelectedTab != tabPage && tabPage != null)
            {
                if (m_btnTabControl.GetSectionTabPage(tabPage.ActionStepID, !tabPage.VirtualMode) != null)
                {
                    ButtonTabPage[] btnPages = m_btnTabControl.TabPages;

                    foreach (ButtonTabPage btnPage in btnPages)
                    {
                        if (btnPage.SectionTabPage != null)
                            tabControl.AddTabPage(btnPage.SectionTabPage);
                    }
            ...
            m_scenarioTab.SelectTabPage(tabPage);
        }

        public void CheckSectionPanelSize()
        {
            if (tabControl.Size.Width > panelTabPage.Size.Width + m_nTabControlHeight)
                SetTabControlArea();
        }

        public void RefreshCurrentTab()
        {
            m_btnTabControl.RefreshCurrentPage();
        }
        ...
        public void CheckCurrentPage()
        {
            if (TargetPage == null)
            {
                /*if (m_backgroundLoadingTabPages != null)
                {
                    ShowTabPages(m_backgroundLoadingTabPages);
                    m_backgroundLoadingTabPages.Clear();
                    m_backgroundLoadingTabPages = null;
                }
                else*/
                {
                    if (tabControl.SelectedTab == null)
                    ...
                    {
                        if (m_btnTabControl.SelectedTabPage == null || m_btnTabControl.SelectedTabPage.SectionTabPage != (SectionTabPage)tabControl.SelectedTab || m_btnTabControl.SelectedTabPage.Enabled == false)
                        {
                            m_btnTabControl.SelectTabPage(tabControl.SelectedTab);
                            RefreshSelectedTabPage();
                        }

                        SectionTabPage currentPage = GetCurrentTabPage();
                        ...
                        if (currentPage != null)
                        {
                            ...
                            if (panelScenarioTab.Visible == false)
                                panelScenarioTab.Show();
                        }
                    }
                }
            }
            ...
            {
                if (TargetPage == (SectionTabPage)tabControl.SelectedTab)
                    TargetPage = null;
            }
            ...
            if (tabControl.Visible == false)
            {
                ...
                if (panelScenarioTab.Visible)
                    panelScenarioTab.Hide();

                if (splitContainerMain.Visible)
    ...
    public class TabPageSOPTeamUserManager
    {
        ...
        public bool ShowDialogEditExternalMembers(SectionTabControl tabControl)
        {
            ...
            if (teamEditor.ShowDialog() == DialogResult.OK)
            {
                ...
                FormSOP.Instance.NetworkManager.SendResetUserDefinedTeamNames(page.ActionStepHistoryID);
    ...
    /*public class SOPScenarioTab
    {
        ...
        private Dictionary<RibbonButton, SOPScenario> m_dicButtonScenarios = new Dictionary<RibbonButton, SOPScenario>();
        ...
        public int Add(SOPScenario scenario)
        {
            m_scenarios.Add(scenario);
            int nIndex = m_scenarios.IndexOf(scenario);

            RibbonButton btn = CreateButton(scenario.ToString());
            m_dicButtonScenarios[btn] = scenario;
            return nIndex;
        }

        private RibbonButton CreateButton(string strText)
        {
        ...
        private void OnClick(object sender, EventArgs e)
        {
            ...
            if (m_dicButtonScenarios.TryGetValue((RibbonButton)sender, out scenario))
            {
                Select(scenario);
            }
        }

        public void Insert(int nIndex, SOPScenario scenario)
        {
        ...
        public void Remove(SOPScenario scenario)
        {
            m_scenarios.Remove(scenario);
            RemoveButton(scenario);
        ...
        private void RemoveButton(SOPScenario scenario)
        {
            RibbonButton btn = GetButton(scenario);
        ...
        private RibbonButton GetButton(SOPScenario scenario)
        {
            foreach (KeyValuePair<RibbonButton, SOPScenario> pair in m_dicButtonScenarios)
            {
                if (pair.Value == scenario)
                {
                    return pair.Key;
                }
            }
        ...
        public SOPScenario Select(SOPScenario scenario, bool systemCall = false)
        {
            if (m_scenarios.Contains(scenario))
            {
                ...
                SelectScenario(scenario, changedScenario, systemCall);
                return scenario;
            }
        ...
        public SOPScenario Select(int nIndex, bool systemCall = false)
        {
            if (nIndex >= 0 && m_scenarios.Count > nIndex)
            {
                ...
                SelectScenario(m_selectedScenario, changedScenario, systemCall);
        ...
        private void SelectScenario(SOPScenario scenario, bool changedScenario, bool systemCall)
        {
            if (scenario == null)
                return;

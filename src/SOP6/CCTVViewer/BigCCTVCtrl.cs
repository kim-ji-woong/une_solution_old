...
namespace UnE.CCTV
{
    public partial class BigCCTVCtrlOwner : Form, ICCTVCtrlOwner
    {
        ...
        public BigCCTVCtrlOwner(CCTV cctv, IntPtr frmParent, int nPositionIndex, bool nEquipZoneCCTVMode, int nEquipZoneID, String nDefaultPreset, bool useTitle)
		{
            m_Instance = this;

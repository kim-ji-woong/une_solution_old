...
namespace AutoUpdater.Data
{
    public class FireAlarm
    {
        ...
        {
            get { return MakeSensorZoneHistoryIDString(m_nSensorZoneHistoryID); }
        }
        ...
        public static string MakeSensorZoneHistoryIDString(int nSensorZoneHistoryID)
        {
            string strSiteID = DataManager.Instance.LocalSiteID;
        ...
        public bool SetSensorZoneHistoryID(string strSensorZoneHistoryID)
        {
            ...
            {
                if (DataManager.Instance.LocalSiteID == strSiteID)
                {
                    int nHistoryID;
            ...
            {
                if (DataManager.Instance.ContainsSiteID(strSiteID))
                {
                    int nHistoryID;

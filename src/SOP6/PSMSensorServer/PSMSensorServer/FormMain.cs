...
namespace PSMSensorServer
{
    ...
    {     
        ...
        private void OnBeginServer(object sender, EventArgs e)
        {
            ...
            int nSiteID = PSMNetworkServer.LoadSiteID();
            DBUtility2.WebDBManager dbMgr = new DBUtility2.WebDBManager(nSiteID);

            server = new PSMNetworkServer(dbMgr);

            m_clientWeb = new NetworkWebClient(dbMgr);

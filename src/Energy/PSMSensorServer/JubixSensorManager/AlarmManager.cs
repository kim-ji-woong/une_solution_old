...
namespace JubixSensor
{
    public class AlarmManager
    {
        ...
        private int GetMaxID(string strTableName, string szIDField, WebDBManager dbMgr)
        {
        ...
        private void InsertCtrInfo(int nType, bool bOnOff, string szDate, string szCreateDate)
        {
            ...
            int nMaxID = GetMaxID("r_ss_ctl_dat", "Ss_ctl_seq", m_dbMgr) + 1;
            string szCtrlID = ((nType == 1) ? szAlarmID1 : szAlarmID2);
        ...
        string szAlarmStatus1 = "";

        public string AlarmStatus1
        {
            get { return szAlarmStatus1; }
        }
        string szAlarmStatus2 = "";

        public string AlarmStatus2
        {
            get { return szAlarmStatus2; }
        }

        public void ReadAlarmInfo(WebDBManager dbMgr)
        {
            m_dbMgr = dbMgr;
            bAlarm1 = false;
            bAlarm2 = false;
            ...
            if (arResult != null && arResult.Count > 0)
            {
                ...
                {
                    string value = WebDBManager.GetStringField(arResult[0]);
            ...
            if (arResult2 != null && arResult2.Count > 0)
            {
                ...
                {
                    string value = WebDBManager.GetStringField(arResult2[0]);
        ...
        // 중앙제어실
        public void SetAlarmContorlRoom(bool bAlarm)
        {
            SetAlarmOnOff(1, bAlarm);
        }

        // 수처리실
        public void SetAlarmWaterRoom(bool bAlarm)
        {
            SetAlarmOnOff(2, bAlarm);
        }
    }
}

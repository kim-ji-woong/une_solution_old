...
namespace DidViewer
{
    ...
    public class Media
    {
        ...
        private AxWindowsMediaPlayer m_player = new AxWindowsMediaPlayer();
        ...
        public void SetPlayer(bool visible, string filePath)
        {
            if (visible)
            {
                if (m_player == null)
                    m_player = new AxWindowsMediaPlayer();

                m_player.CreateControl();
                ...
                m_player.URL = filePath;
                //m_player.Ctlcontrols.currentPosition = m_nBeginSeconds;

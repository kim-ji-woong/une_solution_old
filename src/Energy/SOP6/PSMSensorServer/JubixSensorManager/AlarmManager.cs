...
namespace JubixSensor
{
    public class AlarmManager
    {
        ...
        private int GetMaxID(string strTableName, string szIDField, LocalDBManager dbMgr)
        {
            ...
            return LocalDBManager.GetIntField(arrResult[0].ToString(), 0);
        }
        ...
        public void ReadAlarmInfo(LocalDBManager dbMgr)
        {
            m_dbMgr = dbMgr;
            bAlarm1 = false;
            bAlarm2 = false;

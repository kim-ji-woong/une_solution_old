...
namespace DBUtility
{
    public class LocalDBManager : IDisposable
    {
        ...
        private string m_szDatabaseName = "SOP_3";
        ...
        public LocalDBManager(string strServerIP, string strDatabaseName, string strDBType, int nSiteID)
        {
            //Loadini_ServerConnectionInfo(nSiteID);

            m_szDBHost = strServerIP;
        ...
        {
            string strConnection = "Server=" + m_szDBHost + ";Database=" + m_szDatabaseName + ";Uid=etadams;Pwd=et!2345;CharSet=utf8;";

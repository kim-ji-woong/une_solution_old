...
namespace UnE.SOP.Process
{
    ...
    public abstract class ProcessSectionIF
    {
        ...
        public string ParseSpecialMessage(string strMsg, DateTime dtTime, string strPlace, bool isRealMode, bool isNormalMode, HistoryDisasterPosition position)
        {
            UnE.SOP.Utility.SOPSimulatorScript.DataParameter param = new UnE.SOP.Utility.SOPSimulatorScript.DataParameter(strMsg, dtTime, strPlace);

        ...
        public class RoleMemberManager
        {
            ...
            public ArrayList GetUsingTeamsByHistoryID(int nActionStepHistoryID)
            {
                ...
                for (int i = 0; i < nResultCount - 7; i += 8)
                {
                    ...
                    DBUtility.VariousData<int> teamType = WebDBManager.GetIntField(arrResult[i + 1].ToString());
                    DBUtility.VariousData<int> teamID = WebDBManager.GetIntField(arrResult[i + 2].ToString());
                    ...
                    DBUtility.VariousData<int> allMembers = WebDBManager.GetIntField(arrResult[i + 7].ToString());

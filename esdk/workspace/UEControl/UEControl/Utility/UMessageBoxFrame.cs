...
{
    internal partial class UMessageBoxFrame : UnE.GUI.FormNoFrameSizable
    {
        private static UMessageBoxFrame m_instance = null;
        public static UMessageBoxFrame Instance
        {
        ...
        public UMessageBoxFrame(Form frmMain)
            : base(frmMain)
        {
            InitializeComponent();

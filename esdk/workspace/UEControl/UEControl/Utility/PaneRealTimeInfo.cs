...
namespace UnE
{
    namespace Utility
    {
        public partial class RealTimeInfoPane : Panel
        {
            ...
            private bool m_useMovingText = true;

            public bool UseMovingText
            {
                get { return m_useMovingText; }
                set { m_useMovingText = value; }
            }
            ...
            public Point DisplayBeginPosition
            {
                get { return m_DisplayLabel.Location; }
                set { m_DisplayLabel.Location = value; }
            }
            ...
            public RealTimeInfoPane()
            {
				...
				m_DisplayLabel.Location = new Point(30, 27);
            ...
            private void FormRealTimeInfo_Paint(object sender, PaintEventArgs e)
            {
                if (!m_useMovingText)
                {
                    if (m_brushFixedText == null)
                    {
                        ...
                        m_rectFixedText = new Rectangle(m_DisplayLabel.Location.X, 10, m_DisplayLabel.Size.Width, m_DisplayLabel.Size.Height * 2);
                    }

...
namespace libShapeFile
{
    public class MultiPoint : Shape
    {
        ...
        public static bool Load(IFileEventListener listener, FileStream shapeFileStream, RecordHeader[] recordHeaders, List<Shape> shapes)
        {
            ...
            while (nIndex < pgRecs.Length)
            {
                ...
                if (listener != null)
                {
                    listener.ReadEntity("MultiPoint", nIndex);
                }
    ...
    public class MultiPointM : Shape2
    {
        ...
        public List<Vertex2FM> Vertices
        {
            get { return m_vertices; }
        }
        ...
        public static bool Load(IFileEventListener listener, FileStream shapeFileStream, RecordHeader[] recordHeaders, List<Shape> shapes)
        {
            ...
            while (nIndex < pgRecs.Length)
            {
                ...
                if (numPoints > 0)
                {
                    ...
                    foreach (Vertex2FM vertex in multiPoint.m_vertices)
                    //for (int j = 0; j < numPoints; j++)
                    {
                ...
                if (listener != null)
                {
                    listener.ReadEntity("MultiPointM", nIndex);
                }
    ...
    public class MultiPointZ : Shape3
    {
        ...
        public List<Vertex3FM> Vertices
        {
            get { return m_vertices; }
        }
        ...
        public static bool Load(IFileEventListener listener, FileStream shapeFileStream, RecordHeader[] recordHeaders, List<Shape> shapes)
        {
            ...
            while (nIndex < pgRecs.Length)
            {
                ...
                if (numPoints > 0)
                {
                    ...
                    foreach (Vertex3FM vertex in multiPoint.m_vertices)
                    //for (int j = 0; j < numPoints; j++)
                    {
                ...
                if (listener != null)
                {
                    listener.ReadEntity("MultiPointZ", nIndex);
                }
                nIndex++;
            }

...
#define WM_CBN_SELCHANGED	WM_USER+2
///////////////////////////////////////////////////////////////////////////////////
...
class GRIDCTRL_EXPORT CGridCtrl : public CWnd
{
...
public:
	...
	// 090922 yongju
	void	SetCheckBox(int nRow, int nCol, BOOL bCheck, BOOL bDisable=FALSE);
	BOOL	GetCheck(int row, int col);
...
protected:
	...
	afx_msg void OnCbnSelChanged(NMHDR* pNMHDR, LRESULT* pResult);
    //}}AFX_MSG

...
//  
			...
			#if defined(POCO_DLL)
				#if defined(_DEBUG)
					#define POCO_LIB_SUFFIX "12x64d.lib"
				#else
					#define POCO_LIB_SUFFIX "12x64.lib"
				#endif
			#elif defined(_DLL)
				#if defined(_DEBUG)
					#define POCO_LIB_SUFFIX "12x64mdd.lib"
				#else
					#define POCO_LIB_SUFFIX "12x64md.lib"
				#endif
			#else
				#if defined(_DEBUG)
					#define POCO_LIB_SUFFIX "12x64mtd.lib"
				#else
					#define POCO_LIB_SUFFIX "12x64mt.lib"
				#endif
			#endif
		#else
			#if defined(POCO_DLL)
				#if defined(_DEBUG)
					#define POCO_LIB_SUFFIX "10x64d.lib"
				#else
					#define POCO_LIB_SUFFIX "10x64.lib"
				#endif
			#elif defined(_DLL)
				#if defined(_DEBUG)
					#define POCO_LIB_SUFFIX "10x64mdd.lib"
				#else
					#define POCO_LIB_SUFFIX "10x64md.lib"
				#endif
			#else
				#if defined(_DEBUG)
					#define POCO_LIB_SUFFIX "10x64mtd.lib"
				#else
					#define POCO_LIB_SUFFIX "10x64mt.lib"
				#endif
			#endif			
		#endif
	#else
			...
			#if defined(POCO_DLL)
				#if defined(_DEBUG)
					#define POCO_LIB_SUFFIX "12Win32d.lib"
				#else
					#define POCO_LIB_SUFFIX "12Win32.lib"
				#endif
			#elif defined(_DLL)
				#if defined(_DEBUG)
					#define POCO_LIB_SUFFIX "12Win32mdd.lib"
				#else
					#define POCO_LIB_SUFFIX "12Win32md.lib"
				#endif
			#else
				#if defined(_DEBUG)
					#define POCO_LIB_SUFFIX "12Win32mtd.lib"
				#else
					#define POCO_LIB_SUFFIX "12Win32mt.lib"
				#endif
			#endif
		#else
			#if defined(POCO_DLL)
				#if defined(_DEBUG)
					#define POCO_LIB_SUFFIX "10Win32d.lib"
				#else
					#define POCO_LIB_SUFFIX "10Win32.lib"
				#endif
			#elif defined(_DLL)
				#if defined(_DEBUG)
					#define POCO_LIB_SUFFIX "10Win32mdd.lib"
				#else
					#define POCO_LIB_SUFFIX "10Win32md.lib"
				#endif
			#else
				#if defined(_DEBUG)
					#define POCO_LIB_SUFFIX "10Win32mtd.lib"
				#else
					#define POCO_LIB_SUFFIX "10Win32mt.lib"
				#endif
			#endif
		#endif
	#endif

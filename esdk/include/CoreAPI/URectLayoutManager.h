...
public:
	...
	public:
		...
		// STL needs this
		inline bool operator <(const URectLayoutManager::Rect &R) const { return getBottom() < R.getBottom(); }
	...
	typedef std::list<URectLayoutManager::Rect> RectList;

	URectLayoutManager(unsigned short leftBound,
	...
	bool isOutOfBounds(URectLayoutManager::Rect &r)
	{
...
static bool _fLessBottom(const URectLayoutManager::Rect &L, const URectLayoutManager::Rect &R) { return L.getBottom() < R.getBottom(); }

URectLayoutManager::RectList::iterator URectLayoutManager::addDataBelow(URectLayoutManager::Rect &Data)
{
	bool MoveIt = false;
	bool FoundIt = false;
	...
	URectLayoutManager::Rect &r = Data;
...
static bool _fGreaterTop(const URectLayoutManager::Rect &L, const URectLayoutManager::Rect &R) { return L.getTop() > R.getTop(); }

URectLayoutManager::RectList::iterator URectLayoutManager::addDataAbove(URectLayoutManager::Rect &Data)
{
	bool MoveIt = false;
	bool FoundIt = false;
	RectList::iterator itStart;

...
public :
	...
	*************************************************************************/
	...
	/*************************************************************************
	Summary: Initialiaze the player.
	...
	*************************************************************************/
	...
	bool SendMessage(char* strObjectName, char* strMessageName);
	void PauseInput(bool pause);

	 void InitLayerList();
	 //int GetMessageList(std::vector<CString>& rVecMessage);

	 CKContext* GetCKContext() {return m_CKContext;}
	 CKMessageManager* GetMessageManager() {return m_MessageManager;}

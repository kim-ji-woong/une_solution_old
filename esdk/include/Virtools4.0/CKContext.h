...
// IHM
	...
	void		SetInterfaceMode(CKBOOL iIsInDev = TRUE,CKUICALLBACKFCT CallBackFct=NULL,void *data = NULL);
...
//	Render Engine Implementation Specific
	...
	void ExecuteManagersOnRasterizerEvent(CKRST_EVENTS event,CKRenderContext* dev);
...
public:
	...
	*************************************************/
	CKTimeProfiler(const char* iTitle, CKContext* iContext, int iStartingCount = 4):
	  m_Title(iTitle),m_Context(iContext),m_Marks(iStartingCount) {}

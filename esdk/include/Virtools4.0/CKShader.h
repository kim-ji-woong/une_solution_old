...
public:
	...
	***********************************************************/
	virtual void ExecuteMeanings( CK3dEntity* iEnt, CKMaterial* iMat, CKRenderContext* rc ) = 0;
	virtual void ExecutePerPassMeanings( CK3dEntity* iEnt, CKMaterial* iMat, CKRenderContext* rc ) = 0;

...
#define CKCLASSIMPLEMENTSNOTIF(cls1,flags) CKClassImplementsNotification(cls1::m_ClassID,flags)
...
void CKClassImplementsNotification(CK_CLASSID Cid,CKDWORD flags);					

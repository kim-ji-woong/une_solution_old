...
CKPluginInfo* CDECL_CALL CKGet_XACTSoundManager_PluginInfo(int Index);

//---- XBox Behaviors
CKPluginInfo* CDECL_CALL CKGet_XBOXBBS_PluginInfo(int index);
void CDECL_CALL Register_XBOXBBS_BehaviorDeclarations(XObjectDeclarationArray *reg);

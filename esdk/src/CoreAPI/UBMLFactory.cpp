...
const int UBMLFactory::_3DVERTICES_BASE_INDEX	= 0;
const int UBMLFactory::_2DVERTICES_BASE_INDEX	= 10000000;
const int UBMLFactory::TEXTURE_BASE_INDEX		= 20000000;
const int UBMLFactory::MATERIAL_BASE_INDEX		= 30000000;
const int UBMLFactory::MESH_BASE_INDEX			= 40000000;
const int UBMLFactory::LAYER_BASE_INDEX			= 50000000;
const int UBMLFactory::OBJECT_BASE_INDEX		= 60000000;

std::map<int, std::wstring> TAG_MAP;
std::map<int, std::wstring> TAG_COMMENT_MAP;


static int MakeTagS(std::string strHeader, int numTag, std::wstring strTagDescription)//, const wchar_t* strComment)
{
	UBML::Element * pElement = new UBML::Element();
	if (!pElement->MakeTag(strHeader.c_str(), numTag))
		return 0;
	...
	if (nTag > 100000000)
	{
		//element.MakeTag(strHeader.c_str(), num);
	}
...
const int UBMLFactory::AZIMUTH_TAG = MakeTagS(std::string("AA"), 0, std::wstring(L"방위각"));
const int UBMLFactory::ADDRESS_TAG = MakeTagS(std::string("AB"), 0, std::wstring(L"주소"));
const int UBMLFactory::BODY_TAG = MakeTagS(std::string("BA"), 0, std::wstring(L"Body"));
const int UBMLFactory::BUILDING_NAME_TAG = MakeTagS(std::string("BB"), 0, std::wstring(L"건물명"));
const int UBMLFactory::COORDINATES_SYSTEM_TAG = MakeTagS(std::string("CA"), 0, std::wstring(L"좌표계"));
const int UBMLFactory::FACE_TAG = MakeTagS(std::string("FA"), 0, std::wstring(L"Face"));
const int UBMLFactory::HEADER_TAG = MakeTagS(std::string("HA"), 0, std::wstring(L"Header"));
const int UBMLFactory::HEIGHT_ABOVE_SEA_LEVEL_TAG = MakeTagS(std::string("HB"), 0, std::wstring(L"해발고도"));
const int UBMLFactory::LATITUDE_TAG = MakeTagS(std::string("LA"), 0, std::wstring(L"위도"));
const int UBMLFactory::LONGITUDE_TAG = MakeTagS(std::string("LB"), 0, std::wstring(L"경도"));
const int UBMLFactory::LAYER_GROUP_TAG = MakeTagS(std::string("LC"), 0, std::wstring(L"LayerGroup"));
const int UBMLFactory::LAYER_TAG = MakeTagS(std::string("LD"), 0, std::wstring(L"Layer"));
const int UBMLFactory::MATERIAL_GROUP_TAG = MakeTagS(std::string("MA"), 0, std::wstring(L"MaterialGroup"));
const int UBMLFactory::MATERIAL0_TAG = MakeTagS(std::string("MB"), 0, std::wstring(L"Material"));		// Diffuse, Ambient
const int UBMLFactory::MATERIAL10_TAG = MakeTagS(std::string("MB"), 10, std::wstring(L"Material"));	// Diffuse, Ambient, Specular
const int UBMLFactory::MATERIAL20_TAG = MakeTagS(std::string("MB"), 20, std::wstring(L"Material"));	// Diffuse, Ambient, Specular, Emissive
const int UBMLFactory::MATERIAL30_TAG = MakeTagS(std::string("MB"), 30, std::wstring(L"Material"));	// Diffuse, Ambient, Emissive
const int UBMLFactory::MATERIAL40_TAG = MakeTagS(std::string("MB"), 40, std::wstring(L"Material"));	// Diffuse, Ambient, Texture
const int UBMLFactory::MATERIAL50_TAG = MakeTagS(std::string("MB"), 50, std::wstring(L"Material"));	// Diffuse, Ambient, Specular, Texture
const int UBMLFactory::MATERIAL60_TAG = MakeTagS(std::string("MB"), 60, std::wstring(L"Material"));	// Diffuse, Ambient, Specular, Emissive, Texture
const int UBMLFactory::MATERIAL70_TAG = MakeTagS(std::string("MB"), 70, std::wstring(L"Material"));	// Diffuse, Ambient, Emissive, Texture
const int UBMLFactory::MATERIAL_DIFFUSE_TAG = MakeTagS(std::string("ME"), 0, std::wstring(L"Diffuse"));
const int UBMLFactory::MATERIAL_AMBIENT_TAG = MakeTagS(std::string("MF"), 0, std::wstring(L"Ambient"));
const int UBMLFactory::MATERIAL_SPECULAR_TAG = MakeTagS(std::string("MG"), 0, std::wstring(L"Specular"));
const int UBMLFactory::MATERIAL_SHININESS_TAG = MakeTagS(std::string("MH"), 0, std::wstring(L"Shininess"));
const int UBMLFactory::MATERIAL_TEXTURE_TAG = MakeTagS(std::string("MI"), 0, std::wstring(L"Texture"));
const int UBMLFactory::MATERIAL_EMISSIVE_TAG = MakeTagS(std::string("MJ"), 0, std::wstring(L"Emissive"));
const int UBMLFactory::MATRIX_TAG = MakeTagS(std::string("MK"), 0, std::wstring(L"Matrix"));

const int UBMLFactory::MESH_GROUP_TAG = MakeTagS(std::string("MC"), 0, std::wstring(L"MeshGroup"));
const int UBMLFactory::MESH_TAG = MakeTagS(std::string("MD"), 0, std::wstring(L"Mesh"));

const int UBMLFactory::OBJECT_GROUP_TAG = MakeTagS(std::string("OA"), 0, std::wstring(L"ObjectGroup"));
const int UBMLFactory::OBJECT_TAG = MakeTagS(std::string("OB"), 0, std::wstring(L"Object"));
const int UBMLFactory::OBJECT_ATTR_GROUP_TAG = MakeTagS(std::string("OC"), 0, std::wstring(L"ObjectAttrGroup"));
const int UBMLFactory::OBJECT_ATTR_TAG = MakeTagS(std::string("OD"), 0, std::wstring(L"ObjectAttr"));
const int UBMLFactory::OBJECT_MESH_GROUP_TAG = MakeTagS(std::string("OE"), 0, std::wstring(L"ObjectMeshGroup"));
const int UBMLFactory::OBJECT_MESH_TAG = MakeTagS(std::string("OF"), 0, std::wstring(L"ObjectMesh"));
const int UBMLFactory::TEXTURE_GROUP_TAG = MakeTagS(std::string("TA"), 0, std::wstring(L"TextureGroup"));
const int UBMLFactory::TEXTURE_TAG = MakeTagS(std::string("TB"), 0, std::wstring(L"Texture"));
const int UBMLFactory::_3DVERTICES_GROUP_TAG = MakeTagS(std::string("TC"), 0, std::wstring(L"VertexGroup"));
const int UBMLFactory::_3DVERTICES_TAG = MakeTagS(std::string("TD"), 0, std::wstring(L"VertexList"));
const int UBMLFactory::_3DVERTEX_TAG = MakeTagS(std::string("TE"), 0, std::wstring(L"Vertex3D"));
const int UBMLFactory::_2DVERTICES_GROUP_TAG = MakeTagS(std::string("TF"), 0, std::wstring(L"_2DVerticesGroup"));
const int UBMLFactory::_2DVERTICES_TAG = MakeTagS(std::string("TG"), 0, std::wstring(L"_2DVertices"));
const int UBMLFactory::_2DVERTEX_TAG = MakeTagS(std::string("TH"), 0, std::wstring(L"_2DVertex"));
const int UBMLFactory::_3DFACES_TAG = MakeTagS(std::string("TI"), 0, std::wstring(L"FaceList"));
const int UBMLFactory::_2DFACES_TAG = MakeTagS(std::string("TJ"), 0, std::wstring(L"_2DFaces"));
const int UBMLFactory::TEXTURE_OPTION_TAG = MakeTagS(std::string("TK"), 0, std::wstring(L"TextureOption"));
const int UBMLFactory::UNIT_OF_LENGTH_TAG = MakeTagS(std::string("UA"), 0, std::wstring(L"길이단위"));
const int UBMLFactory::VERSION_TAG = MakeTagS(std::string("VA"), 0, std::wstring(L"Version"));
...
const std::wstring& UBMLFactory::GetErrorString() const
{
	return m_strError;
}

const Texture* UBMLFactory::FindTexture(int nTextureID) const
{
...
const Layer* UBMLFactory::FindLayer(int nLayerID) const
{
...
const Material* UBMLFactory::FindMaterial(int nMaterialID) const
{
...
const Mesh* UBMLFactory::FindMesh(int nMeshID) const
{
...
const Vertices* UBMLFactory::FindVertices(int nVerticesID, bool is3D) const
{
...
void UBMLFactory::SetMeshVersion(std::wstring strMeshVersion)
{
	m_strMeshVersion = strMeshVersion;
}

void UBMLFactory::SetUnitOfLength(UnitOfLength nUnit)
{
	m_unitOfLength = nUnit;
}
//127.04804420
//37.18192868
void UBMLFactory::SetAzimuth(double dDegree)
{
	m_dAzimuth = dDegree;
}

void UBMLFactory::SetLatitude(double dDegree)
{
	m_dLatitude = dDegree;
}

void UBMLFactory::SetLongitude(double dDegree)
{
	m_dLongitude = dDegree;
}

void UBMLFactory::SetHeightAboveSeaLevel(double dHeight)
{
	m_dHeightAboveSeaLevel = dHeight;
}

void UBMLFactory::SetBuildingName(std::wstring strBuildingName)
{
	m_strBuildingName = strBuildingName;
}

void UBMLFactory::SetBuildeingAddr(std::wstring strBuildingAddr)
{
	m_strBuildingAddress = strBuildingAddr;
}

void UBMLFactory::SetHandSystem(bool isRight)
{
	m_isRightHandSystem = isRight;
}

void UBMLFactory::Add3DVertices(Vertices* pVertices, bool sameCheck)
{
...
void UBMLFactory::Add2DVertices(Vertices* pVertices, bool sameCheck)
{
	if (pVertices == 0) return;
...
void UBMLFactory::AddTexture(Texture* pTexture, bool sameCheck)
{
...
void UBMLFactory::AddMaterial(Material* pMaterial, bool sameCheck)
{
...
void UBMLFactory::AddMesh(Mesh* pMesh, bool sameCheck)
{
	if (pMesh == 0) return;
...
void UBMLFactory::AddLayer(Layer* pLayer, bool sameCheck)
{
	if (pLayer == 0) return;
...
void UBMLFactory::AddObject(Object* pObject, bool sameCheck)
{
	if (pObject == 0) return;
...
bool UBMLFactory::Write(std::wstring strPath)
{
...
bool UBMLFactory::MakeHeader(Writer& rWriter)
{
...
bool UBMLFactory::MakeVersion(Element* pParentElement)
{
...
bool UBMLFactory::MakeUnitOfLength(Element* pParentElement)
{
...
bool UBMLFactory::MakeAzimuth(Element* pParentElement)
{
...
bool UBMLFactory::MakeLatitude(Element* pParentElement)
{
...
bool UBMLFactory::MakeLongitude(Element* pParentElement)
{
...
bool UBMLFactory::MakeHASL(Element* pParentElement)
{
...
bool UBMLFactory::MakeBuildingName(Element* pParentElement)
{
...
bool UBMLFactory::MakeBuildingAddress(Element* pParentElement)
{
...
bool UBMLFactory::MakeCoordinatesSystem(Element* pParentElement)
{
...
bool UBMLFactory::MakeBody(Writer& rWriter)
{
...
bool UBMLFactory::Make3DVerticesGroup(Element* pParentElement)
{
...
bool UBMLFactory::Make3DVertices(Vertices& rVertices, Element* pParentElement)
{
...
bool UBMLFactory::Make3DVertex(Vertex& rVertex, Element* pParentElement)
{
...
bool UBMLFactory::Make2DVerticesGroup(Element* pParentElement)
{
...
bool UBMLFactory::Make2DVertices(Vertices& rVertices, Element* pParentElement)
{
...
bool UBMLFactory::Make2DVertex(Vertex& rVertex, Element* pParentElement)
{
...
bool UBMLFactory::MakeTextureGroup(Element* pParentElement)
{
...
bool UBMLFactory::MakeTexture(Texture& rTexture, Element* pParentElement)
{
...
bool UBMLFactory::MakeMaterialGroup(Element* pParentElement)
{
...
bool UBMLFactory::MakeMaterial(Material& rMaterial, Element* pParentElement)
{
...
bool UBMLFactory::MakeMeshGroup(Element* pParentElement)
{
...
bool UBMLFactory::MakeMesh(Mesh& rMesh, Element* pParentElement)
{
...
bool UBMLFactory::MakeFace(Face& rFace, Element* pParentElement)
{
...
bool UBMLFactory::MakeTextureOption(Face& rFace, Element* pParentElement)
{
...
bool UBMLFactory::MakeLayerGroup(Element* pParentElement)
{
...
bool UBMLFactory::MakeLayer(Layer& rLayer, Element* pParentElement)
{
...
bool UBMLFactory::MakeObjectGroup(Element* pParentElement)
{
...
bool UBMLFactory::MakeObject(Object& rObject, Element* pParentElement)
{
...
bool UBMLFactory::MakeObjectAttrGroup(Object& rObject, Element* pParentElement)
{
...
bool UBMLFactory::MakeObjectAttr(Object::Attr& rAttr, Element* pParentElement)
{
...
bool UBMLFactory::MakeObjectMeshGroup(Object& rObject, Element* pParentElement)
{
...
bool UBMLFactory::MakeObjectMesh(Object::ObjectMesh& rMesh, Element* pParentElement)
{
...
bool UBMLFactory::Read(std::wstring strPath, Reader& rReader)
{
...
bool UBMLFactory::ReadHeader(Element& rElement)
{
...
bool UBMLFactory::ReadMeshVersion(Element& rElement)
{
	return ReadString(rElement, m_strMeshVersion, m_strError);

}

bool UBMLFactory::ReadUnitOfLength(Element& rElement)
{
	int nUnitOfLength;
...
bool UBMLFactory::ReadObjectGroup(Element& rElement)
{
	rElement.SetDescription(TAG_MAP[rElement.GetTag()]);
...
bool UBMLFactory::ReadObject(Element& rElement)
{
	const std::wstring& strTagDesc = TAG_MAP[rElement.GetTag()];
	rElement.SetDescription(strTagDesc);
...
bool UBMLFactory::ReadObjectMeshGroup(Element& rElement, Object& rObject)
{
...
bool UBMLFactory::ReadObjectMesh(Element& rElement, Object& rObject)
{
	const std::wstring& strElementDesc = TAG_MAP[rElement.GetTag()];
	rElement.SetDescription(strElementDesc);
...
bool UBMLFactory::ReadObjectAttrGroup(Element& rElement, Object& rObject)
{
	const std::wstring& strElementDesc = TAG_MAP[rElement.GetTag()];
	rElement.SetDescription(strElementDesc);
...
bool UBMLFactory::ReadObjectAttr(Element& rElement, Object& rObject)
{
	const std::wstring& strElementDesc = TAG_MAP[rElement.GetTag()];
	rElement.SetDescription(strElementDesc);
...
bool UBMLFactory::ReadLayerGroup(Element& rElement)
{
	rElement.SetDescription(TAG_MAP[rElement.GetTag()]);
...
bool UBMLFactory::ReadLayer(Element& rElement)
{
	const std::wstring& strTagDesc = TAG_MAP[rElement.GetTag()];
	rElement.SetDescription(strTagDesc);
...
bool UBMLFactory::ReadMeshGroup(Element& rElement)
{
	rElement.SetDescription(TAG_MAP[rElement.GetTag()]);
...
bool UBMLFactory::ReadMesh(Element& rElement)
{
	rElement.SetDescription(TAG_MAP[rElement.GetTag()]);
...
bool UBMLFactory::ReadFaces(Element& rElement, Mesh& rMesh, bool is3D)
{
	const std::wstring& strTagDesc = TAG_MAP[rElement.GetTag()];
	rElement.SetDescription(strTagDesc);
...
bool UBMLFactory::ReadFace(Element& rElement, Mesh& rMesh, bool is3D)
{
	const std::wstring& strTagDesc = TAG_MAP[rElement.GetTag()];
	rElement.SetDescription(strTagDesc);
...
bool UBMLFactory::ReadTextureOption(Element& rElement, Face& rFace)
{
	const std::wstring& strTagDesc = TAG_MAP[rElement.GetTag()];
	rElement.SetDescription(strTagDesc);
...
bool UBMLFactory::ReadMaterialGroup(Element& rElement)
{
	rElement.SetDescription(TAG_MAP[rElement.GetTag()]);
...
bool UBMLFactory::ReadMaterial(Element& rElement)
{
	rElement.SetDescription(TAG_MAP[rElement.GetTag()]);
...
bool UBMLFactory::ReadSpecularColor(Element& rElement, Material& rMaterial, int& rBeginIndex)
{
...
bool UBMLFactory::ReadMaterialTexture(Element& rElement, Material& rMaterial, int& rBeginIndex)
{
	const std::wstring& strTagDesc = TAG_MAP[rElement.GetTag()];
	rElement.SetDescription(strTagDesc);
...
bool UBMLFactory::ReadTextureGroup(Element& rElement)
{
	rElement.SetDescription(TAG_MAP[rElement.GetTag()]);
...
bool UBMLFactory::ReadTexture(Element& rElement)
{
	rElement.SetDescription(TAG_MAP[rElement.GetTag()]);
...
bool UBMLFactory::Read2DVerticesGroup(Element& rElement)
{
	rElement.SetDescription(TAG_MAP[rElement.GetTag()]);
...
bool UBMLFactory::Read2DVertices(Element& rElement)
{
	const std::wstring& strTagDesc = TAG_MAP[rElement.GetTag()];
	rElement.SetDescription(strTagDesc);
...
bool UBMLFactory::Read2DVertex(Element& rElement, Vertices& r2DVertices)
{
	rElement.SetDescription(TAG_MAP[rElement.GetTag()]);
...
bool UBMLFactory::Read3DVerticesGroup(Element& rElement)
{
	rElement.SetDescription(TAG_MAP[rElement.GetTag()]);
...
bool UBMLFactory::Read3DVertices(Element& rElement)
{
	const std::wstring& strTagDesc = TAG_MAP[rElement.GetTag()];
	rElement.SetDescription(strTagDesc);
...
bool UBMLFactory::Read3DVertex(Element& rElement, Vertices& r3DVertices)
{
	rElement.SetDescription(TAG_MAP[rElement.GetTag()]);

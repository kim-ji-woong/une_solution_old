#ifndef __UMATH_asm_math_H__
#define __UMATH_asm_math_H__

#include "UMathAPI.h"

#if  UNE_COMPILER == UNE_COMPILER_MSVC
#  pragma warning (push)
...
namespace UnE
{
	namespace Math
	{
		...
		=============================================================================*/
		#if  UNE_COMPILER == UNE_COMPILER_MSVC && UNE_ARCH_TYPE == UNE_ARCHITECTURE_32
		#	pragma warning( push )

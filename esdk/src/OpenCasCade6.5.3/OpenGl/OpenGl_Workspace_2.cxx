...
# include <config.h>
  ...
  #include <FreeImagePlus.h>
	...
	#ifdef _DEBUG
		#ifdef WIN64
			#pragma comment( lib, "FreeImageDll10x64D.lib" )
			#pragma comment( lib, "FreeImagePlus10x64D.lib" )
		#else
			#pragma comment( lib, "FreeImagedll10win32D.lib" )
			#pragma comment( lib, "FreeImagePlus10win32D.lib" )
		#endif
	#else
		#ifdef WIN64
			#pragma comment( lib, "FreeImagedll10x64.lib" )
			#pragma comment( lib, "FreeImagePlus10x64.lib" )
		#else
			#pragma comment( lib, "FreeImageDll10win32.lib" )
			#pragma comment( lib, "FreeImagePlus10win32.lib" )
		#endif
	#endif

namespace WindowsFormsApplication2
{
	partial class FormPrintPreview
	{
		...
		private void InitializeComponent()
		{
			...
			this.toolStripMenuItem2 = new WindowsFormsApplication2.IDToolStripMenuItem();
			this.toolStripMenuItem1 = new WindowsFormsApplication2.IDToolStripMenuItem();
			this.toolStripMenuItem3 = new WindowsFormsApplication2.IDToolStripMenuItem();
			this.toolStripMenuItem4 = new WindowsFormsApplication2.IDToolStripMenuItem();
			this.toolStripMenuItem5 = new WindowsFormsApplication2.IDToolStripMenuItem();
			this.toolStripMenuItem6 = new WindowsFormsApplication2.IDToolStripMenuItem();
			this.toolStripMenuItem7 = new WindowsFormsApplication2.IDToolStripMenuItem();
			this.toolStripMenuItem8 = new WindowsFormsApplication2.IDToolStripMenuItem();
			this.toolStripMenuItem9 = new WindowsFormsApplication2.IDToolStripMenuItem();

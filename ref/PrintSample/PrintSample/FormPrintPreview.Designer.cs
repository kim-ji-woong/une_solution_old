namespace UnE.Utility.Print
{
	partial class FormPrintPreview
	{
		...
		private void InitializeComponent()
		{
			...
			this.toolStripMenuItem2 = new UnE.Utility.Print.IDToolStripMenuItem();
			this.toolStripMenuItem1 = new UnE.Utility.Print.IDToolStripMenuItem();
			this.toolStripMenuItem3 = new UnE.Utility.Print.IDToolStripMenuItem();
			this.toolStripMenuItem4 = new UnE.Utility.Print.IDToolStripMenuItem();
			this.toolStripMenuItem5 = new UnE.Utility.Print.IDToolStripMenuItem();
			this.toolStripMenuItem6 = new UnE.Utility.Print.IDToolStripMenuItem();
			this.toolStripMenuItem7 = new UnE.Utility.Print.IDToolStripMenuItem();
			this.toolStripMenuItem8 = new UnE.Utility.Print.IDToolStripMenuItem();
			this.toolStripMenuItem9 = new UnE.Utility.Print.IDToolStripMenuItem();

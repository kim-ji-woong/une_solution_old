...
{
    public class Polygon : BoundingShape
    {
        ...
        public Polygon(List<List<Vertex2D>> arrVertices, double dScale, Vertex2D vCenter)
        {
            m_brush = new System.Drawing.SolidBrush(System.Drawing.Color.Black);
            m_arrVertices.Clear();
        ...
        private void DrawFill(System.Drawing.Graphics g)
        {

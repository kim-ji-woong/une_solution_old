...
//    /// </devdoc>
//    public class DataGridViewButtonCell2 : DataGridViewCell
//    {
...
//        {
//            DataGridViewButtonCell2 dataGridViewCell;
//            Type thisType = this.GetType();

//            if (thisType == cellType) //performance improvement
//            {
//                dataGridViewCell = new DataGridViewButtonCell2();
//            }
//            else
//            {
//                // SECREVIEW : Late-binding does not represent a security thread, see bug#411899 for more info..
//                //
//                dataGridViewCell = (DataGridViewButtonCell2)System.Activator.CreateInstance(thisType);
//            }
...
//            {
//                Rectangle rectThemeMargins = DataGridViewButtonCell2.GetThemeMargins(graphics);
...
//            {
//                DataGridViewButtonCell2 dataGridViewCell = (DataGridViewButtonCell2)this.Owner;

...
namespace C4
{
	...
	class TerrainPaintUndoData : public UndoData
	{
		private:
		...
		public:
			...
			TerrainPaintUndoData(TerrainBlock *block, int32 channel1, int32 channel2);
			~TerrainPaintUndoData();
	...
	class TerrainTextureWidget : public RenderableWidget
	{
		private:
			...
			float						imageTexcoord[36];
			ColorRGB					imageColor[12];
			
			static const ConstPoint2D	imageVertex[12];
			static const ConstPoint2D	backgroundVertex[12];
			
			void SetHilitedFace(int32 face);
			void UpdateFaceTexture(int32 face);
	...
	class PaletteWidget : public ImageWidget
	{
		public:
	...
	class TerrainRebuildUndoData : public UndoData
	{
		private:
		...
		public:
			...
			TerrainRebuildUndoData(TerrainBlock *block);
			~TerrainRebuildUndoData();

...
namespace C4
{
	...
	class Editor : public Window, public Observable<Editor, const EditorEvent&>, public ListElement<Editor>
	{
		...
		public:
			...
			typedef bool PickFilterProc(const Node *, const PickData *, void *);
			typedef void PlacementModifierProc(const Editor *, Transform4D *, const Vector3D&, void *);
		...
		private:
			...
			void							*pickFilterCookie;
			
			PlacementModifierProc			*placementModifierProc;
			void							*placementModifierCookie;
			
			List<UndoData>					undoList;
			...
			void HandleCopyTransformMenuItem(Widget *menuItem, const WidgetEventData *eventData);
			void HandlePasteTransformMenuItem(Widget *menuItem, const WidgetEventData *eventData);
			...
			void HandleAutoConnectPortalMenuItem(Widget *menuItem, const WidgetEventData *eventData);
			void HandleConnectRootZoneMenuItem(Widget *menuItem, const WidgetEventData *eventData);
			...
			void HandleShowAllMenuItem(Widget *menuItem, const WidgetEventData *eventData);
			void HandleHideSelectedMenuItem(Widget *menuItem, const WidgetEventData *eventData);
			void HandleShowAllInTargetZoneMenuItem(Widget *menuItem, const WidgetEventData *eventData);
			...
			void HandleEditorSettingsMenuItem(Widget *menuItem, const WidgetEventData *eventData);
			
			void HandleShowAllPagesMenuItem(Widget *menuItem, const WidgetEventData *eventData);
			...
			static bool MaskedPickFilter(const Node *node, const PickData *pickData, void *cookie);
			static bool MaskedSelectedPickFilter(const Node *node, const PickData *pickData, void *cookie);
			
			Node *PickNode(Node *root, Ray *ray, PickData *pickData, PickFilterProc *filterProc = nullptr, void *filterCookie = nullptr) const;
		...
		public:
			...
			{
				editorState |= kEditorSelectionUpdated;
			}
			...
			void InstallPlacementModifier(PlacementModifierProc *proc, void *cookie = nullptr)
			{
				placementModifierProc = proc;
				placementModifierCookie = cookie;
			}
			...
			C4EDITORAPI void AddUndoData(UndoData *data);
			C4EDITORAPI void DeleteLastUndoData(void);
			...
			C4EDITORAPI static bool NodeSelectable(const Node *node, unsigned_int32 mask);
			C4EDITORAPI bool SetTrackPickFilter(EditorTrackData *trackData, PickFilterProc *proc, void *cookie);
			
			Node *PickNode(EditorTrackData *trackData, PickData *pickData, PickFilterProc *filterProc, void *filterCookie = nullptr) const;
			Node *PickNode(EditorTrackData *trackData, PickData *pickData, unsigned_int32 mask) const;
			...
			Node *PickGizmoMover(EditorTrackData *trackData) const;
			Node *PickGizmoRotator(EditorTrackData *trackData) const;
			...
			C4EDITORAPI void ReparentSelectedNodes(Node *super);
			
			C4EDITORAPI void ImportScene(Node *root);
			
			void ConstructViewport(int32 index);
			void UpdateViewportStructures(void);
			void InvalidateFrustumViewports(void);
			...
			C4EDITORAPI void ModifyPlacement(Transform4D *transform, const Vector3D& normal) const;
	...
	class WorldEditor : public Plugin, public Singleton<WorldEditor>
	{
		private:
			...
			Constructor<Manipulator, Node *>	manipulatorConstructor;
			...
			void HandleNewWorldMenuItem(Widget *widget, const WidgetEventData *eventData);
			void HandleOpenWorldMenuItem(Widget *widget, const WidgetEventData *eventData);
			void HandleReopenWorldMenuItem(Widget *widget, const WidgetEventData *eventData);
			void HandleWorldCommand(Command *command, const char *text);
			static void WorldPicked(FilePicker *picker, void *cookie);
			
			void HandleNewPanelMenuItem(Widget *widget, const WidgetEventData *eventData);
			void HandleOpenPanelMenuItem(Widget *widget, const WidgetEventData *eventData);
			void HandlePanelCommand(Command *command, const char *text);
			static void PanelPicked(FilePicker *picker, void *cookie);
			
			void HandleOpenModelMenuItem(Widget *widget, const WidgetEventData *eventData);

...
namespace C4
{
	...
	class GlyphWidget : public ImageWidget, public ListElement<GlyphWidget>
	{
		private:
			
			static const ConstPoint3D		backgroundVertex[12];
			static const ConstColorRGB		backgroundColor[12];
	...
	class FontPicker : public Window, public LinkTarget<FontPicker>
	{
		private:
			...
			class FontWidget : public TextWidget
			{
				public:
	...
	class FontGenerator : public Plugin, public Singleton<FontGenerator>
	{
		private:
			...
			void HandleGenerateFontMenuItem(Widget *widget, const WidgetEventData *eventData);

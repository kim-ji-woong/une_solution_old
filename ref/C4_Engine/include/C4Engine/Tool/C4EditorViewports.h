...
namespace C4
{
	...
	enum
	{
		kEditorViewportOrtho		= 'ORTH',		//## An orthographic viewport.
		kEditorViewportFrustum		= 'FRUS',		//## A perspective viewport.
		kEditorViewportGraph		= 'GRPH'		//## A scene graph viewport.
	};
	...
	class EditorViewport
	{
		...
		protected:
			...
			EditorViewport(EditorViewportType type, Editor *editor, int32 mode, ViewportWidget *widget);
	...
	class OrthoEditorViewport : public EditorViewport
	{
		...
		public:
			...
			OrthoEditorViewport(Editor *editor, const Vector2D& scale, int32 mode);
			~OrthoEditorViewport();
	...
	class FrustumEditorViewport : public EditorViewport
	{
		...
		public:
			...
			FrustumEditorViewport(Editor *editor);
			...
			void Hover(const Point3D& position);
	};
	...
	class GraphEditorViewport : public EditorViewport
	{
		...
		public:
			...
			GraphEditorViewport(Editor *editor, const Vector2D& scale);
			~GraphEditorViewport();

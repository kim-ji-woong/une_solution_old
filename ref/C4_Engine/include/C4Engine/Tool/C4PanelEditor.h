...
namespace C4
{
	...
	{ 
		private: 
			...
			Point2D					widgetVertex[48]; 
			Point2D					widgetTexcoord[48];
			
			List<Attribute>			widgetAttributeList;
			DiffuseAttribute		widgetDiffuseColor; 
			TextureMapAttribute		widgetTextureMap;
			Renderable				widgetRenderable;
			
			void BuildHandle(Point2D *vertex, Point2D *texcoord, float x, float y, float scale);
	...
	class PanelUndoData : public ListElement<PanelUndoData>
	{
		protected:
		...
		public:
			...
			virtual ~PanelUndoData();
			
			virtual void Undo(PanelEditor *panelEditor) = 0;
	};
	
	
	class CreatePanelUndoData : public PanelUndoData
	{
		private:
		...
		public:
			...
			CreatePanelUndoData(Widget *widget);
			CreatePanelUndoData(const List<EditorWidgetManipulator> *selectionList);
			~CreatePanelUndoData();
			
			void Undo(PanelEditor *panelEditor);
	};
	
	
	class DeletePanelUndoData : public PanelUndoData
	{
		private:
		...
		public:
			...
			DeletePanelUndoData(Widget *rootWidget);
			~DeletePanelUndoData();
	...
	class TransformPanelUndoData : public PanelUndoData
	{
		private:
		...
		public:
			...
			TransformPanelUndoData(const List<EditorWidgetManipulator> *selectionList);
			~TransformPanelUndoData();
			
			void Undo(PanelEditor *panelEditor);
	};
	
	
	class WarpPanelUndoData : public PanelUndoData
	{
		private:
		...
		public:
			...
			WarpPanelUndoData(const List<EditorWidgetManipulator> *selectionList);
			~WarpPanelUndoData();
	...
	class ArrangePanelUndoData : public PanelUndoData
	{
		private:
		...
		public:
			...
			ArrangePanelUndoData(Widget *rootWidget);
			~ArrangePanelUndoData();
			
			void Undo(PanelEditor *panelEditor);
	};
	
	
	class GroupPanelUndoData : public PanelUndoData
	{
		private:
		...
		public:
			...
			GroupPanelUndoData(Widget *group, const Widget *rootWidget);
			~GroupPanelUndoData();
	...
	class UngroupPanelUndoData : public PanelUndoData
	{
		private:
		...
		public:
			...
			UngroupPanelUndoData(const List<EditorWidgetManipulator> *selectionList);
			~UngroupPanelUndoData();
			
			void Undo(PanelEditor *panelEditor);
	};
	
	
	class TexturePanelUndoData : public PanelUndoData
	{
		private:
		...
		public:
			...
			TexturePanelUndoData(const List<EditorWidgetManipulator> *selectionList);
			~TexturePanelUndoData();
			
			void Undo(PanelEditor *panelEditor);
	};
	
	
	class ScriptPanelUndoData : public PanelUndoData
	{
		private:
		...
		public:
			...
			ScriptPanelUndoData(const List<EditorWidgetManipulator> *selectionList);
			~ScriptPanelUndoData();
	...
	class PanelEditor : public Window, public ListElement<PanelEditor>
	{
		...
		public:
			...
			void AddUndoData(PanelUndoData *data);
			void RemoveUndoData(PanelUndoData *data);

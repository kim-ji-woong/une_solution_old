...
namespace C4
{
	...
	//#
	//# When a $Connector$ object is first constructed, both the start and finish nodes for the connector are set to the hub
	...
	class Connector : public GraphEdge<Hub, Connector>, public Memory<Connector>
	{
		private:
	...
	class Hub : public GraphElement<Hub, Connector>, public Memory<Connector>
	{
		private:

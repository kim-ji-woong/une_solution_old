...
namespace C4
{
	...
	class Camera : public Node
	{
		...
		private:
			...
			static Camera *Construct(Unpacker& data, unsigned_int32 unpackFlags);
	...
	class FrustumCamera : public Camera, public LinkTarget<FrustumCamera>
	{
		...
		protected:
			...
			C4API void CalculatePostTransform(void) override;
	...
	class RemoteCamera : public FrustumCamera
	{
		...
		private:
			...
			Point3D		remoteVertex[kMaxPortalVertexCount];
		...
		public:
			...
			void CalculateRemoteCameraRegion(int32 vertexCount, const Point3D *vertex, CameraRegion *region);
	};

...
namespace C4
{
	...
	class MenuItemWidget : public Widget, public ListElement<MenuItemWidget>
	{
		private:
	...
	//
	//# \def	class PopupMenuWidget : public TextWidget
	//
	...
	class PopupMenuWidget : public TextWidget
	{
		...
		private:
			...
			Point2D								menuVertex[12];
			Point2D								menuTexcoord[12];
	...
	class PulldownMenuWidget : public TextWidget, public ListElement<PulldownMenuWidget>
	{
		private:
	...
	class MenuButtonWidget : public GuiButtonWidget
	{
		private:
	...
	//
	//# \def	class MenuBarWidget : public RenderableWidget
	//
	...
	class MenuBarWidget : public RenderableWidget
	{
		...
		private:
			...
			Point2D							menuBarVertex[8];
			ColorRGBA						menuBarColor[8];
			Point2D							menuBarTexcoord[8];
	...
	class MenuFrameWidget : public RenderableWidget
	{
		private:
			...
			Point2D					frameVertex[25];
			Point2D					frameTexcoord[25];

...
namespace C4
{
	...
	class C4_API GraphEdgeStart : public ListElement<GraphEdgeStart>
	{
	...
	class C4_API GraphEdgeFinish : public GraphEdgeStart, public ListElement<GraphEdgeFinish>
	{
		friend class GraphElementBase;
	...
	class C4_API GraphElementBase : public ListElement<GraphElementBase>
	{
		...
		protected:
			...
			GraphEdgeStart *FindOutgoingEdge(const GraphElementBase *finish) const;
			GraphEdgeFinish *FindIncomingEdge(const GraphElementBase *start) const;
	...
	//
	//# \tparam		elementType		The type of the class that can be stored as a element in the graph.
	...
	//
	//# \tparam		elementType		The type of the class that can be stored as a element in the graph. This parameter should

...
extern "C"
{
	...
	WINUSERAPI BOOL WINAPI GetClassInfoExW(HINSTANCE hInstance, LPCWSTR lpszClass, WNDCLASSEXW* lpwcx);
	WINBASEAPI DWORD WINAPI GetLastError(void);
	WINBASEAPI void WINAPI GetSystemInfo(SYSTEM_INFO *);
	WINBASEAPI BOOL WINAPI GetVersionExA(OSVERSIONINFO *);
	...
	WINSOCK_API_LINKAGE SOCKET WSAAPI WSASocketA(int, int, int, WSAPROTOCOL_INFO *, GROUP, DWORD);

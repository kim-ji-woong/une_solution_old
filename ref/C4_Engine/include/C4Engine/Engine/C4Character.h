...
namespace C4
{
	...
	//# which the surface is considered to be the ground. This value is used by the $@CharacterController::GroundContact@$
	...
	//# \also	$@CharacterController::GroundContact@$
	...
	//# is used by the $@CharacterController::GroundContact@$ when determining whether any geometry contact represents

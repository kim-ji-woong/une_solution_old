...
namespace C4
{
	...
	//
	//# \def	class PanelController : public ScriptController
	//
	...
	//# \function	PanelController::GetFirstWidget		Returns the first panel item for a panel controller.
	//
	//# \proto	Widget *GetFirstWidget(void) const;
	//
	//# \desc
	//# The $GetFirstWidget$ function returns the first panel item attached to a panel controller. The entire
	//# list of panel items can be iterated by calling the $@Utilities/ListElement::Next@$ function on the returned object.
	//# If a panel controller has no panel items, then the $GetFirstWidget$ returns $nullptr$.
	//
	//# \also	$@PanelController::GetLastWidget@$
	//# \also	$@PanelController::GetWidgetCount@$
	//# \also	$@PanelController::AppendWidget@$
	//# \also	$@PanelController::PrependWidget@$
	//# \also	$@PanelController::InsertWidgetBefore@$
	//# \also	$@PanelController::InsertWidgetAfter@$
	//# \also	$@PanelController::RemoveWidget@$
	//# \also	$@PanelController::PurgeWidgets@$
	//# \also	$@InterfaceMgr/Widget@$
	
	
	//# \function	PanelController::GetLastWidget		Returns the first panel item for a panel controller.
	//
	//# \proto	Widget *GetLastWidget(void) const;
	//
	//# \desc
	//# The $GetLastWidget$ function returns the last panel item attached to a panel controller. The entire
	//# list of panel items can be iterated by calling the $@Utilities/ListElement::Previous@$ function on the returned object.
	//# If a panel controller has no panel items, then the $GetLastWidget$ returns $nullptr$.
	//
	//# \also	$@PanelController::GetFirstWidget@$
	//# \also	$@PanelController::GetWidgetCount@$
	//# \also	$@PanelController::AppendWidget@$
	//# \also	$@PanelController::PrependWidget@$
	//# \also	$@PanelController::InsertWidgetBefore@$
	...
	//# \function	PanelController::GetWidgetCount		Returns the number of panel items attached to a panel controller.
	//
	//# \proto	int32 GetWidgetCount(void) const;
	//
	//# \desc
	//# The $GetWidgetCount$ function returns the number of panel items attached to a panel controller.
	//
	//# \also	$@PanelController::GetFirstWidget@$
	//# \also	$@PanelController::GetLastWidget@$
	//# \also	$@PanelController::AppendWidget@$
	...
	//# \function	PanelController::AppendWidget		Appends a panel item to the list owned by a panel controller.
	//
	//# \proto	void AppendWidget(Widget *item);
	//
	//# \param	item	The panel item to attach to the panel controller.
	//
	//# \desc
	//# The $AppendWidget$ function appends a panel item to the list owned by a panel controller.
	//
	//# \also	$@PanelController::PrependWidget@$
	//# \also	$@PanelController::InsertWidgetBefore@$
	//# \also	$@PanelController::InsertWidgetAfter@$
	...
	//# \function	PanelController::PrependWidget		Prepends a panel item to the list owned by a panel controller.
	//
	//# \proto	void PrependWidget(Widget *item);
	//
	//# \param	item	The panel item to attach to the panel controller.
	//
	//# \desc
	//# The $PrependWidget$ function prepends a panel item to the list owned by a panel controller.
	//
	//# \also	$@PanelController::AppendWidget@$
	//# \also	$@PanelController::InsertWidgetBefore@$
	//# \also	$@PanelController::InsertWidgetAfter@$
	...
	//# \function	PanelController::InsertWidgetBefore		Inserts a panel item before another in the list owned by a panel controller.
	//
	//# \proto	void InsertWidgetBefore(Widget *item, Widget *before);
	//
	//# \param	item	The panel item to attach to the panel controller.
	//# \param	before	The panel item before which $item$ will be inserted. This cannot be $nullptr$.
	//
	//# \desc
	...
	//# \function	PanelController::InsertWidgetAfter		Inserts a panel item after another in the list owned by a panel controller.
	//
	//# \proto	void InsertWidgetAfter(Widget *item, Widget *after);
	//
	//# \param	item	The panel item to attach to the panel controller.
	//# \param	after	The panel item after which $item$ will be inserted. This cannot be $nullptr$.
	//
	//# \desc
	...
	//# \function	PanelController::RemoveWidget		Removes a panel item from the list owned by a panel controller.
	//
	//# \proto	void RemoveWidget(Widget *item);
	//
	//# \param	item	The panel item to be removed from the panel controller.
	//
	//# \desc
	//# The $RemoveWidget$ function removes a panel item from the list owned by a panel controller.
	//
	//# \also	$@PanelController::PurgeWidgets@$
	//# \also	$@PanelController::AppendWidget@$
	//# \also	$@PanelController::PrependWidget@$
	...
	//# \function	PanelController::PurgeWidgets		Purges all panel items from the list owned by a panel controller.
	//
	//# \proto	void PurgeWidgets(void);
	//
	//# \desc
	//# The $PurgeWidgets$ function purges all panel items from the list owned by a panel controller.
	//
	//# \also	$@PanelController::RemoveWidget@$
	//# \also	$@PanelController::AppendWidget@$
	//# \also	$@PanelController::PrependWidget@$
	...
	class PanelController : public ScriptController
	{
		...
		public:
			...
			void ExecuteWidgetScript(ScriptObject *object, Node *activator)
			{
				ExecuteScript(object, nullptr, activator);
			}
	...
	//
	//# \def	class CameraWidget : public ImageWidget
	//
	...
	//# connector belonging to the panel effect that is connected to a $@WorldMgr/FrustumCamera@$ node. The key can
	//# be specified by calling the $@CameraWidget::SetCameraConnectorKey@$ function.
	//
	...
	//# \function	CameraWidget::SetCameraConnectorKey		Returns the connector key that identifies the camera node.
	//
	...
	//# to which the camera widget belongs, and that connector should be connected to a $@WorldMgr/FrustumCamera@$ node.
	...
	class WidgetFunction : public Function
	{
		...
		public:
			...
			C4API void Compress(Compressor& data) const;
			C4API bool Decompress(Decompressor& data);
			
			C4API int32 GetSettingCount(void) const;
			C4API Setting *GetSetting(int32 index) const;
			C4API void SetSetting(const Setting *setting);
			
			C4API bool OverridesFunction(const Function *function) const;
	};
	
	
	class EnableWidgetFunction : public WidgetFunction
	{
		private:
	...
	class DisableWidgetFunction : public WidgetFunction
	{
		private:
	...
	class ShowWidgetFunction : public WidgetFunction
	{
		private:
	...
	class HideWidgetFunction : public WidgetFunction
	{
		private:
	...
	class ActivateWidgetFunction : public WidgetFunction
	{
		private:
	...
	class SetMutatorStateFunction : public WidgetFunction
	{
		private:
	...
	class GetWidgetColorFunction : public WidgetFunction
	{
		private:
	...
	class SetWidgetColorFunction : public WidgetFunction
	{
		private:
	...
	class GetWidgetImageFunction : public WidgetFunction
	{
		private:
	...
	class SetWidgetImageFunction : public WidgetFunction
	{
		private:
	...
	class GetWidgetTextFunction : public WidgetFunction
	{
		private:
	...
	class SetWidgetTextFunction : public WidgetFunction
	{
		private:
	...
	class GetWidgetValueFunction : public WidgetFunction
	{
		private:
	...
	class SetWidgetValueFunction : public WidgetFunction
	{
		private:
	...
	class SetCameraConnectorKeyFunction : public WidgetFunction
	{
		private:

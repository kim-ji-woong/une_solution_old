...
namespace C4
{
	...
	class C4_API PropertyRegistration : public Registration<Property, PropertyRegistration>
	{
		private:
	...
	//# (through logical OR) the following values.
	//
	//# \table	PropertyFlags
	//
	...
	//# which can be zero or a combination (through logical OR) the following values.
	//
	//# \table	PropertyFlags
	//
	...
	class C4_API Property : public MapElement<Property>, public Packable, public Configurable, public Registrable<Property, PropertyRegistration>
	{
		...
		private:
			...
			virtual Property *Replicate(void) const;
			
			static Property *Construct(Unpacker& data, unsigned_int32 unpackFlags = 0);
		...
		public:
			...
			static Property *New(PropertyType type);
	...
	class C4_API PropertyObject : public Object
	{
		private:
	...
	class C4_API NameProperty : public Property
	{
		...
		public:
			...
			NameProperty(const char *name);
			~NameProperty();
			
			const String<>& GetNodeName(void) const
			{
				return (nodeName);
			}
	...
	class C4_API ClearProperty : public Property
	{
		...
		public:
			...
			ClearProperty(const ColorRGBA& color);
			~ClearProperty();
	...
	class C4_API InteractionProperty : public Property
	{
		private:
	...
	class C4_API AcousticsProperty : public Property
	{
		...
		public:
			...
			AcousticsProperty(float direct, float directHF, float reflection, float reflectionHF);
			~AcousticsProperty();

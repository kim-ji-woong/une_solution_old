...
namespace C4
{
	...
	enum
	{
		kEmitterBox			= 'BOX ',		//## A box emitter.
		kEmitterCylinder	= 'CYLD',		//## A cylinder emitter.
		kEmitterSphere		= 'SPHR'		//## A sphere emitter.
	};
	...
	class EmitterObject : public Object, public VolumeObject
	{
		...
		private:
			...
			static EmitterObject *Construct(Unpacker& data, unsigned_int32 unpackFlags);
	...
	//
	//# \def	class BoxEmitterObject : public EmitterObject, public BoxVolume
	//
	...
	class BoxEmitterObject : public EmitterObject, public BoxVolume
	{
		...
		public:
			...
			float GetEmitterRadius(void) const;
			float GetEmitterSurfaceArea(void) const;
			
			Point3D GetVolumeEmissionPoint(void) const;
	...
	//
	//# \def	class CylinderEmitterObject : public EmitterObject, public CylinderVolume
	//
	...
	class CylinderEmitterObject : public EmitterObject, public CylinderVolume
	{
		friend class EmitterObject;
	...
	//
	//# \def	class SphereEmitterObject : public EmitterObject, public SphereVolume
	//
	...
	class SphereEmitterObject : public EmitterObject, public SphereVolume
	{
		friend class EmitterObject;
	...
	class Emitter : public Node
	{
		...
		private:
			...
			static Emitter *Construct(Unpacker& data, unsigned_int32 unpackFlags);
	...
	//
	//# \def	class BoxEmitter : public Emitter
	//
	...
	//
	//# \def	class CylinderEmitter : public Emitter
	//
	...
	class CylinderEmitter : public Emitter
	{
		friend class Emitter;
	...
	//
	//# \def	class SphereEmitter : public Emitter
	//

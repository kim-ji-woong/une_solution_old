...
namespace C4
{
	...
	//# reaches the size limit of a 32-bit integer, it wraps around. The $sampleData$ parameter contains a pointer to the raw
	//# audio data, in uncompressed mono PCM format with 16 bits per sample. The $sampleCount$ parameter contains the number of

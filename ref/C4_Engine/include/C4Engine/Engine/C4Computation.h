...
namespace C4
{
	...
	enum
	{
		kMaxPolyhedronVertexCount	= 24,
		kMaxPolyhedronEdgeCount		= 34,
		kMaxPolyhedronFaceCount		= 12,
		kMaxFaceEdgeCount			= 12
	};
	...
	struct Edge
	{
		unsigned_int16		vertexIndex[2];
		unsigned_int16		faceIndex[2];
	};
	...
	struct Face 
	{
		Antivector4D		plane; 
		int32				edgeCount; 
		unsigned_int16		edgeIndex[kMaxFaceEdgeCount]; 
	};
	...
	struct Polyhedron
	{
		...
		void GetTriangleArray(Triangle *triangle) const;
	};
	...
	//#											<b>Mx</b>&nbsp;=&nbsp;<b>r</b>.
	//
	//# \proto	bool SolveLinearSystem(int32 n, float *m, float *r);
	//
	//# \param	n	The size of the <i>n</i>&nbsp;&times;&nbsp;<i>n</i> coefficient matrix <b>M</b>.
	//# \param	m	A pointer to the <i>n</i><SUP>2</SUP> entries of the coefficient matrx <b>M</b>,
	...
	//
	//# \proto	bool LUDecompose(int32 n, float *m, unsigned_int16 *index, float *detSign = nullptr);
	//
	//# \param	n			The size of the <i>n</i>&nbsp;&times;&nbsp;<i>n</i> matrix <b>M</b>.
	//# \param	m			A pointer to the <i>n</i><SUP>2</SUP> entries of the matrx <b>M</b>,
	...
	//
	//# \proto	void LUBacksubstitute(int32 n, const float *d, const unsigned_int16 *index, const float *r, float *x);
	//
	...
	//
	//# \proto	void LURefineSolution(int32 n, const float *m, const float *d, const unsigned_int16 *index, const float *r, float *x);
	//
	...
	//
	//# \proto	void SolveTridiagonalSystem(int32 n, const float *a, const float *b, const float *c, const float *r, float *x);
	//
	...
	//# 			<mtable>
	//# 				<mtr>
	//# 					<mtd><mrow><mi class="code">b</mi><mo class="code">[</mo><mn class="code">0</mn><mo class="code">]</mo></mrow></mtd>
	//# 					<mtd><mrow><mi class="code">c</mi><mo class="code">[</mo><mn class="code">0</mn><mo class="code">]</mo></mrow></mtd>
	//# 					<mtd><mn>0</mn></mtd>
	//# 					<mtd><mn>0</mn></mtd>
	//# 					<mtd><mn>0</mn></mtd>
	//# 					<mtd><mo>&ctdot;</mo></mtd>
	//# 				</mtr>
	//# 				<mtr>
	//# 					<mtd><mrow><mi class="code">a</mi><mo class="code">[</mo><mn class="code">1</mn><mo class="code">]</mo></mrow></mtd>
	//# 					<mtd><mrow><mi class="code">b</mi><mo class="code">[</mo><mn class="code">1</mn><mo class="code">]</mo></mrow></mtd>
	//# 					<mtd><mrow><mi class="code">c</mi><mo class="code">[</mo><mn class="code">1</mn><mo class="code">]</mo></mrow></mtd>
	//# 					<mtd><mn>0</mn></mtd>
	//# 					<mtd><mn>0</mn></mtd>
	//# 					<mtd></mtd>
	//# 				</mtr>
	//# 				<mtr>
	//# 					<mtd><mn>0</mn></mtd>
	//# 					<mtd><mrow><mi class="code">a</mi><mo class="code">[</mo><mn class="code">2</mn><mo class="code">]</mo></mrow></mtd>
	//# 					<mtd><mrow><mi class="code">b</mi><mo class="code">[</mo><mn class="code">2</mn><mo class="code">]</mo></mrow></mtd>
	//# 					<mtd><mrow><mi class="code">c</mi><mo class="code">[</mo><mn class="code">2</mn><mo class="code">]</mo></mrow></mtd>
	//# 					<mtd><mn>0</mn></mtd>
	//# 					<mtd></mtd>
	//# 				</mtr>
	//# 				<mtr>
	...
	//# \div
	//# \function	Math::ClipSegmentAgainstPlane		Clips a line segment against a plane.
	//
	//# \proto	bool ClipSegmentAgainstPlane(Point3D *p1, Point3D *p2, const Antivector4D& plane);
	//
	...
	//# \param	plane	The plane against which the line segment is clipped.
	//
	//# \desc
	//# The $ClipSegmentAgainstPlane$ function clips the line segment specified by the $p1$ and $p2$ parameters
	//# against the plane specified by the $plane$ parameter. Any portion of the line segment that falls on the
	...
	//# \function	Math::ClipPolygonAgainstPlane		Clips a convex polygon against a plane.
	//
	//# \proto	int32 ClipPolygonAgainstPlane(int32 vertexCount, const Point3D *vertex, const Antivector4D& plane, int8 *location, Point3D *result);
	//
	//# \param	vertexCount		The number of vertices defining the boundary of the polygon. This must be at least 3.
	//# \param	vertex			An array containing the vertices of the polygon, wound in counterclockwise order.
	//# \param	plane			The plane against which the polygon is clipped.
	...
	//
	//# \desc
	//# The $ClipPolygonAgainstPlane$ function clips the polygon specified by the $vertexCount$ and $vertex$
	//# parameters and clips it against the plane specified by the $plane$ parameter. Any portion of the polygon
	//# that lies on the negative side of the clipping plane is removed, and the resulting polygon is stored in
	//# the array pointed to by the $result$ parameter. The return value of this function is the number of vertices
	//# in the clipped polygon. If the polygon is completely clipped away, then the return value is 0.
	
	
	//# \function	Math::TriangulatePolygon		Triangulates a convex or concave polygon having genus zero (i.e., no holes).
	//
	//# \proto	int32 TriangulatePolygon(int32 vertexCount, const Point3D *vertex, const Vector3D& normal, Triangle *triangle, int32 base = 0);
	//
	...
	//# \proto2	const Point3D *vertex, const Vector3D& normal, Point3D *result, Triangle *triangle);
	//
	...
	//
	//# \desc
	//# The $Random$ function returns a random integer between 0 and $n - 1$, inclusive.
	//# The number $n$ should be in the range [0, 65535].
	//
	//# \also	$@Math::RandomFloat@$
	//# \also	$@Math::RandomUnitVector@$
	...
	//# \function	Math::RandomUnitVector		Returns a random unit-length vector.
	//
	//# \proto	Vector3D RandomUnitVector(void);
	//
	//# \desc
	//# The $RandomUnitVector$ function returns a random unit-length vector. The values returned
	...
	namespace Math
	{
		...
		C4API bool IntersectSegmentAndTriangle(const Point3D& p1, const Point3D& p2, const Point3D& v1, const Point3D& v2, const Point3D& v3, Point3D *position, Vector3D *normal, float *t);
		...
		C4API bool SolveLinearSystem(int32 n, float *m, float *r);
		C4API bool LUDecompose(int32 n, float *m, unsigned_int16 *index, float *detSign = nullptr);
		C4API void LUBacksubstitute(int32 n, const float *d, const unsigned_int16 *index, const float *r, float *x);
		C4API void LURefineSolution(int32 n, const float *m, const float *d, const unsigned_int16 *index, const float *r, float *x);
		C4API void SolveTridiagonalSystem(int32 n, const float *a, const float *b, const float *c, const float *r, float *x);
		...
		C4API bool ClipSegmentAgainstPlane(Point3D *p1, Point3D *p2, const Antivector4D& plane);
		...
		C4API int32 ClipPolygonAgainstPlane(int32 vertexCount, const Point3D *vertex, const Antivector4D& plane, int8 *location, Point3D *restrict result);
		
		C4API bool ClipPolyhedronAgainstPlane(const Polyhedron *polyhedron, const Antivector4D& plane, Polyhedron *result);
		
		C4API int32 TriangulatePolygon(int32 vertexCount, const Point3D *vertex, const Vector3D& normal, Triangle *triangle, int32 base = 0);
		C4API int32 TriangulatePolygon(int32 windingCount, const int32 *vertexCount, const unsigned_int16 *const *vertexIndex, const Point3D *vertex, const Vector3D& normal, Point3D *result, Triangle *triangle, int32 triangleCount);
		
		inline int32 TriangulatePolygonalComplex(int32 windingCount, const int32 *vertexCount, const unsigned_int16 *const *vertexIndex, const Point3D *vertex, const Vector3D& normal, Point3D *result, Triangle *triangle)
		{
			return (TriangulatePolygon(windingCount, vertexCount, vertexIndex, vertex, normal, result, triangle, 0));
		}
		
		void IntersectConvexPolygons(const int32 *vertexCount, const Point3D *const *vertex, const Vector3D& normal, int32 *resultCount, Point3D *result);
		bool SubtractConvexPolygons(const int32 *vertexCount, const Point3D *const *vertex, const Vector3D& normal, int32 *resultCount, int32 *triangleCount, Point3D *result, Triangle *triangle);
	}
}

...
namespace C4
{
	...
	class C4_API ListElementBase
	{
		...
		public:
			...
			int32 GetListIndex(void) const;
			
			virtual void Detach(void);
	};
	
	
	class C4_API ListBase
	{
		...
		protected:
			...
			ListElementBase *operator [](machine index) const;
			...
			void Prepend(ListElementBase *element);
			void Append(ListElementBase *element);
			
			void InsertBefore(ListElementBase *element, ListElementBase *before);
			void InsertAfter(ListElementBase *element, ListElementBase *after); 
			
			void Remove(ListElementBase *element); 
	...
	//# a list. If the object is already a member of the list, then it is moved to the beginning. If the
	//# object is a member of a different list, then it is first removed from that list before being added
	//# to the new list.
	//
	//# \also	$@List::Append@$
	...
	//# a list. If the object is already a member of the list, then it is moved to the end. If the
	//# object is a member of a different list, then it is first removed from that list before being added
	//# to the new list.
	//
	//# \also	$@List::Prepend@$
	...
	//# of the list, then it is moved to the new position. If the object is a member of a different list,
	//# then it is first removed from that list before being added to the new list.
	//
	//# \also	$@List::InsertAfter@$
	//# \also	$@List::Prepend@$
	//# \also	$@List::Append@$
	...
	//# The object must belong to list for which the $Remove$ function is called, or the internal links will become corrupted.
	//
	//# \also	$@List::RemoveAll@$
	//# \also	$@List::Purge@$

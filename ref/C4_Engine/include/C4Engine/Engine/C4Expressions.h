...
namespace C4
{
	...
	class IdentifierToken : public Token
	{
		...
		public: 
			...
			IdentifierToken(const char *identifier, int32 len); 
			~IdentifierToken();
	...
	class Evaluator : public Tree<Evaluator>, public Packable, public Memory<ScriptState>
	{
		...
		public:
			...
			static Evaluator *Construct(Unpacker& data, unsigned_int32 unpackFlags);
	...
	class ValueEvaluator : public Evaluator
	{
		...
		public:
			...
			const Value *Evaluate(const ScriptState *state);
	};
	
	
	class MemberEvaluator : public ValueEvaluator
	{
		friend class Evaluator;
	...
	class BooleanEvaluator : public Evaluator
	{
		friend class Evaluator;
	...
	class IntegerEvaluator : public Evaluator
	{
		friend class Evaluator;
	...
	class FloatEvaluator : public Evaluator
	{
		friend class Evaluator;
	...
	class NegateEvaluator : public OperatorEvaluator
	{
		private:
	...
	class InvertEvaluator : public OperatorEvaluator
	{
		private:
	...
	class MultiplyEvaluator : public OperatorEvaluator
	{
		private:
	...
	class DivideEvaluator : public OperatorEvaluator
	{
		private:
	...
	class ModuloEvaluator : public OperatorEvaluator
	{
		private:
	...
	class AddEvaluator : public OperatorEvaluator
	{
		private:
	...
	class SubtractEvaluator : public OperatorEvaluator
	{
		private:
	...
	class AndEvaluator : public OperatorEvaluator
	{
		private:
	...
	class OrEvaluator : public OperatorEvaluator
	{
		private:
	...
	class XorEvaluator : public OperatorEvaluator
	{
		private:
	...
	class ShiftLeftEvaluator : public OperatorEvaluator
	{
		private:
	...
	class ShiftRightEvaluator : public OperatorEvaluator
	{
		private:
	...
	class LessEvaluator : public OperatorEvaluator
	{
		private:
	...
	class GreaterEvaluator : public OperatorEvaluator
	{
		private:
	...
	class LessEqualEvaluator : public OperatorEvaluator
	{
		private:
	...
	class GreaterEqualEvaluator : public OperatorEvaluator
	{
		private:
	...
	class EqualEvaluator : public OperatorEvaluator
	{
		private:
	...
	class NotEqualEvaluator : public OperatorEvaluator
	{
		private:
	...
	class ExpressionMethod : public Method
	{
		private:
			...
			static Token *BuildNumberToken(const char *& text);
			static Token *BuildIdentifierToken(const char *& text);
			static Token *BuildStringToken(const char *& text);
			static Token *BuildCharacterToken(const char *& text);

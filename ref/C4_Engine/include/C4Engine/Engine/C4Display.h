...
namespace C4
{
	...
	class C4_API DisplayEventHandler : public ListElement<DisplayEventHandler>
	{
		public:
	...
	class C4_API DisplayMode : public ListElement<DisplayMode>
	{
		private:
	...
	class C4_API DisplayMgr : public Manager<DisplayMgr>
	{
		private:
			...
			bool						cursorVisible;
				...
				CGrafPtr				displayPort;
				
				EventHandlerUPP			windowEventHandlerUPP;
				EventHandlerRef			windowEventHandlerRef;
				
				static OSStatus WindowEventHandler(EventHandlerCallRef handlerCallRef, EventRef event, void *userData);
		...
		public:
			...
			void InstallDisplayEventHandler(DisplayEventHandler *handler)
			{
				...
				GDHandle GetDisplayDevice(void) const
				{
					return (displayDevice);
				}
				
				CGrafPtr GetDisplayPort(void) const
				{
					return (displayPort);
				}
				
				void GlobalToLocalPoint(HIPoint *point) const;
			
			#endif
			
			EngineResult SetDisplayMode(int32 width, int32 height, int32 samples, unsigned_int32 flags);
	...
	C4_API extern DisplayMgr *TheDisplayMgr;
}

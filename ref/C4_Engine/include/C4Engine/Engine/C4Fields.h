...
namespace C4
{
	...
	enum
	{
		kFieldBox			= 'BOX ',		//## A box field.
		kFieldCylinder		= 'CYLD',		//## A cylinder field.
		kFieldSphere		= 'SPHR'		//## A sphere field.
	};
	...
	enum
	{
		kFieldExclusive		= 1 << 0		//## The field is for exclusive use by a controller and does not globally affect rigid bodies.
	};
	...
	//
	//# \desc
	//# The $GetFieldType$ function returns the specific field type, which may be one of the following values.
	//
	//# \table	FieldType
	...
	class FieldObject : public Object, public VolumeObject
	{
		...
		private:
			...
			static FieldObject *Construct(Unpacker& data, unsigned_int32 unpackFlags);
	...
	//
	//# \def	class BoxFieldObject : public FieldObject, public BoxVolume
	//
	...
	class BoxFieldObject : public FieldObject, public BoxVolume
	{
		...
		public:
			...
			Antivector4D CalculateSurfacePlane(void) const;
	};
	...
	//
	//# \def	class CylinderFieldObject : public FieldObject, public CylinderVolume
	//
	...
	class CylinderFieldObject : public FieldObject, public CylinderVolume
	{
		friend class FieldObject;
	...
	//
	//# \def	class SphereFieldObject : public FieldObject, public SphereVolume
	//
	...
	class Field : public Node
	{
		...
		private:
			...
			static Field *Construct(Unpacker& data, unsigned_int32 unpackFlags);
	...
	//
	//# \def	class BoxField : public Field
	//
	...
	//
	//# \def	class CylinderField : public Field
	//
	...
	//
	//# \def	class SphereField : public Field
	//

...
namespace C4
{
	...
	class Value : public MapElement<Value>, public Packable, public Configurable, public Memory<ScriptState>
	{
		...
		public:
			...
			static Value *Construct(Unpacker& data);
	...
	class ColorValue : public Value
	{
		...
		public:
			...
			bool SetValue(const ColorRGBA& v);
	};
	...
	class VectorValue : public Value
	{
		...
		public:
			...
			bool SetValue(const Vector3D& v);
	};
	
	
	class PointValue : public VectorValue
	{
		private:

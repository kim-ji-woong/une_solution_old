...
namespace C4
{
	...
	//# \base	Utilities/LinkTarget<FilePicker>	A pointer to a $FilePicker$ may be stored in a $@Utilities/Link@$ object.
	...
	class FilePicker : public Window, public LinkTarget<FilePicker>, public Completable<FilePicker>
	{
		...
		protected:
			...
			void SetResourceDescriptor(const ResourceDescriptor *descriptor)
			{
		...
		public:
			...
			static void WritePersistentConfig(File& file, void *cookie);
			...
			C4API void SetFocusWidget(Widget *widget);

...
typedef BOOL (PASCAL *LPDIENUMDEVICESCALLBACKA)(LPCDIDEVICEINSTANCEA, void *);
typedef BOOL (PASCAL *LPDIENUMDEVICEOBJECTSCALLBACKA)(LPCDIDEVICEOBJECTINSTANCEA, void *);
typedef BOOL (PASCAL *LPDICONFIGUREDEVICESCALLBACK)(IUnknown *, void *);
typedef BOOL (PASCAL *LPDIENUMEFFECTSCALLBACKA)(LPCDIEFFECTINFOA, void *);
...
typedef BOOL (PASCAL *LPDIENUMDEVICESBYSEMANTICSCBA)(LPCDIDEVICEINSTANCEA, LPDIRECTINPUTDEVICE8A, DWORD, DWORD, void *);
...
DECLARE_INTERFACE_(IDirectInput8A, IUnknown)
{
    ...
    STDMETHOD(CreateDevice)(REFGUID, LPDIRECTINPUTDEVICE8A *, LPUNKNOWN) = 0;
    STDMETHOD(EnumDevices)(DWORD, LPDIENUMDEVICESCALLBACKA, void *, DWORD) = 0;
    STDMETHOD(GetDeviceStatus)(REFGUID) = 0;
    STDMETHOD(RunControlPanel)(HWND, DWORD) = 0;
    STDMETHOD(Initialize)(HINSTANCE, DWORD) = 0;
    STDMETHOD(FindDevice)(REFGUID, LPCSTR, LPGUID) = 0;
    STDMETHOD(EnumDevicesBySemantics)(LPCSTR, LPDIACTIONFORMATA, LPDIENUMDEVICESBYSEMANTICSCBA, void *, DWORD) = 0;
    STDMETHOD(ConfigureDevices)(LPDICONFIGUREDEVICESCALLBACK, LPDICONFIGUREDEVICESPARAMSA, DWORD, void *) = 0;
};
...
DECLARE_INTERFACE_(IDirectInputDevice8A, IUnknown)
{
    ...
    STDMETHOD(EnumObjects)(LPDIENUMDEVICEOBJECTSCALLBACKA, void *, DWORD) = 0;
    ...
    STDMETHOD(GetObjectInfo)(LPDIDEVICEOBJECTINSTANCEA, DWORD, DWORD) = 0;
    STDMETHOD(GetDeviceInfo)(LPDIDEVICEINSTANCEA) = 0;
    STDMETHOD(RunControlPanel)(HWND, DWORD) = 0;
    STDMETHOD(Initialize)(HINSTANCE, DWORD, REFGUID) = 0;
    STDMETHOD(CreateEffect)(REFGUID, LPCDIEFFECT, LPDIRECTINPUTEFFECT *, LPUNKNOWN) = 0;
    STDMETHOD(EnumEffects)(LPDIENUMEFFECTSCALLBACKA, void *, DWORD) = 0;
    STDMETHOD(GetEffectInfo)(LPDIEFFECTINFOA, REFGUID) = 0;
    ...
    STDMETHOD(EnumEffectsInFile)(LPCSTR, LPDIENUMEFFECTSINFILECALLBACK, void *, DWORD) = 0;
    STDMETHOD(WriteEffectToFile)(LPCSTR, DWORD, LPDIFILEEFFECT, DWORD) = 0;
    STDMETHOD(BuildActionMap)(LPDIACTIONFORMATA, LPCSTR, DWORD) = 0;
    STDMETHOD(SetActionMap)(LPDIACTIONFORMATA, LPCSTR, DWORD) = 0;
    STDMETHOD(GetImageInfo)(LPDIDEVICEIMAGEINFOHEADERA) = 0;
};

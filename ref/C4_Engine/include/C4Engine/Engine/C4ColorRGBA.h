...
namespace C4
{
	//# \class	ColorRGB	Encapsulates an RGB color.
	//
	...
	//# components. An additional alpha component is provided by the $@ColorRGBA@$ class.
	//# When a $ColorRGB$ object is converted to a $@ColorRGBA@$ object, the alpha component
	//# is assumed to be 1.
	//# 
	...
	//# \class	ColorRGBA	Encapsulates an RGBA color.
	//
	...
	//# alpha components. When a $@ColorRGB@$ object is converted to a $ColorRGBA$ object,
	//# the alpha component is assumed to be 1.
	//# 
	//# The default constructor leaves the components of the color undefined. If the values

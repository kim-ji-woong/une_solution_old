...
namespace C4
{
	...
	template <class classType> class ParticleSystemReg : public ParticleSystemRegistration
	{
		public:
			...
			ParticleSystem *Construct(void) const
			{
	...
	//# The particle system flags can be a combination (through logical OR) of the following values.
	//
	//# \table	ParticleSystemFlags
	//
	...
	class C4_API ParticleSystem : public Effect, public Registrable<ParticleSystem, ParticleSystemRegistration>
	{
		private:
			...
			void Initialize(void);
				...
				static void EmitterLinkProc(Node *node, void *cookie);
		...
		protected:
			...
			int32 GetInvisibleTime(void) const
			{
				return (invisibleTime);
			}
			
			void SetRenderFlag(void)
			{
				renderFlag = true;
			}
			...
			void *AllocateArrayStorage(unsigned_int32 size);
		
		public:
			
			~ParticleSystem();
			
			using Constructable<ParticleSystem>::InstallConstructor;
			...
			static ParticleSystem *New(ParticleSystemType type);
			...
			void SetConnectedEmitter(Emitter *emitter);
	...
	class PointParticleSystem : public ParticleSystem
	{
		private:
			...
			static void RenderParticles(Job *job, void *cookie);
		...
		public:
			...
			C4API void Render(const Camera *camera, List<Renderable> *effectList);
	};
	...
	class C4_API InfinitePointParticleSystem : public ParticleSystem
	{
		private:
		...
		protected:
			...
			InfinitePointParticleSystem(const InfinitePointParticleSystem& infinitePointParticleSystem, ParticlePoolBase *pool);
		
		public:
			
			~InfinitePointParticleSystem();
	...
	//#			<mn>18</mn>
	//#			<mo>&times;</mo>
	//#			<mi class="code">totalParticleCount</mi>
	//#			<mo>&times;</mo>
	//#			<msup>
	//#				<mfenced separators="">
	...
	//#						<mfrac>
	//#							<mi class="code">maxRadius</mi>
	//#							<mi class="code">scale</mi>
	//#						</mfrac>
	//#					</mfenced>
	//#					<mspace width="thickmathspace" />
	//#				</mfenced>
	...
	class BlobParticleSystem : public ParticleSystem
	{
		private:
			...
			static void RenderBlob(Job *job, void *cookie);

...
namespace C4
{
	...
	//# before the the timeout interval expires, then the return value is $kSignalTimeout$. Otherwise, the return value
	//# is the index value that was passed to the $@Signal::Trigger@$ function to trigger the signal.
	//
	//# \also	$@Signal::Trigger@$
	...
	//# achieve multithreaded execution. When a new $Thread$ object is constructed, its entry function,
	...
	class C4_API Thread
	{
		...
		public:
			...
			Thread(ThreadProc *proc, void *cookie, unsigned_int32 stack = 0, Signal *signal = nullptr);
			~Thread();
	...
	//# The index is between 0 and <i>n</>&nbsp;&minus;&nbsp;1, inclusive, where <i>n</i> is the number of worker
	...
	class C4_API Job : public ListElement<Job>
	{
		friend class JobMgr;
		...
		public:
			...
			Job(ExecuteProc *execProc, void *cookie = nullptr);
			~Job();
	...
	class C4_API BatchJob : public Job, public ListElement<BatchJob>
	{
		public:
	...
	//#
	//# If the $batch$ parameter is specified, the the $job$ parameter must specify a batch job. The job is added to the
	...
	class C4_API JobMgr : public Manager<JobMgr>
	{
		public:
	...
	C4_API extern JobMgr *TheJobMgr;
}

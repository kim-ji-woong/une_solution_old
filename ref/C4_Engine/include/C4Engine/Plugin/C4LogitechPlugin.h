...
namespace C4
{
	...
	//#
	//# Each Logitech device maintains storage for its own 160&times;42 pixel image. The image shown on the
	...
	//
	//# \privbase	PluginMgr/Plugin					The $LogitechPlugin$ is a specific type of plugin.

...
Manipulator *EmitterManipulator::Construct(Emitter *emitter)
{
...
{
	return (TheWorldEditor->GetStringTable()->GetString(StringID('NAME', kEffectParticleSystem, GetTargetNode()->GetEmitterType())));
}
...
bool EmitterManipulator::RegionPick(const Region *region) const
{

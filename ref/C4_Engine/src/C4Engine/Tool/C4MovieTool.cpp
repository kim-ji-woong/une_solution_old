...
void MovieTool::HandleOpenMovieMenuItem(Widget *widget, const WidgetEventData *eventData)
{
	FilePicker *picker = moviePicker;
	if (picker)
	{
...
void MovieTool::HandleImportMovieMenuItem(Widget *widget, const WidgetEventData *eventData)
{

...
const float K::two_pi_over_15 = 	0.41887902047863909846168578443727F;
const float K::four_pi_over_15 = 	0.83775804095727819692337156887453F;
...
const float K::pi_over_240 =		0.01308996938995747182692768076366F;
const float K::one_over_pi =		1.0F / K::pi;
const float K::two_over_pi =		2.0F / K::pi;
const float K::one_over_two_pi =	1.0F / K::two_pi;
const float K::one_over_four_pi =	1.0F / K::four_pi;
...
const float K::degrees =			180.0F * K::one_over_pi;
const float K::radians =			K::pi / 180.0F;
const float K::seconds =			0.001F;
...
const ConstMatrix3D K::identity_3D = {{{1.0F, 0.0F, 0.0F}, {0.0F, 1.0F, 0.0F}, {0.0F, 0.0F, 1.0F}}};
const ConstTransform4D K::identity_4D = {{{1.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 1.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 1.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 1.0F}}};

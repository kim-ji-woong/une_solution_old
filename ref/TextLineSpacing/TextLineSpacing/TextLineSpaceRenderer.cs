...
{
    public class TextLineSpaceRenderer
    {
        ...
        public float DrawText(Graphics g, string lines, Font font, Brush brush, RectangleF textRect, float lineSpacing, StringFormat format = null)
        {
            ...
            float lineHeight = font.Height;//g.MeasureString("X", font).Height;
            // 전체 텍스트 영역에 몇개를 표시할 것인가? 
            float fHeight = (lineHeight + lineSpacing) * allLines.Count + lineSpacing;

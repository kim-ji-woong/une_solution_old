...
{
    public partial class FormRibbonButton : Form, UnE.GUI.IRibbonButtonOwner
    {
        public FormRibbonButton()
        {
            InitializeComponent();
            this.TopLevel = false;
        }
        
        private void FormRibbonButton_Load(object sender, EventArgs e)
        {

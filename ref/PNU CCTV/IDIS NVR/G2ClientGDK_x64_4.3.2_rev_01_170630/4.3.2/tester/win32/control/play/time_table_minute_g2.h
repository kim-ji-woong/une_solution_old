// time_table_minute_g2.h : header file
//

#ifndef _TIME_TABLE_MINUTE_G2_H_
#define _TIME_TABLE_MINUTE_G2_H_
...
class time_table_minute_g2 : public time_table_base
{
public:
    time_table_minute_g2(void);
    virtual ~time_table_minute_g2(void);
...
#endif // !_TIME_TABLE_MINUTE_G2_H_

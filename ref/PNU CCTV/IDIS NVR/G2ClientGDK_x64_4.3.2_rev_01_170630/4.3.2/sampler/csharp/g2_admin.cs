...
namespace GDK
{
    ...
    public class g2admin
    {
        ...
        [DllImport(G2PLATFORM.DLL_name, CallingConvention = CallingConvention.StdCall)]
        [return: MarshalAs(UnmanagedType.U1)]
        protected static extern bool g2_admin_get_device_group_info(G2HADMIN handle, ref G2GUID device, out G2DEVICE_GROUP group);
        [DllImport(G2PLATFORM.DLL_name, CallingConvention = CallingConvention.StdCall)]
        [return: MarshalAs(UnmanagedType.U1)]
        ...
        /// </summary>
        /// <param name="device">device group unique id</param>
        ...
        public bool get_device_group_info(ref G2GUID device, out G2DEVICE_GROUP group)
        {
            return g2_admin_get_device_group_info(_handle, ref device, out group);
        }

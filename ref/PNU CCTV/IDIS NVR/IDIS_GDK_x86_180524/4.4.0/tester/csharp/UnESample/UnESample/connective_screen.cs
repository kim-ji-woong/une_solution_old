...
namespace UnESample
{
    public partial class FormMain : GDK_tester.screen_listener
    {
        ...
        public void on_mouse_click(GDK_tester.camera_pane cp, MouseEventArgs e)
        {
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
                System.Diagnostics.Trace.WriteLine("LButton Click");
        }

        public void on_mouse_doubleclick(GDK_tester.camera_pane cp, MouseEventArgs e)
        {
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
                System.Diagnostics.Trace.WriteLine("LButton DoubleClick");
        }
    }
}

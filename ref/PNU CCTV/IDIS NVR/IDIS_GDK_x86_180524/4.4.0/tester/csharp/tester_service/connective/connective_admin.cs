...
namespace GDK_tester
{
    public partial class form_admin : g2admin_listener
    {
        ...
        public void on_g2admin_receive_device_modify_list(int handle, G2GUID[] bunch)
        {
            Debug.WriteLine("callback [on_g2admin_receive_device_modify_list] is not implemented.");
        }
        public void on_g2admin_receive_stream_device_in_charge(int handle, G2GUID serviceGUID, G2GUID[] appends, G2GUID[] removes)
        {
            Debug.WriteLine("callback [on_g2admin_receive_stream_device_in_charge] is not implemented.");
        }

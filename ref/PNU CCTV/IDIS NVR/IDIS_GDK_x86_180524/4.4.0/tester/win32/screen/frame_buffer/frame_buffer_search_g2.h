// frame_buffer_search_g2.h : header file
//

#ifndef _SCREEN_FRAME_BUFFER_SEARCH_G2_H_
#define _SCREEN_FRAME_BUFFER_SEARCH_G2_H_
...
class frame_buffer_search_g2 : public frame_buffer
{
public:
    frame_buffer_search_g2(frame_buffer::TYPE type, int limit = frame_buffer::SIZE_SEARCH_G2);
    virtual ~frame_buffer_search_g2(void);
...
#endif // !_SCREEN_FRAME_BUFFER_SEARCH_G2_H_

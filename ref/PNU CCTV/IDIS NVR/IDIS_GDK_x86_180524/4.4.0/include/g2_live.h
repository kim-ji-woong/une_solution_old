...
G2_DLLFUNC bool G2API g2_live_send_command_control_ptz_IDIS(G2HLIVE handle, int channel, const G2GUID* cameraGUID, int camera, const G2LIVE_COMMAND_CONTROL_PTZ_STATUS* status, bool req_result);
G2_DLLFUNC bool G2API g2_live_send_fish_eye_control(G2HLIVE handle, int channel, const G2GUID* cameraGUID, const G2FISHEYE_CONTROL* control);
...
G2_DLLFUNC bool G2API g2_live_get_status_ip_camera_info(G2HLIVE handle, int channel, int channelext, G2DEVICE_STATUS_IP_CAMERA_INFO* status);
...
G2_DLLFUNC bool G2API g2_live_is_enable_audio_device_record(void);
//////////////////////////////////////////////////////////////////////////

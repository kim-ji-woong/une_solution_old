...
struct G2STATUS_LOG
{
    enum G1_SYSTEM_LOG {
        ...
        SYSTEM_LOG_SHUTOFF,
        SYSTEM_LOG_LOCAL_SELF_DIAGNOSIS_SUCCESS,
        SYSTEM_LOG_LOCAL_SELF_DIAGNOSIS_FAIL,
        SYSTEM_LOG_REMOTE_SELF_DIAGNOSIS_SUCCESS,
        SYSTEM_LOG_REMOTE_SELF_DIAGNOSIS_FAIL,
        SYSTEM_LOG_LOCAL_FAILOVER_SUCCESS,
        SYSTEM_LOG_LOCAL_FAILOVER_FAIL,
        SYSTEM_LOG_REMOTE_FAILOVER_SUCCESS,
        SYSTEM_LOG_REMOTE_FAILOVER_FAIL,
        SYSTEM_LOG_BEEP_ON,
        SYSTEM_LOG_BEEP_OFF,
        SYSTEM_LOG_ONLINE_UPGRADE_FOUND,
        SYSTEM_LOG_ONLINE_UPGRADE_SUCCESS,
        SYSTEM_LOG_ONLINE_UPGRADE_FAIL,
        SYSTEM_LOG_REDUNDANT_POWER_FAILURE,
        SYSTEM_LOG_RAID_BROKEN,
        SYSTEM_LOG_RAID_DEGRADE,
        SYSTEM_LOG_HEATER_OFF,

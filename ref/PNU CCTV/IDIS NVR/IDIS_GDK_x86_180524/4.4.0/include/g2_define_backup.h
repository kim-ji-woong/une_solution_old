...
#ifndef _G2_DEFINE_BACKUP_H_
#define _G2_DEFINE_BACKUP_H_
...
struct G2BACKUP_CHANNEL_INFO {
    G2GUID  _guid;
    int     _channelext;
};

struct G2BACKUP_SITE_RESULT {
    enum RESULT {
        UNKNOWN_RESULT = 0,
        SITE_OK,
        FAIL_INIT_TANGO,

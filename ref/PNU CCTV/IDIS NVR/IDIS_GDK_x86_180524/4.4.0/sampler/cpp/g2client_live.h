...
public:
	...
	bool get_status_command_control_color(int channel, const G2GUID& camera, G2LIVE_COMMAND_CONTROL_COLOR* control, G2LIVE_COMMAND_CONTROL_COLOR_RANGE* range) const;

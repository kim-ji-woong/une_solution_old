...
namespace GDK
{
    ...
    public struct G2ADMIN_CALLBACK
    {
        public enum TYPE
        {
            ...
            on_receive_stream_device_in_charge = 43,
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct G2SERVICE_VERSION
    {
        public G2STRING_32 _version;
        public G2STRING_32 _number;
    }

    [StructLayout(LayoutKind.Sequential)]
    public struct G2SERVICE_CHARGE_INFO
    {
        public G2PARAM_GUID_LIST _appends;
        public G2PARAM_GUID_LIST _removes;
        public bool      _isLoadBalance;
        public bool      _requestDirectConnect;
    };

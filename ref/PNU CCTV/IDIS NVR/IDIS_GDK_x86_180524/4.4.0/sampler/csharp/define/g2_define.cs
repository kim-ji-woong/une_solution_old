...
namespace GDK
{
    ...
    public struct G2DEVICE_STATUS_IP_CAMERA_INFO
    {
        ...
        public enum REGION_COMPOSITION
        {
        ...
        [StructLayout(LayoutKind.Sequential)]
        public struct DEWARPING_DETAIL
        {
            public ushort _region_composition;
            public int _original_region;
            public uint _eptz_function;
            public sbyte _mount_type;
        };

        public sbyte _dewarping_status;
        public DEWARPING_DETAIL _dewarping_detail;

        public DEWARPING_STATUS_TYPE dewarping_status { get { return (DEWARPING_STATUS_TYPE)_dewarping_status; } }
        public REGION_COMPOSITION region_composition { get { return (REGION_COMPOSITION)_dewarping_detail._region_composition; } }
        public G2DEVICE_STATUS.PTZ_FUNCTION eptz_function { get { return (G2DEVICE_STATUS.PTZ_FUNCTION)_dewarping_detail._eptz_function; } }
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct G2FISHEYE_CONTROL
    {
        public enum FISHEYE_COMMAND
        {
            UNKNOWN            = -1,
            MOVE_PAN_TILT      = 0,
            CHANGE_DEWARP_TYPE = 1,
            SAVE               = 10,
            RESET              = 100,
        }
        public enum DEWARP_TYPE
        {
            UNKNOWN   = -1,
            NORMAL    = 0,
            PANORAMA  = 2,
        ...
        public int _camera;
        public int _command;
        public short _sub_region;
        public int _dewarp_type;
        public int _pan_value;
        public int _tilt_value;
    }
    ...
    public struct G2PICTURE
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = (int)CONST.NUM_DATA_POINTERS)]
        public IntPtr[] data;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = (int)CONST.NUM_DATA_POINTERS)]
        public int[] linesize;
    }

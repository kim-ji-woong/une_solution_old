...
namespace GDK
{
    ...
    public class g2live
    {
        ...
        [DllImport(G2PLATFORM.DLL_name, CallingConvention = CallingConvention.StdCall)]
        [return: MarshalAs(UnmanagedType.U1)]
        protected static extern bool g2_live_send_command_control_ptz(G2HLIVE handle, int channel, ref G2GUID cameraGUID, int camera, ref G2LIVE_COMMAND_CONTROL_PTZ control, [MarshalAs(UnmanagedType.U1)]bool req_result);
        [DllImport(G2PLATFORM.DLL_name, CallingConvention = CallingConvention.StdCall)]
        [return: MarshalAs(UnmanagedType.U1)]
        protected static extern bool g2_live_send_command_control_ptz_IDIS(G2HLIVE handle, int channel, ref G2GUID cameraGUID, int camera, ref G2LIVE_COMMAND_CONTROL_PTZ_STATUS status, [MarshalAs(UnmanagedType.U1)]bool req_result);
        [DllImport(G2PLATFORM.DLL_name, CallingConvention = CallingConvention.StdCall)]
        [return: MarshalAs(UnmanagedType.U1)]
        protected static extern bool g2_live_send_fish_eye_control(G2HLIVE handle, int channel, ref G2GUID cameraGUID, ref G2FISHEYE_CONTROL control);
        [DllImport(G2PLATFORM.DLL_name, CallingConvention = CallingConvention.StdCall)]
        [return: MarshalAs(UnmanagedType.U1)]
        ...
        [DllImport(G2PLATFORM.DLL_name, CallingConvention = CallingConvention.StdCall)]
        [return: MarshalAs(UnmanagedType.U1)]
        protected static extern bool g2_live_get_status_ip_camera_info(G2HLIVE handle, int channel, int channelext, out G2DEVICE_STATUS_IP_CAMERA_INFO control);
        [DllImport(G2PLATFORM.DLL_name, CallingConvention = CallingConvention.StdCall)]
        [return: MarshalAs(UnmanagedType.U1)]
        ...
        [DllImport(G2PLATFORM.DLL_name, CallingConvention = CallingConvention.StdCall)]
        [return: MarshalAs(UnmanagedType.U1)]
        protected static extern bool g2_live_is_enable_audio_device_record();
        #endregion
        ...
        /// <summary>
        /// @ send_command_control_ptz
        /// </summary>
        /// <para>This method send ptz control command.</para>
        /// <param name="channel">streaming service channel</param>
        /// <param name="cameraGUID">camera unique id</param>
        /// <param name="camera">camera number</param>
        /// <param name="control">G2LIVE_COMMAND_CONTROL_PTZ structure</param>
        /// <param name="req_result">whether obtain result or not</param>
        /// <returns>If a send command succeds, it returns TRUE; otherwise, it returns FALSE.</returns>
        public bool send_command_control_ptz(int channel, ref G2GUID cameraGUID, int camera, ref G2LIVE_COMMAND_CONTROL_PTZ control, bool req_result)
        {
            return g2_live_send_command_control_ptz(_handle, channel, ref cameraGUID, camera, ref control, req_result);
        }
        /// <summary>
        /// @ send_command_control_ptz_IDIS
        /// </summary>
        /// <para>This method send ptz control command.</para>
        /// <param name="channel">streaming service channel</param>
        /// <param name="cameraGUID">camera unique id</param>
        ...
        /// <param name="req_result">whether obtain result or not</param>
        /// <returns>If a send command succeds, it returns TRUE; otherwise, it returns FALSE.</returns>
        public bool send_command_control_ptz_IDIS(int channel, ref G2GUID cameraGUID, int camera, ref G2LIVE_COMMAND_CONTROL_PTZ_STATUS status, bool req_result)
        {
            return g2_live_send_command_control_ptz_IDIS(_handle, channel, ref cameraGUID, camera, ref status, req_result);
        }
        /// <summary>
        /// @ g2_live_send_fish_eye_control
        /// </summary>
        /// <para>This method send fisheye control command.</para>
        /// <param name="channel">streaming service channel</param>
        /// <param name="cameraGUID">camera unique id</param>
        /// <param name="control">G2FISHEYE_CONTROL structure</param>
        /// <returns>If a send command succeds, it returns TRUE; otherwise, it returns FALSE.</returns>
        public bool send_fish_eye_control(int channel, ref G2GUID cameraGUID, ref G2FISHEYE_CONTROL control)
        {
            return g2_live_send_fish_eye_control(_handle, channel, ref cameraGUID, ref control);
        }
        /// <summary>
        /// @ get_camera_list
        ...
        /// <summary>
        /// @ get_status_ip_camera_info
        /// <para>This method obtains ip camera information.</para>
        /// </summary>
        /// <param name="channel">streaming serivce channel</param>
        /// <param name="channelext">channelext</param>
        /// <param name="control">structure to save ipcamera infomation</param>
        /// <returns></returns>
        public bool get_status_ip_camera_info(int channel, int channelext, out G2DEVICE_STATUS_IP_CAMERA_INFO status)
        {
            return g2_live_get_status_ip_camera_info(_handle, channel, channelext, out status);
        }
        ...
        {
            return g2_live_is_enable_audio_device_record();
        }

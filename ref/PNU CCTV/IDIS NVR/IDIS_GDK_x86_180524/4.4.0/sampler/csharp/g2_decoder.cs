...
namespace GDK
{
    ...
    public class g2decoder
    {
        ...
        [DllImport(G2PLATFORM.DLL_name, CallingConvention = CallingConvention.StdCall)]
        [return: MarshalAs(UnmanagedType.U1)]
        protected static extern bool g2_decoder_video_decompress_v3(G2HDECODER handle, ref G2DECODER_VIDEO_PARAM_V3 param, out G2DECODER_VIDEO_RESULT_V3 res);
        [DllImport(G2PLATFORM.DLL_name, CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(G2PLATFORM.DLL_name, CallingConvention = CallingConvention.StdCall)]
        protected static extern int g2_decoder_picture_buf_len(int width, int height, int pix_format);
        [DllImport(G2PLATFORM.DLL_name, CallingConvention = CallingConvention.StdCall)]
        protected static extern void g2_decoder_picture_fill(ref G2PICTURE pic, int pix_format, int width, int height, IntPtr buf, int len);
        [DllImport(G2PLATFORM.DLL_name, CallingConvention = CallingConvention.StdCall)]
        [return: MarshalAs(UnmanagedType.U1)]
        protected static extern bool g2_decoder_picture_scale(ref G2PICTURE dst, int dst_pix_format, int dst_cx, int dst_cy, IntPtr buf, int len, int filter, ref G2PICTURE src, int src_pix_format, int src_cx, int src_cy, int color_space, int color_range);
        [DllImport(G2PLATFORM.DLL_name, CallingConvention = CallingConvention.StdCall)]
        ...
        public bool decompress(ref G2DECODER_VIDEO_PARAM_V3 param, out G2DECODER_VIDEO_RESULT_V3 res)
        {
            return g2_decoder_video_decompress_v3(_handle, ref param, out res);
        }
        ...
        public static int picture_buf_len(int width, int height, int pix_format)
        {
            return g2_decoder_picture_buf_len(width, height, pix_format);
        }
        public static void picture_fill(ref G2PICTURE pic, int pix_format, int width, int height, IntPtr buf, int len)
        {
            g2_decoder_picture_fill(ref pic, pix_format, width, height, buf, len);
        }
        public static bool picture_scale(ref G2PICTURE dst, int dst_pix_format, int dst_cx, int dst_cy, IntPtr buf, int len, int filter, ref G2PICTURE src, int src_pix_format, int src_cx, int src_cy, int color_space, int color_range)
        {
            return g2_decoder_picture_scale(ref dst, dst_pix_format, dst_cx, dst_cy, buf, len, filter, ref src, src_pix_format, src_cx, src_cy, color_space, color_range);
        }

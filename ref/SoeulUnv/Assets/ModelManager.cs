...
{    
    ...
    private float m_fTextLODDistance = 15.0f;
    ...
    public Color m_BDNameColor = Color.yellow;
    ...
    private void CreateWebDB()
    {
        ...
        mWebDBManager.DatabaseType = DBUtility.WebDBManager.DBType.mysql;
        mWebDBManager.DatabaseName = "EDU_100";
        mWebDBManager.DatabasePort = "3306";        

    ...
    public class ScriptProxy
    {
        ...
        private void CreateEngine()
        {
            if (m_Engine == null)
            {
                ...
                string strToolPath = szFullPath + "\\Tools\\Scripts";

                string cPython = @"C:\Python27\Lib";
        ...
        private void CompileSourceAndExecute(String code)
        {
            try
            {
                ScriptSource source = m_Engine.CreateScriptSourceFromString(code, SourceCodeKind.AutoDetect);

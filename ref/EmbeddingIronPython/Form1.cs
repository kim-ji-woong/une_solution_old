...
{
    public partial class Form1 : Form, ITextCommanderOwner
    {
        ...
        public void AddPythonFunction()
        {
            ...
            proxy.UserObject.Activate = new Action(Activate);
            proxy.UserObject.MainForm = this;
            proxy.UserObject.Script = ScriptProxy.Instance;
            proxy.UserObject.ShowMessage = new Func<string, int>(ShowMessage);
        }
        ...
        {
            ScriptProxy.Instance.RunPythonScript(code);
        }
        ...
        public int ShowMessage(string szMessage)
        {
        ...
        private void btnTest2_Click(object sender, EventArgs e)
        {
            ...
            List lst = ScriptProxy.Instance.GetVariable("pyList") as List;
            ...
            ScriptProxy.Instance.AddVariable("pyList", lstTemp);
            CompileSourceAndExecute("for item in pyList: log.AddInfo('List Item: %s'%item)");
            ...
            String str = ScriptProxy.Instance.GetVariable("pyString") as String;
            str += "_Mod_By_C#";
            ...
            ScriptProxy.Instance.AddVariable("pyString", str);
            CompileSourceAndExecute("log.AddInfo(pyString)");
            ...
            CompileSourceAndExecute("log.AddInfo('Counter = %s'%pyCounter)");
            Int32 counter = (Int32)ScriptProxy.Instance.GetVariable("pyCounter");
            _logger.AddInfo(String.Format("Counter++ (from C# side) = {0}", counter++));
            ScriptProxy.Instance.AddVariable("pyCounter", counter);
            CompileSourceAndExecute("log.AddInfo('Counter = %s'%pyCounter)");
        ...
        private void btnTest3_Click(object sender, EventArgs e)
        {
            ...
            Int32 result = (Int32)ScriptProxy.Instance.InvokeClassFunc("Operation", "Operate", new object[] { 7 });
        ...
        private void btnTest7_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ScriptScope proxy = ScriptProxy.Instance.UserObject;

                PyDelegate pyDel = proxy.GetVariable<PyDelegate>("pyDelegate");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            var script = @"ShowMessage('called ShowMessage')";
            int proxyFuncResult = 0;

            ScriptProxy.Instance.AddVariable(@"proxyFuncResult", proxyFuncResult);
            ScriptProxy.Instance.CallAction(script);

            // access the scope through a dynamic variable
           

            // get the proxyFuncResult variable
            proxyFuncResult =  (int)ScriptProxy.Instance.GetVariable("proxyFuncResult");

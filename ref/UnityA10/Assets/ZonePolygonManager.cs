...
public class ZonePolygonManager : MonoBehaviour 
{
    ...
    void ShowEquipZoneVolume(string szName)
    {
        if(szName == "AAAA")
        {
            Transform trnas = ModelManager.Instance.Model.transform.Find("Inner");

            trnas.gameObject.SetActive(true);

            Transform t3 = trnas.Find("A10-015in2014-02");
            if (t3 != null)
                t3.gameObject.SetActive(true);

            Transform t4 = trnas.Find("A10-001in2014-03");
            if (t4 != null)
                t4.gameObject.SetActive(false);

            Transform t1 = trnas.Find("Cube1");
            if (t1 != null)
                t1.gameObject.SetActive(false);

            Transform t2 = trnas.Find("Cube2");
            if (t2 != null)
                t2.gameObject.SetActive(true);

            Transform trnas2 = ModelManager.Instance.Model.transform.Find("Outter");

            trnas2.gameObject.SetActive(false);
            Debug.logger.Log(szName);
        }
    ...
    void HideEquipZonevolume(string szName)
    {
        ...
        if(szName == "AAAA")
        {
            ...
            trnas.gameObject.SetActive(false);
            ...
            Transform trnas2 = ModelManager.Instance.Model.transform.Find("Outter");
            trnas2.gameObject.SetActive(true);

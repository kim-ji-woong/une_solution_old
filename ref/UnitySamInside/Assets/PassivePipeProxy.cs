...
public class PassivePipeProxy : MonoBehaviour
{
    ...
    private string m_szPipeName = "UnityPipeInside";
    ...
    public void SendServer(string szMsg)
    {
        ...
        {            
            ...
            {
                //UnityEngine.Debug.Log("SendServer : " + szMsg);
    ...
    private void  Update()
    {
        ...
        lock(m_localLock)
        {
            arList = (ArrayList)m_arListMessage.Clone();
            m_arListMessage = new ArrayList();
        } 

        foreach (string szCmd in arList)
        {
            UnityEngine.Debug.Log("Call Function : " + szCmd);
    ...
    private void OnMessage(string szMessage)
    {
        if (szMessage != null && szMessage != "")
        {
            if (szMessage.StartsWith("CMD:"))
            {
                ...
                lock (m_localLock)
                {
                    //if(!m_arListMessage.Contains(szCMD))

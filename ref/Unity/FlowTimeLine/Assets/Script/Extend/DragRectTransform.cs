...
public class DragRectTransform : MonoBehaviour, IPointerDownHandler, IDragHandler
{
    ...
    void Awake()
    {
        ...
        //GameObject gobj = GameObject.Find("ContentFlowData");
        //if (gobj != null)
        //    canvasRectTransform = gobj.transform as RectTransform;
        //else

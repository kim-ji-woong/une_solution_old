<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mainWebGL.aspx.cs" Inherits="MonitoringForestFire.mainWebGL" %>
        ...
        <div style="margin: 0 auto;text-align:center;">
            ...
            <div style="margin-left:auto;margin-right:auto;width:1330px;height:810px;" >
                <div class="divIframe" style="float:left;height:810px;width:710px;">
                    <iframe id="LeftFrame" src="MonitoringDrone/WebGL/MonitoringDrone.aspx" border="0" scrolling="no"></iframe>
                </div>
                <div class="divIframe" style="float:left;height:810px;width:610px;">
                    <iframe id="RightFrame" src="FlowTimeLine/WebGL/FlowTimeLine.aspx" border="0" scrolling="no"></iframe>
                </div>
            </div>

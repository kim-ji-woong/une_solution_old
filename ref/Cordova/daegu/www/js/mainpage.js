...
dbtempname = "js/daegufiredb.js";

if(whichManaul == 1) {
    dbtempname = "js/daegufiredb.js";              // 매뉴얼 json데이터 파일로 첫 실행시 DB write
} 												   // 매뉴얼을 추가할 시 else로 계속 추가. 
else if(whichManaul == 2) {
    dbtempname = "js/train.js";
} 
else if(whichManaul == 3) {
    dbtempname = "js/animalDisease.js";
}
else if(whichManaul == 4) {
    dbtempname = "js/infectiousDisease.js";
}
else if(whichManaul == 5) {
    dbtempname = "js/buildingCollapse.js";
}
else if(whichManaul == 6) {
    dbtempname = "js/dam.js";0   
}
else if(whichManaul == 7) {
    dbtempname = "js/tunnel.js";
}
else if(whichManaul == 8) {
    dbtempname = "js/mme.js";
}
else if(whichManaul == 9) {
    dbtempname = "js/psm.js";
}
else if(whichManaul == 10) {
    dbtempname = "js/airplane.js";
}
...
function orgtabopen () {
    ...
    var optionsSize = $('#orgselect option').size(); 
    
    
    if(optionsSize == 1) {
        
        var selectedDepartFirst = $("#orgselect option:first").val();
    
        db.manualcollection.orderBy('action_code').filter(function (oneitem) {

            if($.inArray(selectedDepartFirst, oneitem.org_list)>=0) return true;        
            return false; 

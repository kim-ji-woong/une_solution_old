...
Public Class compactline
    ...
    Public Sub createChart(viewer As WinChartViewer, img As String) _
        ...
        Dim labels() As String = {"-", "10am", "-", " ", "-", "12am", "-", " ", _
            "-", "2pm", "-", " ", "-", "4pm", "-"}
        ...
        c.addTitle2(Chart.Top, "STAR TECH INDEX  2003-01-28", "Arial", 7.5, _
            &Hffffff, &H31319c)
        c.addTitle2(Chart.Bottom, "LATEST  STI:1809.41 (+14.51)", "Arial", 7.5, _
            &Hffffff, &H31319c)
        ...
        c.addText(176, 21, "Chart Demo", "Times New Roman Bold Italic", 11, _
            &Hc09090).setAlignment(Chart.TopRight)

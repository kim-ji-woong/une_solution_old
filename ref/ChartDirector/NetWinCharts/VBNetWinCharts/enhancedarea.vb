...
Public Class enhancedarea
    ...
    Public Sub createChart(viewer As WinChartViewer, img As String) _
        ...
        Dim data() As Double = {30, 28, 40, 55, 75, 68, 54, 60, 50, 62, 75, 65, 75, _
            89, 60, 55, 53, 35, 50, 66, 56, 48, 52, 65, 62}
        ...
        ' Tentatively set the plotarea to 50 pixels from the left depressed edge, and
        ' 25 pixels under the top depressed edge. Set the width to 75 pixels less
        ' than the depressed region width, and the height to 75 pixels less than the
        ' depressed region height. Use white (ffffff) background, transparent border,
        ' and grey (cccccc) horizontal and vertical grid lines.
        ...
        c.addAreaLayer(data, c.linearGradientColor(0, contentBox.getTopY() + 20, 0, _
            contentBox.getTopY() + contentBox.getHeight() - 50, &H60ff0000, _
            &H60ffffff))

...
Public Class finance
    ...
    Public Sub createChart(viewer As WinChartViewer, img As String) _
        ...
        ' The open value starts from 100, and the daily change is random from -5 to
        ' 5.
        ...
        c.setData(timeStamps, highData, lowData, openData, closeData, volData, _
            extraDays)
        ...
        ' Add 20 days bollinger band to the main chart, using light blue (9999ff) as
        ...
        ' The main RSI line is purple (800080). Set threshold region to +/- 20 (that
        ' is, RSI = 50 +/- 25). The upper/lower threshold regions will be filled with
        ' red (ff0000)/blue (0000ff).
        c.addRSI(75, 14, &H800080, 20, &Hff0000, &H0000ff)

        ' Append a 12-days momentum indicator chart (75 pixels high) using blue
        ' (0000ff) color.

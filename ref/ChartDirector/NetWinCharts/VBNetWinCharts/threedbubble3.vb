...
Public Class threedbubble3
    ...
    Public Sub createChart(viewer As WinChartViewer, img As String) _
        ...
        ' Add a legend box at (70, 30) (top of the chart) with horizontal layout. Use
        ' 12 pts Times Bold Italic font. Set the background and border color to
        ' Transparent.
        c.addLegend(70, 30, False, "Times New Roman Bold Italic", 12 _
        ...
        ' Add (dataX0, dataY0) as a scatter layer with red (ff3333) spheres, where
        ' the sphere size is modulated by dataZ0. This creates a bubble effect.
        c.addScatterLayer(dataX0, dataY0, "Technology AAA", Chart.SolidSphereShape, _
            15, &Hff3333).setSymbolScale(dataZ0)

        ' Add (dataX1, dataY1) as a scatter layer with blue (0000ff) spheres, where
        ' the sphere size is modulated by dataZ1. This creates a bubble effect.
        c.addScatterLayer(dataX1, dataY1, "Technology BBB", Chart.SolidSphereShape, _
            15, &H0000ff).setSymbolScale(dataZ1)
        ...
        viewer.ImageMap = c.getHTMLImageMap("clickable", "", _
            "title='[{dataSetName}] Range = {x} miles, Capacity = {value} tons, " & _
            "Length = {z} meters'")

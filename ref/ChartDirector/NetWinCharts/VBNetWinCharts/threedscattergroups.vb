...
Public Class threedscattergroups
    ...
    Public Sub createChart(viewer As WinChartViewer, img As String) _
        ...
        c.addTitle("3D Scatter Groups                    ", _
        ...
        c.addScatterGroup(xData0, yData0, zData0, "Alpha", Chart.GlassSphere2Shape, _
            9, &Hff0000)
        c.addScatterGroup(xData1, yData1, zData1, "Beta", Chart.GlassSphere2Shape, _
            9, &H00ff00)
        c.addScatterGroup(xData2, yData2, zData2, "Gamma", Chart.GlassSphere2Shape, _
            9, &H0000ff)

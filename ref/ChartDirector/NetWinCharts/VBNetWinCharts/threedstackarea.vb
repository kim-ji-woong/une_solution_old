...
Public Class threedstackarea
    ...
    Public Sub createChart(viewer As WinChartViewer, img As String) _
        ...
        Dim data1() As Double = {50, 45, 47, 34, 42, 49, 63, 62, 73, 59, 56, 50, _
            64, 60, 67, 67, 58, 59, 73, 77, 84, 82, 80, 84, 89}
        Dim data2() As Double = {61, 79, 85, 66, 53, 39, 24, 21, 37, 56, 37, 22, _
            21, 33, 13, 17, 4, 23, 16, 25, 9, 10, 5, 7, 16}

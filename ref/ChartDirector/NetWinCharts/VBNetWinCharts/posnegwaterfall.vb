...
Public Class posnegwaterfall
    ...
    Public Sub createChart(viewer As WinChartViewer, img As String) _
        ...
        ' use the ChartDirector ArrayMath utility to accumulate the data. The "total"
        ' is handled by inserting a zero point at the end before accumulation (after
        ' accumulation it will become the total).
        Dim boxTop() As Double = New ArrayMath(data).insert2(0, 1, UBound(data) + 1 _
            ).acc().result()
        ...
        c.addTitle("Corporate Cash Flow - Year 2004", "Arial Bold Italic", 13, _

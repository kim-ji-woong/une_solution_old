...
Public Class customsymbolline
    ...
    Public Sub createChart(viewer As WinChartViewer, img As String) _
        ...
        Dim labels() As String = {"1995", "1996", "1997", "1998", "1999", "2000", _
            "2001", "2002"}
        ...
        ' Add a legend box at (60, 20) (top of the chart) with horizontal layout. Use
        ...
        c.addTitle("Information Resource Usage", "Arial Bold", 12, &Hffffff _
            ).setBackground(c.patternColor(New Integer() {&H000040, &H000080}, 2))
        ...
        layer.addDataSet(data1, &H40cf40, "Computers").setDataSymbol2( _
            "small_computer.png")

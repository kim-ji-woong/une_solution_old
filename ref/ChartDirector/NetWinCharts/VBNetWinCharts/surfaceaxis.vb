...
Public Class surfaceaxis
    ...
    Public Sub createChart(viewer As WinChartViewer, img As String) _
        ...
        Dim dataX() As Date = {DateSerial(2008, 9, 1), DateSerial(2008, 9, 2), _
            DateSerial(2008, 9, 3), DateSerial(2008, 9, 4), DateSerial(2008, 9, 5), _
            DateSerial(2008, 9, 6)}
        ...
        ' data series, they are just the concatenation of the individual data series.
        c.setData(Chart.CTime(dataX), Nothing, New ArrayMath(lowData).insert( _
        ...
        Dim cAxis As ColorAxis = c.setColorAxis(95, 100, Chart.TopRight, 160, _
            Chart.Left)

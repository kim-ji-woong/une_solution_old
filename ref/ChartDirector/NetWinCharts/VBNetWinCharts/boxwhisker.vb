...
Public Class boxwhisker
    ...
    Public Sub createChart(viewer As WinChartViewer, img As String) _
        ...
        Dim labels() As String = {"Group A", "Group B", "Group C", "Group D", _
        ...
        c.addBoxWhiskerLayer(Q3Data, Q1Data, Q4Data, Q0Data, Q2Data, &H9999ff, _
            &H0000cc).setLineWidth(2)

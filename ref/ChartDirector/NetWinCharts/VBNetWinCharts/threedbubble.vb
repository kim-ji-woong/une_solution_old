...
Public Class threedbubble
    Implements DemoModule

    'Name of demo module
    Public Function getName() As String Implements DemoModule.getName
        Return "3D Bubble Chart (1)"
    End Function
    ...
    Public Sub createChart(viewer As WinChartViewer, img As String) _
        ...
        c.addScatterLayer(dataX0, dataY0, "Technology AAA", Chart.GlassSphereShape, _
        ...
        c.addScatterLayer(dataX1, dataY1, "Technology BBB", Chart.GlassSphereShape, _

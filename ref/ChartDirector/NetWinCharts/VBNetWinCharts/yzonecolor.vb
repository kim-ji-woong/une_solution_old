...
Public Class yzonecolor
    ...
    Public Sub createChart(viewer As WinChartViewer, img As String) _
        ...
        ' Add a title box to the chart using 13 pts Arial Bold Italic font. The title
        ...
        c.addTitle( _
            ...
            "Color Demo <*img=star.png*><*img=star.png*><*/*>", _
            "Arial Bold Italic", 13, &Hffffff).setBackground(&H000000, -1, 1)
        ...
        ' color is semi-transparent green below 60, and semi-transparent red above
        ' 60.

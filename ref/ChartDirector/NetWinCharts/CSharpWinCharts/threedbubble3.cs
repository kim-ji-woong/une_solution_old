...
namespace CSharpChartExplorer
{
    public class threedbubble3 : DemoModule
    {
        ...
        public void createChart(WinChartViewer viewer, string img)
        {
            ...
            // Add (dataX0, dataY0) as a scatter layer with red (ff3333) spheres,
            // where the sphere size is modulated by dataZ0. This creates a bubble
            // effect.
            c.addScatterLayer(dataX0, dataY0, "Technology AAA",
                Chart.SolidSphereShape, 15, 0xff3333).setSymbolScale(dataZ0);

            // Add (dataX1, dataY1) as a scatter layer with blue (0000ff) spheres,
            // where the sphere size is modulated by dataZ1. This creates a bubble
            // effect.
            c.addScatterLayer(dataX1, dataY1, "Technology BBB",
                Chart.SolidSphereShape, 15, 0x0000ff).setSymbolScale(dataZ1);

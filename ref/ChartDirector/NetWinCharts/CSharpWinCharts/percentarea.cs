...
namespace CSharpChartExplorer
{
    public class percentarea : DemoModule
    {
        ...
        public void createChart(WinChartViewer viewer, string img)
        {
            ...
            double[] data2 = {87, 89, 85, 66, 53, 39, 24, 21, 37, 56, 37, 23, 21, 33,
                13, 17, 14, 23, 16, 25, 29, 30, 45, 47, 46};

            // The timestamps on the x-axis
            DateTime[] labels = {new DateTime(1996, 1, 1), new DateTime(1996, 4, 1),
                new DateTime(1996, 7, 1), new DateTime(1996, 10, 1), new DateTime(
                1997, 1, 1), new DateTime(1997, 4, 1), new DateTime(1997, 7, 1),
                new DateTime(1997, 10, 1), new DateTime(1998, 1, 1), new DateTime(
                1998, 4, 1), new DateTime(1998, 7, 1), new DateTime(1998, 10, 1),
                new DateTime(1999, 1, 1), new DateTime(1999, 4, 1), new DateTime(
                1999, 7, 1), new DateTime(1999, 10, 1), new DateTime(2000, 1, 1),
                new DateTime(2000, 4, 1), new DateTime(2000, 7, 1), new DateTime(
                2000, 10, 1), new DateTime(2001, 1, 1), new DateTime(2001, 4, 1),
                new DateTime(2001, 7, 1), new DateTime(2001, 10, 1), new DateTime(
                2002, 1, 1)};
            ...
            // white font color, and 0x804020 as the background color
            ...
            // Set multi-style axis label formatting. Start of year labels are
            // displayed as yyyy. For other labels, just show minor tick.
            ...
            // Add the three data sets to the area layer, using icons images with
            ...
            viewer.ImageMap = c.getHTMLImageMap("clickable", "",
                "title='{dataSetName} sales at {xLabel|yyyy} " +

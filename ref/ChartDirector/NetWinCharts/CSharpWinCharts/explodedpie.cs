...
namespace CSharpChartExplorer
{
    public class explodedpie : DemoModule
    {
        ...
        public void createChart(WinChartViewer viewer, string img)
        {
            ...
            // Use a vertical gradient color from deep blue (000066) to blue (0000cc)
            // as background. Use rounded corners of 20 pixels radius. Enable soft
            // drop shadow.
            ...
            c.addTitle("Exploded Pie Chart Demonstration",
                "Times New Roman Bold Italic", 18).setMargin2(0, 0, 16, 0);
            ...
            c.setSectorStyle(Chart.LocalGradientShading, unchecked((int)0xbbffffff),
                5);
            ...
            // background color the same as the sector color. Use soft lighting
            // effect with light direction from right. Use 8 pixels rounded corners.
            ChartDirector.TextBox t = c.setLabelStyle("Arial Bold", 10, 0x000000);
            t.setBackground(Chart.SameAsMainColor, Chart.Transparent,
                Chart.softLighting(Chart.Right, 0));
            t.setRoundedCorners(8);

            // Set the sector label format. The label is centered in a 110 pixels
            // wide bounding box. It consists of two lines. The first line is the
            // sector name. The second line shows the data value and percentage.
            c.setLabelFormat(

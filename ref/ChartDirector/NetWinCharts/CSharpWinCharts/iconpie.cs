...
namespace CSharpChartExplorer
{
    public class iconpie : DemoModule
    {
        ...
        public void createChart(WinChartViewer viewer, string img)
        {
            ...
            // Create a PieChart object of size 400 x 310 pixels, with a blue
            // (CCCCFF) vertical metal gradient background, black border, 1 pixel 3D
            // border effect and rounded corners
            PieChart c = new PieChart(400, 310, Chart.metalColor(0xccccff, 0),
                0x000000, 1);
            c.setRoundedFrame();
            ...
            // Add a title box using 15 pts Times Bold Italic font, on a blue
            // (CCCCFF) background with glass effect

...
namespace CSharpChartExplorer
{
    public class threeddonut : DemoModule
    {
        ...
        public void createChart(WinChartViewer viewer, string img)
        {
            ...
            // gradient color from deep blue (000066) to blue (0000cc) as background.
            // Use rounded corners of 20 pixels radius.
            ...
            // Set sector border color to same as fill color. Set label join line
            ...
            // Set the sector label format. The label consists of two lines. The
            // first line is the sector name in Times Bold Italic font and is
            // underlined. The second line shows the data value and percentage.
            c.setLabelFormat(
                "<*block,halign=left*><*font=Times New Roman Bold " +
                "Italic,size=12,underline=1*>{label}<*/font*><*br*>US$ {value}K " +
                "({percent}%)");

            // Set the label box background color the same as the sector color. Use
            // soft lighting effect with light direction from right. Use rounded
            // corners.

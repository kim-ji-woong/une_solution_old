...
namespace CSharpChartExplorer
{
    public class finance : DemoModule
    {
        ...
        public void createChart(WinChartViewer viewer, string img)
        {
            ...
            // Add a 5 period simple moving average to the main chart, using brown
            // color
            ...
            // Add 20 days bollinger band to the main chart, using light blue
            ...
            // Append a 14-days RSI indicator chart (75 pixels high) after the main
            // chart. The main RSI line is purple (800080). Set threshold region to
            // +/- 20 (that is, RSI = 50 +/- 25). The upper/lower threshold regions
            // will be filled with red (ff0000)/blue (0000ff).

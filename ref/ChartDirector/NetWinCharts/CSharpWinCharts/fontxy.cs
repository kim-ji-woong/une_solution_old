...
namespace CSharpChartExplorer
{
    public class fontxy : DemoModule
    {
        ...
        public void createChart(WinChartViewer viewer, string img)
        {
            ...
            // Add a title to the chart using 20 pts Times Bold Italic (timesbi.ttf)
            // font and using a deep blue color (0x000080)
            c.addTitle("Weekly Server Load", "Times New Roman Bold Italic", 20,
                0x000080);

            // Add a legend box at (420, 100) (right of plot area) using 12 pts Times
            // Bold font. Sets the background of the legend box to light grey
            // 0xd0d0d0 with a 1 pixel 3D border.
            ...
            // font. Set the background to yellow (0xffff00) with a 2 pixel 3D
            // border.
            ...
            // Use 10 pts Arial Bold/green (0x008000) font for the x axis labels. Set
            // the label angle to 45 degrees.
            ...
            // Use 10 pts Times Bold Italic (timesbi.ttf) as the aggregate label
            // font. Set the background to flesh (0xffcc66) color with a 1 pixel 3D
            // border.
            ...
            // Add the third data set to the stacked bar layer, and set its data
            // label font to Arial Bold Italic.
            ChartDirector.TextBox textbox = layer.addDataSet(data2, -1, "Server #3"
                ).setDataLabelStyle("Arial Bold Italic");

            // Set the data label font color for the third data set to yellow
            // (0xffff00)
            textbox.setFontColor(0xffff00);

            // Set the data label background color to the same color as the bar
            // segment, with a 1 pixel 3D border.

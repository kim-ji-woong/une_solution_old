...
protected void Page_Load(object sender, EventArgs e)
{
    ...
    BoxWhiskerLayer errLayer = c.addBoxWhiskerLayer(null, null, new ArrayMath(data
        ).add(errData).result(), new ArrayMath(data).sub(errData).result(), data,
    ...
    // whisker layer.
    WebChartViewer1.ImageMap = errLayer.getHTMLImageMap("", "",

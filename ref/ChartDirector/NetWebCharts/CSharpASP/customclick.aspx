...
protected void Page_Load(object sender, EventArgs e)
{
    ...
    double[] data0 = {50, 55, 47, 36, 42, 49, 63, 62, 73, 59, 56, 50, 64, 60, 67, 67,
        58, 59, 73, 77, 84, 82, 80, 84};
    double[] data1 = {36, 28, 25, 33, 38, 20, 22, 30, 25, 33, 30, 24, 28, 36, 30, 45,
    ...
    // Add a legend box at (55, 58) (top of plot area) using 9 pts Arial Bold font
    ...
    // Add a title to the chart using 15 pts Times Bold Italic font. The text is
    // white (ffffff) on a blue (0000cc) background, with glass effect.
    ...
    // axis.
    Mark mark = c.xAxis2().addMark(17, unchecked((int)0x809933ff),
        "Merge with Star Tech", "Arial Bold");
    ...
    string titleImageMap = "<area " + title.getImageCoor() +
        " href='javascript:popMsg(\"the chart title\");' title='The title is " +
        "clickable!'>";

    // Obtain the image map for the mark
    string markImageMap = "<area " + mark.getImageCoor() +
        " href='javascript:popMsg(\"the Merge with Star Tech mark\");' title='The " +
        "Merge with Star Tech text is clickable!'>";

    // Obtain the image map for the copyright message
    string copyRightImageMap = "<area " + copyRight.getImageCoor() +
        " href='javascript:popMsg(\"the copyright message\");' title='The " +
        "copyright text is clickable!'>";

    // Get the combined image map
    WebChartViewer1.ImageMap = chartImageMap + legendImageMap + titleImageMap +
        markImageMap + copyRightImageMap;
}

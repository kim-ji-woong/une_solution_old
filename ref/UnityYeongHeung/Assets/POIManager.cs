...
public class POIManager : MonoBehaviour
{
    ...
    public void AddIconPOI(string szPath, float x, float y, float z)
    {
        ...
        if(int.TryParse(paths[2], out nID))
        {
            ...
            poi.m_bVisible = false;

            float dx = ModelManager.Instance.Model.transform.localScale.x;
            float dy = 0.1f;
            poi.Position = new Vector3(x * dx, z * dy, -y * dx);
            ...
            obj.transform.position = new Vector3(x * dx, z * dy + m_fExtraHeight, -y * dx);
    ...
    {       
        ...
        if(render!= null)
        {
            ...
            if(mat != null)
            {
                ...
                float dx = ModelManager.Instance.Model.transform.localScale.x;
                float dy = 0.1f;
                mNameText.transform.position = new Vector3(x * dx, y * dy, z * dx);

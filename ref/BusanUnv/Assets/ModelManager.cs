...
{    
    ...
    private float m_fTextLODDistance = 450.0f;
    ...
    public Material outline_TextMaterial;
    public Material OutlineTextMaterial
    {
        get { return outline_TextMaterial; }
        set { outline_TextMaterial = value; }
    }
    ...
    // Inside
    private float m_DistanceRatioIcon = 20.0f;
    // outside
    ...
    private void CreateWebDB()
    {
        ...
        if( Application.isEditor == false)
        {
            ...
            Debug.logger.Log("Read SiteID : " + szSiteID);
        }
        else
        {
        ...
        mWebDBManager.DatabaseType = DBUtility.WebDBManager.DBType.sqlserver;
        mWebDBManager.DatabaseName = "EDU_101";
        mWebDBManager.DatabasePort = "1433";        
    ...
    {
        //if (!szMeshName.Contains("("))
        //    return "";

        //string szKey = szMeshName;
        //string[] temp = szMeshName.Split(new char[] { '(' }, StringSplitOptions.RemoveEmptyEntries);
        //if(temp != null)
        //{
        //    int nIdx = temp.Length - 1;
        //    if( nIdx > 0)
        //    {
        //        szKey = temp[nIdx];
        //        szKey = "(" + szKey;
        ...
        //if (!m_MeshAlias.Contains(szKey))
        //    return "";
        //string szName = (string)m_MeshAlias[szKey];

        if (szMeshName.EndsWith("607_02") == true)
        {
            szMeshName = szMeshName.Replace("_02", "");
        }

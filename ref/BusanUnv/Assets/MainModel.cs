...
public class MainModel : MonoBehaviour
{
    ...
    private float m_fZoomDistance = 14.0f;
    ...
    void Update()
    {
        ...
        Debug.Log("Input x : " + Input.mousePosition.x + "    Screen Width : " +  Screen.width);
        Debug.Log("Input y : " + Input.mousePosition.y + "    Screen Height : " + Screen.height);
        // Wheel button click
        if (Input.GetMouseButtonDown(2) && !(Input.mousePosition.x == 0 || Input.mousePosition.y == 0 || Input.mousePosition.x >= Screen.width - 1 || Input.mousePosition.y == Screen.height - 1))  //if (m_bZoominng == true)
        {

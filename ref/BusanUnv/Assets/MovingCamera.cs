...
{
    private float m_fTopViewDistance = 100.0f;
    ...
    //지진 시뮬레이션
    private void SetEarthquake(int amount, int duration)
    {
        ...
        switch (amount)
        {
            case 1: shakeAmount = 0.01f;
                break;
            case 2: shakeAmount = 0.03f;
                break;
            case 3: shakeAmount = 0.05f;
                break;
            default: shakeAmount = 0.01f;
                break;
        }
        switch (duration)
        {
            case 1: shakeDuration = 5.0f;
                break;
            case 2: shakeDuration = 10.0f;
                break;
            case 3: shakeDuration = 15.0f;
                break;
            default: shakeDuration = 5.0f;
                break;
        }
    ...
    private string m_szMainModelName = "site_01";
    ...
    {
        string szTemp = szObjectName;
        if (szObjectName.Contains("_0"))
        {
            string[] sp = szObjectName.Split(new char[] { '_' }, StringSplitOptions.RemoveEmptyEntries);
            if (sp != null)
            {
                szTemp = sp[0];
            }
        }
        FindOptimunView(szTemp, 1, false, m_fTopViewAngle, m_fTopViewDistance);
    }

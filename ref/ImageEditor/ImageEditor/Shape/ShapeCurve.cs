...
namespace ImageEditor
{
    class ShapeCurve// : ShapeBase
    {
        ...
        public ShapeCurve(int x, int y, int x2, int y2, Color color, int nThick)
        {
            this.X = x;
            this.Y = y;
            this.X2 = x2;
        ...
        public ShapeCurve(Point pt, Point pt2, Color color, int nThick)
        {
            this.X = pt.X;
            this.Y = pt.Y;
            this.X2 = pt2.X;

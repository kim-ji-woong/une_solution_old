...
public class SearchSnowToday extends SearchSnow {
	...
	public SearchSnowToday()
	{
		...
		SnowData today = new SnowData();
		today.setSumData(true);
		itemValues.add(today);
		
		// 최대값 사용하지 않는다.
		/*SnowData maxHour = new SnowData();
	...
	public void setMax(String max)
	{
		...
		{
			max = DoubleToString(num.getValue() * 0.1);
		}
		
		this.max = max;
		//setItemValue(this.max, 25);
	}
}

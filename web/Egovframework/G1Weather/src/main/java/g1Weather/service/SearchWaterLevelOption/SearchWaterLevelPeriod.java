...
public class SearchWaterLevelPeriod extends SearchWaterLevel {
	...
	public SearchWaterLevelPeriod()
	{
		...
		/*WaterLevelData sum = new WaterLevelData();
		sum.setSumData(true);
		itemValues.add(sum);*/
	}
	...
	public void setH01(String waterLevelHour)
	{
		...
		else
		{
			...
			{
				this.h01 = Double.toString(waterLevel.getValue());
				postProcess(waterLevel.getValue());
			}
		}

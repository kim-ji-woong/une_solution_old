...
public class SearchRain extends PageVO {
	...
	protected List<RainData> itemValues = new ArrayList();
	
	public RainData makeRainData()
	{
		return new RainData();
	}
	
	public void setRainDataValue(RainData data, String value)
	{
		data.setValue(value);
	}
	...
	public List<RainData> getItemValues()
	{
		return itemValues;
	}

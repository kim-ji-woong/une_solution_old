...
public class SearchSnow extends PageVO {
	...
	protected List<SnowData> itemValues = new ArrayList();
	
	public SnowData makeSnowData()
	{
		return new SnowData();
	}
	
	public void setSnowDataValue(SnowData data, String value)
	{
		data.setValue(value);
	}
	...
	public List<SnowData> getItemValues()
	{
		return itemValues;
	}

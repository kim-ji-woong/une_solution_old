			...
			while(result.next())
	 		{
                ...
                //int nMemberID = result.getInt("MemberID");
                //String strUserName = result.getString("UserName");
                //int nUserLevel = result.getInt("UserLevel");
                //int nTeamID = result.getInt("TeamID");
                //String strPassword = result.getString("Password");
                //String strUserID = result.getString("UserID");
	 		}

...
<%
	...
	*/
	...
	if (strDeviceID == null || strSerialNumber == null || strPhoneNumber == null)
	{
	...
	{
		String encPhoneNumber = strPhoneNumber;//AES256Cipher.AES_Encode(strPhoneNumber);
		...
		try
		{
			...
			{	
				...
				if (firstRequest)
				{
					...
					strSQL = "Insert into CertRequest (ID, DeviceID, PhoneNumber, SerialNumber) ";
					strSQL += String.format("values (%d, '%s', '%s', '%s')", nID, strDeviceID, encPhoneNumber, strSerialNumber);

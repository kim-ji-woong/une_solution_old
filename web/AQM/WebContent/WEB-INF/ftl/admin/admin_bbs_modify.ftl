...
<head>
	...
	function loadContent() {
		...
		Editor.modify({
			   ...
			   "content": document.getElementById("contentText") /* 내용 문자열, 주어진 필드(textarea) 엘리먼트 */
	  	});
 	}
        ...
        <div class="container">
            ...
            <div class="content">
                <div class="breadcrumbs breadcrumbs_no_margin">
                   홈 > 관리자> <strong>수정하기</strong>
                </div>
                <div class="well">
                    <div class="admin_sub_menu">
                      <h2 class="title_admin">수정하기</h2>
                      <#include "../inc/admin_menu.ftl">
                    </div>
                    <form id="bbs_content" class="bbs_detail" action="${Context.contextPath}/Admin/post/modify/${Post.id}"                    
                     method="post"><table>
                          <thead>
                              <tr>
                                  ...
                                  <td colspan="5">
                              	  <#if (Post.title) ??>
                              		<input type="text" name="title" placeholder="제목을 입력하세요" value="${Post.title}"></input>  
                                  <#else>
                          ...
                          <tbody>
                              <tr>
                                  <textarea name="contentText" id="contentText" cols="130" rows="30" placeholder="내용을 입력하세요" style="display:none;">${Post.content}</textarea>

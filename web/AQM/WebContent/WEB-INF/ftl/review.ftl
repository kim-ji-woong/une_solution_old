...
<head>
	...
	$( function() {	
        ...
        .on( "change", function() 
        {
        		...
        		minDate.setDate(minDate.getDate() + 6);   
	     		...
	     		to.datepicker( "option", "maxDate", minDate);     		
	...
	{
		var dateTxt = document.getElementById("from");
		var txt = dateTxt.value;
		if(txt != "")
		{
			var form = document.getElementById("formExcelDownload");		
			form.action = "${Context.contextPath}/File/report/excel/" + currentNodeID;
			form.submit();
		}		
		else
		{
            ...
            <div class="content">
                ...
                <div class="search">
                    <div class="search_school school_info">
                        ...
                        <div class="box">
							...
							<div class="list">  
							    <div class="item"><h3>설치장소</h3></div>
							    <br>
                                <div><h4>서울특별시 용산구 서계동 주연빌딩 8층</h4></div>
                                <br>
                                <div><h4>유엔이 사무실</h4></div>
                            </div>
                ...
                <div class="search_information">
                    ...
                    <div class="search_detail">
                        <h3>실내공기질 상세측정정보</h3>
                        <form id="formExcelDownload" action="${Context.contextPath}/File/report/excel/" method="get">
                             <input id="SiteID" name="SiteID" value="${SiteID}" type="hidden" />
                             <table>
                                <tbody>
                                    <tr>
                            ...
                            <div class="btn_search_detail">
                                ...
                                <input type="image" src="${Context.contextPath}/images/btn_result.png" onclick="downloadReport();return false;" />
                            </div>
                        </form>
                    </div>
